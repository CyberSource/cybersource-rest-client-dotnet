...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseProcessingInformationBankTransferOptions :  IEquatable<TssV2TransactionsGet200ResponseProcessingInformationBankTransferOptions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (SecCode != null) sb.Append("  SecCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationBankTransferOptions", "secCode", SecCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseProcessingInformationBankTransferOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
