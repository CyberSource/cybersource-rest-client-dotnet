...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002KeyInformation :  IEquatable<InlineResponse2002KeyInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002KeyInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2002KeyInformation(string OrganizationId = default(string), string ReferenceNumber = default(string), string KeyId = default(string), string Status = default(string), string ExpirationDate = default(string), string Message = default(string), string Alias = default(string), InlineResponse201ErrorInformation ErrorInformation = default(InlineResponse201ErrorInformation))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2002KeyInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002KeyInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2002KeyInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002KeyInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002KeyInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
