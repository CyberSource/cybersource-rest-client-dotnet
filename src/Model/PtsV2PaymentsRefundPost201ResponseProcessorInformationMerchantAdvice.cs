...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsRefundPost201ResponseProcessorInformationMerchantAdvice :  IEquatable<PtsV2PaymentsRefundPost201ResponseProcessorInformationMerchantAdvice>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformationMerchantAdvice", "code", Code.ToString())).Append("\n");
            if (CodeRaw != null) sb.Append("  CodeRaw: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformationMerchantAdvice", "codeRaw", CodeRaw.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsRefundPost201ResponseProcessorInformationMerchantAdvice", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
