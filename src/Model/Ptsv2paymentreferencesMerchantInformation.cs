...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentreferencesMerchantInformation :  IEquatable<Ptsv2paymentreferencesMerchantInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (MerchantDescriptor != null) sb.Append("  MerchantDescriptor: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentreferencesMerchantInformation", "merchantDescriptor", MerchantDescriptor.ToString())).Append("\n");
            if (CancelUrl != null) sb.Append("  CancelUrl: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentreferencesMerchantInformation", "cancelUrl", CancelUrl.ToString())).Append("\n");
