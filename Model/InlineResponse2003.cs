...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(string SubmitTimeUtc = default(string), Kmsv2keyssymClientReferenceInformation ClientReferenceInformation = default(Kmsv2keyssymClientReferenceInformation), List<InlineResponse2003KeyInformation> KeyInformation = default(List<InlineResponse2003KeyInformation>))
        {
        ...
        public List<InlineResponse2003KeyInformation> KeyInformation { get; set; }
