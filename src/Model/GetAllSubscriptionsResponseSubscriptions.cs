...
namespace CyberSource.Model
{
    ...
    public partial class GetAllSubscriptionsResponseSubscriptions :  IEquatable<GetAllSubscriptionsResponseSubscriptions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "id", Id.ToString())).Append("\n");
            if (PlanInformation != null) sb.Append("  PlanInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "planInformation", PlanInformation.ToString())).Append("\n");
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponseSubscriptions", "orderInformation", OrderInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("GetAllSubscriptionsResponseSubscriptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
