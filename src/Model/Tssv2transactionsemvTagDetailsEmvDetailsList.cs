...
namespace CyberSource.Model
{
    ...
    public partial class Tssv2transactionsemvTagDetailsEmvDetailsList :  IEquatable<Tssv2transactionsemvTagDetailsEmvDetailsList>, IValidatableObject
    {
        ...
        [JsonPropertyName("emvRequestCombinedTags")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        public override string ToString()
        {
            ...
            if (RequestId != null) sb.Append("  RequestId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Tssv2transactionsemvTagDetailsEmvDetailsList", "requestId", RequestId.ToString())).Append("\n");
            if (EmvRequestCombinedTags != null) sb.Append("  EmvRequestCombinedTags: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Tssv2transactionsemvTagDetailsEmvDetailsList", "emvRequestCombinedTags", EmvRequestCombinedTags.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Tssv2transactionsemvTagDetailsEmvDetailsList", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
