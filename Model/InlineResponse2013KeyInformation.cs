...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013KeyInformation :  IEquatable<InlineResponse2013KeyInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013KeyInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2013KeyInformation(string Provider = default(string), string Tenant = default(string), string OrganizationId = default(string), string ClientKeyId = default(string), string KeyId = default(string), string Key = default(string), string KeyType = default(string), string Status = default(string), string ExpirationDate = default(string), string Message = default(string), InlineResponse2013KeyInformationErrorInformation ErrorInformation = default(InlineResponse2013KeyInformationErrorInformation))
        {
        ...
        public InlineResponse2013KeyInformationErrorInformation ErrorInformation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013KeyInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2013KeyInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013KeyInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013KeyInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
