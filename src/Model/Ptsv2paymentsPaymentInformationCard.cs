...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPaymentInformationCard :  IEquatable<Ptsv2paymentsPaymentInformationCard>, IValidatableObject
    {
        ...
        [JsonPropertyName("securityCodeIndicator")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        [JsonPropertyName("typeSelectionIndicator")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public string TypeSelectionIndicator { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "number", Number.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "type", Type.ToString())).Append("\n");
            if (UseAs != null) sb.Append("  UseAs: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "useAs", UseAs.ToString())).Append("\n");
            if (SourceAccountType != null) sb.Append("  SourceAccountType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "sourceAccountType", SourceAccountType.ToString())).Append("\n");
            if (SourceAccountTypeDetails != null) sb.Append("  SourceAccountTypeDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "sourceAccountTypeDetails", SourceAccountTypeDetails.ToString())).Append("\n");
            if (SecurityCode != null) sb.Append("  SecurityCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "securityCode", SecurityCode.ToString())).Append("\n");
            if (SecurityCodeIndicator != null) sb.Append("  SecurityCodeIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "securityCodeIndicator", SecurityCodeIndicator.ToString())).Append("\n");
            if (AccountEncoderId != null) sb.Append("  AccountEncoderId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "accountEncoderId", AccountEncoderId.ToString())).Append("\n");
            if (IssueNumber != null) sb.Append("  IssueNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "issueNumber", IssueNumber.ToString())).Append("\n");
            if (StartMonth != null) sb.Append("  StartMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "startMonth", StartMonth.ToString())).Append("\n");
            if (StartYear != null) sb.Append("  StartYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "startYear", StartYear.ToString())).Append("\n");
            if (ProductName != null) sb.Append("  ProductName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "productName", ProductName.ToString())).Append("\n");
            if (ProductSubtype != null) sb.Append("  ProductSubtype: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "productSubtype", ProductSubtype.ToString())).Append("\n");
            if (TypeSelectionIndicator != null) sb.Append("  TypeSelectionIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationCard", "typeSelectionIndicator", TypeSelectionIndicator.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsPaymentInformationCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
