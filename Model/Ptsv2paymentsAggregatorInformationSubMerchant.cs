...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsAggregatorInformationSubMerchant :  IEquatable<Ptsv2paymentsAggregatorInformationSubMerchant>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Id, length must be less than or equal to 20.", new [] { "Id" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Region, length must be less than or equal to 3.", new [] { "Region" });
            }
