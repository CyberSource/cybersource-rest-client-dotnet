...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponsePayoutOptions :  IEquatable<TssV2TransactionsGet200ResponsePayoutOptions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (PayoutInquiry != null) sb.Append("  PayoutInquiry: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponsePayoutOptions", "payoutInquiry", PayoutInquiry.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponsePayoutOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
