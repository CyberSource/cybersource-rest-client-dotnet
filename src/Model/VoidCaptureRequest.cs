...
namespace CyberSource.Model
{
    ...
    public partial class VoidCaptureRequest :  IEquatable<VoidCaptureRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidCaptureRequest", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidCaptureRequest", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidCaptureRequest", "orderInformation", OrderInformation.ToString())).Append("\n");
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("VoidCaptureRequest", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
