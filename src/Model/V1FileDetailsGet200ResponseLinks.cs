...
namespace CyberSource.Model
{
    ...
    public partial class V1FileDetailsGet200ResponseLinks :  IEquatable<V1FileDetailsGet200ResponseLinks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Self != null) sb.Append("  Self: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinks", "self", Self.ToString())).Append("\n");
            if (Files != null) sb.Append("  Files: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinks", "files", Files.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("V1FileDetailsGet200ResponseLinks", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
