...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2CreateOrderPost201ResponseBuyerInformation :  IEquatable<PtsV2CreateOrderPost201ResponseBuyerInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (MerchantCustomerId != null) sb.Append("  MerchantCustomerId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreateOrderPost201ResponseBuyerInformation", "merchantCustomerId", MerchantCustomerId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2CreateOrderPost201ResponseBuyerInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
