...
{
    public class ScAuthorizationOnly
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "ScAuthorizationOnly";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/CapturePayment/SimpleCapture/CreateAuthorizationOnly.csv"), true))
            {
