...
{
    public class VisaInstallmentcommerceIndicatorInstall
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "VisaInstallmentCommerceIndicatorInstall";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/CreateVisaInstallmentCommerceIndicatorInstall.csv"), true))
            {
