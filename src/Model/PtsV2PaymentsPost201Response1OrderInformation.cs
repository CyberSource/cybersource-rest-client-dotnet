...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PtsV2PaymentsPost201Response1OrderInformation :  IEquatable<PtsV2PaymentsPost201Response1OrderInformation>, IValidatableObject
    {
        /// <summary>
        ...
        public PtsV2PaymentsPost201Response1OrderInformationBillTo BillTo { get; set; }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201Response1OrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PtsV2PaymentsPost201Response1OrderInformation);
        }

        /// <summary>
        /// Returns true if PtsV2PaymentsPost201Response1OrderInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of PtsV2PaymentsPost201Response1OrderInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PtsV2PaymentsPost201Response1OrderInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
