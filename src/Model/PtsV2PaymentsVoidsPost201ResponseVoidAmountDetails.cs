...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails :  IEquatable<PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (VoidAmount != null) sb.Append("  VoidAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails", "voidAmount", VoidAmount.ToString())).Append("\n");
            if (OriginalTransactionAmount != null) sb.Append("  OriginalTransactionAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails", "originalTransactionAmount", OriginalTransactionAmount.ToString())).Append("\n");
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails", "currency", Currency.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
