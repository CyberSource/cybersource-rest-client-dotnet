...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20010EmbeddedTotals :  IEquatable<InlineResponse20010EmbeddedTotals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010EmbeddedTotals" /> class.
        /// </summary>
        ...
        public InlineResponse20010EmbeddedTotals(int? AcceptedRecords = default(int?), int? RejectedRecords = default(int?), int? UpdatedRecords = default(int?), int? CaResponses = default(int?), int? CaResponsesOmitted = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20010EmbeddedTotals);
        }

        /// <summary>
        /// Returns true if InlineResponse20010EmbeddedTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20010EmbeddedTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010EmbeddedTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
