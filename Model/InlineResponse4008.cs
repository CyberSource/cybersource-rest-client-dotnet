...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4008 :  IEquatable<InlineResponse4008>, IValidatableObject
    {
        ...
        public InlineResponse4008(string Status = default(string), string Message = default(string), string Code = default(string), List<InlineResponse4008Details> Details = default(List<InlineResponse4008Details>), string SubmitTimeUtc = default(string))
        {
            this.Status = Status;
        ...
        public List<InlineResponse4008Details> Details { get; set; }
