...
namespace CybsQaScript.Payments.Authorize_Payment.Purchase_Cards_Level_2
{
    public class Pcl2MasterCard
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "PurchaseLevel2MasterCard";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/PurchaseCardsLevel2/CreateMasterCard.csv"), true))
            {
