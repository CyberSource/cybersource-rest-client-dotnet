...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseOrderInformationInvoiceDetails :  IEquatable<PtsV2PaymentsPost201ResponseOrderInformationInvoiceDetails>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Level3TransmissionStatus != null) sb.Append("  Level3TransmissionStatus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseOrderInformationInvoiceDetails", "level3TransmissionStatus", Level3TransmissionStatus.ToString())).Append("\n");
            if (SalesSlipNumber != null) sb.Append("  SalesSlipNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseOrderInformationInvoiceDetails", "salesSlipNumber", SalesSlipNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseOrderInformationInvoiceDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
