...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TssV2TransactionsPost201Response1 :  IEquatable<TssV2TransactionsPost201Response1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TssV2TransactionsPost201Response1" /> class.
        /// </summary>
        ...
        public TssV2TransactionsPost201Response1(string SearchId = default(string), bool? Save = default(bool?), string Name = default(string), string Timezone = default(string), string Query = default(string), int? Offset = default(int?), int? Limit = default(int?), string Sort = default(string), int? Count = default(int?), int? TotalCount = default(int?), string Status = default(string), string SubmitTimeUtc = default(string), TssV2TransactionsPost201Response1Embedded Embedded = default(TssV2TransactionsPost201Response1Embedded), PtsV2PaymentsReversalsPost201ResponseLinks Links = default(PtsV2PaymentsReversalsPost201ResponseLinks))
        {
        ...
        public TssV2TransactionsPost201Response1Embedded Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TssV2TransactionsPost201Response1 {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TssV2TransactionsPost201Response1);
        }

        /// <summary>
        /// Returns true if TssV2TransactionsPost201Response1 instances are equal
        /// </summary>
        /// <param name="other">Instance of TssV2TransactionsPost201Response1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TssV2TransactionsPost201Response1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
