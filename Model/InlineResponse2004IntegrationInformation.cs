...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004IntegrationInformation :  IEquatable<InlineResponse2004IntegrationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004IntegrationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2004IntegrationInformation(List<Boardingv1registrationsIntegrationInformationOauth2> Oauth2 = default(List<Boardingv1registrationsIntegrationInformationOauth2>), List<InlineResponse2004IntegrationInformationTenantConfigurations> TenantConfigurations = default(List<InlineResponse2004IntegrationInformationTenantConfigurations>))
        {
            this.Oauth2 = Oauth2;
        ...
        public List<InlineResponse2004IntegrationInformationTenantConfigurations> TenantConfigurations { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004IntegrationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2004IntegrationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004IntegrationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004IntegrationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
