...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsPaymentInformationCard :  IEquatable<V2payoutsPaymentInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsPaymentInformationCard" /> class.
        /// </summary>
        ...
        public V2payoutsPaymentInformationCard(string Type = default(string), string Number = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string SourceAccountType = default(string))
        {
            this.Type = Type;
            this.Number = Number;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2payoutsPaymentInformationCard {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsPaymentInformationCard);
        }

        /// <summary>
        /// Returns true if V2payoutsPaymentInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsPaymentInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsPaymentInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
