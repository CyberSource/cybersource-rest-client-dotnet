...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsClientReferenceInformation :  IEquatable<Ptsv2paymentsClientReferenceInformation>, IValidatableObject
    {
        ...
        public Ptsv2paymentsClientReferenceInformation(string Code = default(string), string PausedRequestId = default(string), string TransactionId = default(string), string Comments = default(string), Ptsv2paymentsClientReferenceInformationPartner Partner = default(Ptsv2paymentsClientReferenceInformationPartner), string ApplicationName = default(string), string ApplicationVersion = default(string), string ApplicationUser = default(string))
        {
            this.Code = Code;
