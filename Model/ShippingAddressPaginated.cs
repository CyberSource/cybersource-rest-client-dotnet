...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShippingAddressPaginated :  IEquatable<ShippingAddressPaginated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingAddressPaginated" /> class.
        /// </summary>
        /// <param name="Links">Links.</param>
        /// <param name="Embedded">Embedded.</param>
        public ShippingAddressPaginated(ShippingAddressListForCustomerLinks Links = default(ShippingAddressListForCustomerLinks), ShippingAddressListForCustomerEmbedded Embedded = default(ShippingAddressListForCustomerEmbedded))
        {
            this.Links = Links;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShippingAddressPaginated);
        }

        /// <summary>
        /// Returns true if ShippingAddressPaginated instances are equal
        /// </summary>
        /// <param name="other">Instance of ShippingAddressPaginated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippingAddressPaginated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
