...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PtsV2PaymentsPost201ResponsePaymentAccountInformationCard :  IEquatable<PtsV2PaymentsPost201ResponsePaymentAccountInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PtsV2PaymentsPost201ResponsePaymentAccountInformationCard" /> class.
        /// </summary>
        ...
        /// <param name="HashedNumber">#### Visa Platform Connect This API field will contain the SHA 256 hashed value of PAN. .</param>
        public PtsV2PaymentsPost201ResponsePaymentAccountInformationCard(string Suffix = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Type = default(string), string Prefix = default(string), string HashedNumber = default(string))
        {
            this.Suffix = Suffix;
        ...
        /// </summary>
        /// <value>#### Visa Platform Connect This API field will contain the SHA 256 hashed value of PAN. </value>
        ...
        public override string ToString()
        {
            ...
            if (Suffix != null) sb.Append("  Suffix: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", "suffix", Suffix.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", "type", Type.ToString())).Append("\n");
            if (Prefix != null) sb.Append("  Prefix: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", "prefix", Prefix.ToString())).Append("\n");
            if (HashedNumber != null) sb.Append("  HashedNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", "hashedNumber", HashedNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponsePaymentAccountInformationCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PtsV2PaymentsPost201ResponsePaymentAccountInformationCard);
        }

        /// <summary>
        /// Returns true if PtsV2PaymentsPost201ResponsePaymentAccountInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of PtsV2PaymentsPost201ResponsePaymentAccountInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PtsV2PaymentsPost201ResponsePaymentAccountInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.HashedNumber == other.HashedNumber ||
                    this.HashedNumber != null &&
                    this.HashedNumber.Equals(other.HashedNumber)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HashedNumber != null)
                    hash = hash * 59 + this.HashedNumber.GetHashCode();
                return hash;
            }
        }
