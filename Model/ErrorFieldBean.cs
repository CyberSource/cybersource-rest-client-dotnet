...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ErrorFieldBean :  IEquatable<ErrorFieldBean>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorFieldBean" /> class.
        /// </summary>
        ...
        public ErrorFieldBean(string Path = default(string), string Message = default(string), string LocalizationKey = default(string))
        {
            this.Path = Path;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ErrorFieldBean);
        }

        /// <summary>
        /// Returns true if ErrorFieldBean instances are equal
        /// </summary>
        /// <param name="other">Instance of ErrorFieldBean to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorFieldBean other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
