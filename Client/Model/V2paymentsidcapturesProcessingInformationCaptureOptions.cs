...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesProcessingInformationCaptureOptions :  IEquatable<V2paymentsidcapturesProcessingInformationCaptureOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesProcessingInformationCaptureOptions" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesProcessingInformationCaptureOptions(decimal? CaptureSequenceNumber = default(decimal?), decimal? TotalCaptureCount = default(decimal?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesProcessingInformationCaptureOptions);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesProcessingInformationCaptureOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesProcessingInformationCaptureOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesProcessingInformationCaptureOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
