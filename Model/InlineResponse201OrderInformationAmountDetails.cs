...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse201OrderInformationAmountDetails :  IEquatable<InlineResponse201OrderInformationAmountDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse201OrderInformationAmountDetails" /> class.
        /// </summary>
        ...
        public InlineResponse201OrderInformationAmountDetails(string TotalAmount = default(string), string AuthorizedAmount = default(string), string Currency = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse201OrderInformationAmountDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse201OrderInformationAmountDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse201OrderInformationAmountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse201OrderInformationAmountDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
