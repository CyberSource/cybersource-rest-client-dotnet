...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PblPaymentLinksGet200Response :  IEquatable<PblPaymentLinksGet200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PblPaymentLinksGet200Response" /> class.
        /// </summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public PblPaymentLinksPost201ResponsePurchaseInformation PurchaseInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "status", Status.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            if (PurchaseInformation != null) sb.Append("  PurchaseInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "purchaseInformation", PurchaseInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksGet200Response", "orderInformation", OrderInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PblPaymentLinksGet200Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PblPaymentLinksGet200Response);
        }

        /// <summary>
        /// Returns true if PblPaymentLinksGet200Response instances are equal
        /// </summary>
        /// <param name="other">Instance of PblPaymentLinksGet200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PblPaymentLinksGet200Response other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
