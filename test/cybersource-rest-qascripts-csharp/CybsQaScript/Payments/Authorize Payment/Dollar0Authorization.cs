...
{
    public class Dollar0Authorization
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "Dollar0Authorization";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/Dollar0Authorization.csv"), true))
            {
