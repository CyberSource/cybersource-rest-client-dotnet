...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4003 :  IEquatable<InlineResponse4003>, IValidatableObject
    {
        ...
        public InlineResponse4003(string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<InlineResponse201ErrorInformationDetails> Details = default(List<InlineResponse201ErrorInformationDetails>))
        {
