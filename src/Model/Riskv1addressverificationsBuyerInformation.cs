...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1addressverificationsBuyerInformation :  IEquatable<Riskv1addressverificationsBuyerInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (MerchantCustomerId != null) sb.Append("  MerchantCustomerId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsBuyerInformation", "merchantCustomerId", MerchantCustomerId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1addressverificationsBuyerInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
