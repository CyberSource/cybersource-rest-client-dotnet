...
{
    public class Pcl2Visa
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "PurchaseLevel2Visa";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/PurchaseCardsLevel2/CreateVisa.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var invoiceDetailsObj = new Ptsv2paymentsOrderInformationInvoiceDetails
                            {
