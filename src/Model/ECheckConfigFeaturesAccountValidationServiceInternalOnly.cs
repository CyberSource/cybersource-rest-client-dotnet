...
namespace CyberSource.Model
{
    ...
    public partial class ECheckConfigFeaturesAccountValidationServiceInternalOnly :  IEquatable<ECheckConfigFeaturesAccountValidationServiceInternalOnly>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Processors != null) sb.Append("  Processors: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ECheckConfigFeaturesAccountValidationServiceInternalOnly", "processors", Processors.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("ECheckConfigFeaturesAccountValidationServiceInternalOnly", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
