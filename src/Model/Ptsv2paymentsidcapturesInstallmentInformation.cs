...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidcapturesInstallmentInformation :  IEquatable<Ptsv2paymentsidcapturesInstallmentInformation>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Amount">Amount for the current installment payment.  This field is supported only for CyberSource through VisaNet. .</param>
        /// <param name="Frequency">Frequency of the installment payments. When you do not include this field in a request for a Crediario installment payment, CyberSource sends a space character to the processor.  This field is supported only for CyberSource through VisaNet. Possible values: - &#x60;B&#x60;: Biweekly - &#x60;M&#x60;: Monthly - &#x60;W&#x60;: Weekly  For Crediario installment payments, the value for this field corresponds to the following data in the TC 33 capture file5: - Record: CP01 TCR9 - Position: 41 - Field: Installment Frequency .</param>
        ...
        /// <param name="TotalAmount">Total amount of the loan that is being paid in installments. This field is supported only for CyberSource through VisaNet. .</param>
        ...
        /// </summary>
        /// <value>Amount for the current installment payment.  This field is supported only for CyberSource through VisaNet. </value>
        ...
        /// </summary>
        /// <value>Frequency of the installment payments. When you do not include this field in a request for a Crediario installment payment, CyberSource sends a space character to the processor.  This field is supported only for CyberSource through VisaNet. Possible values: - &#x60;B&#x60;: Biweekly - &#x60;M&#x60;: Monthly - &#x60;W&#x60;: Weekly  For Crediario installment payments, the value for this field corresponds to the following data in the TC 33 capture file5: - Record: CP01 TCR9 - Position: 41 - Field: Installment Frequency </value>
        ...
        /// </summary>
        /// <value>Total amount of the loan that is being paid in installments. This field is supported only for CyberSource through VisaNet. </value>
        ...
        /// Total number of installments when making payments in installments.  #### Chase Paymentech Solutions and FDC Compass This field is optional because this value is required in the merchant descriptors.  #### American Express Direct, Cielo, and Comercio Latino This value is the total number of installments you approved.  #### CyberSource Latin American Processing in Brazil This value is the total number of installments that you approved. The default is 1.  #### All Other Processors This value is used along with _sequence_ to track which payment is being processed.  For example, the second of 5 payments would be passed to CyberSource as _sequence_ &#x3D; 2 and _totalCount_ &#x3D; 5.  #### CyberSource through VisaNet For Crediario installment payments, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP01 TCR9 - Position: 23-25 - Field: Number of Installments  For installment payments with American Express in Brazil, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP07 TCR3 - Position: 7-8 - Field: Number of Installments  For installment payments with Visa in Brazil, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP07 TCR1 - Position: 7-8 - Field: Number of Installments  For all other kinds of installment payments, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP01 TCR5 - Position: 20-22 - Field: Installment Total Count  **Note** The TC 33 Capture file contains information about the purchases and refunds that a merchant submits to CyberSource. CyberSource through VisaNet creates the TC 33 Capture file at the end of the day and sends it to the merchant&#39;s acquirer, who uses this information to facilitate end-of-day clearing processing with payment card companies. 
        /// </summary>
        /// <value>Total number of installments when making payments in installments.  #### Chase Paymentech Solutions and FDC Compass This field is optional because this value is required in the merchant descriptors.  #### American Express Direct, Cielo, and Comercio Latino This value is the total number of installments you approved.  #### CyberSource Latin American Processing in Brazil This value is the total number of installments that you approved. The default is 1.  #### All Other Processors This value is used along with _sequence_ to track which payment is being processed.  For example, the second of 5 payments would be passed to CyberSource as _sequence_ &#x3D; 2 and _totalCount_ &#x3D; 5.  #### CyberSource through VisaNet For Crediario installment payments, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP01 TCR9 - Position: 23-25 - Field: Number of Installments  For installment payments with American Express in Brazil, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP07 TCR3 - Position: 7-8 - Field: Number of Installments  For installment payments with Visa in Brazil, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP07 TCR1 - Position: 7-8 - Field: Number of Installments  For all other kinds of installment payments, the value for this field corresponds to the following data in the TC 33 capture file*: - Record: CP01 TCR5 - Position: 20-22 - Field: Installment Total Count  **Note** The TC 33 Capture file contains information about the purchases and refunds that a merchant submits to CyberSource. CyberSource through VisaNet creates the TC 33 Capture file at the end of the day and sends it to the merchant&#39;s acquirer, who uses this information to facilitate end-of-day clearing processing with payment card companies. </value>
        ...
        public override string ToString()
        {
            ...
            if (Amount != null) sb.Append("  Amount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "amount", Amount.ToString())).Append("\n");
            if (Frequency != null) sb.Append("  Frequency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "frequency", Frequency.ToString())).Append("\n");
            if (PlanType != null) sb.Append("  PlanType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "planType", PlanType.ToString())).Append("\n");
            if (Sequence != null) sb.Append("  Sequence: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "sequence", Sequence.ToString())).Append("\n");
            if (TotalAmount != null) sb.Append("  TotalAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "totalAmount", TotalAmount.ToString())).Append("\n");
            if (TotalCount != null) sb.Append("  TotalCount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "totalCount", TotalCount.ToString())).Append("\n");
            if (FirstInstallmentDate != null) sb.Append("  FirstInstallmentDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "firstInstallmentDate", FirstInstallmentDate.ToString())).Append("\n");
            if (FirstInstallmentAmount != null) sb.Append("  FirstInstallmentAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "firstInstallmentAmount", FirstInstallmentAmount.ToString())).Append("\n");
            if (InvoiceData != null) sb.Append("  InvoiceData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "invoiceData", InvoiceData.ToString())).Append("\n");
            if (PaymentType != null) sb.Append("  PaymentType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "paymentType", PaymentType.ToString())).Append("\n");
            if (AdditionalCosts != null) sb.Append("  AdditionalCosts: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "additionalCosts", AdditionalCosts.ToString())).Append("\n");
            if (AdditionalCostsPercentage != null) sb.Append("  AdditionalCostsPercentage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "additionalCostsPercentage", AdditionalCostsPercentage.ToString())).Append("\n");
            if (AmountFunded != null) sb.Append("  AmountFunded: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "amountFunded", AmountFunded.ToString())).Append("\n");
            if (AmountRequestedPercentage != null) sb.Append("  AmountRequestedPercentage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "amountRequestedPercentage", AmountRequestedPercentage.ToString())).Append("\n");
            if (AnnualFinancingCost != null) sb.Append("  AnnualFinancingCost: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "annualFinancingCost", AnnualFinancingCost.ToString())).Append("\n");
            if (AnnualInterestRate != null) sb.Append("  AnnualInterestRate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "annualInterestRate", AnnualInterestRate.ToString())).Append("\n");
            if (Expenses != null) sb.Append("  Expenses: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "expenses", Expenses.ToString())).Append("\n");
            if (ExpensesPercentage != null) sb.Append("  ExpensesPercentage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "expensesPercentage", ExpensesPercentage.ToString())).Append("\n");
            if (Fees != null) sb.Append("  Fees: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "fees", Fees.ToString())).Append("\n");
            if (FeesPercentage != null) sb.Append("  FeesPercentage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "feesPercentage", FeesPercentage.ToString())).Append("\n");
            if (Insurance != null) sb.Append("  Insurance: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "insurance", Insurance.ToString())).Append("\n");
            if (InsurancePercentage != null) sb.Append("  InsurancePercentage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "insurancePercentage", InsurancePercentage.ToString())).Append("\n");
            if (MonthlyInterestRate != null) sb.Append("  MonthlyInterestRate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "monthlyInterestRate", MonthlyInterestRate.ToString())).Append("\n");
            if (Taxes != null) sb.Append("  Taxes: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "taxes", Taxes.ToString())).Append("\n");
            if (TaxesPercentage != null) sb.Append("  TaxesPercentage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesInstallmentInformation", "taxesPercentage", TaxesPercentage.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidcapturesInstallmentInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
