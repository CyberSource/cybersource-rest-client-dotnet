...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007EmbeddedBatches :  IEquatable<InlineResponse2007EmbeddedBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007EmbeddedBatches" /> class.
        /// </summary>
        ...
        public InlineResponse2007EmbeddedBatches(InlineResponse2007EmbeddedLinks Links = default(InlineResponse2007EmbeddedLinks), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchModifiedDate = default(string), string BatchSource = default(string), string TokenSource = default(string), string MerchantReference = default(string), List<string> BatchCaEndpoints = default(List<string>), string Status = default(string), InlineResponse2007EmbeddedTotals Totals = default(InlineResponse2007EmbeddedTotals))
        {
            this.Links = Links;
        ...
        public InlineResponse2007EmbeddedLinks Links { get; set; }
        ...
        public InlineResponse2007EmbeddedTotals Totals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2007EmbeddedBatches {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2007EmbeddedBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse2007EmbeddedBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2007EmbeddedBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007EmbeddedBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
