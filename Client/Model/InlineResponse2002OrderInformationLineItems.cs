...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002OrderInformationLineItems :  IEquatable<InlineResponse2002OrderInformationLineItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002OrderInformationLineItems" /> class.
        /// </summary>
        ...
        public InlineResponse2002OrderInformationLineItems(string ProductCode = default(string), string ProductName = default(string), string ProductSku = default(string), decimal? Quantity = default(decimal?), string UnitPrice = default(string), string UnitOfMeasure = default(string), string TotalAmount = default(string), string TaxAmount = default(string), string TaxRate = default(string), string TaxTypeCode = default(string), bool? AmountIncludesTax = default(bool?), string CommodityCode = default(string), string DiscountAmount = default(string), bool? DiscountApplied = default(bool?), string DiscountRate = default(string), string InvoiceNumber = default(string), List<V2paymentsOrderInformationAmountDetailsTaxDetails> TaxDetails = default(List<V2paymentsOrderInformationAmountDetailsTaxDetails>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002OrderInformationLineItems);
        }

        /// <summary>
        /// Returns true if InlineResponse2002OrderInformationLineItems instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002OrderInformationLineItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002OrderInformationLineItems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
