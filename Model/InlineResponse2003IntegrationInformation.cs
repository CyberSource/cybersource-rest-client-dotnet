...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2003IntegrationInformation :  IEquatable<InlineResponse2003IntegrationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003IntegrationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2003IntegrationInformation(List<Boardingv1registrationsIntegrationInformationOauth2> Oauth2 = default(List<Boardingv1registrationsIntegrationInformationOauth2>), List<InlineResponse2003IntegrationInformationTenantConfigurations> TenantConfigurations = default(List<InlineResponse2003IntegrationInformationTenantConfigurations>))
        {
            this.Oauth2 = Oauth2;
        ...
        public List<InlineResponse2003IntegrationInformationTenantConfigurations> TenantConfigurations { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2003IntegrationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2003IntegrationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2003IntegrationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003IntegrationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
