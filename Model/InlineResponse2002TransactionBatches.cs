...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002TransactionBatches :  IEquatable<InlineResponse2002TransactionBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002TransactionBatches" /> class.
        /// </summary>
        ...
        public InlineResponse2002TransactionBatches(string Id = default(string), string UploadDate = default(string), string CompletionDate = default(string), int? TransactionCount = default(int?), int? AcceptedTransactionCount = default(int?), string RejectedTransactionCount = default(string), string Status = default(string))
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002TransactionBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse2002TransactionBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002TransactionBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002TransactionBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
