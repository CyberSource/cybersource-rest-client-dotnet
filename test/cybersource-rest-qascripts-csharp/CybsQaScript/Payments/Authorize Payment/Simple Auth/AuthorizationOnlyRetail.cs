...
{
    public class AuthorizationOnlyRetail
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizationOnlyRetail";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/CreateAuthorizationOnlyRetail.csv"), true))
            {
