...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenizeParametersCardInfo :  IEquatable<TokenizeParametersCardInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenizeParametersCardInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenizeParametersCardInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenizeParametersCardInfo" /> class.
        /// </summary>
        ...
        public TokenizeParametersCardInfo(string CardNumber = default(string), string CardExpirationMonth = default(string), string CardExpirationYear = default(string), string CardType = default(string))
        {
            // to ensure "CardNumber" is required (not null)
            if (CardNumber == null)
            {
                throw new InvalidDataException("CardNumber is a required property for TokenizeParametersCardInfo and cannot be null");
            }
            else
            {
            ...
            if (CardType == null)
            {
                throw new InvalidDataException("CardType is a required property for TokenizeParametersCardInfo and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TokenizeParametersCardInfo);
        }

        /// <summary>
        /// Returns true if TokenizeParametersCardInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of TokenizeParametersCardInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenizeParametersCardInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
