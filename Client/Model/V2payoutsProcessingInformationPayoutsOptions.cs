...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsProcessingInformationPayoutsOptions :  IEquatable<V2payoutsProcessingInformationPayoutsOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsProcessingInformationPayoutsOptions" /> class.
        /// </summary>
        ...
        /// <param name="RetrievalReferenceNumber">This field contains a number that is used with other data elements as a key to identify and track all messages related to a given cardholder transaction; that is, to a given transaction set. * Applicable only for CTV for Payouts. .</param>
        ...
        public V2payoutsProcessingInformationPayoutsOptions(string AcquirerMerchantId = default(string), string AcquirerBin = default(string), string RetrievalReferenceNumber = default(string), string AccountFundingReferenceId = default(string))
        {
        ...
        /// </summary>
        /// <value>This field contains a number that is used with other data elements as a key to identify and track all messages related to a given cardholder transaction; that is, to a given transaction set. * Applicable only for CTV for Payouts. </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsProcessingInformationPayoutsOptions);
        }

        /// <summary>
        /// Returns true if V2payoutsProcessingInformationPayoutsOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsProcessingInformationPayoutsOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsProcessingInformationPayoutsOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AcquirerMerchantId, length must be less than 15.", new [] { "AcquirerMerchantId" });
            }

            // AcquirerBin (string) maxLength
            if(this.AcquirerBin != null && this.AcquirerBin.Length > 11)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AcquirerBin, length must be less than 11.", new [] { "AcquirerBin" });
            }

            // RetrievalReferenceNumber (string) maxLength
            if(this.RetrievalReferenceNumber != null && this.RetrievalReferenceNumber.Length > 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RetrievalReferenceNumber, length must be less than 12.", new [] { "RetrievalReferenceNumber" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountFundingReferenceId, length must be less than 15.", new [] { "AccountFundingReferenceId" });
            }
