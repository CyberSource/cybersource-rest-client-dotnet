...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009EmbeddedBatches :  IEquatable<InlineResponse2009EmbeddedBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009EmbeddedBatches" /> class.
        /// </summary>
        ...
        public InlineResponse2009EmbeddedBatches(InlineResponse2009EmbeddedLinks Links = default(InlineResponse2009EmbeddedLinks), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchModifiedDate = default(string), string BatchSource = default(string), string TokenSource = default(string), string MerchantReference = default(string), List<string> BatchCaEndpoints = default(List<string>), string Status = default(string), InlineResponse2009EmbeddedTotals Totals = default(InlineResponse2009EmbeddedTotals))
        {
            this.Links = Links;
        ...
        public InlineResponse2009EmbeddedLinks Links { get; set; }
        ...
        public InlineResponse2009EmbeddedTotals Totals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009EmbeddedBatches {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2009EmbeddedBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse2009EmbeddedBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2009EmbeddedBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009EmbeddedBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
