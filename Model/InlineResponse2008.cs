...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(int? TotalCount = default(int?), int? Offset = default(int?), int? Limit = default(int?), string Sort = default(string), int? Count = default(int?), List<InlineResponse2008Devices> Devices = default(List<InlineResponse2008Devices>))
        {
        ...
        public List<InlineResponse2008Devices> Devices { get; set; }
