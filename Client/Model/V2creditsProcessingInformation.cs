...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2creditsProcessingInformation :  IEquatable<V2creditsProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2creditsProcessingInformation" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2creditsProcessingInformation);
        }

        /// <summary>
        /// Returns true if V2creditsProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2creditsProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2creditsProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
