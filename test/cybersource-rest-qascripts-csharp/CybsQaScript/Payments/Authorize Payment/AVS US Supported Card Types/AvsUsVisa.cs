...
{
    public class AvsUsVisa
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AvsUsVisa";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSusSupportedCardTypes/CreateVisa.csv"), true))
            {
