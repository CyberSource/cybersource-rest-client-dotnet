...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseLinksSelf :  IEquatable<PtsV2PaymentsPost201ResponseLinksSelf>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Href != null) sb.Append("  Href: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseLinksSelf", "href", Href.ToString())).Append("\n");
            if (Method != null) sb.Append("  Method: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseLinksSelf", "method", Method.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseLinksSelf", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
