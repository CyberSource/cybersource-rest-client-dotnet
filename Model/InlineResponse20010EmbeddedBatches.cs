...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20010EmbeddedBatches :  IEquatable<InlineResponse20010EmbeddedBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010EmbeddedBatches" /> class.
        /// </summary>
        ...
        public InlineResponse20010EmbeddedBatches(InlineResponse20010EmbeddedLinks Links = default(InlineResponse20010EmbeddedLinks), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchModifiedDate = default(string), string BatchSource = default(string), string TokenSource = default(string), string MerchantReference = default(string), List<string> BatchCaEndpoints = default(List<string>), string Status = default(string), InlineResponse20010EmbeddedTotals Totals = default(InlineResponse20010EmbeddedTotals))
        {
            this.Links = Links;
        ...
        public InlineResponse20010EmbeddedLinks Links { get; set; }
        ...
        public InlineResponse20010EmbeddedTotals Totals { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20010EmbeddedBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse20010EmbeddedBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20010EmbeddedBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010EmbeddedBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
