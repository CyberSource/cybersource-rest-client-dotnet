...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4004 :  IEquatable<InlineResponse4004>, IValidatableObject
    {
        ...
        public InlineResponse4004(string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<InlineResponse201ErrorInformationDetails> Details = default(List<InlineResponse201ErrorInformationDetails>))
        {
