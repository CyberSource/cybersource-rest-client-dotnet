...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4007 :  IEquatable<InlineResponse4007>, IValidatableObject
    {
        ...
        public InlineResponse4007(DateTime? SubmitTimeUtc = default(DateTime?), string Status = default(string), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<InlineResponse4007Details> Details = default(List<InlineResponse4007Details>))
        {
