...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20013ResponseRecord :  IEquatable<InlineResponse20013ResponseRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013ResponseRecord" /> class.
        /// </summary>
        ...
        public InlineResponse20013ResponseRecord(string Response = default(string), string Reason = default(string), string Token = default(string), string InstrumentIdentifierId = default(string), string InstrumentIdentifierCreated = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string), List<InlineResponse20013ResponseRecordAdditionalUpdates> AdditionalUpdates = default(List<InlineResponse20013ResponseRecordAdditionalUpdates>))
        {
        ...
        public List<InlineResponse20013ResponseRecordAdditionalUpdates> AdditionalUpdates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20013ResponseRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse20013ResponseRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20013ResponseRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013ResponseRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
