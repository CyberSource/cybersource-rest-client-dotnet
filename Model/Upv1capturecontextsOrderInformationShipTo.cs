...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Upv1capturecontextsOrderInformationShipTo :  IEquatable<Upv1capturecontextsOrderInformationShipTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Upv1capturecontextsOrderInformationShipTo" /> class.
        /// </summary>
        ...
        public Upv1capturecontextsOrderInformationShipTo(string Address1 = default(string), string Address2 = default(string), string Address3 = default(string), string Address4 = default(string), string AdministrativeArea = default(string), string BuildingNumber = default(string), string Country = default(string), string District = default(string), string Locality = default(string), string PostalCode = default(string), string FirstName = default(string), string LastName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Upv1capturecontextsOrderInformationShipTo);
        }

        /// <summary>
        /// Returns true if Upv1capturecontextsOrderInformationShipTo instances are equal
        /// </summary>
        /// <param name="other">Instance of Upv1capturecontextsOrderInformationShipTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Upv1capturecontextsOrderInformationShipTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
