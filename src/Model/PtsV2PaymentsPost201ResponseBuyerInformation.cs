...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseBuyerInformation :  IEquatable<PtsV2PaymentsPost201ResponseBuyerInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (MerchantCustomerId != null) sb.Append("  MerchantCustomerId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseBuyerInformation", "merchantCustomerId", MerchantCustomerId.ToString())).Append("\n");
            if (DateOfBirth != null) sb.Append("  DateOfBirth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseBuyerInformation", "dateOfBirth", DateOfBirth.ToString())).Append("\n");
            if (VatRegistrationNumber != null) sb.Append("  VatRegistrationNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseBuyerInformation", "vatRegistrationNumber", VatRegistrationNumber.ToString())).Append("\n");
            if (PersonalIdentification != null) sb.Append("  PersonalIdentification: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseBuyerInformation", "personalIdentification", PersonalIdentification.ToString())).Append("\n");
            if (TaxId != null) sb.Append("  TaxId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseBuyerInformation", "taxId", TaxId.ToString())).Append("\n");
            if (LoginId != null) sb.Append("  LoginId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseBuyerInformation", "loginId", LoginId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseBuyerInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
