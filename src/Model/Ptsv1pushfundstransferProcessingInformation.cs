...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv1pushfundstransferProcessingInformation :  IEquatable<Ptsv1pushfundstransferProcessingInformation>, IValidatableObject
    {
        ...
        [JsonPropertyName("sharingGroupCode")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        public override string ToString()
        {
            ...
            if (BusinessApplicationId != null) sb.Append("  BusinessApplicationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv1pushfundstransferProcessingInformation", "businessApplicationId", BusinessApplicationId.ToString())).Append("\n");
