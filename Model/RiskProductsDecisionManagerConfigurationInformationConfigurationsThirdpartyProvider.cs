...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider :  IEquatable<RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider" /> class.
        /// </summary>
        ...
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderAccurint Accurint { get; set; }

        /// <summary>
        /// Gets or Sets Credilink
        /// </summary>
        [DataMember(Name="credilink", EmitDefaultValue=false)]
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink Credilink { get; set; }

        /// <summary>
        /// Gets or Sets Ekata
        /// </summary>
        [DataMember(Name="ekata", EmitDefaultValue=false)]
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEkata Ekata { get; set; }

        /// <summary>
        /// Gets or Sets Emailage
        /// </summary>
        [DataMember(Name="emailage", EmitDefaultValue=false)]
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage Emailage { get; set; }

        /// <summary>
        /// Gets or Sets Perseuss
        /// </summary>
        [DataMember(Name="perseuss", EmitDefaultValue=false)]
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderPerseuss Perseuss { get; set; }

        /// <summary>
        /// Gets or Sets Signifyd
        /// </summary>
        [DataMember(Name="signifyd", EmitDefaultValue=false)]
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderSignifyd Signifyd { get; set; }

        /// <summary>
        /// Gets or Sets Targus
        /// </summary>
        [DataMember(Name="targus", EmitDefaultValue=false)]
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderTargus Targus { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider);
        }

        /// <summary>
        /// Returns true if RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider instances are equal
        /// </summary>
        /// <param name="other">Instance of RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProvider other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
