...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesPointOfSaleInformationEmv :  IEquatable<V2paymentsidcapturesPointOfSaleInformationEmv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesPointOfSaleInformationEmv" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesPointOfSaleInformationEmv(string Tags = default(string), bool? Fallback = false)
        {
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsidcapturesPointOfSaleInformationEmv {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesPointOfSaleInformationEmv);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesPointOfSaleInformationEmv instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesPointOfSaleInformationEmv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesPointOfSaleInformationEmv other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
