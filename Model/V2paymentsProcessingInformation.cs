...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsProcessingInformation :  IEquatable<V2paymentsProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsProcessingInformation" /> class.
        /// </summary>
        ...
        /// <param name="BusinessApplicationId">TBD.</param>
        ...
        public V2paymentsProcessingInformation(bool? Capture = false, string ProcessorId = default(string), string BusinessApplicationId = default(string), string CommerceIndicator = default(string), string PaymentSolution = default(string), string ReconciliationId = default(string), string LinkId = default(string), string PurchaseLevel = default(string), string ReportGroup = default(string), string VisaCheckoutId = default(string), V2paymentsProcessingInformationIssuer Issuer = default(V2paymentsProcessingInformationIssuer), V2paymentsProcessingInformationAuthorizationOptions AuthorizationOptions = default(V2paymentsProcessingInformationAuthorizationOptions), V2paymentsProcessingInformationCaptureOptions CaptureOptions = default(V2paymentsProcessingInformationCaptureOptions), V2paymentsProcessingInformationRecurringOptions RecurringOptions = default(V2paymentsProcessingInformationRecurringOptions))
        {
        ...
        public V2paymentsProcessingInformationIssuer Issuer { get; set; }

        /// <summary>
        /// Gets or Sets AuthorizationOptions
        /// </summary>
        [DataMember(Name="authorizationOptions", EmitDefaultValue=false)]
        public V2paymentsProcessingInformationAuthorizationOptions AuthorizationOptions { get; set; }

        /// <summary>
        /// Gets or Sets CaptureOptions
        /// </summary>
        [DataMember(Name="captureOptions", EmitDefaultValue=false)]
        public V2paymentsProcessingInformationCaptureOptions CaptureOptions { get; set; }

        /// <summary>
        /// Gets or Sets RecurringOptions
        /// </summary>
        [DataMember(Name="recurringOptions", EmitDefaultValue=false)]
        public V2paymentsProcessingInformationRecurringOptions RecurringOptions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsProcessingInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
