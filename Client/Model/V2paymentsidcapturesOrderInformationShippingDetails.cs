...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesOrderInformationShippingDetails :  IEquatable<V2paymentsidcapturesOrderInformationShippingDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesOrderInformationShippingDetails" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesOrderInformationShippingDetails(string ShipFromPostalCode = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesOrderInformationShippingDetails);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesOrderInformationShippingDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesOrderInformationShippingDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesOrderInformationShippingDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
