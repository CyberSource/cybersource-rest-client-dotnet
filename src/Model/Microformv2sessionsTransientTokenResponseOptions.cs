...
namespace CyberSource.Model
{
    ...
    public partial class Microformv2sessionsTransientTokenResponseOptions :  IEquatable<Microformv2sessionsTransientTokenResponseOptions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (IncludeCardPrefix != null) sb.Append("  IncludeCardPrefix: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Microformv2sessionsTransientTokenResponseOptions", "includeCardPrefix", IncludeCardPrefix.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Microformv2sessionsTransientTokenResponseOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
