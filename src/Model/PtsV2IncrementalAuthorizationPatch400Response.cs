...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2IncrementalAuthorizationPatch400Response :  IEquatable<PtsV2IncrementalAuthorizationPatch400Response>, IValidatableObject
    {
        ...
        /// <param name="Reason">The reason of the status.  Possible values:  - MISSING_FIELD  - INVALID_DATA  - DUPLICATE_REQUEST  - INVALID_CARD  - CARD_TYPE_NOT_ACCEPTED  - INVALID_MERCHANT_CONFIGURATION  - PROCESSOR_UNAVAILABLE  - INVALID_PAYMENT_ID  - NOT_SUPPORTED .</param>
        ...
        /// </summary>
        /// <value>The reason of the status.  Possible values:  - MISSING_FIELD  - INVALID_DATA  - DUPLICATE_REQUEST  - INVALID_CARD  - CARD_TYPE_NOT_ACCEPTED  - INVALID_MERCHANT_CONFIGURATION  - PROCESSOR_UNAVAILABLE  - INVALID_PAYMENT_ID  - NOT_SUPPORTED </value>
        ...
        public override string ToString()
        {
            ...
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch400Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch400Response", "status", Status.ToString())).Append("\n");
            if (Reason != null) sb.Append("  Reason: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch400Response", "reason", Reason.ToString())).Append("\n");
            if (Message != null) sb.Append("  Message: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch400Response", "message", Message.ToString())).Append("\n");
            if (Details != null) sb.Append("  Details: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch400Response", "details", Details.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2IncrementalAuthorizationPatch400Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
