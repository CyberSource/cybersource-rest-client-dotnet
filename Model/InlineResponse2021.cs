...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2021 :  IEquatable<InlineResponse2021>, IValidatableObject
    {
        ...
        public InlineResponse2021(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), InlineResponse2021SubscriptionInformation SubscriptionInformation = default(InlineResponse2021SubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        public InlineResponse2021SubscriptionInformation SubscriptionInformation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2021);
        }

        /// <summary>
        /// Returns true if InlineResponse2021 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2021 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2021 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
