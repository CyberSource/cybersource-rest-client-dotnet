...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TmsMerchantInformationMerchantDescriptor :  IEquatable<TmsMerchantInformationMerchantDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmsMerchantInformationMerchantDescriptor" /> class.
        /// </summary>
        ...
        public TmsMerchantInformationMerchantDescriptor(string AlternateName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            if (AlternateName != null) sb.Append("  AlternateName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsMerchantInformationMerchantDescriptor", "alternateName", AlternateName.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TmsMerchantInformationMerchantDescriptor", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TmsMerchantInformationMerchantDescriptor);
        }

        /// <summary>
        /// Returns true if TmsMerchantInformationMerchantDescriptor instances are equal
        /// </summary>
        /// <param name="other">Instance of TmsMerchantInformationMerchantDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmsMerchantInformationMerchantDescriptor other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
