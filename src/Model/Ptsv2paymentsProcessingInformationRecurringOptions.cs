...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsProcessingInformationRecurringOptions :  IEquatable<Ptsv2paymentsProcessingInformationRecurringOptions>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="LoanPayment">Flag that indicates whether this is a payment towards an existing contractual loan.  Possible values: - &#x60;true&#x60;: Loan payment - &#x60;false&#x60;: (default) Not a loan payment  (default to false).</param>
        ...
        /// </summary>
        /// <value>Flag that indicates whether this is a payment towards an existing contractual loan.  Possible values: - &#x60;true&#x60;: Loan payment - &#x60;false&#x60;: (default) Not a loan payment </value>
        ...
        public override string ToString()
        {
            ...
            if (LoanPayment != null) sb.Append("  LoanPayment: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsProcessingInformationRecurringOptions", "loanPayment", LoanPayment.ToString())).Append("\n");
            if (FirstRecurringPayment != null) sb.Append("  FirstRecurringPayment: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsProcessingInformationRecurringOptions", "firstRecurringPayment", FirstRecurringPayment.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsProcessingInformationRecurringOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
