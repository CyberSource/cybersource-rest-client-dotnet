...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013ProcessorInformation :  IEquatable<InlineResponse2013ProcessorInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013ProcessorInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2013ProcessorInformation(string TransactionId = default(string), string ForwardedAcquirerCode = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013ProcessorInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2013ProcessorInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013ProcessorInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013ProcessorInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
