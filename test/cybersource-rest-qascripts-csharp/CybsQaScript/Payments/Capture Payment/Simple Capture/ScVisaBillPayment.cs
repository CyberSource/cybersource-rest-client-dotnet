...
{
    public class ScVisaBillPayment
    {
        public static void CapturePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "ScVisaBillPayment";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/CapturePayment/SimpleCapture/CreateVisaBillPayment.csv"), true))
            {
