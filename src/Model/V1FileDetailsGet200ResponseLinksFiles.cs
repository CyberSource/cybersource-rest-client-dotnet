...
namespace CyberSource.Model
{
    ...
    public partial class V1FileDetailsGet200ResponseLinksFiles :  IEquatable<V1FileDetailsGet200ResponseLinksFiles>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (FileId != null) sb.Append("  FileId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinksFiles", "fileId", FileId.ToString())).Append("\n");
            if (Href != null) sb.Append("  Href: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinksFiles", "href", Href.ToString())).Append("\n");
            if (Method != null) sb.Append("  Method: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinksFiles", "method", Method.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("V1FileDetailsGet200ResponseLinksFiles", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
