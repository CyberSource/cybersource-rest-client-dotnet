...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2013 :  IEquatable<InlineResponse2013>, IValidatableObject
    {
        ...
        public InlineResponse2013(string Id = default(string), InlineResponse2013RegistrationInformation RegistrationInformation = default(InlineResponse2013RegistrationInformation), InlineResponse2013IntegrationInformation IntegrationInformation = default(InlineResponse2013IntegrationInformation), InlineResponse2013OrganizationInformation OrganizationInformation = default(InlineResponse2013OrganizationInformation), List<InlineResponse2013ProductInformationSetups> ProductInformationSetups = default(List<InlineResponse2013ProductInformationSetups>), string Message = default(string), Dictionary<string, List<Object>> Details = default(Dictionary<string, List<Object>>))
        {
            this.Id = Id;
        ...
        public InlineResponse2013RegistrationInformation RegistrationInformation { get; set; }

        /// <summary>
        /// Gets or Sets IntegrationInformation
        /// </summary>
        [DataMember(Name="integrationInformation", EmitDefaultValue=false)]
        public InlineResponse2013IntegrationInformation IntegrationInformation { get; set; }

        /// <summary>
        /// Gets or Sets OrganizationInformation
        /// </summary>
        [DataMember(Name="organizationInformation", EmitDefaultValue=false)]
        public InlineResponse2013OrganizationInformation OrganizationInformation { get; set; }
