...
namespace Example
{
    public class ActionDecisionManagerCaseExample
    {
        public void main()
        {
            ...
            var caseManagementActionsRequest = new CaseManagementActionsRequest(); // CaseManagementActionsRequest | 
            ...
            {
                Debug.Print("Exception when calling DecisionManagerApi.ActionDecisionManagerCase: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class CommentDecisionManagerCaseExample
    {
        public void main()
        {
            var apiInstance = new DecisionManagerApi();
            var id = id_example;  // string | An unique identification number generated by Cybersource to identify the submitted request.
            var caseManagementCommentsRequest = new CaseManagementCommentsRequest(); // CaseManagementCommentsRequest | 
            ...
            {
                Debug.Print("Exception when calling DecisionManagerApi.CommentDecisionManagerCase: " + e.Message );
            }
        }
    }
}
