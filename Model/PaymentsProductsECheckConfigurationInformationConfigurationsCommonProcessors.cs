...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors :  IEquatable<PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors" /> class.
        /// </summary>
        ...
        public PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors(string CompanyEntryDescription = default(string), string CompanyId = default(string), string BatchGroup = default(string), bool? EnableAccuityForAvs = true, bool? SetCompletedState = false)
        {
            // to ensure "CompanyEntryDescription" is required (not null)
            if (CompanyEntryDescription == null)
            {
                throw new InvalidDataException("CompanyEntryDescription is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors);
        }

        /// <summary>
        /// Returns true if PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
