...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer :  IEquatable<PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer" /> class.
        /// </summary>
        ...
        public PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer(string InstitutionId = default(string), string InterbankCardAssociationId = default(string), string DiscoverInstitutionId = default(string), string CountryCode = default(string), string FileDestinationBin = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer);
        }

        /// <summary>
        /// Returns true if PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
