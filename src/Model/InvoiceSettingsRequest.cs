...
namespace CyberSource.Model
{
    ...
    public partial class InvoiceSettingsRequest :  IEquatable<InvoiceSettingsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (InvoiceSettingsInformation != null) sb.Append("  InvoiceSettingsInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoiceSettingsRequest", "invoiceSettingsInformation", InvoiceSettingsInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InvoiceSettingsRequest", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
