...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4001 :  IEquatable<InlineResponse4001>, IValidatableObject
    {
        ...
        public InlineResponse4001(string SubmitTimeUtc = default(string), string Status = default(string), string Reason = default(string), string Message = default(string), List<PtsV2PaymentsPost201ResponseErrorInformationDetails> Details = default(List<PtsV2PaymentsPost201ResponseErrorInformationDetails>))
        {
