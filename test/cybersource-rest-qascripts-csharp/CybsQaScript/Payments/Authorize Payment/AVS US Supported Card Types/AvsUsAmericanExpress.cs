...
namespace CybsQaScript.Payments.Authorize_Payment.AVS_US_Supported_Card_Types
{
    public class AvsUsAmericanExpress
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "AvsUsAmericanExpress";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSusSupportedCardTypes/CreateAmericanExpress.csv"), true))
            {
