...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsAcquirerInformation :  IEquatable<Riskv1authenticationsAcquirerInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsAcquirerInformation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationsAcquirerInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsAcquirerInformation);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsAcquirerInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsAcquirerInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsAcquirerInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
