...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationresultsOrderInformationLineItems :  IEquatable<Riskv1authenticationresultsOrderInformationLineItems>, IValidatableObject
    {
        ...
        public Riskv1authenticationresultsOrderInformationLineItems(string UnitPrice = default(string), decimal? Quantity = default(decimal?), string TaxAmount = default(string))
        {
