...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsetupsPaymentInformation :  IEquatable<Riskv1authenticationsetupsPaymentInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Card != null) sb.Append("  Card: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformation", "card", Card.ToString())).Append("\n");
            if (TokenizedCard != null) sb.Append("  TokenizedCard: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformation", "tokenizedCard", TokenizedCard.ToString())).Append("\n");
            if (FluidData != null) sb.Append("  FluidData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformation", "fluidData", FluidData.ToString())).Append("\n");
            if (Customer != null) sb.Append("  Customer: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformation", "customer", Customer.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1authenticationsetupsPaymentInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
