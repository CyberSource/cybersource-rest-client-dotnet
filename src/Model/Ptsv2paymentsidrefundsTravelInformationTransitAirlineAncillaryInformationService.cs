...
{
    /// <summary>
    /// Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService :  IEquatable<Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService" /> class.
        /// </summary>
        ...
        public Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService(string CategoryCode = default(string), string SubCategoryCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService {\n");
            if (CategoryCode != null) sb.Append("  CategoryCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService", "categoryCode", CategoryCode.ToString())).Append("\n");
            if (SubCategoryCode != null) sb.Append("  SubCategoryCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService", "subCategoryCode", SubCategoryCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
