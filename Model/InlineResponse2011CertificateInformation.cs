...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2011CertificateInformation :  IEquatable<InlineResponse2011CertificateInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2011CertificateInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2011CertificateInformation(string Alias = default(string), string KeyId = default(string), string Key = default(string), string ExpirationDate = default(string))
        {
            this.Alias = Alias;
            this.KeyId = KeyId;
            this.Key = Key;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2011CertificateInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2011CertificateInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2011CertificateInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2011CertificateInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
