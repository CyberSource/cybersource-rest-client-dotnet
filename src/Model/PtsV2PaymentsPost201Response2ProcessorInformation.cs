...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201Response2ProcessorInformation :  IEquatable<PtsV2PaymentsPost201Response2ProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response2ProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (PaymentUrl != null) sb.Append("  PaymentUrl: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response2ProcessorInformation", "paymentUrl", PaymentUrl.ToString())).Append("\n");
            if (ResponseDetails != null) sb.Append("  ResponseDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response2ProcessorInformation", "responseDetails", ResponseDetails.ToString())).Append("\n");
            if (Token != null) sb.Append("  Token: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response2ProcessorInformation", "token", Token.ToString())).Append("\n");
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response2ProcessorInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201Response2ProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
