...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2002Embedded :  IEquatable<InlineResponse2002Embedded>, IValidatableObject
    {
        ...
        public InlineResponse2002Embedded(InlineResponse2002EmbeddedCapture Capture = default(InlineResponse2002EmbeddedCapture), InlineResponse2002EmbeddedReversal Reversal = default(InlineResponse2002EmbeddedReversal))
        {
        ...
        public InlineResponse2002EmbeddedCapture Capture { get; set; }

        /// <summary>
        /// Gets or Sets Reversal
        /// </summary>
        [DataMember(Name="reversal", EmitDefaultValue=false)]
        public InlineResponse2002EmbeddedReversal Reversal { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002Embedded);
        }

        /// <summary>
        /// Returns true if InlineResponse2002Embedded instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002Embedded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002Embedded other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
