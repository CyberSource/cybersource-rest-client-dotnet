...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsPaymentInformationCard :  IEquatable<Riskv1authenticationsPaymentInformationCard>, IValidatableObject
    {
        ...
        public Riskv1authenticationsPaymentInformationCard(string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
