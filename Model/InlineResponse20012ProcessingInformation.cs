...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012ProcessingInformation :  IEquatable<InlineResponse20012ProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012ProcessingInformation" /> class.
        /// </summary>
        ...
        public InlineResponse20012ProcessingInformation(string PaymentSolution = default(string), string CommerceIndicator = default(string), string BusinessApplicationId = default(string), InlineResponse20012ProcessingInformationAuthorizationOptions AuthorizationOptions = default(InlineResponse20012ProcessingInformationAuthorizationOptions), InlineResponse20012ProcessingInformationBankTransferOptions BankTransferOptions = default(InlineResponse20012ProcessingInformationBankTransferOptions))
        {
        ...
        public InlineResponse20012ProcessingInformationAuthorizationOptions AuthorizationOptions { get; set; }

        /// <summary>
        /// Gets or Sets BankTransferOptions
        /// </summary>
        [DataMember(Name="bankTransferOptions", EmitDefaultValue=false)]
        public InlineResponse20012ProcessingInformationBankTransferOptions BankTransferOptions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012ProcessingInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse20012ProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012ProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012ProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
