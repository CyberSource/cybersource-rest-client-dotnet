...
namespace CyberSource.Model
{
    ...
    public partial class DmConfigPortfolioControls :  IEquatable<DmConfigPortfolioControls>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonPropertyName("hideRiskMenus")]
        ...
        /// </summary>
        [JsonPropertyName("hideRiskTransactionData")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        public override string ToString()
        {
            ...
            if (HideRiskMenus != null) sb.Append("  HideRiskMenus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigPortfolioControls", "hideRiskMenus", HideRiskMenus.ToString())).Append("\n");
            if (HideRiskTransactionData != null) sb.Append("  HideRiskTransactionData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigPortfolioControls", "hideRiskTransactionData", HideRiskTransactionData.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DmConfigPortfolioControls", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
