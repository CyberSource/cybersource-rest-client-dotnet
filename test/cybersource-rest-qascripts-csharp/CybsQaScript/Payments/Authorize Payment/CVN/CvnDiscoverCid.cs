...
{
    public class CvnDiscoverCid
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "CvnDiscoverCid";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/CVN/CreateDiscoverCID.csv"), true))
            {
