...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsClientReferenceInformation :  IEquatable<V2paymentsClientReferenceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsClientReferenceInformation" /> class.
        /// </summary>
        ...
        public V2paymentsClientReferenceInformation(string Code = default(string), string TransactionId = default(string), string Comments = default(string))
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsClientReferenceInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsClientReferenceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsClientReferenceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsClientReferenceInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
