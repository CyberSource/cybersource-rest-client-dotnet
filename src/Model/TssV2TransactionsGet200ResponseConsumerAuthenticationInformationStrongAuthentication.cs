...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication :  IEquatable<TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (LowValueExemptionIndicator != null) sb.Append("  LowValueExemptionIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication", "lowValueExemptionIndicator", LowValueExemptionIndicator.ToString())).Append("\n");
            if (RiskAnalysisExemptionIndicator != null) sb.Append("  RiskAnalysisExemptionIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication", "riskAnalysisExemptionIndicator", RiskAnalysisExemptionIndicator.ToString())).Append("\n");
            if (TrustedMerchantExemptionIndicator != null) sb.Append("  TrustedMerchantExemptionIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication", "trustedMerchantExemptionIndicator", TrustedMerchantExemptionIndicator.ToString())).Append("\n");
            if (SecureCorporatePaymentIndicator != null) sb.Append("  SecureCorporatePaymentIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication", "secureCorporatePaymentIndicator", SecureCorporatePaymentIndicator.ToString())).Append("\n");
            if (DelegatedAuthenticationExemptionIndicator != null) sb.Append("  DelegatedAuthenticationExemptionIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication", "delegatedAuthenticationExemptionIndicator", DelegatedAuthenticationExemptionIndicator.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
