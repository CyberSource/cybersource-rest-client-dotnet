...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsVoidsPost201Response :  IEquatable<PtsV2PaymentsVoidsPost201Response>, IValidatableObject
    {
        ...
        /// <param name="Status">The status of the submitted transaction.  Possible values:  - VOIDED  - CANCELLED  - FAILED .</param>
        ...
        /// <param name="ReconciliationId">Reference number that you use to reconcile CyberSource reports with your reports. .</param>
        ...
        /// </summary>
        /// <value>The status of the submitted transaction.  Possible values:  - VOIDED  - CANCELLED  - FAILED </value>
        ...
        /// </summary>
        [JsonPropertyName("voidAmountDetails")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        /// </summary>
        /// <value>Reference number that you use to reconcile CyberSource reports with your reports. </value>
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "status", Status.ToString())).Append("\n");
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (VoidAmountDetails != null) sb.Append("  VoidAmountDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "voidAmountDetails", VoidAmountDetails.ToString())).Append("\n");
            if (ProcessorInformation != null) sb.Append("  ProcessorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "processorInformation", ProcessorInformation.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsVoidsPost201Response", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsVoidsPost201Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
