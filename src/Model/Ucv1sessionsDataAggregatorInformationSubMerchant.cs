...
{
    /// <summary>
    /// Ucv1sessionsDataAggregatorInformationSubMerchant
    /// </summary>
    [DataContract]
    public partial class Ucv1sessionsDataAggregatorInformationSubMerchant :  IEquatable<Ucv1sessionsDataAggregatorInformationSubMerchant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ucv1sessionsDataAggregatorInformationSubMerchant" /> class.
        /// </summary>
        ...
        /// <param name="Address1">First line of the sub-merchant&#39;s street address.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. .</param>
        /// <param name="Locality">Sub-merchant&#39;s city.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. .</param>
        /// <param name="AdministrativeArea">Sub-merchant&#39;s state or province.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. .</param>
        /// <param name="Region">Sub-merchant&#39;s region.  **Example**\\ &#x60;NE&#x60; indicates that the sub-merchant is in the northeast region. .</param>
        /// <param name="PostalCode">Partial postal code for the sub-merchant&#39;s address.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. .</param>
        ...
        public Ucv1sessionsDataAggregatorInformationSubMerchant(string CardAcceptorId = default(string), string Id = default(string), string Name = default(string), string Address1 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string Region = default(string), string PostalCode = default(string), string Country = default(string), string Email = default(string), string PhoneNumber = default(string))
        {
        ...
        [JsonPropertyName("cardAcceptorId")]
        ...
        /// </summary>
        /// <value>First line of the sub-merchant&#39;s street address.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. </value>
        ...
        /// </summary>
        /// <value>Sub-merchant&#39;s city.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. </value>
        ...
        /// </summary>
        /// <value>Sub-merchant&#39;s state or province.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. </value>
        ...
        /// </summary>
        /// <value>Partial postal code for the sub-merchant&#39;s address.  #### CyberSource through VisaNet The value for this field does not map to the TC 33 capture file5.  #### FDC Compass This value must consist of uppercase characters. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ucv1sessionsDataAggregatorInformationSubMerchant {\n");
            if (CardAcceptorId != null) sb.Append("  CardAcceptorId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "cardAcceptorId", CardAcceptorId.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "id", Id.ToString())).Append("\n");
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "name", Name.ToString())).Append("\n");
            if (Address1 != null) sb.Append("  Address1: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "address1", Address1.ToString())).Append("\n");
            if (Locality != null) sb.Append("  Locality: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "locality", Locality.ToString())).Append("\n");
            if (AdministrativeArea != null) sb.Append("  AdministrativeArea: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "administrativeArea", AdministrativeArea.ToString())).Append("\n");
            if (Region != null) sb.Append("  Region: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "region", Region.ToString())).Append("\n");
            if (PostalCode != null) sb.Append("  PostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "postalCode", PostalCode.ToString())).Append("\n");
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "country", Country.ToString())).Append("\n");
            if (Email != null) sb.Append("  Email: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "email", Email.ToString())).Append("\n");
            if (PhoneNumber != null) sb.Append("  PhoneNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformationSubMerchant", "phoneNumber", PhoneNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ucv1sessionsDataAggregatorInformationSubMerchant", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ucv1sessionsDataAggregatorInformationSubMerchant);
        }

        /// <summary>
        /// Returns true if Ucv1sessionsDataAggregatorInformationSubMerchant instances are equal
        /// </summary>
        /// <param name="other">Instance of Ucv1sessionsDataAggregatorInformationSubMerchant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ucv1sessionsDataAggregatorInformationSubMerchant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
