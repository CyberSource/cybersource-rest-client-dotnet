...
namespace CyberSource.Model
{
    ...
    public partial class DmConfigThirdpartyProviderSignifyd :  IEquatable<DmConfigThirdpartyProviderSignifyd>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Enabled != null) sb.Append("  Enabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigThirdpartyProviderSignifyd", "enabled", Enabled.ToString())).Append("\n");
            if (Credentials != null) sb.Append("  Credentials: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigThirdpartyProviderSignifyd", "credentials", Credentials.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DmConfigThirdpartyProviderSignifyd", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
