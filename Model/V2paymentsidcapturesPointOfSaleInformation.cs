...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesPointOfSaleInformation :  IEquatable<V2paymentsidcapturesPointOfSaleInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesPointOfSaleInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesPointOfSaleInformation(V2paymentsidcapturesPointOfSaleInformationEmv Emv = default(V2paymentsidcapturesPointOfSaleInformationEmv), string AmexCapnData = default(string), bool CardPresent = default(bool), string CatLevel = default(string), string TerminalCapability = default(string))
        {
            this.Emv = Emv;
        ...
        public V2paymentsidcapturesPointOfSaleInformationEmv Emv { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsidcapturesPointOfSaleInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesPointOfSaleInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesPointOfSaleInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesPointOfSaleInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesPointOfSaleInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
