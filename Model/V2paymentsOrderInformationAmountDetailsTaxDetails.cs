...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsOrderInformationAmountDetailsTaxDetails :  IEquatable<V2paymentsOrderInformationAmountDetailsTaxDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsOrderInformationAmountDetailsTaxDetails" /> class.
        /// </summary>
        ...
        public V2paymentsOrderInformationAmountDetailsTaxDetails(TypeEnum? Type = default(TypeEnum?), string Amount = default(string), string Rate = default(string), string Code = default(string), string TaxId = default(string), bool? Applied = default(bool?))
        {
            this.Type = Type;
            this.Amount = Amount;
            this.Rate = Rate;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsOrderInformationAmountDetailsTaxDetails);
        }

        /// <summary>
        /// Returns true if V2paymentsOrderInformationAmountDetailsTaxDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsOrderInformationAmountDetailsTaxDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsOrderInformationAmountDetailsTaxDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
