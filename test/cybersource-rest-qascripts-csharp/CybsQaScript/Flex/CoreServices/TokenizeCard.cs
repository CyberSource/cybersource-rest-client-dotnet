...
namespace CybsQaScript.Flex.CoreServices
{
    ...
    {
        public static void TokenizeCardExec()
        {
            // Initialize Api Name
            var apiFunctionName = "TokenizeCard";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Flex/CoreServices/TokenizeCard.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.Tokenize(requestObj);
