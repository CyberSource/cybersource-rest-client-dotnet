...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination :  IEquatable<PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination>, IValidatableObject
    {
        ...
        public PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination(string Country = default(string), string Locality = default(string), string Latitude = default(string), string Longitude = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination", "country", Country.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination);
        }

        /// <summary>
        /// Returns true if PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination instances are equal
        /// </summary>
        /// <param name="other">Instance of PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PtsV2PaymentsPost201ResponseRiskInformationTravelFirstDestination other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
