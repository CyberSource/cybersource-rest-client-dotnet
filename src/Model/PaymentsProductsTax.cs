...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsTax :  IEquatable<PaymentsProductsTax>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsTax", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentsProductsTax", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsTax);
        }

        /// <summary>
        /// Returns true if PaymentsProductsTax instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsTax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsTax other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
