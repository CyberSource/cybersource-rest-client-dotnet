...
namespace CybsQaScript.Payments.Authorize_Payment.Digital_Payments.Chase_Pay
{
    public class ChasePay
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "ChasePay";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/DigitalPayments/Chasepay/CreateChasePay.csv"), true))
            {
