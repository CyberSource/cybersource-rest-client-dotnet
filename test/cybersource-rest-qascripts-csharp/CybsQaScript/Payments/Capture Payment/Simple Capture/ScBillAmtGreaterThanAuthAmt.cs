...
namespace CybsQaScript.Payments.Capture_Payment.Simple_Capture
{
    public class ScBillAmtGreaterThanAuthAmt
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "ScBillAmtGreaterThanAuthAmt";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/CapturePayment/SimpleCapture/CreateBillAmtGTthanAuthAmt.csv"), true))
            {
