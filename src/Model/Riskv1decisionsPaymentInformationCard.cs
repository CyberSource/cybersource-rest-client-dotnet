...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1decisionsPaymentInformationCard :  IEquatable<Riskv1decisionsPaymentInformationCard>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsPaymentInformationCard", "number", Number.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsPaymentInformationCard", "type", Type.ToString())).Append("\n");
