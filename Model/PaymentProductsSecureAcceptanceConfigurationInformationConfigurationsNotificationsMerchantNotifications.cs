...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications :  IEquatable<PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications" /> class.
        /// </summary>
        ...
        public PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications(bool? BackofficePostEnabled = default(bool?), string BackofficeEmailAddress = default(string), bool? BackofficeEmailEnabled = default(bool?), string BackofficePostUrl = default(string), string CardNumberFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications);
        }

        /// <summary>
        /// Returns true if PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
