...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2payoutsProcessingInformationPayoutsOptions :  IEquatable<Ptsv2payoutsProcessingInformationPayoutsOptions>, IValidatableObject
    {
        ...
        /// <param name="AccountFundingReferenceId">Visa (maxLength of 15) or MasterCard (maxLength of 40) generated transaction identifier (TID) that is unique for each original authorization and financial request. * Applicable only for CTV for Payouts. .</param>
        /// <param name="DeferredDateTime">#### Visa Platform Connect  Contains date and time value indicating scheduled deferred OCT.  Format is : &#39;yyyyMMddHHmm&#39;, where  &#39;YYYY&#39; &#x3D; year &#39;MM&#39; &#x3D; month &#39;DD&#39; &#x3D; day &#39;hh&#39; &#x3D; hour &#39;mm&#39; &#x3D; minutes .</param>
        public Ptsv2payoutsProcessingInformationPayoutsOptions(string AcquirerMerchantId = default(string), string AcquirerBin = default(string), string RetrievalReferenceNumber = default(string), string AccountFundingReferenceId = default(string), string DeferredDateTime = default(string))
        {
        ...
        /// </summary>
        /// <value>Visa (maxLength of 15) or MasterCard (maxLength of 40) generated transaction identifier (TID) that is unique for each original authorization and financial request. * Applicable only for CTV for Payouts. </value>
        ...
        /// </summary>
        /// <value>#### Visa Platform Connect  Contains date and time value indicating scheduled deferred OCT.  Format is : &#39;yyyyMMddHHmm&#39;, where  &#39;YYYY&#39; &#x3D; year &#39;MM&#39; &#x3D; month &#39;DD&#39; &#x3D; day &#39;hh&#39; &#x3D; hour &#39;mm&#39; &#x3D; minutes </value>
        [JsonPropertyName("deferredDateTime")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public string DeferredDateTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (AcquirerMerchantId != null) sb.Append("  AcquirerMerchantId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsProcessingInformationPayoutsOptions", "acquirerMerchantId", AcquirerMerchantId.ToString())).Append("\n");
            if (AcquirerBin != null) sb.Append("  AcquirerBin: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsProcessingInformationPayoutsOptions", "acquirerBin", AcquirerBin.ToString())).Append("\n");
            if (RetrievalReferenceNumber != null) sb.Append("  RetrievalReferenceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsProcessingInformationPayoutsOptions", "retrievalReferenceNumber", RetrievalReferenceNumber.ToString())).Append("\n");
            if (AccountFundingReferenceId != null) sb.Append("  AccountFundingReferenceId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsProcessingInformationPayoutsOptions", "accountFundingReferenceId", AccountFundingReferenceId.ToString())).Append("\n");
            if (DeferredDateTime != null) sb.Append("  DeferredDateTime: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsProcessingInformationPayoutsOptions", "deferredDateTime", DeferredDateTime.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2payoutsProcessingInformationPayoutsOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public bool Equals(Ptsv2payoutsProcessingInformationPayoutsOptions other)
        {
            ...
            return 
                ...
                (
                    this.DeferredDateTime == other.DeferredDateTime ||
                    this.DeferredDateTime != null &&
                    this.DeferredDateTime.Equals(other.DeferredDateTime)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeferredDateTime != null)
                    hash = hash * 59 + this.DeferredDateTime.GetHashCode();
                return hash;
            }
        }
