...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseProcessorInformationCustomer :  IEquatable<PtsV2PaymentsPost201ResponseProcessorInformationCustomer>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (PersonalIdResult != null) sb.Append("  PersonalIdResult: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationCustomer", "personalIdResult", PersonalIdResult.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseProcessorInformationCustomer", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
