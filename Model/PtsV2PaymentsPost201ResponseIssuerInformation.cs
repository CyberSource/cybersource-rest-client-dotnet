...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseIssuerInformation :  IEquatable<PtsV2PaymentsPost201ResponseIssuerInformation>, IValidatableObject
    {
        ...
        public PtsV2PaymentsPost201ResponseIssuerInformation(string Country = default(string), string DiscretionaryData = default(string), string CountrySpecificDiscretionaryData = default(string), string ResponseCode = default(string))
        {
