...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2creditsProcessingInformationElectronicBenefitsTransfer :  IEquatable<Ptsv2creditsProcessingInformationElectronicBenefitsTransfer>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Category != null) sb.Append("  Category: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2creditsProcessingInformationElectronicBenefitsTransfer", "category", Category.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2creditsProcessingInformationElectronicBenefitsTransfer", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
