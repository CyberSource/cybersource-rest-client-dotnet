...
namespace CyberSource.Model
{
    ...
    public partial class PredefinedSubscriptionRequestBean :  IEquatable<PredefinedSubscriptionRequestBean>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ReportDefinitionName != null) sb.Append("  ReportDefinitionName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "reportDefinitionName", ReportDefinitionName.ToString())).Append("\n");
            if (SubscriptionType != null) sb.Append("  SubscriptionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "subscriptionType", SubscriptionType.ToString())).Append("\n");
            if (ReportName != null) sb.Append("  ReportName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "reportName", ReportName.ToString())).Append("\n");
            if (ReportMimeType != null) sb.Append("  ReportMimeType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "reportMimeType", ReportMimeType.ToString())).Append("\n");
            if (ReportFrequency != null) sb.Append("  ReportFrequency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "reportFrequency", ReportFrequency.ToString())).Append("\n");
            if (ReportInterval != null) sb.Append("  ReportInterval: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "reportInterval", ReportInterval.ToString())).Append("\n");
            if (Timezone != null) sb.Append("  Timezone: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PredefinedSubscriptionRequestBean", "timezone", Timezone.ToString())).Append("\n");
