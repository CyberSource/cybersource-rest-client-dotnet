...
namespace CyberSource.Model
{
    ...
    public partial class ReportingV3NotificationofChangesGet200Response :  IEquatable<ReportingV3NotificationofChangesGet200Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (NotificationOfChanges != null) sb.Append("  NotificationOfChanges: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ReportingV3NotificationofChangesGet200Response", "notificationOfChanges", NotificationOfChanges.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("ReportingV3NotificationofChangesGet200Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
