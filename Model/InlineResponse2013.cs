...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2013 :  IEquatable<InlineResponse2013>, IValidatableObject
    {
        ...
        public InlineResponse2013(InlineResponse2013Links Links = default(InlineResponse2013Links), string Id = default(string), string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), string ReconciliationId = default(string), InlineResponse201ClientReferenceInformation ClientReferenceInformation = default(InlineResponse201ClientReferenceInformation), InlineResponse2013RefundAmountDetails RefundAmountDetails = default(InlineResponse2013RefundAmountDetails), InlineResponse2013ProcessorInformation ProcessorInformation = default(InlineResponse2013ProcessorInformation), InlineResponse2013OrderInformation OrderInformation = default(InlineResponse2013OrderInformation))
        {
            this.Links = Links;
            this.Id = Id;
