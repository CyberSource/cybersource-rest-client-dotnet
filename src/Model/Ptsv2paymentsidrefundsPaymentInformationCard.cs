...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidrefundsPaymentInformationCard :  IEquatable<Ptsv2paymentsidrefundsPaymentInformationCard>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "number", Number.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "type", Type.ToString())).Append("\n");
            if (AccountEncoderId != null) sb.Append("  AccountEncoderId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "accountEncoderId", AccountEncoderId.ToString())).Append("\n");
            if (IssueNumber != null) sb.Append("  IssueNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "issueNumber", IssueNumber.ToString())).Append("\n");
            if (StartMonth != null) sb.Append("  StartMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "startMonth", StartMonth.ToString())).Append("\n");
            if (StartYear != null) sb.Append("  StartYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "startYear", StartYear.ToString())).Append("\n");
            if (SourceAccountType != null) sb.Append("  SourceAccountType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "sourceAccountType", SourceAccountType.ToString())).Append("\n");
            if (SourceAccountTypeDetails != null) sb.Append("  SourceAccountTypeDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "sourceAccountTypeDetails", SourceAccountTypeDetails.ToString())).Append("\n");
            if (SecurityCode != null) sb.Append("  SecurityCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "securityCode", SecurityCode.ToString())).Append("\n");
            if (UseAs != null) sb.Append("  UseAs: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationCard", "useAs", UseAs.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsPaymentInformationCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
