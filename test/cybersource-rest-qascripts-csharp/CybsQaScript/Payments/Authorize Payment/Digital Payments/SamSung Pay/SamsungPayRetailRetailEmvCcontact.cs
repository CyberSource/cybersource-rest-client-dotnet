...
{
    public class SamsungPayRetailRetailEmvContact
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "SamsungPayRetailRetailEmvContact";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/DigitalPayments/SamsungPay/CreateSamsungPayRetailEMVcontact.csv"), true))
            {
