...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse5021 :  IEquatable<InlineResponse5021>, IValidatableObject
    {
        ...
        public InlineResponse5021(string SubmitTimeUtc = default(string), string Status = default(string), string Reason = default(string), string Message = default(string), string StatusCode = default(string))
        {
