...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsPaymentInformationTokenizedCard :  IEquatable<Riskv1authenticationsPaymentInformationTokenizedCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        [JsonConstructor]
        protected Riskv1authenticationsPaymentInformationTokenizedCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        /// <param name="TransactionType">Type of transaction that provided the token data. This value does not specify the token service provider; it specifies the entity that provided you with information about the token.  Possible value: - &#x60;2&#x60;: Near-field communication (NFC) transaction. The customer&#39;s mobile device provided the token data for a contactless EMV transaction. For recurring transactions, use this value if the original transaction was a contactless EMV transaction.  #### Visa Platform Connect - &#x60;1&#x60;: For Rupay and In App tokenization. Example: InApp apple pay. - &#x60;3&#x60;: Card/Credential On File Tokenization.  **NOTE** No CyberSource through VisaNet acquirers support EMV at this time.  Required field for PIN debit credit or PIN debit purchase transactions that use payment network tokens; otherwise, not used.  #### Rupay - &#x60;3&#x60;: Card/Credential On File Tokenization. - &#x60;4&#x60;: Tokenizined Transaction. Should be used for Guest Checkout transactions with token.  (required).</param>
        ...
        /// <param name="Cryptogram">This field contains token information. (required).</param>
        /// <param name="SecurityCode">Card Verification Number (CVN).  #### Ingenico ePayments Do not include this field when **commerceIndicator&#x3D;recurring**. **Note** Ingenico ePayments was previously called _Global Collect_.  (required).</param>
        ...
        /// </summary>
        /// <value>Type of transaction that provided the token data. This value does not specify the token service provider; it specifies the entity that provided you with information about the token.  Possible value: - &#x60;2&#x60;: Near-field communication (NFC) transaction. The customer&#39;s mobile device provided the token data for a contactless EMV transaction. For recurring transactions, use this value if the original transaction was a contactless EMV transaction.  #### Visa Platform Connect - &#x60;1&#x60;: For Rupay and In App tokenization. Example: InApp apple pay. - &#x60;3&#x60;: Card/Credential On File Tokenization.  **NOTE** No CyberSource through VisaNet acquirers support EMV at this time.  Required field for PIN debit credit or PIN debit purchase transactions that use payment network tokens; otherwise, not used.  #### Rupay - &#x60;3&#x60;: Card/Credential On File Tokenization. - &#x60;4&#x60;: Tokenizined Transaction. Should be used for Guest Checkout transactions with token. </value>
        ...
        /// </summary>
        /// <value>This field contains token information.</value>
        ...
        /// </summary>
        /// <value>Card Verification Number (CVN).  #### Ingenico ePayments Do not include this field when **commerceIndicator&#x3D;recurring**. **Note** Ingenico ePayments was previously called _Global Collect_. </value>
        ...
        public override string ToString()
        {
            ...
            if (TransactionType != null) sb.Append("  TransactionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "transactionType", TransactionType.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "type", Type.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Cryptogram != null) sb.Append("  Cryptogram: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "cryptogram", Cryptogram.ToString())).Append("\n");
            if (SecurityCode != null) sb.Append("  SecurityCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "securityCode", SecurityCode.ToString())).Append("\n");
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationTokenizedCard", "number", Number.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1authenticationsPaymentInformationTokenizedCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsPaymentInformationTokenizedCard);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsPaymentInformationTokenizedCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsPaymentInformationTokenizedCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsPaymentInformationTokenizedCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
