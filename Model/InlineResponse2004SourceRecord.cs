...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004SourceRecord :  IEquatable<InlineResponse2004SourceRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004SourceRecord" /> class.
        /// </summary>
        ...
        public InlineResponse2004SourceRecord(string Token = default(string), string CustomerId = default(string), string PaymentInstrumentId = default(string), string InstrumentIdentifierId = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string))
        {
            this.Token = Token;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004SourceRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse2004SourceRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004SourceRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004SourceRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
