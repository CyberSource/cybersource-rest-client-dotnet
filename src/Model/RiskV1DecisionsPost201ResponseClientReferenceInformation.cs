...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1DecisionsPost201ResponseClientReferenceInformation :  IEquatable<RiskV1DecisionsPost201ResponseClientReferenceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1DecisionsPost201ResponseClientReferenceInformation", "code", Code.ToString())).Append("\n");
            if (Comments != null) sb.Append("  Comments: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1DecisionsPost201ResponseClientReferenceInformation", "comments", Comments.ToString())).Append("\n");
            if (Partner != null) sb.Append("  Partner: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1DecisionsPost201ResponseClientReferenceInformation", "partner", Partner.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskV1DecisionsPost201ResponseClientReferenceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
