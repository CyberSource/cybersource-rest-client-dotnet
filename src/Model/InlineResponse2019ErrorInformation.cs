...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2019ErrorInformation :  IEquatable<InlineResponse2019ErrorInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2019ErrorInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2019ErrorInformation(string Reason = default(string), string Message = default(string))
        {
            this.Reason = Reason;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2019ErrorInformation {\n");
            if (Reason != null) sb.Append("  Reason: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2019ErrorInformation", "reason", Reason.ToString())).Append("\n");
            if (Message != null) sb.Append("  Message: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2019ErrorInformation", "message", Message.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InlineResponse2019ErrorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2019ErrorInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2019ErrorInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2019ErrorInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2019ErrorInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
