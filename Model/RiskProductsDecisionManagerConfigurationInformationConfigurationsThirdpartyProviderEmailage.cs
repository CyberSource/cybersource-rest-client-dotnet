...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage :  IEquatable<RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage" /> class.
        /// </summary>
        /// <param name="Enabled">Enabled.</param>
        /// <param name="EnableRealTime">EnableRealTime.</param>
        /// <param name="UseCybsCredentials">UseCybsCredentials.</param>
        /// <param name="Credentials">Credentials.</param>
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage(bool? Enabled = default(bool?), bool? EnableRealTime = default(bool?), bool? UseCybsCredentials = default(bool?), RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderAccurintCredentials Credentials = default(RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderAccurintCredentials))
        {
        ...
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderAccurintCredentials Credentials { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage);
        }

        /// <summary>
        /// Returns true if RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage instances are equal
        /// </summary>
        /// <param name="other">Instance of RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderEmailage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
