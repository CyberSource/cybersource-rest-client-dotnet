...
{
    public class SamsungPayRetailEmvMsd
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "SamsungPayRetailEmvMsd";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/DigitalPayments/SamsungPay/CreateSamsungPayRetailEMVmsd.csv"), true))
            {
