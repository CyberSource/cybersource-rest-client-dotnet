...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2002IntegrationInformationTenantConfigurations :  IEquatable<InlineResponse2002IntegrationInformationTenantConfigurations>, IValidatableObject
    {
        ...
        public InlineResponse2002IntegrationInformationTenantConfigurations(string SolutionId = default(string), string TenantConfigurationId = default(string), string Status = default(string), DateTime? SubmitTimeUtc = default(DateTime?), Boardingv1registrationsIntegrationInformationTenantInformation TenantInformation = default(Boardingv1registrationsIntegrationInformationTenantInformation))
        {
