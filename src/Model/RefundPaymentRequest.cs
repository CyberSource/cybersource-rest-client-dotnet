...
namespace CyberSource.Model
{
    ...
    public partial class RefundPaymentRequest :  IEquatable<RefundPaymentRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "orderInformation", OrderInformation.ToString())).Append("\n");
            if (BuyerInformation != null) sb.Append("  BuyerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "buyerInformation", BuyerInformation.ToString())).Append("\n");
            if (DeviceInformation != null) sb.Append("  DeviceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "deviceInformation", DeviceInformation.ToString())).Append("\n");
            if (MerchantInformation != null) sb.Append("  MerchantInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "merchantInformation", MerchantInformation.ToString())).Append("\n");
            if (AggregatorInformation != null) sb.Append("  AggregatorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "aggregatorInformation", AggregatorInformation.ToString())).Append("\n");
            if (PointOfSaleInformation != null) sb.Append("  PointOfSaleInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "pointOfSaleInformation", PointOfSaleInformation.ToString())).Append("\n");
            if (MerchantDefinedInformation != null) sb.Append("  MerchantDefinedInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "merchantDefinedInformation", MerchantDefinedInformation.ToString())).Append("\n");
            if (TravelInformation != null) sb.Append("  TravelInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "travelInformation", TravelInformation.ToString())).Append("\n");
            if (PromotionInformation != null) sb.Append("  PromotionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "promotionInformation", PromotionInformation.ToString())).Append("\n");
            if (ProcessorInformation != null) sb.Append("  ProcessorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundPaymentRequest", "processorInformation", ProcessorInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RefundPaymentRequest", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
