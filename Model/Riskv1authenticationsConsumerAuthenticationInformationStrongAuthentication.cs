...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication :  IEquatable<Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication(string AuthenticationIndicator = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
