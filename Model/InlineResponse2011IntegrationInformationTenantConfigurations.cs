...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2011IntegrationInformationTenantConfigurations :  IEquatable<InlineResponse2011IntegrationInformationTenantConfigurations>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2011IntegrationInformationTenantConfigurations" /> class.
        /// </summary>
        ...
        public InlineResponse2011IntegrationInformationTenantConfigurations(string SolutionId = default(string), string TenantConfigurationId = default(string), StatusEnum? Status = default(StatusEnum?), DateTime? SubmitTimeUtc = default(DateTime?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2011IntegrationInformationTenantConfigurations);
        }

        /// <summary>
        /// Returns true if InlineResponse2011IntegrationInformationTenantConfigurations instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2011IntegrationInformationTenantConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2011IntegrationInformationTenantConfigurations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
