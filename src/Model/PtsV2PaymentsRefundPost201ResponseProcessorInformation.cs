...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsRefundPost201ResponseProcessorInformation :  IEquatable<PtsV2PaymentsRefundPost201ResponseProcessorInformation>, IValidatableObject
    {
        ...
        /// <param name="ResponseSourceCode">This field is used by Visa only and contains the response source/reason code that identifies the source of the field 39 response decision. Use this field only for clearing with your acquirer. .</param>
        ...
        /// </summary>
        /// <value>This field is used by Visa only and contains the response source/reason code that identifies the source of the field 39 response decision. Use this field only for clearing with your acquirer. </value>
        ...
        public override string ToString()
        {
            ...
            if (ApprovalCode != null) sb.Append("  ApprovalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "approvalCode", ApprovalCode.ToString())).Append("\n");
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (ForwardedAcquirerCode != null) sb.Append("  ForwardedAcquirerCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "forwardedAcquirerCode", ForwardedAcquirerCode.ToString())).Append("\n");
            if (MerchantNumber != null) sb.Append("  MerchantNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "merchantNumber", MerchantNumber.ToString())).Append("\n");
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            if (ResponseSourceCode != null) sb.Append("  ResponseSourceCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "responseSourceCode", ResponseSourceCode.ToString())).Append("\n");
            if (AchVerification != null) sb.Append("  AchVerification: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "achVerification", AchVerification.ToString())).Append("\n");
            if (NetworkTransactionId != null) sb.Append("  NetworkTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "networkTransactionId", NetworkTransactionId.ToString())).Append("\n");
            if (SettlementDate != null) sb.Append("  SettlementDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsRefundPost201ResponseProcessorInformation", "settlementDate", SettlementDate.ToString())).Append("\n");
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsRefundPost201ResponseProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
