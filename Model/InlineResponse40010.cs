...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse40010 :  IEquatable<InlineResponse40010>, IValidatableObject
    {
        ...
        public InlineResponse40010(string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), string Reason = default(string), string Message = default(string), List<PushFunds400ResponseDetails> Details = default(List<PushFunds400ResponseDetails>))
        {
            this.Id = Id;
