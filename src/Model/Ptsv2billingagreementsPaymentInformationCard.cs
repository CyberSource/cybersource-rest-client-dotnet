...
{
    /// <summary>
    /// Ptsv2billingagreementsPaymentInformationCard
    /// </summary>
    [DataContract]
    public partial class Ptsv2billingagreementsPaymentInformationCard :  IEquatable<Ptsv2billingagreementsPaymentInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2billingagreementsPaymentInformationCard" /> class.
        /// </summary>
        ...
        public Ptsv2billingagreementsPaymentInformationCard(string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string), string SecurityCode = default(string), string Type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ptsv2billingagreementsPaymentInformationCard {\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationCard", "number", Number.ToString())).Append("\n");
            if (SecurityCode != null) sb.Append("  SecurityCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationCard", "securityCode", SecurityCode.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationCard", "type", Type.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2billingagreementsPaymentInformationCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2billingagreementsPaymentInformationCard);
        }

        /// <summary>
        /// Returns true if Ptsv2billingagreementsPaymentInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2billingagreementsPaymentInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2billingagreementsPaymentInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
