...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse201 :  IEquatable<InlineResponse201>, IValidatableObject
    {
        ...
        public InlineResponse201(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), InlineResponse201PlanInformation PlanInformation = default(InlineResponse201PlanInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        public InlineResponse201PlanInformation PlanInformation { get; set; }
