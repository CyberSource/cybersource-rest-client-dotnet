...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidreversalsPointOfSaleInformationEmv :  IEquatable<Ptsv2paymentsidreversalsPointOfSaleInformationEmv>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Tags != null) sb.Append("  Tags: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsPointOfSaleInformationEmv", "tags", Tags.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidreversalsPointOfSaleInformationEmv", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
