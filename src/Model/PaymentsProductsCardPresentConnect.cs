...
namespace CyberSource.Model
{
    ...
    public partial class PaymentsProductsCardPresentConnect :  IEquatable<PaymentsProductsCardPresentConnect>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsCardPresentConnect", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            if (ConfigurationInformation != null) sb.Append("  ConfigurationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsCardPresentConnect", "configurationInformation", ConfigurationInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentsProductsCardPresentConnect", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
