...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsECheckConfigurationInformationConfigurationsCommon :  IEquatable<PaymentProductsECheckConfigurationInformationConfigurationsCommon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsECheckConfigurationInformationConfigurationsCommon" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentProductsECheckConfigurationInformationConfigurationsCommon() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsECheckConfigurationInformationConfigurationsCommon" /> class.
        /// </summary>
        ...
        public PaymentProductsECheckConfigurationInformationConfigurationsCommon(Dictionary<string, PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors> Processors = default(Dictionary<string, PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors>), PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnly InternalOnly = default(PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnly), string AccountHolderName = default(string), string AccountType = default(string), string AccountRoutingNumber = default(string), string AccountNumber = default(string))
        {
            ...
            if (AccountType == null)
            {
                throw new InvalidDataException("AccountType is a required property for PaymentProductsECheckConfigurationInformationConfigurationsCommon and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AccountRoutingNumber is a required property for PaymentProductsECheckConfigurationInformationConfigurationsCommon and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AccountNumber is a required property for PaymentProductsECheckConfigurationInformationConfigurationsCommon and cannot be null");
            }
            else
            {
        ...
        public Dictionary<string, PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors> Processors { get; set; }

        /// <summary>
        /// Gets or Sets InternalOnly
        /// </summary>
        [DataMember(Name="internalOnly", EmitDefaultValue=false)]
        public PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnly InternalOnly { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsECheckConfigurationInformationConfigurationsCommon);
        }

        /// <summary>
        /// Returns true if PaymentProductsECheckConfigurationInformationConfigurationsCommon instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsECheckConfigurationInformationConfigurationsCommon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsECheckConfigurationInformationConfigurationsCommon other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
