...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1decisionsRiskInformationProfile :  IEquatable<Riskv1decisionsRiskInformationProfile>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1decisionsRiskInformationProfile);
        }

        /// <summary>
        /// Returns true if Riskv1decisionsRiskInformationProfile instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1decisionsRiskInformationProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1decisionsRiskInformationProfile other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
