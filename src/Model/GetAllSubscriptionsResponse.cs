...
namespace CyberSource.Model
{
    ...
    public partial class GetAllSubscriptionsResponse :  IEquatable<GetAllSubscriptionsResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponse", "_links", Links.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponse", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (TotalCount != null) sb.Append("  TotalCount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponse", "totalCount", TotalCount.ToString())).Append("\n");
            if (Subscriptions != null) sb.Append("  Subscriptions: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetAllSubscriptionsResponse", "subscriptions", Subscriptions.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("GetAllSubscriptionsResponse", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
