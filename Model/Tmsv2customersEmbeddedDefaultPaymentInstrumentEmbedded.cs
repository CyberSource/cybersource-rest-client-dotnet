...
namespace CyberSource.Model
{
    ...
    public partial class Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded :  IEquatable<Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded);
        }

        /// <summary>
        /// Returns true if Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded instances are equal
        /// </summary>
        /// <param name="other">Instance of Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbedded other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
