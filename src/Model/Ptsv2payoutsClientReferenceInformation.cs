...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2payoutsClientReferenceInformation :  IEquatable<Ptsv2payoutsClientReferenceInformation>, IValidatableObject
    {
        ...
        public Ptsv2payoutsClientReferenceInformation(string Code = default(string), string ApplicationName = default(string), string ApplicationVersion = default(string), string ApplicationUser = default(string))
        {
            this.Code = Code;
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsClientReferenceInformation", "code", Code.ToString())).Append("\n");
            if (ApplicationName != null) sb.Append("  ApplicationName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsClientReferenceInformation", "applicationName", ApplicationName.ToString())).Append("\n");
            if (ApplicationVersion != null) sb.Append("  ApplicationVersion: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsClientReferenceInformation", "applicationVersion", ApplicationVersion.ToString())).Append("\n");
            if (ApplicationUser != null) sb.Append("  ApplicationUser: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsClientReferenceInformation", "applicationUser", ApplicationUser.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2payoutsClientReferenceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
