...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009ResponseRecord :  IEquatable<InlineResponse2009ResponseRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009ResponseRecord" /> class.
        /// </summary>
        ...
        public InlineResponse2009ResponseRecord(string Response = default(string), string Reason = default(string), string Token = default(string), string InstrumentIdentifierId = default(string), string InstrumentIdentifierCreated = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string), List<InlineResponse2009ResponseRecordAdditionalUpdates> AdditionalUpdates = default(List<InlineResponse2009ResponseRecordAdditionalUpdates>))
        {
        ...
        public List<InlineResponse2009ResponseRecordAdditionalUpdates> AdditionalUpdates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2009ResponseRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse2009ResponseRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2009ResponseRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009ResponseRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
