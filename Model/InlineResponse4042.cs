...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4042 :  IEquatable<InlineResponse4042>, IValidatableObject
    {
        ...
        public InlineResponse4042(string Status = default(string), string Reason = default(string), string Message = default(string), List<InlineResponse4007Details> Details = default(List<InlineResponse4007Details>))
        {
            this.Status = Status;
            this.Reason = Reason;
