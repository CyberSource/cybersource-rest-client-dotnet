...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidrefundsMerchantInformation :  IEquatable<V2paymentsidrefundsMerchantInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidrefundsMerchantInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidrefundsMerchantInformation(V2paymentsMerchantInformationMerchantDescriptor MerchantDescriptor = default(V2paymentsMerchantInformationMerchantDescriptor), int? CategoryCode = default(int?), string VatRegistrationNumber = default(string), string CardAcceptorReferenceNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsidrefundsMerchantInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidrefundsMerchantInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidrefundsMerchantInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidrefundsMerchantInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidrefundsMerchantInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
