# CyberSource.Model.Upv1capturecontextsDataOrderInformationBillToCompany
## Properties
...
**Address3** | **string** | Additional address information (third line of the billing address) Optional field.  | [optional] 
**Address4** | **string** | Additional address information (fourth line of the billing address) Optional field  | [optional] 
