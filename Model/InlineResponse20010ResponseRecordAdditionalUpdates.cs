...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20010ResponseRecordAdditionalUpdates :  IEquatable<InlineResponse20010ResponseRecordAdditionalUpdates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010ResponseRecordAdditionalUpdates" /> class.
        /// </summary>
        ...
        public InlineResponse20010ResponseRecordAdditionalUpdates(string CustomerId = default(string), string PaymentInstrumentId = default(string), string Creator = default(string), string State = default(string), string Message = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20010ResponseRecordAdditionalUpdates);
        }

        /// <summary>
        /// Returns true if InlineResponse20010ResponseRecordAdditionalUpdates instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20010ResponseRecordAdditionalUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010ResponseRecordAdditionalUpdates other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
