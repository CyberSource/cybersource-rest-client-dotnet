...
namespace CyberSource.Model
{
    ...
    public partial class PushFunds201ResponseIssuerInformation :  IEquatable<PushFunds201ResponseIssuerInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (OctDomesticParticipantIndicator != null) sb.Append("  OctDomesticParticipantIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octDomesticParticipantIndicator", OctDomesticParticipantIndicator.ToString())).Append("\n");
            if (OctCrossBorderParticipantIndicator != null) sb.Append("  OctCrossBorderParticipantIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octCrossBorderParticipantIndicator", OctCrossBorderParticipantIndicator.ToString())).Append("\n");
            if (OctMoneyTransferDomesticIndicator != null) sb.Append("  OctMoneyTransferDomesticIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octMoneyTransferDomesticIndicator", OctMoneyTransferDomesticIndicator.ToString())).Append("\n");
            if (OctMoneyTransferCrossBorderIndicator != null) sb.Append("  OctMoneyTransferCrossBorderIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octMoneyTransferCrossBorderIndicator", OctMoneyTransferCrossBorderIndicator.ToString())).Append("\n");
            if (OctMoneyTransferFastFundsDomesticIndicator != null) sb.Append("  OctMoneyTransferFastFundsDomesticIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octMoneyTransferFastFundsDomesticIndicator", OctMoneyTransferFastFundsDomesticIndicator.ToString())).Append("\n");
            if (OctMoneyTransferFastFundsCrossBorderIndicator != null) sb.Append("  OctMoneyTransferFastFundsCrossBorderIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octMoneyTransferFastFundsCrossBorderIndicator", OctMoneyTransferFastFundsCrossBorderIndicator.ToString())).Append("\n");
            if (OctMoneyTransferMerchantCountryRestricted != null) sb.Append("  OctMoneyTransferMerchantCountryRestricted: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octMoneyTransferMerchantCountryRestricted", OctMoneyTransferMerchantCountryRestricted.ToString())).Append("\n");
            if (OctNonMoneyTransferDomesticIndicator != null) sb.Append("  OctNonMoneyTransferDomesticIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octNonMoneyTransferDomesticIndicator", OctNonMoneyTransferDomesticIndicator.ToString())).Append("\n");
            ...
            if (OctOnlineGamblingDomesticIndicator != null) sb.Append("  OctOnlineGamblingDomesticIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octOnlineGamblingDomesticIndicator", OctOnlineGamblingDomesticIndicator.ToString())).Append("\n");
            if (OctOnlineGamblingCrossBorderIndicator != null) sb.Append("  OctOnlineGamblingCrossBorderIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octOnlineGamblingCrossBorderIndicator", OctOnlineGamblingCrossBorderIndicator.ToString())).Append("\n");
            if (OctOnlineGamblingFastFundsDomesticIndicator != null) sb.Append("  OctOnlineGamblingFastFundsDomesticIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octOnlineGamblingFastFundsDomesticIndicator", OctOnlineGamblingFastFundsDomesticIndicator.ToString())).Append("\n");
            if (OctOnlineGamblingFastFundsCrossBorderIndicator != null) sb.Append("  OctOnlineGamblingFastFundsCrossBorderIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseIssuerInformation", "octOnlineGamblingFastFundsCrossBorderIndicator", OctOnlineGamblingFastFundsCrossBorderIndicator.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PushFunds201ResponseIssuerInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
