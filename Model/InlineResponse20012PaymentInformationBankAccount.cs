...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012PaymentInformationBankAccount :  IEquatable<InlineResponse20012PaymentInformationBankAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012PaymentInformationBankAccount" /> class.
        /// </summary>
        ...
        public InlineResponse20012PaymentInformationBankAccount(string Suffix = default(string), string Prefix = default(string), string CheckNumber = default(string), string Type = default(string), string Name = default(string), string CheckDigit = default(string), string EncoderId = default(string))
        {
            this.Suffix = Suffix;
            this.Prefix = Prefix;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012PaymentInformationBankAccount);
        }

        /// <summary>
        /// Returns true if InlineResponse20012PaymentInformationBankAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012PaymentInformationBankAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012PaymentInformationBankAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
