...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsMerchantInformationMerchantDescriptor :  IEquatable<Riskv1authenticationsMerchantInformationMerchantDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsMerchantInformationMerchantDescriptor" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsMerchantInformationMerchantDescriptor(string Name = default(string), string Url = default(string))
        {
            this.Name = Name;
            this.Url = Url;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsMerchantInformationMerchantDescriptor);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsMerchantInformationMerchantDescriptor instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsMerchantInformationMerchantDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsMerchantInformationMerchantDescriptor other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
