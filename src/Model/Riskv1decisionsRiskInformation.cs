...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1decisionsRiskInformation :  IEquatable<Riskv1decisionsRiskInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Profile != null) sb.Append("  Profile: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsRiskInformation", "profile", Profile.ToString())).Append("\n");
            if (EventType != null) sb.Append("  EventType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsRiskInformation", "eventType", EventType.ToString())).Append("\n");
            if (BuyerHistory != null) sb.Append("  BuyerHistory: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsRiskInformation", "buyerHistory", BuyerHistory.ToString())).Append("\n");
            if (AuxiliaryData != null) sb.Append("  AuxiliaryData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsRiskInformation", "auxiliaryData", AuxiliaryData.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1decisionsRiskInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
