...
namespace CybsQaScript.Payments.Authorize_Payment.Simple_Auth
{
    public class RetailPosStandardSwipe
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "RetailPosStandardSwipe";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/RetailPOSstandardSwipe.csv"), true))
            {
