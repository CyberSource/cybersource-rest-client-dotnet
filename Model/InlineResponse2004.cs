...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(string WebhookId = default(string), string OrganizationId = default(string), List<Notificationsubscriptionsv1webhooksProducts> Products = default(List<Notificationsubscriptionsv1webhooksProducts>), string WebhookUrl = default(string), string HealthCheckUrl = default(string), Notificationsubscriptionsv1webhooksNotificationScope NotificationScope = default(Notificationsubscriptionsv1webhooksNotificationScope), string Status = "INACTIVE", string Name = default(string), string Description = default(string), Notificationsubscriptionsv1webhooksRetryPolicy RetryPolicy = default(Notificationsubscriptionsv1webhooksRetryPolicy), Notificationsubscriptionsv1webhooksSecurityPolicy SecurityPolicy = default(Notificationsubscriptionsv1webhooksSecurityPolicy), string CreatedOn = default(string), string UpdatedOn = default(string), List<Dictionary<string, string>> AdditionalAttributes = default(List<Dictionary<string, string>>))
        {
