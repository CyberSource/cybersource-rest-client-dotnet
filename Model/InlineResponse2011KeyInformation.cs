...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2011KeyInformation :  IEquatable<InlineResponse2011KeyInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2011KeyInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2011KeyInformation(string OrganizationId = default(string), string ReferenceNumber = default(string), string KeyId = default(string), string Key = default(string), string Status = default(string), string ExpirationDate = default(string), string Message = default(string), string Alias = default(string), InlineResponse201ErrorInformation ErrorInformation = default(InlineResponse201ErrorInformation))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2011KeyInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2011KeyInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2011KeyInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2011KeyInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
