...
namespace CyberSource.Model
{
    ...
    public partial class CreatePaymentInstrumentRequest :  IEquatable<CreatePaymentInstrumentRequest>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreatePaymentInstrumentRequest);
        }

        /// <summary>
        /// Returns true if CreatePaymentInstrumentRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CreatePaymentInstrumentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePaymentInstrumentRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
