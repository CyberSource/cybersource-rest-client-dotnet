...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsPaymentInformation :  IEquatable<Riskv1authenticationexemptionsPaymentInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformation" /> class.
        /// </summary>
        ...
        public Riskv1authenticationexemptionsPaymentInformationCard Card { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsPaymentInformation);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsPaymentInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsPaymentInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsPaymentInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
