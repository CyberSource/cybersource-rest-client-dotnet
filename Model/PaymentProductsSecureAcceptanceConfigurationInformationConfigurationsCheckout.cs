...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout :  IEquatable<PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout" /> class.
        /// </summary>
        ...
        public PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout(bool? DisplayTaxAmount = default(bool?), string TemplateType = default(string), string ReturnToMerchantSiteUrl = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout);
        }

        /// <summary>
        /// Returns true if PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
