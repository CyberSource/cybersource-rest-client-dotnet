...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseProcessingInformationCaptureOptions :  IEquatable<TssV2TransactionsGet200ResponseProcessingInformationCaptureOptions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TotalCaptureCount != null) sb.Append("  TotalCaptureCount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationCaptureOptions", "totalCaptureCount", TotalCaptureCount.ToString())).Append("\n");
            if (CaptureSequenceNumber != null) sb.Append("  CaptureSequenceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationCaptureOptions", "captureSequenceNumber", CaptureSequenceNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseProcessingInformationCaptureOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
