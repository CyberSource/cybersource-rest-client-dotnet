...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1DecisionsPost201ResponseOrderInformationAmountDetails :  IEquatable<RiskV1DecisionsPost201ResponseOrderInformationAmountDetails>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1DecisionsPost201ResponseOrderInformationAmountDetails", "currency", Currency.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskV1DecisionsPost201ResponseOrderInformationAmountDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
