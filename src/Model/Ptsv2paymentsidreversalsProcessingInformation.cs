...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidreversalsProcessingInformation :  IEquatable<Ptsv2paymentsidreversalsProcessingInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (PaymentSolution != null) sb.Append("  PaymentSolution: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "paymentSolution", PaymentSolution.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            if (LinkId != null) sb.Append("  LinkId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "linkId", LinkId.ToString())).Append("\n");
            if (ReportGroup != null) sb.Append("  ReportGroup: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "reportGroup", ReportGroup.ToString())).Append("\n");
            if (VisaCheckoutId != null) sb.Append("  VisaCheckoutId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "visaCheckoutId", VisaCheckoutId.ToString())).Append("\n");
            if (Issuer != null) sb.Append("  Issuer: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "issuer", Issuer.ToString())).Append("\n");
            if (ActionList != null) sb.Append("  ActionList: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "actionList", ActionList.ToString())).Append("\n");
            if (TransactionTypeIndicator != null) sb.Append("  TransactionTypeIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsProcessingInformation", "transactionTypeIndicator", TransactionTypeIndicator.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidreversalsProcessingInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
