...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013SetupsPaymentsAlternativePaymentMethods :  IEquatable<InlineResponse2013SetupsPaymentsAlternativePaymentMethods>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013SetupsPaymentsAlternativePaymentMethods" /> class.
        /// </summary>
        ...
        public InlineResponse2013SetupsPaymentsAlternativePaymentMethods(InlineResponse2013SetupsPaymentsAlternativePaymentMethodsConfigurationStatus ConfigurationStatus = default(InlineResponse2013SetupsPaymentsAlternativePaymentMethodsConfigurationStatus), InlineResponse2013SetupsPaymentsAlternativePaymentMethodsConfigurationStatus SubscriptionStatus = default(InlineResponse2013SetupsPaymentsAlternativePaymentMethodsConfigurationStatus), string Status = default(string), DateTime? SubmitTimeUtc = default(DateTime?))
        {
        ...
        public InlineResponse2013SetupsPaymentsAlternativePaymentMethodsConfigurationStatus ConfigurationStatus { get; set; }

        /// <summary>
        /// Gets or Sets SubscriptionStatus
        /// </summary>
        [DataMember(Name="subscriptionStatus", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsAlternativePaymentMethodsConfigurationStatus SubscriptionStatus { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013SetupsPaymentsAlternativePaymentMethods);
        }

        /// <summary>
        /// Returns true if InlineResponse2013SetupsPaymentsAlternativePaymentMethods instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013SetupsPaymentsAlternativePaymentMethods to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013SetupsPaymentsAlternativePaymentMethods other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
