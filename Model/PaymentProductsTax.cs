...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsTax :  IEquatable<PaymentProductsTax>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsTax" /> class.
        /// </summary>
        /// <param name="SubscriptionInformation">SubscriptionInformation.</param>
        public PaymentProductsTax(PaymentProductsPayerAuthenticationSubscriptionInformation SubscriptionInformation = default(PaymentProductsPayerAuthenticationSubscriptionInformation))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsTax);
        }

        /// <summary>
        /// Returns true if PaymentProductsTax instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsTax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsTax other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
