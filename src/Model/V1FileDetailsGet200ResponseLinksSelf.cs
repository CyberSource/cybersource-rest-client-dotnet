...
namespace CyberSource.Model
{
    ...
    public partial class V1FileDetailsGet200ResponseLinksSelf :  IEquatable<V1FileDetailsGet200ResponseLinksSelf>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Href != null) sb.Append("  Href: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinksSelf", "href", Href.ToString())).Append("\n");
            if (Method != null) sb.Append("  Method: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("V1FileDetailsGet200ResponseLinksSelf", "method", Method.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("V1FileDetailsGet200ResponseLinksSelf", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
