...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012ConsumerAuthenticationInformation :  IEquatable<InlineResponse20012ConsumerAuthenticationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012ConsumerAuthenticationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse20012ConsumerAuthenticationInformation(string EciRaw = default(string), string Cavv = default(string), string Xid = default(string), string TransactionId = default(string))
        {
            this.EciRaw = EciRaw;
            this.Cavv = Cavv;
            this.Xid = Xid;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012ConsumerAuthenticationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse20012ConsumerAuthenticationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012ConsumerAuthenticationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012ConsumerAuthenticationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
