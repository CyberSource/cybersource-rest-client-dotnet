...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013RefundAmountDetails :  IEquatable<InlineResponse2013RefundAmountDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013RefundAmountDetails" /> class.
        /// </summary>
        ...
        public InlineResponse2013RefundAmountDetails(string RefundAmount = default(string), string Currency = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013RefundAmountDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse2013RefundAmountDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013RefundAmountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013RefundAmountDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RefundAmount, length must be less than 15.", new [] { "RefundAmount" });
            }
