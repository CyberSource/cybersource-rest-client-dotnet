...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsOrderInformationInvoiceDetails :  IEquatable<V2paymentsOrderInformationInvoiceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsOrderInformationInvoiceDetails" /> class.
        /// </summary>
        ...
        public V2paymentsOrderInformationInvoiceDetails(string PurchaseOrderNumber = default(string), string PurchaseOrderDate = default(string), string PurchaseContactName = default(string), bool? Taxable = default(bool?), string VatInvoiceReferenceNumber = default(string), string CommodityCode = default(string), decimal? MerchandiseCode = default(decimal?), List<V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum> TransactionAdviceAddendum = default(List<V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsOrderInformationInvoiceDetails);
        }

        /// <summary>
        /// Returns true if V2paymentsOrderInformationInvoiceDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsOrderInformationInvoiceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsOrderInformationInvoiceDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
