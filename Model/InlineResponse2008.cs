...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(InlineResponse2006Links Links = default(InlineResponse2006Links), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), InlineResponse2011SubscriptionInformation SubscriptionInformation = default(InlineResponse2011SubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        public InlineResponse2011SubscriptionInformation SubscriptionInformation { get; set; }
