...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1addressverificationsOrderInformationLineItems :  IEquatable<Riskv1addressverificationsOrderInformationLineItems>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (UnitPrice != null) sb.Append("  UnitPrice: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsOrderInformationLineItems", "unitPrice", UnitPrice.ToString())).Append("\n");
            if (Quantity != null) sb.Append("  Quantity: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsOrderInformationLineItems", "quantity", Quantity.ToString())).Append("\n");
            if (ProductSKU != null) sb.Append("  ProductSKU: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsOrderInformationLineItems", "productSKU", ProductSKU.ToString())).Append("\n");
            if (ProductRisk != null) sb.Append("  ProductRisk: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsOrderInformationLineItems", "productRisk", ProductRisk.ToString())).Append("\n");
            if (ProductName != null) sb.Append("  ProductName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsOrderInformationLineItems", "productName", ProductName.ToString())).Append("\n");
            if (ProductCode != null) sb.Append("  ProductCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1addressverificationsOrderInformationLineItems", "productCode", ProductCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1addressverificationsOrderInformationLineItems", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
