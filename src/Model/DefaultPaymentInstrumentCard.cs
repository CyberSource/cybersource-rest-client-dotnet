...
{
    /// <summary>
    /// DefaultPaymentInstrumentCard
    /// </summary>
    [DataContract]
    public partial class DefaultPaymentInstrumentCard :  IEquatable<DefaultPaymentInstrumentCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultPaymentInstrumentCard" /> class.
        /// </summary>
        ...
        public DefaultPaymentInstrumentCard(string ExpirationMonth = default(string), string ExpirationYear = default(string), string Type = default(string), string IssueNumber = default(string), string StartMonth = default(string), string StartYear = default(string), string UseAs = default(string), DefaultPaymentInstrumentCardTokenizedInformation TokenizedInformation = default(DefaultPaymentInstrumentCardTokenizedInformation))
        {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public DefaultPaymentInstrumentCardTokenizedInformation TokenizedInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DefaultPaymentInstrumentCard {\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "type", Type.ToString())).Append("\n");
            if (IssueNumber != null) sb.Append("  IssueNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "issueNumber", IssueNumber.ToString())).Append("\n");
            if (StartMonth != null) sb.Append("  StartMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "startMonth", StartMonth.ToString())).Append("\n");
            if (StartYear != null) sb.Append("  StartYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "startYear", StartYear.ToString())).Append("\n");
            if (UseAs != null) sb.Append("  UseAs: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "useAs", UseAs.ToString())).Append("\n");
            if (Hash != null) sb.Append("  Hash: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "hash", Hash.ToString())).Append("\n");
            if (TokenizedInformation != null) sb.Append("  TokenizedInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCard", "tokenizedInformation", TokenizedInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DefaultPaymentInstrumentCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DefaultPaymentInstrumentCard);
        }

        /// <summary>
        /// Returns true if DefaultPaymentInstrumentCard instances are equal
        /// </summary>
        /// <param name="other">Instance of DefaultPaymentInstrumentCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DefaultPaymentInstrumentCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
