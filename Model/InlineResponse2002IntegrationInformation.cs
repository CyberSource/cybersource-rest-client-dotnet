...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002IntegrationInformation :  IEquatable<InlineResponse2002IntegrationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002IntegrationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2002IntegrationInformation(List<Boardingv1registrationsIntegrationInformationOauth2> Oauth2 = default(List<Boardingv1registrationsIntegrationInformationOauth2>), List<InlineResponse2002IntegrationInformationTenantConfigurations> TenantConfigurations = default(List<InlineResponse2002IntegrationInformationTenantConfigurations>))
        {
            this.Oauth2 = Oauth2;
        ...
        public List<InlineResponse2002IntegrationInformationTenantConfigurations> TenantConfigurations { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002IntegrationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2002IntegrationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002IntegrationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002IntegrationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
