...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushFunds400Response :  IEquatable<PushFunds400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushFunds400Response" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The reason of the status.  Possible values: - INVALID_DATA - MISSING_FIELD - INVALID_MERCHANT_CONFIGURATION - INVALID_REQUEST - INVALID_PAYMENT_ID </value>
        ...
        public override string ToString()
        {
            ...
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds400Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds400Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds400Response", "status", Status.ToString())).Append("\n");
            if (Reason != null) sb.Append("  Reason: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds400Response", "reason", Reason.ToString())).Append("\n");
            if (Message != null) sb.Append("  Message: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds400Response", "message", Message.ToString())).Append("\n");
            if (Details != null) sb.Append("  Details: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds400Response", "details", Details.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PushFunds400Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PushFunds400Response);
        }

        /// <summary>
        /// Returns true if PushFunds400Response instances are equal
        /// </summary>
        /// <param name="other">Instance of PushFunds400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushFunds400Response other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
