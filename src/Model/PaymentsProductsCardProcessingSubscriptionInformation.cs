...
namespace CyberSource.Model
{
    ...
    public partial class PaymentsProductsCardProcessingSubscriptionInformation :  IEquatable<PaymentsProductsCardProcessingSubscriptionInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Enabled != null) sb.Append("  Enabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsCardProcessingSubscriptionInformation", "enabled", Enabled.ToString())).Append("\n");
            if (SelfServiceability != null) sb.Append("  SelfServiceability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsCardProcessingSubscriptionInformation", "selfServiceability", SelfServiceability.ToString())).Append("\n");
            if (Features != null) sb.Append("  Features: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsCardProcessingSubscriptionInformation", "features", Features.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentsProductsCardProcessingSubscriptionInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
