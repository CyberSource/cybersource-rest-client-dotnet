...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum :  IEquatable<V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum" /> class.
        /// </summary>
        ...
        public V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum(string Data = default(string))
        {
            this.Data = Data;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum);
        }

        /// <summary>
        /// Returns true if V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
