...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(string ProductId = default(string), string ProductName = default(string), List<Notificationsubscriptionsv2productsorganizationIdEventTypes> EventTypes = default(List<Notificationsubscriptionsv2productsorganizationIdEventTypes>))
        {
