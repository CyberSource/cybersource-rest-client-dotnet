...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012OrderInformationBillTo :  IEquatable<InlineResponse20012OrderInformationBillTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012OrderInformationBillTo" /> class.
        /// </summary>
        ...
        public InlineResponse20012OrderInformationBillTo(string FirstName = default(string), string LastName = default(string), string MiddelName = default(string), string NameSuffix = default(string), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string Company = default(string), string Email = default(string), string Country = default(string), string Title = default(string), string PhoneNumber = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012OrderInformationBillTo);
        }

        /// <summary>
        /// Returns true if InlineResponse20012OrderInformationBillTo instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012OrderInformationBillTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012OrderInformationBillTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
