...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004OrderInformationAmountDetails :  IEquatable<InlineResponse2004OrderInformationAmountDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004OrderInformationAmountDetails" /> class.
        /// </summary>
        ...
        public InlineResponse2004OrderInformationAmountDetails(string TotalAmount = default(string), string Currency = default(string), string DiscountAmount = default(string), string DutyAmount = default(string), string TaxAmount = default(string), string NationalTaxIncluded = default(string), string FreightAmount = default(string), List<V2paymentsOrderInformationAmountDetailsTaxDetails> TaxDetails = default(List<V2paymentsOrderInformationAmountDetailsTaxDetails>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004OrderInformationAmountDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse2004OrderInformationAmountDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004OrderInformationAmountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004OrderInformationAmountDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
