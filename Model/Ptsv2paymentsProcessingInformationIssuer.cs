...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsProcessingInformationIssuer :  IEquatable<Ptsv2paymentsProcessingInformationIssuer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2paymentsProcessingInformationIssuer" /> class.
        /// </summary>
        ...
        public Ptsv2paymentsProcessingInformationIssuer(string DiscretionaryData = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsProcessingInformationIssuer);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsProcessingInformationIssuer instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsProcessingInformationIssuer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsProcessingInformationIssuer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
