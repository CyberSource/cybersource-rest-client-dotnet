...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelSubscriptionResponse :  IEquatable<CancelSubscriptionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CancelSubscriptionResponse(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), CancelSubscriptionResponseSubscriptionInformation SubscriptionInformation = default(CancelSubscriptionResponseSubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public CancelSubscriptionResponseSubscriptionInformation SubscriptionInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CancelSubscriptionResponse", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CancelSubscriptionResponse", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CancelSubscriptionResponse", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CancelSubscriptionResponse", "status", Status.ToString())).Append("\n");
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CancelSubscriptionResponse", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("CancelSubscriptionResponse", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CancelSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if CancelSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CancelSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelSubscriptionResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
