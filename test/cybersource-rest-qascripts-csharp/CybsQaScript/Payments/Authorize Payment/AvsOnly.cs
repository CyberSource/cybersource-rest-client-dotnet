...
namespace CybsQaScript.Payments.Authorize_Payment
{
    public class AvsOnly
    {
        public static void CreatePaymentExec()
        {
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSonly.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            {
                                DeclineAvsFlags = new List<Ptsv2paymentsProcessingInformationAuthorizationOptions.DeclineAvsFlagsEnum>()
                {
                    Ptsv2paymentsProcessingInformationAuthorizationOptions.DeclineAvsFlagsEnum.N
                }
                            };
