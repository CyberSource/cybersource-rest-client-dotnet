...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuspendSubscriptionResponse :  IEquatable<SuspendSubscriptionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuspendSubscriptionResponse" /> class.
        /// </summary>
        ...
        public SuspendSubscriptionResponse(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), SuspendSubscriptionResponseSubscriptionInformation SubscriptionInformation = default(SuspendSubscriptionResponseSubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public SuspendSubscriptionResponseSubscriptionInformation SubscriptionInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SuspendSubscriptionResponse", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SuspendSubscriptionResponse", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SuspendSubscriptionResponse", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SuspendSubscriptionResponse", "status", Status.ToString())).Append("\n");
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SuspendSubscriptionResponse", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("SuspendSubscriptionResponse", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SuspendSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if SuspendSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SuspendSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuspendSubscriptionResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
