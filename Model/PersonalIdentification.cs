...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonalIdentification :  IEquatable<PersonalIdentification>, IValidatableObject
    {
        /// <summary>
        ...
        public PersonalIdentification(string Id = default(string), TypeEnum? Type = default(TypeEnum?), TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedBuyerInformationIssuedBy IssuedBy = default(TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedBuyerInformationIssuedBy))
        {
            this.Id = Id;
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PersonalIdentification);
        }

        /// <summary>
        /// Returns true if PersonalIdentification instances are equal
        /// </summary>
        /// <param name="other">Instance of PersonalIdentification to be compared</param>
        /// <returns>Boolean</returns>
