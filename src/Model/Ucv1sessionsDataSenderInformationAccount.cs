...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ucv1sessionsDataSenderInformationAccount :  IEquatable<Ucv1sessionsDataSenderInformationAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ucv1sessionsDataSenderInformationAccount" /> class.
        /// </summary>
        ...
        public Ucv1sessionsDataSenderInformationAccount(string Number = default(string), string FundsSource = default(string))
        {
            this.Number = Number;
        ...
        public override string ToString()
        {
            ...
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataSenderInformationAccount", "number", Number.ToString())).Append("\n");
            if (FundsSource != null) sb.Append("  FundsSource: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataSenderInformationAccount", "fundsSource", FundsSource.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ucv1sessionsDataSenderInformationAccount", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ucv1sessionsDataSenderInformationAccount);
        }

        /// <summary>
        /// Returns true if Ucv1sessionsDataSenderInformationAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of Ucv1sessionsDataSenderInformationAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ucv1sessionsDataSenderInformationAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
