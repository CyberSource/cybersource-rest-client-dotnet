...
namespace CybsQaScript.Payments.Authorize_Payment.Currency_Support
{
    public class AuthorizationOnly0ExponentCurrencies
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizationOnly0ExponentCurrencies";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/CurrencySupport/AuthorizationOnly0exponentcurrencies.csv"), true))
            {
