...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPaymentInformationFluidData :  IEquatable<Ptsv2paymentsPaymentInformationFluidData>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (KeySerialNumber != null) sb.Append("  KeySerialNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationFluidData", "keySerialNumber", KeySerialNumber.ToString())).Append("\n");
            if (Descriptor != null) sb.Append("  Descriptor: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationFluidData", "descriptor", Descriptor.ToString())).Append("\n");
            if (Value != null) sb.Append("  Value: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationFluidData", "value", Value.ToString())).Append("\n");
            if (Encoding != null) sb.Append("  Encoding: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationFluidData", "encoding", Encoding.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsPaymentInformationFluidData", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
