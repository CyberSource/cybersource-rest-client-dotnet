...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse202 :  IEquatable<InlineResponse202>, IValidatableObject
    {
        ...
        public InlineResponse202(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), InlineResponse202SubscriptionInformation SubscriptionInformation = default(InlineResponse202SubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        public InlineResponse202SubscriptionInformation SubscriptionInformation { get; set; }
