...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseApplicationInformationApplications :  IEquatable<TssV2TransactionsGet200ResponseApplicationInformationApplications>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "name", Name.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "status", Status.ToString())).Append("\n");
            if (ReasonCode != null) sb.Append("  ReasonCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "reasonCode", ReasonCode.ToString())).Append("\n");
            if (RCode != null) sb.Append("  RCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "rCode", RCode.ToString())).Append("\n");
            if (RFlag != null) sb.Append("  RFlag: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "rFlag", RFlag.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            if (RMessage != null) sb.Append("  RMessage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "rMessage", RMessage.ToString())).Append("\n");
            if (ReturnCode != null) sb.Append("  ReturnCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseApplicationInformationApplications", "returnCode", ReturnCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseApplicationInformationApplications", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
