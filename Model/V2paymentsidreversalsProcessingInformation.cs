...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidreversalsProcessingInformation :  IEquatable<V2paymentsidreversalsProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidreversalsProcessingInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidreversalsProcessingInformation(string PaymentSolution = default(string), string ReconciliationId = default(string), string LinkId = default(string), string ReportGroup = default(string), string VisaCheckoutId = default(string), V2paymentsProcessingInformationIssuer Issuer = default(V2paymentsProcessingInformationIssuer))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidreversalsProcessingInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidreversalsProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidreversalsProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidreversalsProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
