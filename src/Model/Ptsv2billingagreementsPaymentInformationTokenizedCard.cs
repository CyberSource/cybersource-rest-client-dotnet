...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2billingagreementsPaymentInformationTokenizedCard :  IEquatable<Ptsv2billingagreementsPaymentInformationTokenizedCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2billingagreementsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        ...
        public Ptsv2billingagreementsPaymentInformationTokenizedCard(string Cryptogram = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string), string TransactionType = default(string), string Type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ptsv2billingagreementsPaymentInformationTokenizedCard {\n");
            if (Cryptogram != null) sb.Append("  Cryptogram: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationTokenizedCard", "cryptogram", Cryptogram.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationTokenizedCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationTokenizedCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationTokenizedCard", "number", Number.ToString())).Append("\n");
            if (TransactionType != null) sb.Append("  TransactionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationTokenizedCard", "transactionType", TransactionType.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsPaymentInformationTokenizedCard", "type", Type.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2billingagreementsPaymentInformationTokenizedCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2billingagreementsPaymentInformationTokenizedCard);
        }

        /// <summary>
        /// Returns true if Ptsv2billingagreementsPaymentInformationTokenizedCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2billingagreementsPaymentInformationTokenizedCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2billingagreementsPaymentInformationTokenizedCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
