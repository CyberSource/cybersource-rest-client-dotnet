...
namespace CyberSource.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NetworkTokensApi : INetworkTokensApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public NetworkTokensApi(string basePath)
        {
        ...
        /// <returns></returns>
        public NetworkTokensApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> PostTokenizedCardDeleteWithHttpInfo (string tokenizedCardId, string profileId = null, TmsTokenizedCardDeleteRequest postTokenizedCardDeleteRequest = null)
        {
            ...
            {
                SdkTracker sdkTracker = new SdkTracker();
                postTokenizedCardDeleteRequest = (TmsTokenizedCardDeleteRequest)sdkTracker.InsertDeveloperIdTracker(postTokenizedCardDeleteRequest, postTokenizedCardDeleteRequest.GetType().Name, Configuration.ApiClient.Configuration.MerchantConfigDictionaryObj["runEnvironment"], Configuration.ApiClient.Configuration.MerchantConfigDictionaryObj.ContainsKey("defaultDeveloperId")? Configuration.ApiClient.Configuration.MerchantConfigDictionaryObj["defaultDeveloperId"]:"");
                localVarPostBody = Configuration.ApiClient.Serialize(postTokenizedCardDeleteRequest); // http body (model) parameter
            }
            else
            {
            ...
            String inboundMLEStatus = "optional";
            MerchantConfig merchantConfig = new MerchantConfig(Configuration.MerchantConfigDictionaryObj, Configuration.MapToControlMLEonAPI, Configuration.ResponseMlePrivateKey);
            if (MLEUtility.CheckIsMLEForAPI(merchantConfig, inboundMLEStatus, "PostTokenizedCardDelete,PostTokenizedCardDeleteAsync,PostTokenizedCardDeleteWithHttpInfo,PostTokenizedCardDeleteAsyncWithHttpInfo"))
            {
                try
                {
                    localVarPostBody = MLEUtility.EncryptRequestPayload(merchantConfig, localVarPostBody);
            ...
            bool isResponseMLEForApi = MLEUtility.CheckIsResponseMLEForAPI(merchantConfig, "PostTokenizedCardDelete,PostTokenizedCardDeleteAsync,PostTokenizedCardDeleteWithHttpInfo,PostTokenizedCardDeleteAsyncWithHttpInfo");
        ...
        /// <param name="postTokenizedCardDeleteRequest"> (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostTokenizedCardDeleteAsync (string tokenizedCardId, string profileId = null, TmsTokenizedCardDeleteRequest postTokenizedCardDeleteRequest = null)
        {
        ...
        /// <param name="postTokenizedCardDeleteRequest"> (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PostTokenizedCardDeleteAsyncWithHttpInfo (string tokenizedCardId, string profileId = null, TmsTokenizedCardDeleteRequest postTokenizedCardDeleteRequest = null)
        {
            LogUtility logUtility = new LogUtility();
