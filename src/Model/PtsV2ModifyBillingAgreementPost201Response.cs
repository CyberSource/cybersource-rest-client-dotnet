...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2ModifyBillingAgreementPost201Response :  IEquatable<PtsV2ModifyBillingAgreementPost201Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "status", Status.ToString())).Append("\n");
            if (ProcessorInformation != null) sb.Append("  ProcessorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "processorInformation", ProcessorInformation.ToString())).Append("\n");
            if (InstallmentInformation != null) sb.Append("  InstallmentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "installmentInformation", InstallmentInformation.ToString())).Append("\n");
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (RiskInformation != null) sb.Append("  RiskInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2ModifyBillingAgreementPost201Response", "riskInformation", RiskInformation.ToString())).Append("\n");
