...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponsePaymentInformationCard :  IEquatable<PtsV2PaymentsPost201ResponsePaymentInformationCard>, IValidatableObject
    {
        ...
        public PtsV2PaymentsPost201ResponsePaymentInformationCard(string Suffix = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Type = default(string), string Prefix = default(string))
        {
            this.Suffix = Suffix;
