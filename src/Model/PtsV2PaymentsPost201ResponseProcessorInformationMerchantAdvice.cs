...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice :  IEquatable<PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice", "code", Code.ToString())).Append("\n");
            if (CodeRaw != null) sb.Append("  CodeRaw: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice", "codeRaw", CodeRaw.ToString())).Append("\n");
            if (NameMatch != null) sb.Append("  NameMatch: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice", "nameMatch", NameMatch.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
