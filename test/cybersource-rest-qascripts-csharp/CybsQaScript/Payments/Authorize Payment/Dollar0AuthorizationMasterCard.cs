...
{
    public class Dollar0AuthorizationMasterCard
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "Dollar0AuthorizationMasterCard";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/Dollar0AuthorizationMasterCard.csv"), true))
            {
