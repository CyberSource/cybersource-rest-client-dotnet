...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsClientReferenceInformationPartner :  IEquatable<Ptsv2paymentsClientReferenceInformationPartner>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            if (OriginalTransactionId != null) sb.Append("  OriginalTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsClientReferenceInformationPartner", "originalTransactionId", OriginalTransactionId.ToString())).Append("\n");
            if (DeveloperId != null) sb.Append("  DeveloperId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsClientReferenceInformationPartner", "developerId", DeveloperId.ToString())).Append("\n");
            if (SolutionId != null) sb.Append("  SolutionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsClientReferenceInformationPartner", "solutionId", SolutionId.ToString())).Append("\n");
            if (ThirdPartyCertificationNumber != null) sb.Append("  ThirdPartyCertificationNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsClientReferenceInformationPartner", "thirdPartyCertificationNumber", ThirdPartyCertificationNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsClientReferenceInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsClientReferenceInformationPartner);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsClientReferenceInformationPartner instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsClientReferenceInformationPartner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsClientReferenceInformationPartner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
