...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPaymentInformationDirectDebit :  IEquatable<Ptsv2paymentsPaymentInformationDirectDebit>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Mandate != null) sb.Append("  Mandate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationDirectDebit", "mandate", Mandate.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsPaymentInformationDirectDebit", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
