...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPointOfSaleInformation :  IEquatable<Ptsv2paymentsPointOfSaleInformation>, IValidatableObject
    {
        ...
        [DataMember(Name="pinEntrySolution", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            if (LaneNumber != null) sb.Append("  LaneNumber: ").Append(LaneNumber).Append("\n");
            if (CatLevel != null) sb.Append("  CatLevel: ").Append(CatLevel).Append("\n");
            ...
            if (OperatingEnvironment != null) sb.Append("  OperatingEnvironment: ").Append(OperatingEnvironment).Append("\n");
            if (Emv != null) sb.Append("  Emv: ").Append(Emv).Append("\n");
            if (AmexCapnData != null) sb.Append("  AmexCapnData: ").Append(AmexCapnData).Append("\n");
            if (TrackData != null) sb.Append("  TrackData: ").Append(TrackData).Append("\n");
            if (StoreAndForwardIndicator != null) sb.Append("  StoreAndForwardIndicator: ").Append(StoreAndForwardIndicator).Append("\n");
            if (CardholderVerificationMethod != null) sb.Append("  CardholderVerificationMethod: ").Append(CardholderVerificationMethod).Append("\n");
            if (TerminalCategory != null) sb.Append("  TerminalCategory: ").Append(TerminalCategory).Append("\n");
            if (TerminalInputCapability != null) sb.Append("  TerminalInputCapability: ").Append(TerminalInputCapability).Append("\n");
            if (TerminalCardCaptureCapability != null) sb.Append("  TerminalCardCaptureCapability: ").Append(TerminalCardCaptureCapability).Append("\n");
            if (TerminalOutputCapability != null) sb.Append("  TerminalOutputCapability: ").Append(TerminalOutputCapability).Append("\n");
            if (TerminalPinCapability != null) sb.Append("  TerminalPinCapability: ").Append(TerminalPinCapability).Append("\n");
            if (PinEntrySolution != null) sb.Append("  PinEntrySolution: ").Append(PinEntrySolution).Append("\n");
            if (DeviceId != null) sb.Append("  DeviceId: ").Append(DeviceId).Append("\n");
            if (PinBlockEncodingFormat != null) sb.Append("  PinBlockEncodingFormat: ").Append(PinBlockEncodingFormat).Append("\n");
            if (EncryptedPin != null) sb.Append("  EncryptedPin: ").Append(EncryptedPin).Append("\n");
            if (EncryptedKeySerialNumber != null) sb.Append("  EncryptedKeySerialNumber: ").Append(EncryptedKeySerialNumber).Append("\n");
            if (EncryptedKeyId != null) sb.Append("  EncryptedKeyId: ").Append(EncryptedKeyId).Append("\n");
            if (PartnerSdkVersion != null) sb.Append("  PartnerSdkVersion: ").Append(PartnerSdkVersion).Append("\n");
            if (EmvApplicationIdentifierAndDedicatedFileName != null) sb.Append("  EmvApplicationIdentifierAndDedicatedFileName: ").Append(EmvApplicationIdentifierAndDedicatedFileName).Append("\n");
            if (TerminalCompliance != null) sb.Append("  TerminalCompliance: ").Append(TerminalCompliance).Append("\n");
            if (IsDedicatedHardwareTerminal != null) sb.Append("  IsDedicatedHardwareTerminal: ").Append(IsDedicatedHardwareTerminal).Append("\n");
            if (TerminalModel != null) sb.Append("  TerminalModel: ").Append(TerminalModel).Append("\n");
            if (TerminalMake != null) sb.Append("  TerminalMake: ").Append(TerminalMake).Append("\n");
            if (ServiceCode != null) sb.Append("  ServiceCode: ").Append(ServiceCode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
