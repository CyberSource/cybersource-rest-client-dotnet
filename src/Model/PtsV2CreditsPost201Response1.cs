...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PtsV2CreditsPost201Response1 :  IEquatable<PtsV2CreditsPost201Response1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PtsV2CreditsPost201Response1" /> class.
        /// </summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public PtsV2CreditsPost201Response1ProcessorInformation ProcessorInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreditsPost201Response1", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreditsPost201Response1", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreditsPost201Response1", "status", Status.ToString())).Append("\n");
            if (ProcessorInformation != null) sb.Append("  ProcessorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreditsPost201Response1", "processorInformation", ProcessorInformation.ToString())).Append("\n");
            if (InstallmentInformation != null) sb.Append("  InstallmentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreditsPost201Response1", "installmentInformation", InstallmentInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2CreditsPost201Response1", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PtsV2CreditsPost201Response1);
        }

        /// <summary>
        /// Returns true if PtsV2CreditsPost201Response1 instances are equal
        /// </summary>
        /// <param name="other">Instance of PtsV2CreditsPost201Response1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PtsV2CreditsPost201Response1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
