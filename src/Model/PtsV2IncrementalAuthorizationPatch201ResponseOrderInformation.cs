...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation :  IEquatable<PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            if (AmountDetails != null) sb.Append("  AmountDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation", "amountDetails", AmountDetails.ToString())).Append("\n");
            if (InvoiceDetails != null) sb.Append("  InvoiceDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation", "invoiceDetails", InvoiceDetails.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation);
        }

        /// <summary>
        /// Returns true if PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PtsV2IncrementalAuthorizationPatch201ResponseOrderInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
