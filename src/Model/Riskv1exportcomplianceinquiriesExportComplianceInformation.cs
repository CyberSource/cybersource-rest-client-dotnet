...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1exportcomplianceinquiriesExportComplianceInformation :  IEquatable<Riskv1exportcomplianceinquiriesExportComplianceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AddressOperator != null) sb.Append("  AddressOperator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesExportComplianceInformation", "addressOperator", AddressOperator.ToString())).Append("\n");
            if (Weights != null) sb.Append("  Weights: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesExportComplianceInformation", "weights", Weights.ToString())).Append("\n");
            if (SanctionLists != null) sb.Append("  SanctionLists: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesExportComplianceInformation", "sanctionLists", SanctionLists.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1exportcomplianceinquiriesExportComplianceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
