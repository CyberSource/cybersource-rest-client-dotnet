...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsDigitalPaymentsSubscriptionInformation :  IEquatable<PaymentProductsDigitalPaymentsSubscriptionInformation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsDigitalPaymentsSubscriptionInformation" /> class.
        /// </summary>
        ...
        public PaymentProductsDigitalPaymentsSubscriptionInformation(bool? Enabled = default(bool?), SelfServiceabilityEnum? SelfServiceability = SelfServiceabilityEnum.NOTSELFSERVICEABLE, Dictionary<string, PaymentProductsCardProcessingSubscriptionInformationFeatures> Features = default(Dictionary<string, PaymentProductsCardProcessingSubscriptionInformationFeatures>))
        {
        ...
        public Dictionary<string, PaymentProductsCardProcessingSubscriptionInformationFeatures> Features { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentProductsDigitalPaymentsSubscriptionInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsDigitalPaymentsSubscriptionInformation);
        }

        /// <summary>
        /// Returns true if PaymentProductsDigitalPaymentsSubscriptionInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsDigitalPaymentsSubscriptionInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsDigitalPaymentsSubscriptionInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
