...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions :  IEquatable<PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (SettlementMethod != null) sb.Append("  SettlementMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions", "settlementMethod", SettlementMethod.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
