...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1liststypeentriesPaymentInformation :  IEquatable<Riskv1liststypeentriesPaymentInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Card != null) sb.Append("  Card: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1liststypeentriesPaymentInformation", "card", Card.ToString())).Append("\n");
            if (Bank != null) sb.Append("  Bank: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1liststypeentriesPaymentInformation", "bank", Bank.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1liststypeentriesPaymentInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
