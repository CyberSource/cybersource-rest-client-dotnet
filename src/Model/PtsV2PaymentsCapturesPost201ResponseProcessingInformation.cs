...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsCapturesPost201ResponseProcessingInformation :  IEquatable<PtsV2PaymentsCapturesPost201ResponseProcessingInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (EnhancedDataEnabled != null) sb.Append("  EnhancedDataEnabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessingInformation", "enhancedDataEnabled", EnhancedDataEnabled.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsCapturesPost201ResponseProcessingInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
