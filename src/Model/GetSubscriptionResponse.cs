...
namespace CyberSource.Model
{
    ...
    public partial class GetSubscriptionResponse :  IEquatable<GetSubscriptionResponse>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonPropertyName("reactivationInformation")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public GetSubscriptionResponseReactivationInformation ReactivationInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (PlanInformation != null) sb.Append("  PlanInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "planInformation", PlanInformation.ToString())).Append("\n");
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "orderInformation", OrderInformation.ToString())).Append("\n");
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ReactivationInformation != null) sb.Append("  ReactivationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse", "reactivationInformation", ReactivationInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("GetSubscriptionResponse", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetSubscriptionResponse);
        }
