...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsPointOfSaleInformation :  IEquatable<V2paymentsPointOfSaleInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsPointOfSaleInformation" /> class.
        /// </summary>
        ...
        /// <param name="TerminalSerialNumber">TBD.</param>
        ...
        /// <param name="TrackData">Cardâ€™s track 1 and 2 data. For all processors except FDMS Nashville, this value consists of one of the following:   - Track 1 data  - Track 2 data  - Data for both tracks 1 and 2  For FDMS Nashville, this value consists of one of the following:  - Track 1 data  - Data for both tracks 1 and 2  Example: %B4111111111111111^SMITH/JOHN ^1612101976110000868000000?;4111111111111111&#x3D;16121019761186800000? .</param>
        public V2paymentsPointOfSaleInformation(string TerminalId = default(string), string TerminalSerialNumber = default(string), string LaneNumber = default(string), bool? CardPresent = default(bool?), int? CatLevel = default(int?), string EntryMode = default(string), int? TerminalCapability = default(int?), int? PinEntryCapability = default(int?), string OperatingEnvironment = default(string), V2paymentsPointOfSaleInformationEmv Emv = default(V2paymentsPointOfSaleInformationEmv), string AmexCapnData = default(string), string TrackData = default(string))
        {
        ...
        /// </summary>
        /// <value>POS terminalâ€™s capability. Possible values:   - 1: Terminal has a magnetic stripe reader only.  - 2: Terminal has a magnetic stripe reader and manual entry capability.  - 3: Terminal has manual entry capability only.  - 4: Terminal can read chip cards.  - 5: Terminal can read contactless chip cards.  The values of 4 and 5 are supported only for EMV transactions. * Applicable only for CTV for Payouts.   </value>
        ...
        public V2paymentsPointOfSaleInformationEmv Emv { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsPointOfSaleInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsPointOfSaleInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsPointOfSaleInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsPointOfSaleInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
