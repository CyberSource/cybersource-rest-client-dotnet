...
namespace CyberSource.Model
{
    ...
    public partial class PblPaymentLinksAllGet200ResponseSdkLinks :  IEquatable<PblPaymentLinksAllGet200ResponseSdkLinks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "id", Id.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "status", Status.ToString())).Append("\n");
            if (CreatedDate != null) sb.Append("  CreatedDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "createdDate", CreatedDate.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            if (PurchaseInformation != null) sb.Append("  PurchaseInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "purchaseInformation", PurchaseInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksAllGet200ResponseSdkLinks", "orderInformation", OrderInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PblPaymentLinksAllGet200ResponseSdkLinks", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
