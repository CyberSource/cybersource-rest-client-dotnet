...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse400 :  IEquatable<InlineResponse400>, IValidatableObject
    {
        ...
        public InlineResponse400(string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<InlineResponse201ErrorInformationDetails> Details = default(List<InlineResponse201ErrorInformationDetails>))
        {
