...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(InlineResponse2006Links Links = default(InlineResponse2006Links), string Id = default(string), string SubmitTimeUtc = default(string), InlineResponse2006PlanInformation PlanInformation = default(InlineResponse2006PlanInformation), InlineResponse2006SubscriptionInformation SubscriptionInformation = default(InlineResponse2006SubscriptionInformation), InlineResponse2006PaymentInformation PaymentInformation = default(InlineResponse2006PaymentInformation), InlineResponse2006OrderInformation OrderInformation = default(InlineResponse2006OrderInformation))
        {
            this.Links = Links;
            this.Id = Id;
