...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskV1DecisionsPost201ResponseRiskInformationProfile :  IEquatable<RiskV1DecisionsPost201ResponseRiskInformationProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskV1DecisionsPost201ResponseRiskInformationProfile" /> class.
        /// </summary>
        ...
        public RiskV1DecisionsPost201ResponseRiskInformationProfile(string Name = default(string), string DesinationQueue = default(string), string SelectorRule = default(string))
        {
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RiskV1DecisionsPost201ResponseRiskInformationProfile {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RiskV1DecisionsPost201ResponseRiskInformationProfile);
        }

        /// <summary>
        /// Returns true if RiskV1DecisionsPost201ResponseRiskInformationProfile instances are equal
        /// </summary>
        /// <param name="other">Instance of RiskV1DecisionsPost201ResponseRiskInformationProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskV1DecisionsPost201ResponseRiskInformationProfile other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
