...
namespace CyberSource.Model
{
    ...
    public partial class PtsV1TransactionBatchesGet400Response :  IEquatable<PtsV1TransactionBatchesGet400Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ErrorInformation != null) sb.Append("  ErrorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV1TransactionBatchesGet400Response", "errorInformation", ErrorInformation.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV1TransactionBatchesGet400Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV1TransactionBatchesGet400Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
