...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009ResponseRecordAdditionalUpdates :  IEquatable<InlineResponse2009ResponseRecordAdditionalUpdates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009ResponseRecordAdditionalUpdates" /> class.
        /// </summary>
        ...
        public InlineResponse2009ResponseRecordAdditionalUpdates(string CustomerId = default(string), string PaymentInstrumentId = default(string), string Creator = default(string), string State = default(string), string Message = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2009ResponseRecordAdditionalUpdates);
        }

        /// <summary>
        /// Returns true if InlineResponse2009ResponseRecordAdditionalUpdates instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2009ResponseRecordAdditionalUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009ResponseRecordAdditionalUpdates other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
