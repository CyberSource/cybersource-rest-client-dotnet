...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoicingV2InvoicesPut200Response :  IEquatable<InvoicingV2InvoicesPut200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicingV2InvoicesPut200Response" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "status", Status.ToString())).Append("\n");
            if (CustomerInformation != null) sb.Append("  CustomerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "customerInformation", CustomerInformation.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            if (InvoiceInformation != null) sb.Append("  InvoiceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "invoiceInformation", InvoiceInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "orderInformation", OrderInformation.ToString())).Append("\n");
            if (MerchantDefinedFieldValuesWithDefinition != null) sb.Append("  MerchantDefinedFieldValuesWithDefinition: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPut200Response", "merchantDefinedFieldValuesWithDefinition", MerchantDefinedFieldValuesWithDefinition.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InvoicingV2InvoicesPut200Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoicingV2InvoicesPut200Response);
        }

        /// <summary>
        /// Returns true if InvoicingV2InvoicesPut200Response instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoicingV2InvoicesPut200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoicingV2InvoicesPut200Response other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
