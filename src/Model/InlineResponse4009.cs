...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4009 :  IEquatable<InlineResponse4009>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse4009", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse4009", "status", Status.ToString())).Append("\n");
