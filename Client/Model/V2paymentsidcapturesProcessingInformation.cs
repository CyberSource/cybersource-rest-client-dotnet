...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesProcessingInformation :  IEquatable<V2paymentsidcapturesProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesProcessingInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesProcessingInformation(string PaymentSolution = default(string), string ReconciliationId = default(string), string LinkId = default(string), string ReportGroup = default(string), string VisaCheckoutId = default(string), string PurchaseLevel = default(string), V2paymentsProcessingInformationIssuer Issuer = default(V2paymentsProcessingInformationIssuer), V2paymentsidcapturesProcessingInformationAuthorizationOptions AuthorizationOptions = default(V2paymentsidcapturesProcessingInformationAuthorizationOptions), V2paymentsidcapturesProcessingInformationCaptureOptions CaptureOptions = default(V2paymentsidcapturesProcessingInformationCaptureOptions))
        {
        ...
        public V2paymentsidcapturesProcessingInformationAuthorizationOptions AuthorizationOptions { get; set; }

        /// <summary>
        /// Gets or Sets CaptureOptions
        /// </summary>
        [DataMember(Name="captureOptions", EmitDefaultValue=false)]
        public V2paymentsidcapturesProcessingInformationCaptureOptions CaptureOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsidcapturesProcessingInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesProcessingInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
