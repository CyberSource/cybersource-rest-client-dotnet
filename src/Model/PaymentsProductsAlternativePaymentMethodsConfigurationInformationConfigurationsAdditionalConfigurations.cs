...
namespace CyberSource.Model
{
    ...
    public partial class PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations :  IEquatable<PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Key != null) sb.Append("  Key: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations", "key", Key.ToString())).Append("\n");
            if (Value != null) sb.Append("  Value: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations", "value", Value.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
