...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2billingagreementsClientReferenceInformation :  IEquatable<Ptsv2billingagreementsClientReferenceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2billingagreementsClientReferenceInformation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ptsv2billingagreementsClientReferenceInformation {\n");
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "code", Code.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            if (PausedRequestId != null) sb.Append("  PausedRequestId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "pausedRequestId", PausedRequestId.ToString())).Append("\n");
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (Comments != null) sb.Append("  Comments: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "comments", Comments.ToString())).Append("\n");
            if (Partner != null) sb.Append("  Partner: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "partner", Partner.ToString())).Append("\n");
            if (ApplicationName != null) sb.Append("  ApplicationName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "applicationName", ApplicationName.ToString())).Append("\n");
            if (ApplicationVersion != null) sb.Append("  ApplicationVersion: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "applicationVersion", ApplicationVersion.ToString())).Append("\n");
            if (ApplicationUser != null) sb.Append("  ApplicationUser: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsClientReferenceInformation", "applicationUser", ApplicationUser.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2billingagreementsClientReferenceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2billingagreementsClientReferenceInformation);
        }

        /// <summary>
        /// Returns true if Ptsv2billingagreementsClientReferenceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2billingagreementsClientReferenceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2billingagreementsClientReferenceInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
