...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPaymentInformationFluidData :  IEquatable<Ptsv2paymentsPaymentInformationFluidData>, IValidatableObject
    {
        ...
        /// <param name="Value">Represents the encrypted payment data BLOB. The entry for this field is dependent on the payment solution a merchant uses.  #### Used by **Authorization and Standalone Credits** Required for authorizations and standalone credits that use Bluefin PCI P2PE.  #### Card Present processing This field represents the encrypted Bluefin PCI P2PE payment data. Obtain the encrypted payment data from a Bluefin-supported device. .</param>
