...
namespace CybsQaScript.Payments.Authorize_Payment.Digital_Payments.SamSung_Pay
{
    public class AuthorizeSamsungPayMerchantDecryption
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizeSamsungPayMerchantDecryption";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/DigitalPayments/SamsungPay/CreateAuthorizeSamsungPayMerchantDecryption.csv"), true))
            {
