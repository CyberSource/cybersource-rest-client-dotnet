...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsPaymentInformationFluidData :  IEquatable<V2paymentsPaymentInformationFluidData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsPaymentInformationFluidData" /> class.
        /// </summary>
        ...
        public V2paymentsPaymentInformationFluidData(string Key = default(string), string Descriptor = default(string), string Value = default(string), string Encoding = default(string))
        {
            this.Key = Key;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsPaymentInformationFluidData);
        }

        /// <summary>
        /// Returns true if V2paymentsPaymentInformationFluidData instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsPaymentInformationFluidData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsPaymentInformationFluidData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
