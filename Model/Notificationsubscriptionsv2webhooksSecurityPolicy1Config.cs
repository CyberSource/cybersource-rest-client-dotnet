...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Notificationsubscriptionsv2webhooksSecurityPolicy1Config :  IEquatable<Notificationsubscriptionsv2webhooksSecurityPolicy1Config>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Notificationsubscriptionsv2webhooksSecurityPolicy1Config" /> class.
        /// </summary>
        ...
        public Notificationsubscriptionsv2webhooksSecurityPolicy1Config(string OAuthTokenExpiry = default(string), string OAuthURL = default(string), string OAuthTokenType = default(string), Notificationsubscriptionsv2webhooksSecurityPolicy1ConfigAdditionalConfig AdditionalConfig = default(Notificationsubscriptionsv2webhooksSecurityPolicy1ConfigAdditionalConfig))
        {
        ...
        public Notificationsubscriptionsv2webhooksSecurityPolicy1ConfigAdditionalConfig AdditionalConfig { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Notificationsubscriptionsv2webhooksSecurityPolicy1Config);
        }

        /// <summary>
        /// Returns true if Notificationsubscriptionsv2webhooksSecurityPolicy1Config instances are equal
        /// </summary>
        /// <param name="other">Instance of Notificationsubscriptionsv2webhooksSecurityPolicy1Config to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Notificationsubscriptionsv2webhooksSecurityPolicy1Config other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
