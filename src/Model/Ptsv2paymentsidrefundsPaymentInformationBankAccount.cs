...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsidrefundsPaymentInformationBankAccount :  IEquatable<Ptsv2paymentsidrefundsPaymentInformationBankAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2paymentsidrefundsPaymentInformationBankAccount" /> class.
        /// </summary>
        ...
        public Ptsv2paymentsidrefundsPaymentInformationBankAccount(string Type = default(string), string Number = default(string), string EncoderId = default(string), string CheckNumber = default(string), string CheckImageReferenceNumber = default(string))
        {
            this.Type = Type;
            this.Number = Number;
        ...
        public override string ToString()
        {
            ...
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBankAccount", "type", Type.ToString())).Append("\n");
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBankAccount", "number", Number.ToString())).Append("\n");
            if (EncoderId != null) sb.Append("  EncoderId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBankAccount", "encoderId", EncoderId.ToString())).Append("\n");
            if (CheckNumber != null) sb.Append("  CheckNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBankAccount", "checkNumber", CheckNumber.ToString())).Append("\n");
            if (CheckImageReferenceNumber != null) sb.Append("  CheckImageReferenceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBankAccount", "checkImageReferenceNumber", CheckImageReferenceNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsPaymentInformationBankAccount", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsidrefundsPaymentInformationBankAccount);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsidrefundsPaymentInformationBankAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsidrefundsPaymentInformationBankAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsidrefundsPaymentInformationBankAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
