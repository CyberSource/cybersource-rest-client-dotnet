...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures :  IEquatable<PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures>, IValidatableObject
    {
        ...
        /// <param name="AccountStatus">Possible values:   - &#x60;N&#x60;: Nonregulated  - &#x60;R&#x60;: Regulated  **Note** This field is returned only for Visa Platform Connect. .</param>
        ...
        /// <param name="Group">Type of commercial card. This field is supported only for Visa Platform Connect. Possible values:   - **B**: Business card  - **R**: Corporate card  - **S**: Purchasing card  - **0**: Noncommercial card .</param>
        /// <param name="HealthCare">Indicates whether the card is a healthcare card. This field is supported for Visa and Mastercard on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_healthcare&#x60; reply field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) .</param>
        /// <param name="Payroll">Indicates whether the card is a payroll card. This field is supported for Visa, Discover, Diners Club, and JCB on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_payroll&#x60; field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) .</param>
        ...
        /// <param name="PinlessDebit">Indicates whether the card is a PINless debit card. This field is supported for Visa and Mastercard on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_pinless_debit&#x60; reply field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) .</param>
        ...
        /// </summary>
        /// <value>Possible values:   - &#x60;N&#x60;: Nonregulated  - &#x60;R&#x60;: Regulated  **Note** This field is returned only for Visa Platform Connect. </value>
        ...
        /// </summary>
        /// <value>#### CyberSource through VisaNet Visa or Mastercard product ID that is associated with the primary account number (PAN). For descriptions of the Visa product IDs, see the Product ID table on the [Visa Request &amp; Response Codes web page.](https://developer.visa.com/guides/request_response_codes)  Data Length: String (3)  #### GPN Visa or Mastercard product ID that is associated with the primary account number (PAN). For descriptions of the Visa product IDs, seepag the Product ID table on the [Visa Request &amp; Response Codes web page.](https://developer.visa.com/guides/request_response_codes) For descriptions of the Mastercard product IDs, see \&quot;Product IDs\&quot; in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm)  Data Length: String (3)  #### Worldpay VAP **Important** Before using this field on Worldpay VAP, you must contact CyberSource Customer Support to have your account configured for this feature.  Type of card used in the transaction. The only possible value is: - &#x60;PREPAID&#x60;: Prepaid Card  Data Length: String (7)  #### RBS WorldPay Atlanta Type of card used in the transaction. Possible values: - &#x60;B&#x60;: Business Card - &#x60;O&#x60;: Noncommercial Card - &#x60;R&#x60;: Corporate Card - &#x60;S&#x60;: Purchase Card - &#x60;Blank&#x60;: Purchase card not supported  Data Length: String (1) </value>
        ...
        /// </summary>
        /// <value>Indicates whether the card is a commercial card, which enables you to include Level II data in your transaction requests. This field is supported for Visa and Mastercard on **Chase Paymentech Solutions**. Possible values:   - **Y**: Yes  - **N**: No  - **X**: Not applicable / Unknown  For details, see &#x60;auth_card_commercial&#x60; reply field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) </value>
        ...
        /// </summary>
        /// <value>Type of commercial card. This field is supported only for Visa Platform Connect. Possible values:   - **B**: Business card  - **R**: Corporate card  - **S**: Purchasing card  - **0**: Noncommercial card </value>
        ...
        /// </summary>
        /// <value>Indicates whether the card is a healthcare card. This field is supported for Visa and Mastercard on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_healthcare&#x60; reply field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) </value>
        ...
        /// </summary>
        /// <value>Indicates whether the card is a payroll card. This field is supported for Visa, Discover, Diners Club, and JCB on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_payroll&#x60; field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) </value>
        ...
        /// </summary>
        /// <value>Indicates whether the card is eligible for Level III interchange fees, which enables you to include Level III data in your transaction requests. This field is supported for Visa and Mastercard on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_level_3_eligible&#x60; reply field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) </value>
        ...
        /// </summary>
        /// <value>Indicates whether the card is a PINless debit card. This field is supported for Visa and Mastercard on **Chase Paymentech Solutions**. Possible values:   - &#x60;Y&#x60;: Yes  - &#x60;N&#x60;: No  - &#x60;X&#x60;: Not applicable / Unknown  For details, see &#x60;auth_card_pinless_debit&#x60; reply field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/wwhelp/wwhimpl/js/html/wwhelp.htm) </value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountType, length must be less than or equal to 2.", new [] { "AccountType" });
            }

            // AccountStatus (string) maxLength
            if(this.AccountStatus != null && this.AccountStatus.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountStatus, length must be less than or equal to 1.", new [] { "AccountStatus" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for BalanceAmountType, length must be less than or equal to 2.", new [] { "BalanceAmountType" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AffluenceIndicator, length must be less than or equal to 13.", new [] { "AffluenceIndicator" });
            }

            // Category (string) maxLength
            if(this.Category != null && this.Category.Length >= 7)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Category, length must be less than or equal to 7.", new [] { "Category" });
            }

            // Commercial (string) maxLength
            if(this.Commercial != null && this.Commercial.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Commercial, length must be less than or equal to 1.", new [] { "Commercial" });
            }

            // Group (string) maxLength
            if(this.Group != null && this.Group.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Group, length must be less than or equal to 1.", new [] { "Group" });
            }

            // HealthCare (string) maxLength
            if(this.HealthCare != null && this.HealthCare.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for HealthCare, length must be less than or equal to 1.", new [] { "HealthCare" });
            }

            // Payroll (string) maxLength
            if(this.Payroll != null && this.Payroll.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Payroll, length must be less than or equal to 1.", new [] { "Payroll" });
            }

            // Level3Eligible (string) maxLength
            if(this.Level3Eligible != null && this.Level3Eligible.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Level3Eligible, length must be less than or equal to 1.", new [] { "Level3Eligible" });
            }

            // PinlessDebit (string) maxLength
            if(this.PinlessDebit != null && this.PinlessDebit.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PinlessDebit, length must be less than or equal to 1.", new [] { "PinlessDebit" });
            }

            // SignatureDebit (string) maxLength
            if(this.SignatureDebit != null && this.SignatureDebit.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SignatureDebit, length must be less than or equal to 1.", new [] { "SignatureDebit" });
            }

            // Prepaid (string) maxLength
            if(this.Prepaid != null && this.Prepaid.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Prepaid, length must be less than or equal to 1.", new [] { "Prepaid" });
            }

            // Regulated (string) maxLength
            if(this.Regulated != null && this.Regulated.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Regulated, length must be less than or equal to 1.", new [] { "Regulated" });
            }
