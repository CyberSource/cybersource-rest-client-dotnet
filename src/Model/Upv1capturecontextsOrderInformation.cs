...
namespace CyberSource.Model
{
    ...
    public partial class Upv1capturecontextsOrderInformation :  IEquatable<Upv1capturecontextsOrderInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AmountDetails != null) sb.Append("  AmountDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformation", "amountDetails", AmountDetails.ToString())).Append("\n");
            if (BillTo != null) sb.Append("  BillTo: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformation", "billTo", BillTo.ToString())).Append("\n");
            if (ShipTo != null) sb.Append("  ShipTo: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformation", "shipTo", ShipTo.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Upv1capturecontextsOrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
