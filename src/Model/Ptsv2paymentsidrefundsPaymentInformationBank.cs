...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidrefundsPaymentInformationBank :  IEquatable<Ptsv2paymentsidrefundsPaymentInformationBank>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Account != null) sb.Append("  Account: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBank", "account", Account.ToString())).Append("\n");
            if (RoutingNumber != null) sb.Append("  RoutingNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBank", "routingNumber", RoutingNumber.ToString())).Append("\n");
            if (Iban != null) sb.Append("  Iban: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBank", "iban", Iban.ToString())).Append("\n");
            if (SwiftCode != null) sb.Append("  SwiftCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsPaymentInformationBank", "swiftCode", SwiftCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsPaymentInformationBank", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
