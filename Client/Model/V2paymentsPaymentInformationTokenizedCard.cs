...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsPaymentInformationTokenizedCard :  IEquatable<V2paymentsPaymentInformationTokenizedCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        /// <param name="Number">Customerâ€™s payment network token value. .</param>
        ...
        /// <param name="TransactionType">Type of transaction that provided the token data. This value does not specify the token service provider; it specifies the entity that provided you with information about the token.  Set the value for this field to 1. An application on the customerâ€™s mobile device provided the token data. .</param>
        ...
        /// </summary>
        /// <value>Customerâ€™s payment network token value. </value>
        ...
        /// </summary>
        /// <value>Type of transaction that provided the token data. This value does not specify the token service provider; it specifies the entity that provided you with information about the token.  Set the value for this field to 1. An application on the customerâ€™s mobile device provided the token data. </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsPaymentInformationTokenizedCard);
        }

        /// <summary>
        /// Returns true if V2paymentsPaymentInformationTokenizedCard instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsPaymentInformationTokenizedCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsPaymentInformationTokenizedCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
