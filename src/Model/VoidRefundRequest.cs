...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoidRefundRequest :  IEquatable<VoidRefundRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidRefundRequest", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidRefundRequest", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidRefundRequest", "orderInformation", OrderInformation.ToString())).Append("\n");
            if (AgreementInformation != null) sb.Append("  AgreementInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidRefundRequest", "agreementInformation", AgreementInformation.ToString())).Append("\n");
            if (MerchantInformation != null) sb.Append("  MerchantInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidRefundRequest", "merchantInformation", MerchantInformation.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("VoidRefundRequest", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("VoidRefundRequest", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoidRefundRequest);
        }

        /// <summary>
        /// Returns true if VoidRefundRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of VoidRefundRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoidRefundRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
