...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsOrderInformationLineItems :  IEquatable<V2paymentsOrderInformationLineItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsOrderInformationLineItems" /> class.
        /// </summary>
        ...
        public V2paymentsOrderInformationLineItems(string ProductCode = default(string), string ProductName = default(string), string ProductSku = default(string), decimal? Quantity = default(decimal?), string UnitPrice = default(string), string UnitOfMeasure = default(string), string TotalAmount = default(string), string TaxAmount = default(string), string TaxRate = default(string), string TaxAppliedAfterDiscount = default(string), string TaxStatusIndicator = default(string), string TaxTypeCode = default(string), bool? AmountIncludesTax = default(bool?), string TypeOfSupply = default(string), string CommodityCode = default(string), string DiscountAmount = default(string), bool? DiscountApplied = default(bool?), string DiscountRate = default(string), string InvoiceNumber = default(string), List<V2paymentsOrderInformationAmountDetailsTaxDetails> TaxDetails = default(List<V2paymentsOrderInformationAmountDetailsTaxDetails>), string FulfillmentType = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsOrderInformationLineItems);
        }

        /// <summary>
        /// Returns true if V2paymentsOrderInformationLineItems instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsOrderInformationLineItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsOrderInformationLineItems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
