...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommerceSolutionsProductsTokenManagement :  IEquatable<CommerceSolutionsProductsTokenManagement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommerceSolutionsProductsTokenManagement" /> class.
        /// </summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public CommerceSolutionsProductsTokenManagementConfigurationInformation ConfigurationInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CommerceSolutionsProductsTokenManagement", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            if (ConfigurationInformation != null) sb.Append("  ConfigurationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CommerceSolutionsProductsTokenManagement", "configurationInformation", ConfigurationInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("CommerceSolutionsProductsTokenManagement", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CommerceSolutionsProductsTokenManagement);
        }

        /// <summary>
        /// Returns true if CommerceSolutionsProductsTokenManagement instances are equal
        /// </summary>
        /// <param name="other">Instance of CommerceSolutionsProductsTokenManagement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommerceSolutionsProductsTokenManagement other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
