...
{
    public class CvnMaestroUkDomestic
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "CvnMaestroUkDomestic";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/CVN/CreateMaestroUKDomestic.csv"), true))
            {
