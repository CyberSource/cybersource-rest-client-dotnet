...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidreversalsClientReferenceInformationPartner :  IEquatable<Ptsv2paymentsidreversalsClientReferenceInformationPartner>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (DeveloperId != null) sb.Append("  DeveloperId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformationPartner", "developerId", DeveloperId.ToString())).Append("\n");
            if (SolutionId != null) sb.Append("  SolutionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformationPartner", "solutionId", SolutionId.ToString())).Append("\n");
            if (ThirdPartyCertificationNumber != null) sb.Append("  ThirdPartyCertificationNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformationPartner", "thirdPartyCertificationNumber", ThirdPartyCertificationNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidreversalsClientReferenceInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
