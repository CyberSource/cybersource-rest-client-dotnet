...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), InlineResponse200PlanInformation PlanInformation = default(InlineResponse200PlanInformation), InlineResponse200OrderInformation OrderInformation = default(InlineResponse200OrderInformation))
        {
            this.Links = Links;
            this.Id = Id;
