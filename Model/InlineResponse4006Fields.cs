...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse4006Fields :  IEquatable<InlineResponse4006Fields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4006Fields" /> class.
        /// </summary>
        ...
        public InlineResponse4006Fields(string Path = default(string), string Message = default(string), string LocalizationKey = default(string))
        {
            this.Path = Path;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4006Fields {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse4006Fields);
        }

        /// <summary>
        /// Returns true if InlineResponse4006Fields instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse4006Fields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4006Fields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
