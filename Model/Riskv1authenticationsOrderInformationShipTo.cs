...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsOrderInformationShipTo :  IEquatable<Riskv1authenticationsOrderInformationShipTo>, IValidatableObject
    {
        ...
        public Riskv1authenticationsOrderInformationShipTo(string Address1 = default(string), string Address2 = default(string), string AdministrativeArea = default(string), string Country = default(string), string DestinationTypes = default(string), string Locality = default(string), string FirstName = default(string), string LastName = default(string), string PhoneNumber = default(string), string PostalCode = default(string), int? DestinationCode = default(int?), string Method = default(string))
        {
