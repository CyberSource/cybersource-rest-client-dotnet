...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService :  IEquatable<PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService" /> class.
        /// </summary>
        ...
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService(bool? DecisionManagerVerboseEnabled = default(bool?), decimal? DeclinedRetryLimit = default(decimal?), bool? DecisionManagerEnabled = default(bool?), bool? TokenizationEnabled = default(bool?), bool? ReverseAuthOnAddressVerificationSystemFailure = default(bool?), bool? DeviceFingerprintEnabled = default(bool?), bool? ReverseAuthOnCardVerificationNumberFailure = default(bool?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService);
        }

        /// <summary>
        /// Returns true if PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
