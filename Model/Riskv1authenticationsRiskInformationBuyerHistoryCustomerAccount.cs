...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount :  IEquatable<Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount(string LastChangeDate = default(string), string CreationHistory = default(string), string ModificationHistory = default(string), string PasswordHistory = default(string), string CreateDate = default(string), string PasswordChangeDate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LastChangeDate, length must be less than 10.", new [] { "LastChangeDate" });
            }

            // CreateDate (string) maxLength
            if(this.CreateDate != null && this.CreateDate.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CreateDate, length must be less than 10.", new [] { "CreateDate" });
            }

            // PasswordChangeDate (string) maxLength
            if(this.PasswordChangeDate != null && this.PasswordChangeDate.Length > 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PasswordChangeDate, length must be less than 10.", new [] { "PasswordChangeDate" });
            }
