...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2014 :  IEquatable<InlineResponse2014>, IValidatableObject
    {
        ...
        public InlineResponse2014(string EventDate = default(string), string EventType = default(string), string OrganizationId = default(string), InlineResponse2014Payloads Payloads = default(InlineResponse2014Payloads), string ProductId = default(string), string RequestType = default(string), int? RetryNumber = default(int?), string TransactionTraceId = default(string), string WebhookId = default(string))
        {
        ...
        public InlineResponse2014Payloads Payloads { get; set; }
