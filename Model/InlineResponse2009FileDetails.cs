...
{
    /// <summary>
    /// InlineResponse2009FileDetails
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009FileDetails :  IEquatable<InlineResponse2009FileDetails>, IValidatableObject
    {
        /// <summary>
        /// File extension
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009FileDetails" /> class.
        /// </summary>
        ...
        public InlineResponse2009FileDetails(string FileId = default(string), string Name = default(string), DateTime? CreatedTime = default(DateTime?), DateTime? LastModifiedTime = default(DateTime?), DateTime? Date = default(DateTime?), MimeTypeEnum? MimeType = default(MimeTypeEnum?), int? Size = default(int?))
        {
            this.FileId = FileId;
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009FileDetails {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2009FileDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse2009FileDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2009FileDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009FileDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
