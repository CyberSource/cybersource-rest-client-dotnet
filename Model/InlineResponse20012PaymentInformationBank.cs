...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012PaymentInformationBank :  IEquatable<InlineResponse20012PaymentInformationBank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012PaymentInformationBank" /> class.
        /// </summary>
        ...
        public InlineResponse20012PaymentInformationBank(string RoutingNumber = default(string), string BranchCode = default(string), string SwiftCode = default(string), string BankCode = default(string), string Iban = default(string), InlineResponse20012PaymentInformationBankAccount Account = default(InlineResponse20012PaymentInformationBankAccount), InlineResponse20012PaymentInformationBankMandate Mandate = default(InlineResponse20012PaymentInformationBankMandate))
        {
        ...
        public InlineResponse20012PaymentInformationBankAccount Account { get; set; }

        /// <summary>
        /// Gets or Sets Mandate
        /// </summary>
        [DataMember(Name="mandate", EmitDefaultValue=false)]
        public InlineResponse20012PaymentInformationBankMandate Mandate { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012PaymentInformationBank);
        }

        /// <summary>
        /// Returns true if InlineResponse20012PaymentInformationBank instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012PaymentInformationBank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012PaymentInformationBank other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
