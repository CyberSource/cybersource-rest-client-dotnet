...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1DecisionsPost400Response :  IEquatable<RiskV1DecisionsPost400Response>, IValidatableObject
    {
        ...
        public RiskV1DecisionsPost400Response(string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), string Reason = default(string), string Message = default(string), List<PtsV2PaymentsPost201ResponseErrorInformationDetails> Details = default(List<PtsV2PaymentsPost201ResponseErrorInformationDetails>))
        {
