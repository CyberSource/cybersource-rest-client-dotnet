...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsPaymentInformationPaymentType :  IEquatable<Ptsv2paymentsPaymentInformationPaymentType>, IValidatableObject
    {
        /// <summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2paymentsPaymentInformationPaymentTypeMethod Method { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationPaymentType", "name", Name.ToString())).Append("\n");
            if (SubTypeName != null) sb.Append("  SubTypeName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationPaymentType", "subTypeName", SubTypeName.ToString())).Append("\n");
            if (Method != null) sb.Append("  Method: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationPaymentType", "method", Method.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsPaymentInformationPaymentType", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsPaymentInformationPaymentType);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsPaymentInformationPaymentType instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsPaymentInformationPaymentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsPaymentInformationPaymentType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
