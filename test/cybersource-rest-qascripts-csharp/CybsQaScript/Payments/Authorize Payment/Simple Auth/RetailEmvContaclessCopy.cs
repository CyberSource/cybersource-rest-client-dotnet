...
namespace CybsQaScript.Payments.Authorize_Payment.Simple_Auth
{
    public class RetailEmvContactlessCopy
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "RetailEmvContactlessCopy";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/RetailEMVcontactlessCopy.csv"), true))
            {
