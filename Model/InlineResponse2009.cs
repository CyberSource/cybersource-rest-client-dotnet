...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(string Version = default(string), string ReportCreatedDate = default(string), string BatchId = default(string), string BatchSource = default(string), string BatchCaEndpoints = default(string), string BatchCreatedDate = default(string), string MerchantReference = default(string), InlineResponse2007EmbeddedTotals Totals = default(InlineResponse2007EmbeddedTotals), InlineResponse2008Billing Billing = default(InlineResponse2008Billing), List<InlineResponse2009Records> Records = default(List<InlineResponse2009Records>))
        {
        ...
        public InlineResponse2008Billing Billing { get; set; }

        /// <summary>
        /// Gets or Sets Records
        /// </summary>
        [DataMember(Name="records", EmitDefaultValue=false)]
        public List<InlineResponse2009Records> Records { get; set; }
