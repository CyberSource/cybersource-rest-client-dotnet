...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes :  IEquatable<PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes" /> class.
        /// </summary>
        ...
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisa VerifiedByVisa { get; set; }

        /// <summary>
        /// Gets or Sets MasterCardSecureCode
        /// </summary>
        [DataMember(Name="masterCardSecureCode", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisa MasterCardSecureCode { get; set; }

        /// <summary>
        /// Gets or Sets AmexSafeKey
        /// </summary>
        [DataMember(Name="amexSafeKey", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisa AmexSafeKey { get; set; }

        /// <summary>
        /// Gets or Sets JCBJSecure
        /// </summary>
        [DataMember(Name="jCBJSecure", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesJCBJSecure JCBJSecure { get; set; }

        /// <summary>
        /// Gets or Sets DinersClubInternationalProtectBuy
        /// </summary>
        [DataMember(Name="dinersClubInternationalProtectBuy", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisa DinersClubInternationalProtectBuy { get; set; }

        /// <summary>
        /// Gets or Sets ELO
        /// </summary>
        [DataMember(Name="ELO", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisa ELO { get; set; }

        /// <summary>
        /// Gets or Sets UPI
        /// </summary>
        [DataMember(Name="UPI", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisa UPI { get; set; }

        /// <summary>
        /// Gets or Sets CB
        /// </summary>
        [DataMember(Name="CB", EmitDefaultValue=false)]
        public PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesCB CB { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes);
        }

        /// <summary>
        /// Returns true if PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
