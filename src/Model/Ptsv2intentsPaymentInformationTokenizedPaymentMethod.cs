...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2intentsPaymentInformationTokenizedPaymentMethod :  IEquatable<Ptsv2intentsPaymentInformationTokenizedPaymentMethod>, IValidatableObject
    {
        ...
        public Ptsv2intentsPaymentInformationTokenizedPaymentMethod(string Description = default(string), string UsagePattern = default(string), string UsageType = default(string), string AllowMultipleTokens = default(string))
        {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public string AllowMultipleTokens { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Description != null) sb.Append("  Description: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2intentsPaymentInformationTokenizedPaymentMethod", "description", Description.ToString())).Append("\n");
            if (UsagePattern != null) sb.Append("  UsagePattern: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2intentsPaymentInformationTokenizedPaymentMethod", "usagePattern", UsagePattern.ToString())).Append("\n");
            if (UsageType != null) sb.Append("  UsageType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2intentsPaymentInformationTokenizedPaymentMethod", "usageType", UsageType.ToString())).Append("\n");
            if (AllowMultipleTokens != null) sb.Append("  AllowMultipleTokens: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2intentsPaymentInformationTokenizedPaymentMethod", "allowMultipleTokens", AllowMultipleTokens.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2intentsPaymentInformationTokenizedPaymentMethod", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
