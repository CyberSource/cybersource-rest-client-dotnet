...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2011 :  IEquatable<InlineResponse2011>, IValidatableObject
    {
        ...
        public InlineResponse2011(string SubmitTimeUtc = default(string), string Status = default(string), Kmsv2keyssymClientReferenceInformation ClientReferenceInformation = default(Kmsv2keyssymClientReferenceInformation), List<InlineResponse2011KeyInformation> KeyInformation = default(List<InlineResponse2011KeyInformation>), List<InlineResponse2011CertificateInformation> CertificateInformation = default(List<InlineResponse2011CertificateInformation>))
        {
        ...
        public List<InlineResponse2011KeyInformation> KeyInformation { get; set; }

        /// <summary>
        /// Gets or Sets CertificateInformation
        /// </summary>
        [DataMember(Name="certificateInformation", EmitDefaultValue=false)]
        public List<InlineResponse2011CertificateInformation> CertificateInformation { get; set; }
