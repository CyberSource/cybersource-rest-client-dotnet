...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsProcessingInformation :  IEquatable<V2payoutsProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsProcessingInformation" /> class.
        /// </summary>
        ...
        public V2payoutsProcessingInformation(string BusinessApplicationId = default(string), string NetworkRoutingOrder = default(string), string CommerceIndicator = default(string), string ReconciliationId = default(string), V2payoutsProcessingInformationPayoutsOptions PayoutsOptions = default(V2payoutsProcessingInformationPayoutsOptions))
        {
        ...
        public V2payoutsProcessingInformationPayoutsOptions PayoutsOptions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsProcessingInformation);
        }

        /// <summary>
        /// Returns true if V2payoutsProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
