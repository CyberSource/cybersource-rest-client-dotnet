...
namespace CyberSource.Model
{
    ...
    public partial class RiskProductsDecisionManagerConfigurationInformation :  IEquatable<RiskProductsDecisionManagerConfigurationInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TemplateId != null) sb.Append("  TemplateId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskProductsDecisionManagerConfigurationInformation", "templateId", TemplateId.ToString())).Append("\n");
            if (Configurations != null) sb.Append("  Configurations: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskProductsDecisionManagerConfigurationInformation", "configurations", Configurations.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskProductsDecisionManagerConfigurationInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
