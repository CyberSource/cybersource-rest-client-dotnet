...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsPost201ResponseEmbeddedLinks :  IEquatable<TssV2TransactionsPost201ResponseEmbeddedLinks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TransactionDetail != null) sb.Append("  TransactionDetail: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedLinks", "transactionDetail", TransactionDetail.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsPost201ResponseEmbeddedLinks", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
