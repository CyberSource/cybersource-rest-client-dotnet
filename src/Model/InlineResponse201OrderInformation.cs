...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse201OrderInformation :  IEquatable<InlineResponse201OrderInformation>, IValidatableObject
    {
        ...
        public InlineResponse201OrderInformation(InlineResponse201OrderInformationShipTo ShipTo = default(InlineResponse201OrderInformationShipTo))
        {
            this.ShipTo = ShipTo;
        }
        ...
        public InlineResponse201OrderInformationShipTo ShipTo { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (ShipTo != null) sb.Append("  ShipTo: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse201OrderInformation", "shipTo", ShipTo.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InlineResponse201OrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
