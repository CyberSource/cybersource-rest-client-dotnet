...
namespace CybsQaScript.Payments.Authorize_Payment.Simple_Auth
{
    public class AuthorizationOnlyCommerceIndicatorMoto
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "AuthOnlyCommerceIndicatorMoto";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/CreateAuthorizationOnlyCommerceIndicatorMoto.csv"), true))
            {
