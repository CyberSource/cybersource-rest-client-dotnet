...
namespace CybsQaScript.Payments.Authorize_Payment.Network_Tokenization
{
    public class PaymentNetworkTokenization
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "PaymentNetworkTokenization";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/NetworkTokenization/PaymentNetworkTokenization.csv"), true))
            {
