...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4007 :  IEquatable<InlineResponse4007>, IValidatableObject
    {
        ...
        public InlineResponse4007(string Code = default(string), string Message = default(string), string LocalizationKey = default(string), string CorrelationId = default(string), string Detail = default(string), List<InlineResponse4007Fields> Fields = default(List<InlineResponse4007Fields>))
        {
            // to ensure "Code" is required (not null)
            if (Code == null)
            {
                throw new InvalidDataException("Code is a required property for InlineResponse4007 and cannot be null");
            }
            else
            {
                this.Code = Code;
            ...
            if (Message == null)
            {
                throw new InvalidDataException("Message is a required property for InlineResponse4007 and cannot be null");
            }
            else
            {
        ...
        public List<InlineResponse4007Fields> Fields { get; set; }
