...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner :  IEquatable<TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (OriginalTransactionId != null) sb.Append("  OriginalTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner", "originalTransactionId", OriginalTransactionId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
