...
namespace CyberSource.Model
{
    ...
    public partial class InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails :  IEquatable<InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails>, IValidatableObject
    {
        ...
        /// <param name="DiscountPercent">The total discount percentage applied to the order..</param>
        /// <param name="SubAmount">Sub-amount of the order..</param>
        ...
        public InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails(string TotalAmount = default(string), string Currency = default(string), string BalanceAmount = default(string), string DiscountAmount = default(string), string DiscountPercent = default(string), string SubAmount = default(string), string MinimumPartialAmount = default(string), Invoicingv2invoicesOrderInformationAmountDetailsTaxDetails TaxDetails = default(Invoicingv2invoicesOrderInformationAmountDetailsTaxDetails), Invoicingv2invoicesOrderInformationAmountDetailsFreight Freight = default(Invoicingv2invoicesOrderInformationAmountDetailsFreight))
        {
        ...
        /// </summary>
        /// <value>The total discount percentage applied to the order.</value>
        ...
        /// </summary>
        /// <value>Sub-amount of the order.</value>
        ...
        public override string ToString()
        {
            ...
            if (TotalAmount != null) sb.Append("  TotalAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "totalAmount", TotalAmount.ToString())).Append("\n");
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "currency", Currency.ToString())).Append("\n");
            if (BalanceAmount != null) sb.Append("  BalanceAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "balanceAmount", BalanceAmount.ToString())).Append("\n");
            if (DiscountAmount != null) sb.Append("  DiscountAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "discountAmount", DiscountAmount.ToString())).Append("\n");
            if (DiscountPercent != null) sb.Append("  DiscountPercent: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "discountPercent", DiscountPercent.ToString())).Append("\n");
            if (SubAmount != null) sb.Append("  SubAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "subAmount", SubAmount.ToString())).Append("\n");
            if (MinimumPartialAmount != null) sb.Append("  MinimumPartialAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "minimumPartialAmount", MinimumPartialAmount.ToString())).Append("\n");
            if (TaxDetails != null) sb.Append("  TaxDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "taxDetails", TaxDetails.ToString())).Append("\n");
            if (Freight != null) sb.Append("  Freight: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", "freight", Freight.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InvoicingV2InvoicesPost201ResponseOrderInformationAmountDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
