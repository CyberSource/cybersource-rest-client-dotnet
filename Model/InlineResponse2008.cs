...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(InlineResponse2008Links Links = default(InlineResponse2008Links), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchSource = default(string), string MerchantReference = default(string), string BatchCaEndpoints = default(string), string Status = default(string), InlineResponse2007EmbeddedTotals Totals = default(InlineResponse2007EmbeddedTotals), InlineResponse2008Billing Billing = default(InlineResponse2008Billing), string Description = default(string))
        {
            this.Links = Links;
        ...
        public InlineResponse2008Links Links { get; set; }
