...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard :  IEquatable<PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard" /> class.
        /// </summary>
        ...
        public PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard(string Prefix = default(string), string Suffix = default(string), string Type = default(string), string AssuranceLevel = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string RequestorId = default(string), string AssuranceMethod = default(string))
        {
            this.Prefix = Prefix;
            this.Suffix = Suffix;
            this.Type = Type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard {\n");
            if (Prefix != null) sb.Append("  Prefix: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "prefix", Prefix.ToString())).Append("\n");
            if (Suffix != null) sb.Append("  Suffix: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "suffix", Suffix.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "type", Type.ToString())).Append("\n");
            if (AssuranceLevel != null) sb.Append("  AssuranceLevel: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "assuranceLevel", AssuranceLevel.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (RequestorId != null) sb.Append("  RequestorId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "requestorId", RequestorId.ToString())).Append("\n");
            if (AssuranceMethod != null) sb.Append("  AssuranceMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", "assuranceMethod", AssuranceMethod.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard);
        }

        /// <summary>
        /// Returns true if PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard instances are equal
        /// </summary>
        /// <param name="other">Instance of PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
