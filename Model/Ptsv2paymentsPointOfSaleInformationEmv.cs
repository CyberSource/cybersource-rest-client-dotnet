...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPointOfSaleInformationEmv :  IEquatable<Ptsv2paymentsPointOfSaleInformationEmv>, IValidatableObject
    {
        ...
        /// <param name="IsRepeat">#### Visa Platform Connect Value 1  indicates this transaction is intentionally duplicated  The field contains value “1” which indicates that merchant has intentionally duplicated single tap transaction. Merchant is intentionally sending a duplicate auth request for a single tap txn because the issuer requested a PIN. .</param>
        public Ptsv2paymentsPointOfSaleInformationEmv(string Tags = default(string), int? CardholderVerificationMethodUsed = default(int?), string CardSequenceNumber = default(string), bool? Fallback = default(bool?), int? FallbackCondition = default(int?), string IsRepeat = default(string))
        {
            this.Tags = Tags;
        ...
        /// </summary>
        /// <value>#### Visa Platform Connect Value 1  indicates this transaction is intentionally duplicated  The field contains value “1” which indicates that merchant has intentionally duplicated single tap transaction. Merchant is intentionally sending a duplicate auth request for a single tap txn because the issuer requested a PIN. </value>
