...
{
    /// <summary>
    /// InlineResponse2008EmbeddedTotals
    /// </summary>
    [DataContract]
    public partial class InlineResponse2008EmbeddedTotals :  IEquatable<InlineResponse2008EmbeddedTotals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008EmbeddedTotals" /> class.
        /// </summary>
        ...
        public InlineResponse2008EmbeddedTotals(int? AcceptedRecords = default(int?), int? RejectedRecords = default(int?), int? UpdatedRecords = default(int?), int? CaResponses = default(int?), int? CaResponsesOmitted = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2008EmbeddedTotals);
        }

        /// <summary>
        /// Returns true if InlineResponse2008EmbeddedTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2008EmbeddedTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008EmbeddedTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
