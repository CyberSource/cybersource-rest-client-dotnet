...
namespace CyberSource.Model
{
    ...
    public partial class SaveSymEgressKey :  IEquatable<SaveSymEgressKey>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SaveSymEgressKey", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ClientRequestAction != null) sb.Append("  ClientRequestAction: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SaveSymEgressKey", "clientRequestAction", ClientRequestAction.ToString())).Append("\n");
            if (KeyInformation != null) sb.Append("  KeyInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("SaveSymEgressKey", "keyInformation", KeyInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("SaveSymEgressKey", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
