...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentIdentifierCard :  IEquatable<InstrumentIdentifierCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentIdentifierCard" /> class.
        /// </summary>
        /// <param name="Number">Customer’s credit card number..</param>
        public InstrumentIdentifierCard(string Number = default(string))
        {
            this.Number = Number;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InstrumentIdentifierCard);
        }

        /// <summary>
        /// Returns true if InstrumentIdentifierCard instances are equal
        /// </summary>
        /// <param name="other">Instance of InstrumentIdentifierCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentIdentifierCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
