...
namespace CyberSource.Model
{
    ...
    public partial class Upv1capturecontextsOrderInformationBillToCompany :  IEquatable<Upv1capturecontextsOrderInformationBillToCompany>, IValidatableObject
    {
        ...
        public Upv1capturecontextsOrderInformationBillToCompany(string Name = default(string), string Address1 = default(string), string Address2 = default(string), string Address3 = default(string), string Address4 = default(string), string AdministrativeArea = default(string), string Country = default(string), string BuildingNumber = default(string), string District = default(string), string Locality = default(string), string PostalCode = default(string))
        {
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "name", Name.ToString())).Append("\n");
            if (Address1 != null) sb.Append("  Address1: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "address1", Address1.ToString())).Append("\n");
            if (Address2 != null) sb.Append("  Address2: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "address2", Address2.ToString())).Append("\n");
            if (Address3 != null) sb.Append("  Address3: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "address3", Address3.ToString())).Append("\n");
            if (Address4 != null) sb.Append("  Address4: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "address4", Address4.ToString())).Append("\n");
            if (AdministrativeArea != null) sb.Append("  AdministrativeArea: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "administrativeArea", AdministrativeArea.ToString())).Append("\n");
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "country", Country.ToString())).Append("\n");
            if (BuildingNumber != null) sb.Append("  BuildingNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "buildingNumber", BuildingNumber.ToString())).Append("\n");
            if (District != null) sb.Append("  District: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "district", District.ToString())).Append("\n");
            if (Locality != null) sb.Append("  Locality: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "locality", Locality.ToString())).Append("\n");
            if (PostalCode != null) sb.Append("  PostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsOrderInformationBillToCompany", "postalCode", PostalCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Upv1capturecontextsOrderInformationBillToCompany", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
