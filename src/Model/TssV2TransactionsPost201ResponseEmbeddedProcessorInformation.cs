...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsPost201ResponseEmbeddedProcessorInformation :  IEquatable<TssV2TransactionsPost201ResponseEmbeddedProcessorInformation>, IValidatableObject
    {
        ...
        /// <param name="ProviderTransactionId">Unique ID [codigo] generated by the processor for real-time payments processed directly by the Iugu processor..</param>
        ...
        public TssV2TransactionsPost201ResponseEmbeddedProcessorInformation(TssV2TransactionsGet200ResponseProcessorInformationProcessor Processor = default(TssV2TransactionsGet200ResponseProcessorInformationProcessor), string ProviderTransactionId = default(string), string ApprovalCode = default(string), string EventStatus = default(string), string RetrievalReferenceNumber = default(string))
        {
        ...
        /// </summary>
        /// <value>Unique ID [codigo] generated by the processor for real-time payments processed directly by the Iugu processor.</value>
        ...
        public override string ToString()
        {
            ...
            if (Processor != null) sb.Append("  Processor: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedProcessorInformation", "processor", Processor.ToString())).Append("\n");
            if (ProviderTransactionId != null) sb.Append("  ProviderTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedProcessorInformation", "providerTransactionId", ProviderTransactionId.ToString())).Append("\n");
            if (ApprovalCode != null) sb.Append("  ApprovalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedProcessorInformation", "approvalCode", ApprovalCode.ToString())).Append("\n");
            if (EventStatus != null) sb.Append("  EventStatus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedProcessorInformation", "eventStatus", EventStatus.ToString())).Append("\n");
            if (RetrievalReferenceNumber != null) sb.Append("  RetrievalReferenceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedProcessorInformation", "retrievalReferenceNumber", RetrievalReferenceNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsPost201ResponseEmbeddedProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
