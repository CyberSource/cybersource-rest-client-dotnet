...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsPaymentInformationCard :  IEquatable<Riskv1authenticationsPaymentInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsPaymentInformationCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Riskv1authenticationsPaymentInformationCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsPaymentInformationCard" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsPaymentInformationCard(string Bin = default(string), string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Riskv1authenticationsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            {
                throw new InvalidDataException("ExpirationMonth is a required property for Riskv1authenticationsPaymentInformationCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationYear is a required property for Riskv1authenticationsPaymentInformationCard and cannot be null");
            }
            else
            {
            ...
            if (Number == null)
            {
                throw new InvalidDataException("Number is a required property for Riskv1authenticationsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Number = Number;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationsPaymentInformationCard {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsPaymentInformationCard);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsPaymentInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsPaymentInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsPaymentInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
