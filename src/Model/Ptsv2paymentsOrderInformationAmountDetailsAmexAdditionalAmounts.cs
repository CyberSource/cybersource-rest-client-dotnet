...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts :  IEquatable<Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Code">Additional amount type. This field is supported only for **American Express Direct**. .</param>
        ...
        /// </summary>
        /// <value>Additional amount type. This field is supported only for **American Express Direct**. </value>
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts", "code", Code.ToString())).Append("\n");
            if (Amount != null) sb.Append("  Amount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts", "amount", Amount.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
