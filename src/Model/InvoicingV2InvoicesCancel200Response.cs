...
namespace CyberSource.Model
{
    ...
    public partial class InvoicingV2InvoicesCancel200Response :  IEquatable<InvoicingV2InvoicesCancel200Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesCancel200Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesCancel200Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesCancel200Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesCancel200Response", "status", Status.ToString())).Append("\n");
            if (CustomerInformation != null) sb.Append("  CustomerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesCancel200Response", "customerInformation", CustomerInformation.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoicingV2InvoicesCancel200Response);
        }

        /// <summary>
        /// Returns true if InvoicingV2InvoicesCancel200Response instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoicingV2InvoicesCancel200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoicingV2InvoicesCancel200Response other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
