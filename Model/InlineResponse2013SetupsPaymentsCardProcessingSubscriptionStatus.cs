...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus :  IEquatable<InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus" /> class.
        /// </summary>
        ...
        public InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus(string SubmitTimeUtc = default(string), string Status = default(string), string Reason = default(string), List<Dictionary<string, string>> Details = default(List<Dictionary<string, string>>), string Message = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus);
        }

        /// <summary>
        /// Returns true if InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013SetupsPaymentsCardProcessingSubscriptionStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
