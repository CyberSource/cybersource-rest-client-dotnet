...
namespace CybsQaScript.TransactionBatches.CoreServices
{
    ...
    {
        public static void GetListOfBatchFilesExec()
        {
            // Initialize Api Name
            var apiFunctionName = "GetListOfBatchFiles";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/TransactionBatches/CoreServices/GetListOfBatchFiles.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.PtsV1TransactionBatchesGet(startTime, endTime);
