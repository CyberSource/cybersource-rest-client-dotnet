...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationresultsPaymentInformationTokenizedCard :  IEquatable<Riskv1authenticationresultsPaymentInformationTokenizedCard>, IValidatableObject
    {
        ...
        protected Riskv1authenticationresultsPaymentInformationTokenizedCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationresultsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        ...
        public Riskv1authenticationresultsPaymentInformationTokenizedCard(string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Riskv1authenticationresultsPaymentInformationTokenizedCard and cannot be null");
            }
            else
            {
                this.Type = Type;
