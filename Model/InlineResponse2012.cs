...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2012 :  IEquatable<InlineResponse2012>, IValidatableObject
    {
        ...
        public InlineResponse2012(string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), TmsBinLookupPaymentAccountInformation PaymentAccountInformation = default(TmsBinLookupPaymentAccountInformation), TmsBinLookupIssuerInformation IssuerInformation = default(TmsBinLookupIssuerInformation), InlineResponse2012PayoutInformation PayoutInformation = default(InlineResponse2012PayoutInformation))
        {
            this.Id = Id;
        ...
        public InlineResponse2012PayoutInformation PayoutInformation { get; set; }
