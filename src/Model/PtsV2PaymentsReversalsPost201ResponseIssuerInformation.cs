...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsReversalsPost201ResponseIssuerInformation :  IEquatable<PtsV2PaymentsReversalsPost201ResponseIssuerInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseIssuerInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsReversalsPost201ResponseIssuerInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
