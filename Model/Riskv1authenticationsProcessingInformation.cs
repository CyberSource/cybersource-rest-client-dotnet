...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsProcessingInformation :  IEquatable<Riskv1authenticationsProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsProcessingInformation" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsProcessingInformation(string PaymentSolution = default(string), string VisaCheckoutId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationsProcessingInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsProcessingInformation);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
