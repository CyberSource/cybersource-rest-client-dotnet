...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4001 :  IEquatable<InlineResponse4001>, IValidatableObject
    {
        ...
        public InlineResponse4001(string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<InlineResponse201ErrorInformationDetails> Details = default(List<InlineResponse201ErrorInformationDetails>))
        {
