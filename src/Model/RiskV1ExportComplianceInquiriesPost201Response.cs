...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1ExportComplianceInquiriesPost201Response :  IEquatable<RiskV1ExportComplianceInquiriesPost201Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (SubmitTimeLocal != null) sb.Append("  SubmitTimeLocal: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "submitTimeLocal", SubmitTimeLocal.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "status", Status.ToString())).Append("\n");
            if (Message != null) sb.Append("  Message: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "message", Message.ToString())).Append("\n");
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ExportComplianceInformation != null) sb.Append("  ExportComplianceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "exportComplianceInformation", ExportComplianceInformation.ToString())).Append("\n");
            if (ErrorInformation != null) sb.Append("  ErrorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1ExportComplianceInquiriesPost201Response", "errorInformation", ErrorInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskV1ExportComplianceInquiriesPost201Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
