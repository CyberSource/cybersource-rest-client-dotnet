...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2011PaymentAccountInformationFeatures :  IEquatable<InlineResponse2011PaymentAccountInformationFeatures>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2011PaymentAccountInformationFeatures" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CorporatePurchase: ").Append(CorporatePurchase).Append("\n");
            sb.Append("  HealthCard: ").Append(HealthCard).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2011PaymentAccountInformationFeatures);
        }

        /// <summary>
        /// Returns true if InlineResponse2011PaymentAccountInformationFeatures instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2011PaymentAccountInformationFeatures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2011PaymentAccountInformationFeatures other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
