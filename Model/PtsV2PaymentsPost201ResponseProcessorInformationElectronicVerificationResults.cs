...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults :  IEquatable<PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Code, length must be less than or equal to 1.", new [] { "Code" });
            }

            // CodeRaw (string) maxLength
            if(this.CodeRaw != null && this.CodeRaw.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CodeRaw, length must be less than or equal to 1.", new [] { "CodeRaw" });
            }
