...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2017EmbeddedPaymentInformationCard :  IEquatable<InlineResponse2017EmbeddedPaymentInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2017EmbeddedPaymentInformationCard" /> class.
        /// </summary>
        ...
        public InlineResponse2017EmbeddedPaymentInformationCard(string Suffix = default(string), string Prefix = default(string), string Type = default(string))
        {
            this.Suffix = Suffix;
            this.Prefix = Prefix;
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2017EmbeddedPaymentInformationCard);
        }

        /// <summary>
        /// Returns true if InlineResponse2017EmbeddedPaymentInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2017EmbeddedPaymentInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2017EmbeddedPaymentInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
