...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsPaymentInformationCustomer :  IEquatable<Riskv1authenticationsPaymentInformationCustomer>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (CustomerId != null) sb.Append("  CustomerId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationCustomer", "customerId", CustomerId.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsPaymentInformationCustomer", "id", Id.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1authenticationsPaymentInformationCustomer", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
