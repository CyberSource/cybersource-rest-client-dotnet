...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsOrderInformationBillTo :  IEquatable<Ptsv2paymentsOrderInformationBillTo>, IValidatableObject
    {
        ...
        public Ptsv2paymentsOrderInformationBillTo(string FirstName = default(string), string LastName = default(string), string MiddleName = default(string), string NameSuffix = default(string), string Title = default(string), Ptsv2paymentsOrderInformationBillToCompany Company = default(Ptsv2paymentsOrderInformationBillToCompany), string Address1 = default(string), string Address2 = default(string), string Address3 = default(string), string Address4 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string Country = default(string), string District = default(string), string BuildingNumber = default(string), string Email = default(string), string PhoneNumber = default(string), PhoneTypeEnum? PhoneType = default(PhoneTypeEnum?))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Address3, length must be less than 60.", new [] { "Address3" });
            }

            // Address4 (string) maxLength
            if(this.Address4 != null && this.Address4.Length > 60)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Address4, length must be less than 60.", new [] { "Address4" });
            }
