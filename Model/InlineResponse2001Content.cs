...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2001Content :  IEquatable<InlineResponse2001Content>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Content" /> class.
        /// </summary>
        ...
        public InlineResponse2001Content(string Type = default(string), string Data = default(string), int? Width = default(int?), int? Height = default(int?))
        {
            this.Type = Type;
            this.Data = Data;
            this.Width = Width;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2001Content);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Content instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2001Content to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Content other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
