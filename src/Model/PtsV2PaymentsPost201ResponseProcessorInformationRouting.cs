...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseProcessorInformationRouting :  IEquatable<PtsV2PaymentsPost201ResponseProcessorInformationRouting>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Network != null) sb.Append("  Network: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationRouting", "network", Network.ToString())).Append("\n");
            if (NetworkName != null) sb.Append("  NetworkName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationRouting", "networkName", NetworkName.ToString())).Append("\n");
            if (CustomerSignatureRequired != null) sb.Append("  CustomerSignatureRequired: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationRouting", "customerSignatureRequired", CustomerSignatureRequired.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseProcessorInformationRouting", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
