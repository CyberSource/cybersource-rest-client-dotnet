...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse4007Fields :  IEquatable<InlineResponse4007Fields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4007Fields" /> class.
        /// </summary>
        ...
        public InlineResponse4007Fields(string Path = default(string), string Message = default(string), string LocalizationKey = default(string))
        {
            this.Path = Path;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4007Fields {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse4007Fields);
        }

        /// <summary>
        /// Returns true if InlineResponse4007Fields instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse4007Fields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4007Fields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
