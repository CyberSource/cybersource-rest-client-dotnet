...
{
    /// <summary>
    /// Ucv1sessionsDataAggregatorInformation
    /// </summary>
    [DataContract]
    public partial class Ucv1sessionsDataAggregatorInformation :  IEquatable<Ucv1sessionsDataAggregatorInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ucv1sessionsDataAggregatorInformation" /> class.
        /// </summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ucv1sessionsDataAggregatorInformationSubMerchant SubMerchant { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (AggregatorId != null) sb.Append("  AggregatorId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "aggregatorId", AggregatorId.ToString())).Append("\n");
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "name", Name.ToString())).Append("\n");
            if (SubMerchant != null) sb.Append("  SubMerchant: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "subMerchant", SubMerchant.ToString())).Append("\n");
            if (StreetAddress != null) sb.Append("  StreetAddress: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "streetAddress", StreetAddress.ToString())).Append("\n");
            if (City != null) sb.Append("  City: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "city", City.ToString())).Append("\n");
            if (State != null) sb.Append("  State: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "state", State.ToString())).Append("\n");
            if (PostalCode != null) sb.Append("  PostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "postalCode", PostalCode.ToString())).Append("\n");
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "country", Country.ToString())).Append("\n");
            if (ServiceProvidername != null) sb.Append("  ServiceProvidername: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataAggregatorInformation", "serviceProvidername", ServiceProvidername.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ucv1sessionsDataAggregatorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ucv1sessionsDataAggregatorInformation);
        }

        /// <summary>
        /// Returns true if Ucv1sessionsDataAggregatorInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Ucv1sessionsDataAggregatorInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ucv1sessionsDataAggregatorInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
