...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsOrderInformationLineItems :  IEquatable<Riskv1authenticationsOrderInformationLineItems>, IValidatableObject
    {
        ...
        public Riskv1authenticationsOrderInformationLineItems(string TotalAmount = default(string), string UnitPrice = default(string), decimal? Quantity = default(decimal?), int? GiftCardCurrency = default(int?), string ProductSKU = default(string), string ProductDescription = default(string), string ProductName = default(string), Riskv1decisionsOrderInformationPassenger Passenger = default(Riskv1decisionsOrderInformationPassenger), string TaxAmount = default(string))
        {
