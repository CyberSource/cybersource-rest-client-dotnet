...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponsePaymentInformationEWallet :  IEquatable<PtsV2PaymentsPost201ResponsePaymentInformationEWallet>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (FundingSource != null) sb.Append("  FundingSource: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationEWallet", "fundingSource", FundingSource.ToString())).Append("\n");
            if (AccountId != null) sb.Append("  AccountId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationEWallet", "accountId", AccountId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponsePaymentInformationEWallet", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
