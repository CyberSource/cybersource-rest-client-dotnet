...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidrefundsClientReferenceInformation :  IEquatable<Ptsv2paymentsidrefundsClientReferenceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "code", Code.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            if (ReturnReconciliationId != null) sb.Append("  ReturnReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "returnReconciliationId", ReturnReconciliationId.ToString())).Append("\n");
            if (PausedRequestId != null) sb.Append("  PausedRequestId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "pausedRequestId", PausedRequestId.ToString())).Append("\n");
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (Comments != null) sb.Append("  Comments: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "comments", Comments.ToString())).Append("\n");
            if (Partner != null) sb.Append("  Partner: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "partner", Partner.ToString())).Append("\n");
            if (ApplicationName != null) sb.Append("  ApplicationName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "applicationName", ApplicationName.ToString())).Append("\n");
            if (ApplicationVersion != null) sb.Append("  ApplicationVersion: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "applicationVersion", ApplicationVersion.ToString())).Append("\n");
            if (ApplicationUser != null) sb.Append("  ApplicationUser: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsClientReferenceInformation", "applicationUser", ApplicationUser.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsClientReferenceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
