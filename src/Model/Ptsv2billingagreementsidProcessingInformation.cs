...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2billingagreementsidProcessingInformation :  IEquatable<Ptsv2billingagreementsidProcessingInformation>, IValidatableObject
    {
        ...
        public Ptsv2billingagreementsidProcessingInformation(string CommerceIndicator = default(string), string PaymentCompletionTimeout = default(string), List<string> ActionList = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            if (CommerceIndicator != null) sb.Append("  CommerceIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsidProcessingInformation", "commerceIndicator", CommerceIndicator.ToString())).Append("\n");
            if (PaymentCompletionTimeout != null) sb.Append("  PaymentCompletionTimeout: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsidProcessingInformation", "paymentCompletionTimeout", PaymentCompletionTimeout.ToString())).Append("\n");
            if (ActionList != null) sb.Append("  ActionList: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsidProcessingInformation", "actionList", ActionList.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2billingagreementsidProcessingInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
