...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds :  IEquatable<PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds" /> class.
        /// </summary>
        ...
        public PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds(int? AcquirerCountryCode = default(int?), int? AcquiringBIN = default(int?), bool? AllowCryptoCurrencyPurchase = default(bool?), string FinancialInstitutionId = default(string), string NetworkOrder = default(string), string NationalReimbursementFee = default(string), string OriginatorBusinessApplicationId = default(string), string OriginatorPseudoAbaNumber = default(string), List<PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount> ProcessorAccount = default(List<PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount>))
        {
            // to ensure "AcquirerCountryCode" is required (not null)
            if (AcquirerCountryCode == null)
            {
                throw new InvalidDataException("AcquirerCountryCode is a required property for PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AcquiringBIN is a required property for PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("OriginatorBusinessApplicationId is a required property for PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProcessorAccount is a required property for PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds and cannot be null");
            }
            else
            {
        ...
        public List<PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount> ProcessorAccount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds);
        }

        /// <summary>
        /// Returns true if PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
