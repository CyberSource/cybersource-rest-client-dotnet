...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(string Version = default(string), string ReportCreatedDate = default(string), string BatchId = default(string), string BatchSource = default(string), string BatchCaEndpoints = default(string), string BatchCreatedDate = default(string), string MerchantReference = default(string), InlineResponse2006EmbeddedTotals Totals = default(InlineResponse2006EmbeddedTotals), InlineResponse2007Billing Billing = default(InlineResponse2007Billing), List<InlineResponse2008Records> Records = default(List<InlineResponse2008Records>))
        {
        ...
        public InlineResponse2007Billing Billing { get; set; }

        /// <summary>
        /// Gets or Sets Records
        /// </summary>
        [DataMember(Name="records", EmitDefaultValue=false)]
        public List<InlineResponse2008Records> Records { get; set; }
