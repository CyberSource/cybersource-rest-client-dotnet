...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013SetupsValueAddedServices :  IEquatable<InlineResponse2013SetupsValueAddedServices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013SetupsValueAddedServices" /> class.
        /// </summary>
        ...
        public InlineResponse2013SetupsValueAddedServices(InlineResponse2013SetupsPaymentsDigitalPayments Reporting = default(InlineResponse2013SetupsPaymentsDigitalPayments), InlineResponse2013SetupsPaymentsDigitalPayments TransactionSearch = default(InlineResponse2013SetupsPaymentsDigitalPayments), InlineResponse2013SetupsPaymentsDigitalPayments BankAccountValidation = default(InlineResponse2013SetupsPaymentsDigitalPayments))
        {
        ...
        public InlineResponse2013SetupsPaymentsDigitalPayments Reporting { get; set; }

        /// <summary>
        /// Gets or Sets TransactionSearch
        /// </summary>
        [DataMember(Name="transactionSearch", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments TransactionSearch { get; set; }

        /// <summary>
        /// Gets or Sets BankAccountValidation
        /// </summary>
        [DataMember(Name="bankAccountValidation", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments BankAccountValidation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013SetupsValueAddedServices);
        }

        /// <summary>
        /// Returns true if InlineResponse2013SetupsValueAddedServices instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013SetupsValueAddedServices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013SetupsValueAddedServices other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
