...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor :  IEquatable<Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor" /> class.
        /// </summary>
        ...
        public Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor(string Name = default(string), string Locality = default(string), string AdministrativeArea = default(string), string Country = default(string))
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsMerchantInformationMerchantDescriptor other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
