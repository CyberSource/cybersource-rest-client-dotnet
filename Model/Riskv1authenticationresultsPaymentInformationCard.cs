...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationresultsPaymentInformationCard :  IEquatable<Riskv1authenticationresultsPaymentInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationresultsPaymentInformationCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Riskv1authenticationresultsPaymentInformationCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationresultsPaymentInformationCard" /> class.
        /// </summary>
        ...
        public Riskv1authenticationresultsPaymentInformationCard(string Bin = default(string), string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
            // to ensure "Bin" is required (not null)
            if (Bin == null)
            {
                throw new InvalidDataException("Bin is a required property for Riskv1authenticationresultsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Bin = Bin;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Riskv1authenticationresultsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationresultsPaymentInformationCard);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationresultsPaymentInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationresultsPaymentInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationresultsPaymentInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
