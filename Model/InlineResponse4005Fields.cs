...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse4005Fields :  IEquatable<InlineResponse4005Fields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4005Fields" /> class.
        /// </summary>
        ...
        public InlineResponse4005Fields(string Path = default(string), string Message = default(string), string LocalizationKey = default(string))
        {
            this.Path = Path;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse4005Fields);
        }

        /// <summary>
        /// Returns true if InlineResponse4005Fields instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse4005Fields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4005Fields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
