...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseConsumerAuthenticationInformation :  IEquatable<PtsV2PaymentsPost201ResponseConsumerAuthenticationInformation>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AcsUrl, length must be less than or equal to 2048.", new [] { "AcsUrl" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EcommerceIndicator, length must be less than or equal to 255.", new [] { "EcommerceIndicator" });
            }
