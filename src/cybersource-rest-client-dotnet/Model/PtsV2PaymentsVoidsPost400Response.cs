...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsVoidsPost400Response :  IEquatable<PtsV2PaymentsVoidsPost400Response>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The reason of the status.  Possible values:  - MISSING_FIELD  - INVALID_DATA  - DUPLICATE_REQUEST  - INVALID_MERCHANT_CONFIGURATION  - NOT_VOIDABLE </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ReasonEnum
        {
            ...
            /// <summary>
            /// Enum NOTVOIDABLE for "NOT_VOIDABLE"
            /// </summary>
            [EnumMember(Value = "NOT_VOIDABLE")]
            NOTVOIDABLE
        }
        ...
        /// <param name="Reason">The reason of the status.  Possible values:  - MISSING_FIELD  - INVALID_DATA  - DUPLICATE_REQUEST  - INVALID_MERCHANT_CONFIGURATION  - NOT_VOIDABLE .</param>
        /// <param name="Message">The detail message related to the status and reason listed above..</param>
        /// <param name="Details">Details.</param>
        public PtsV2PaymentsVoidsPost400Response(string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<PtsV2PaymentsPost201ResponseErrorInformationDetails> Details = default(List<PtsV2PaymentsPost201ResponseErrorInformationDetails>))
        {
