...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1decisionsOrderInformationAddress :  IEquatable<Riskv1decisionsOrderInformationAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1decisionsOrderInformationAddress" /> class.
        /// </summary>
        ...
        public Riskv1decisionsOrderInformationAddress(string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string Country = default(string), string AdministrativeArea = default(string), string PostalCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1decisionsOrderInformationAddress {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1decisionsOrderInformationAddress);
        }

        /// <summary>
        /// Returns true if Riskv1decisionsOrderInformationAddress instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1decisionsOrderInformationAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1decisionsOrderInformationAddress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
