...
namespace CyberSource.Model
{
    ...
    public partial class InvoicingV2InvoicesAllGet200ResponseInvoices :  IEquatable<InvoicingV2InvoicesAllGet200ResponseInvoices>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "id", Id.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "status", Status.ToString())).Append("\n");
            if (CreatedDate != null) sb.Append("  CreatedDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "createdDate", CreatedDate.ToString())).Append("\n");
            if (CustomerInformation != null) sb.Append("  CustomerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "customerInformation", CustomerInformation.ToString())).Append("\n");
            if (InvoiceInformation != null) sb.Append("  InvoiceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "invoiceInformation", InvoiceInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesAllGet200ResponseInvoices", "orderInformation", OrderInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InvoicingV2InvoicesAllGet200ResponseInvoices", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
