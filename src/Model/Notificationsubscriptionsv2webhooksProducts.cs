...
namespace CyberSource.Model
{
    ...
    public partial class Notificationsubscriptionsv2webhooksProducts :  IEquatable<Notificationsubscriptionsv2webhooksProducts>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ProductId != null) sb.Append("  ProductId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Notificationsubscriptionsv2webhooksProducts", "productId", ProductId.ToString())).Append("\n");
            if (EventTypes != null) sb.Append("  EventTypes: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Notificationsubscriptionsv2webhooksProducts", "eventTypes", EventTypes.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Notificationsubscriptionsv2webhooksProducts", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
