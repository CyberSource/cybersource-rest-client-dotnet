...
namespace CyberSource.Model
{
    ...
    public partial class UmsV1UsersGet200Response :  IEquatable<UmsV1UsersGet200Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Users != null) sb.Append("  Users: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("UmsV1UsersGet200Response", "users", Users.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("UmsV1UsersGet200Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
