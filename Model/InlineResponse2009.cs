...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(PtsV2IncrementalAuthorizationPatch201ResponseLinks Links = default(PtsV2IncrementalAuthorizationPatch201ResponseLinks), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), InlineResponse2009SubscriptionInformation SubscriptionInformation = default(InlineResponse2009SubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        public InlineResponse2009SubscriptionInformation SubscriptionInformation { get; set; }
