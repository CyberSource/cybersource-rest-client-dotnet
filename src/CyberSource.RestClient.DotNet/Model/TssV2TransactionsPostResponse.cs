...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TssV2TransactionsPostResponse :  IEquatable<TssV2TransactionsPostResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TssV2TransactionsPostResponse" /> class.
        /// </summary>
        ...
        public TssV2TransactionsPostResponse(bool? Save = default(bool?), string Name = default(string), string Timezone = default(string), string Query = default(string), int? Offset = default(int?), int? Limit = default(int?), string Sort = default(string))
        {
            this.Save = Save;
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TssV2TransactionsPostResponse);
        }

        /// <summary>
        /// Returns true if TssV2TransactionsPostResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TssV2TransactionsPostResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TssV2TransactionsPostResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
