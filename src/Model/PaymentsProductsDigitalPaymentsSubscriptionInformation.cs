...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsDigitalPaymentsSubscriptionInformation :  IEquatable<PaymentsProductsDigitalPaymentsSubscriptionInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsDigitalPaymentsSubscriptionInformation" /> class.
        /// </summary>
        ...
        public PaymentsProductsDigitalPaymentsSubscriptionInformation(bool? Enabled = default(bool?), string SelfServiceability = "NOT_SELF_SERVICEABLE", Dictionary<string, PaymentsProductsDigitalPaymentsSubscriptionInformationFeatures> Features = default(Dictionary<string, PaymentsProductsDigitalPaymentsSubscriptionInformationFeatures>))
        {
        ...
        public override string ToString()
        {
            ...
            if (Enabled != null) sb.Append("  Enabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsDigitalPaymentsSubscriptionInformation", "enabled", Enabled.ToString())).Append("\n");
            if (SelfServiceability != null) sb.Append("  SelfServiceability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsDigitalPaymentsSubscriptionInformation", "selfServiceability", SelfServiceability.ToString())).Append("\n");
            if (Features != null) sb.Append("  Features: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsDigitalPaymentsSubscriptionInformation", "features", Features.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentsProductsDigitalPaymentsSubscriptionInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsDigitalPaymentsSubscriptionInformation);
        }

        /// <summary>
        /// Returns true if PaymentsProductsDigitalPaymentsSubscriptionInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsDigitalPaymentsSubscriptionInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsDigitalPaymentsSubscriptionInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
