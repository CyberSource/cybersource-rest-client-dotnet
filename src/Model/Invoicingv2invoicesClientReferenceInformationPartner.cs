...
namespace CyberSource.Model
{
    ...
    public partial class Invoicingv2invoicesClientReferenceInformationPartner :  IEquatable<Invoicingv2invoicesClientReferenceInformationPartner>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (DeveloperId != null) sb.Append("  DeveloperId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoicesClientReferenceInformationPartner", "developerId", DeveloperId.ToString())).Append("\n");
            if (SolutionId != null) sb.Append("  SolutionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoicesClientReferenceInformationPartner", "solutionId", SolutionId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Invoicingv2invoicesClientReferenceInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
