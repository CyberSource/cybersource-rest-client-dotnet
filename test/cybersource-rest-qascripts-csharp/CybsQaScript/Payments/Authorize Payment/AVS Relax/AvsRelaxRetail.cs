...
namespace CybsQaScript.Payments.Authorize_Payment.AVS_Relax
{
    public class AvsRelaxRetail
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AvsRelaxRetail";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSRelaxAvs/CreateRetail.csv"), true))
            {
