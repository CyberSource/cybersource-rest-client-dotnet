...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidcapturesInstallmentInformation :  IEquatable<Ptsv2paymentsidcapturesInstallmentInformation>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceData, length must be less than 20.", new [] { "InvoiceData" });
            }

            // PaymentType (string) maxLength
            if(this.PaymentType != null && this.PaymentType.Length > 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PaymentType, length must be less than 1.", new [] { "PaymentType" });
            }
