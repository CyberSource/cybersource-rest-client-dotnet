...
{
    public class RetailPosStandardKey
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "RetailPosStandardKey";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/RetailPOSstandardKey.csv"), true))
            {
