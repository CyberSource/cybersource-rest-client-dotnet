...
namespace CyberSource.Model
{
    ...
    public partial class PaymentsProductsECheckSubscriptionInformation :  IEquatable<PaymentsProductsECheckSubscriptionInformation>, IValidatableObject
    {
        ...
        public PaymentsProductsECheckSubscriptionInformation(bool? Enabled = default(bool?), SelfServiceabilityEnum? SelfServiceability = SelfServiceabilityEnum.NOTSELFSERVICEABLE, List<string> Mode = default(List<string>))
        {
