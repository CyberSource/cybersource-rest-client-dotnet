...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2refreshpaymentstatusidPaymentInformationPaymentType :  IEquatable<Ptsv2refreshpaymentstatusidPaymentInformationPaymentType>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2refreshpaymentstatusidPaymentInformationPaymentType", "name", Name.ToString())).Append("\n");
            if (Method != null) sb.Append("  Method: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2refreshpaymentstatusidPaymentInformationPaymentType", "method", Method.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2refreshpaymentstatusidPaymentInformationPaymentType", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
