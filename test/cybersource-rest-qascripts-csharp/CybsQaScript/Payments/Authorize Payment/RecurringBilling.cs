...
namespace CybsQaScript.Payments.Authorize_Payment
{
    public class RecurringBilling
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "RecurringBilling";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/RecurringBilling.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var customerObj = new Ptsv2paymentsPaymentInformationCustomer
                            {
