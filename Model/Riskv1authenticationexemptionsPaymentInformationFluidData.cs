...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsPaymentInformationFluidData :  IEquatable<Riskv1authenticationexemptionsPaymentInformationFluidData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformationFluidData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Riskv1authenticationexemptionsPaymentInformationFluidData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformationFluidData" /> class.
        /// </summary>
        /// <param name="Value">Represents the encrypted payment data BLOB. The entry for this field is dependent on the payment solution a merchant uses.  For details, see [Creating an Online Authorization](https://developer.cybersource.com/api/developer-guides/dita-payments/CreatingOnlineAuth.html) for the specific payment- solution entry.  (required).</param>
        ...
        public Riskv1authenticationexemptionsPaymentInformationFluidData(string Value = default(string), string KeySerialNumber = default(string), string Descriptor = default(string), string Encoding = default(string))
        {
            // to ensure "Value" is required (not null)
            if (Value == null)
            {
                throw new InvalidDataException("Value is a required property for Riskv1authenticationexemptionsPaymentInformationFluidData and cannot be null");
            }
            else
            {
                this.Value = Value;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsPaymentInformationFluidData);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsPaymentInformationFluidData instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsPaymentInformationFluidData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsPaymentInformationFluidData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
