...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004ResponseRecord :  IEquatable<InlineResponse2004ResponseRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004ResponseRecord" /> class.
        /// </summary>
        ...
        public InlineResponse2004ResponseRecord(string Response = default(string), string Reason = default(string), string Token = default(string), string InstrumentIdentifierId = default(string), string InstrumentIdentifierCreated = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string), List<InlineResponse2004ResponseRecordAdditionalUpdates> AdditionalUpdates = default(List<InlineResponse2004ResponseRecordAdditionalUpdates>))
        {
        ...
        public List<InlineResponse2004ResponseRecordAdditionalUpdates> AdditionalUpdates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004ResponseRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse2004ResponseRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004ResponseRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004ResponseRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
