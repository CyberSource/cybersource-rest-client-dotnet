...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsTravelInformationAutoRentalTaxDetails :  IEquatable<Ptsv2paymentsTravelInformationAutoRentalTaxDetails>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.TaxType != null && this.TaxType.Length >= 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TaxType, length must be less than or equal to 10.", new [] { "TaxType" });
            }

            // TaxSummary (string) maxLength
            if(this.TaxSummary != null && this.TaxSummary.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TaxSummary, length must be less than or equal to 12.", new [] { "TaxSummary" });
            }
