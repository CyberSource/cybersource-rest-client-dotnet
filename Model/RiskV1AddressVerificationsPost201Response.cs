...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1AddressVerificationsPost201Response :  IEquatable<RiskV1AddressVerificationsPost201Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (SubmitTimeLocal != null) sb.Append("  SubmitTimeLocal: ").Append(SubmitTimeLocal).Append("\n");
            ...
            if (AddressVerificationInformation != null) sb.Append("  AddressVerificationInformation: ").Append(AddressVerificationInformation).Append("\n");
