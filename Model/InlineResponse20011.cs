...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(string Version = default(string), string ReportCreatedDate = default(string), string BatchId = default(string), string BatchSource = default(string), string BatchCaEndpoints = default(string), string BatchCreatedDate = default(string), string MerchantReference = default(string), InlineResponse2009EmbeddedTotals Totals = default(InlineResponse2009EmbeddedTotals), InlineResponse20010Billing Billing = default(InlineResponse20010Billing), List<InlineResponse20011Records> Records = default(List<InlineResponse20011Records>))
        {
        ...
        public InlineResponse20010Billing Billing { get; set; }

        /// <summary>
        /// Gets or Sets Records
        /// </summary>
        [DataMember(Name="records", EmitDefaultValue=false)]
        public List<InlineResponse20011Records> Records { get; set; }
