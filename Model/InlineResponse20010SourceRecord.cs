...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20010SourceRecord :  IEquatable<InlineResponse20010SourceRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010SourceRecord" /> class.
        /// </summary>
        ...
        public InlineResponse20010SourceRecord(string Token = default(string), string CustomerId = default(string), string PaymentInstrumentId = default(string), string InstrumentIdentifierId = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string))
        {
            this.Token = Token;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20010SourceRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse20010SourceRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20010SourceRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010SourceRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
