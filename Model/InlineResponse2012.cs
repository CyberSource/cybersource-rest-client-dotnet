...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2012 :  IEquatable<InlineResponse2012>, IValidatableObject
    {
        ...
        public InlineResponse2012(InlineResponse2012Links Links = default(InlineResponse2012Links), string Id = default(string), string SubmitTimeUtc = default(string), StatusEnum? Status = default(StatusEnum?), string ReconciliationId = default(string), InlineResponse201ClientReferenceInformation ClientReferenceInformation = default(InlineResponse201ClientReferenceInformation), InlineResponse2012ProcessorInformation ProcessorInformation = default(InlineResponse2012ProcessorInformation), InlineResponse2012OrderInformation OrderInformation = default(InlineResponse2012OrderInformation))
        {
            this.Links = Links;
            this.Id = Id;
        ...
        public InlineResponse2012OrderInformation OrderInformation { get; set; }
