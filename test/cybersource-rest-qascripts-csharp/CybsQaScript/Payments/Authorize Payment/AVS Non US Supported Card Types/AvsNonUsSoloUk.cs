...
{
    public class AvsNonUsSoloUk
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AvsNonUsSoloUk";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSNonUsSupportedCardTypes/CreateSoloUK.csv"), true))
            {
