...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1decisionsConsumerAuthenticationInformation :  IEquatable<Riskv1decisionsConsumerAuthenticationInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (StrongAuthentication != null) sb.Append("  StrongAuthentication: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "strongAuthentication", StrongAuthentication.ToString())).Append("\n");
            if (AcsWindowSize != null) sb.Append("  AcsWindowSize: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "acsWindowSize", AcsWindowSize.ToString())).Append("\n");
            if (AlternateAuthenticationData != null) sb.Append("  AlternateAuthenticationData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "alternateAuthenticationData", AlternateAuthenticationData.ToString())).Append("\n");
            if (AlternateAuthenticationDate != null) sb.Append("  AlternateAuthenticationDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "alternateAuthenticationDate", AlternateAuthenticationDate.ToString())).Append("\n");
            if (AlternateAuthenticationMethod != null) sb.Append("  AlternateAuthenticationMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "alternateAuthenticationMethod", AlternateAuthenticationMethod.ToString())).Append("\n");
            if (AuthenticationDate != null) sb.Append("  AuthenticationDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "authenticationDate", AuthenticationDate.ToString())).Append("\n");
            if (AuthenticationTransactionId != null) sb.Append("  AuthenticationTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "authenticationTransactionId", AuthenticationTransactionId.ToString())).Append("\n");
            if (TransactionFlowIndicator != null) sb.Append("  TransactionFlowIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "transactionFlowIndicator", TransactionFlowIndicator.ToString())).Append("\n");
            if (ChallengeCode != null) sb.Append("  ChallengeCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "challengeCode", ChallengeCode.ToString())).Append("\n");
            if (ChallengeStatus != null) sb.Append("  ChallengeStatus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "challengeStatus", ChallengeStatus.ToString())).Append("\n");
            if (CustomerCardAlias != null) sb.Append("  CustomerCardAlias: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "customerCardAlias", CustomerCardAlias.ToString())).Append("\n");
            if (DecoupledAuthenticationIndicator != null) sb.Append("  DecoupledAuthenticationIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "decoupledAuthenticationIndicator", DecoupledAuthenticationIndicator.ToString())).Append("\n");
            if (DecoupledAuthenticationMaxTime != null) sb.Append("  DecoupledAuthenticationMaxTime: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "decoupledAuthenticationMaxTime", DecoupledAuthenticationMaxTime.ToString())).Append("\n");
            if (DefaultCard != null) sb.Append("  DefaultCard: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "defaultCard", DefaultCard.ToString())).Append("\n");
            if (DeviceChannel != null) sb.Append("  DeviceChannel: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "deviceChannel", DeviceChannel.ToString())).Append("\n");
            if (InstallmentTotalCount != null) sb.Append("  InstallmentTotalCount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "installmentTotalCount", InstallmentTotalCount.ToString())).Append("\n");
            if (MerchantFraudRate != null) sb.Append("  MerchantFraudRate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "merchantFraudRate", MerchantFraudRate.ToString())).Append("\n");
            if (MarketingOptIn != null) sb.Append("  MarketingOptIn: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "marketingOptIn", MarketingOptIn.ToString())).Append("\n");
            if (MarketingSource != null) sb.Append("  MarketingSource: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "marketingSource", MarketingSource.ToString())).Append("\n");
            if (Mcc != null) sb.Append("  Mcc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "mcc", Mcc.ToString())).Append("\n");
            if (MerchantScore != null) sb.Append("  MerchantScore: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "merchantScore", MerchantScore.ToString())).Append("\n");
            if (MessageCategory != null) sb.Append("  MessageCategory: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "messageCategory", MessageCategory.ToString())).Append("\n");
            if (NpaCode != null) sb.Append("  NpaCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "npaCode", NpaCode.ToString())).Append("\n");
            if (OverridePaymentMethod != null) sb.Append("  OverridePaymentMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "overridePaymentMethod", OverridePaymentMethod.ToString())).Append("\n");
            if (OverrideCountryCode != null) sb.Append("  OverrideCountryCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "overrideCountryCode", OverrideCountryCode.ToString())).Append("\n");
            if (PriorAuthenticationData != null) sb.Append("  PriorAuthenticationData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "priorAuthenticationData", PriorAuthenticationData.ToString())).Append("\n");
            if (PriorAuthenticationMethod != null) sb.Append("  PriorAuthenticationMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "priorAuthenticationMethod", PriorAuthenticationMethod.ToString())).Append("\n");
            if (PriorAuthenticationReferenceId != null) sb.Append("  PriorAuthenticationReferenceId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "priorAuthenticationReferenceId", PriorAuthenticationReferenceId.ToString())).Append("\n");
            if (PriorAuthenticationTime != null) sb.Append("  PriorAuthenticationTime: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "priorAuthenticationTime", PriorAuthenticationTime.ToString())).Append("\n");
            if (ProductCode != null) sb.Append("  ProductCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "productCode", ProductCode.ToString())).Append("\n");
            if (ReturnUrl != null) sb.Append("  ReturnUrl: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "returnUrl", ReturnUrl.ToString())).Append("\n");
            if (RequestorId != null) sb.Append("  RequestorId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "requestorId", RequestorId.ToString())).Append("\n");
            if (RequestorInitiatedAuthenticationIndicator != null) sb.Append("  RequestorInitiatedAuthenticationIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "requestorInitiatedAuthenticationIndicator", RequestorInitiatedAuthenticationIndicator.ToString())).Append("\n");
            if (RequestorName != null) sb.Append("  RequestorName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "requestorName", RequestorName.ToString())).Append("\n");
            if (ReferenceId != null) sb.Append("  ReferenceId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "referenceId", ReferenceId.ToString())).Append("\n");
            if (SdkMaxTimeout != null) sb.Append("  SdkMaxTimeout: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "sdkMaxTimeout", SdkMaxTimeout.ToString())).Append("\n");
            if (SecureCorporatePaymentIndicator != null) sb.Append("  SecureCorporatePaymentIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "secureCorporatePaymentIndicator", SecureCorporatePaymentIndicator.ToString())).Append("\n");
            if (TransactionMode != null) sb.Append("  TransactionMode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "transactionMode", TransactionMode.ToString())).Append("\n");
            if (WhiteListStatus != null) sb.Append("  WhiteListStatus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "whiteListStatus", WhiteListStatus.ToString())).Append("\n");
            if (ScoreRequest != null) sb.Append("  ScoreRequest: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsConsumerAuthenticationInformation", "scoreRequest", ScoreRequest.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1decisionsConsumerAuthenticationInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
