...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsTravelInformationTransitAirline :  IEquatable<Ptsv2paymentsTravelInformationTransitAirline>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (IsDomestic != null) sb.Append("  IsDomestic: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "isDomestic", IsDomestic.ToString())).Append("\n");
            if (BookingReferenceNumber != null) sb.Append("  BookingReferenceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "bookingReferenceNumber", BookingReferenceNumber.ToString())).Append("\n");
            if (CarrierName != null) sb.Append("  CarrierName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "carrierName", CarrierName.ToString())).Append("\n");
            if (TicketIssuer != null) sb.Append("  TicketIssuer: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "ticketIssuer", TicketIssuer.ToString())).Append("\n");
            if (TicketNumber != null) sb.Append("  TicketNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "ticketNumber", TicketNumber.ToString())).Append("\n");
            if (CheckDigit != null) sb.Append("  CheckDigit: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "checkDigit", CheckDigit.ToString())).Append("\n");
            if (RestrictedTicketIndicator != null) sb.Append("  RestrictedTicketIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "restrictedTicketIndicator", RestrictedTicketIndicator.ToString())).Append("\n");
            if (TransactionType != null) sb.Append("  TransactionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "transactionType", TransactionType.ToString())).Append("\n");
            if (ExtendedPaymentCode != null) sb.Append("  ExtendedPaymentCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "extendedPaymentCode", ExtendedPaymentCode.ToString())).Append("\n");
            if (PassengerName != null) sb.Append("  PassengerName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "passengerName", PassengerName.ToString())).Append("\n");
            if (CustomerCode != null) sb.Append("  CustomerCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "customerCode", CustomerCode.ToString())).Append("\n");
            if (DocumentType != null) sb.Append("  DocumentType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "documentType", DocumentType.ToString())).Append("\n");
            if (DocumentNumber != null) sb.Append("  DocumentNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "documentNumber", DocumentNumber.ToString())).Append("\n");
            if (DocumentNumberOfParts != null) sb.Append("  DocumentNumberOfParts: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "documentNumberOfParts", DocumentNumberOfParts.ToString())).Append("\n");
            if (InvoiceNumber != null) sb.Append("  InvoiceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "invoiceNumber", InvoiceNumber.ToString())).Append("\n");
            if (InvoiceDate != null) sb.Append("  InvoiceDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "invoiceDate", InvoiceDate.ToString())).Append("\n");
            if (AdditionalCharges != null) sb.Append("  AdditionalCharges: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "additionalCharges", AdditionalCharges.ToString())).Append("\n");
            if (TotalFeeAmount != null) sb.Append("  TotalFeeAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "totalFeeAmount", TotalFeeAmount.ToString())).Append("\n");
            if (ClearingSequence != null) sb.Append("  ClearingSequence: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "clearingSequence", ClearingSequence.ToString())).Append("\n");
            if (ClearingCount != null) sb.Append("  ClearingCount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "clearingCount", ClearingCount.ToString())).Append("\n");
            if (TotalClearingAmount != null) sb.Append("  TotalClearingAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "totalClearingAmount", TotalClearingAmount.ToString())).Append("\n");
            if (NumberOfPassengers != null) sb.Append("  NumberOfPassengers: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "numberOfPassengers", NumberOfPassengers.ToString())).Append("\n");
            if (ReservationSystemCode != null) sb.Append("  ReservationSystemCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "reservationSystemCode", ReservationSystemCode.ToString())).Append("\n");
            if (ProcessIdentifier != null) sb.Append("  ProcessIdentifier: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "processIdentifier", ProcessIdentifier.ToString())).Append("\n");
            if (TicketIssueDate != null) sb.Append("  TicketIssueDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "ticketIssueDate", TicketIssueDate.ToString())).Append("\n");
            if (ElectronicTicketIndicator != null) sb.Append("  ElectronicTicketIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "electronicTicketIndicator", ElectronicTicketIndicator.ToString())).Append("\n");
            if (OriginalTicketNumber != null) sb.Append("  OriginalTicketNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "originalTicketNumber", OriginalTicketNumber.ToString())).Append("\n");
            if (PurchaseType != null) sb.Append("  PurchaseType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "purchaseType", PurchaseType.ToString())).Append("\n");
            if (CreditReasonIndicator != null) sb.Append("  CreditReasonIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "creditReasonIndicator", CreditReasonIndicator.ToString())).Append("\n");
            if (TicketChangeIndicator != null) sb.Append("  TicketChangeIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "ticketChangeIndicator", TicketChangeIndicator.ToString())).Append("\n");
            if (PlanNumber != null) sb.Append("  PlanNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "planNumber", PlanNumber.ToString())).Append("\n");
            if (ArrivalDate != null) sb.Append("  ArrivalDate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "arrivalDate", ArrivalDate.ToString())).Append("\n");
            if (RestrictedTicketDesciption != null) sb.Append("  RestrictedTicketDesciption: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "restrictedTicketDesciption", RestrictedTicketDesciption.ToString())).Append("\n");
            if (ExchangeTicketAmount != null) sb.Append("  ExchangeTicketAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "exchangeTicketAmount", ExchangeTicketAmount.ToString())).Append("\n");
            if (ExchangeTicketFeeAmount != null) sb.Append("  ExchangeTicketFeeAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "exchangeTicketFeeAmount", ExchangeTicketFeeAmount.ToString())).Append("\n");
            if (ReservationType != null) sb.Append("  ReservationType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "reservationType", ReservationType.ToString())).Append("\n");
            if (BoardingFeeAmount != null) sb.Append("  BoardingFeeAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "boardingFeeAmount", BoardingFeeAmount.ToString())).Append("\n");
            if (Legs != null) sb.Append("  Legs: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "legs", Legs.ToString())).Append("\n");
            if (AncillaryInformation != null) sb.Append("  AncillaryInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "ancillaryInformation", AncillaryInformation.ToString())).Append("\n");
            if (FlightType != null) sb.Append("  FlightType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "flightType", FlightType.ToString())).Append("\n");
            if (InsuranceAmount != null) sb.Append("  InsuranceAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "insuranceAmount", InsuranceAmount.ToString())).Append("\n");
            if (FrequentFlyerNumber != null) sb.Append("  FrequentFlyerNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "frequentFlyerNumber", FrequentFlyerNumber.ToString())).Append("\n");
            if (ThirdPartyStatus != null) sb.Append("  ThirdPartyStatus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "thirdPartyStatus", ThirdPartyStatus.ToString())).Append("\n");
            if (PassengerType != null) sb.Append("  PassengerType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "passengerType", PassengerType.ToString())).Append("\n");
            if (TotalInsuranceAmount != null) sb.Append("  TotalInsuranceAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsTravelInformationTransitAirline", "totalInsuranceAmount", TotalInsuranceAmount.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsTravelInformationTransitAirline", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
