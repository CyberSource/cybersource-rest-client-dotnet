...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ucv1sessionsCaptureMandateCPF :  IEquatable<Ucv1sessionsCaptureMandateCPF>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ucv1sessionsCaptureMandateCPF" /> class.
        /// </summary>
        ...
        public Ucv1sessionsCaptureMandateCPF(bool? Required = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            if (Required != null) sb.Append("  Required: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsCaptureMandateCPF", "required", Required.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ucv1sessionsCaptureMandateCPF", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ucv1sessionsCaptureMandateCPF);
        }

        /// <summary>
        /// Returns true if Ucv1sessionsCaptureMandateCPF instances are equal
        /// </summary>
        /// <param name="other">Instance of Ucv1sessionsCaptureMandateCPF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ucv1sessionsCaptureMandateCPF other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
