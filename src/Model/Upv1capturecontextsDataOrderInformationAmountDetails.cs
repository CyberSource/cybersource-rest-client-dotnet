...
namespace CyberSource.Model
{
    ...
    public partial class Upv1capturecontextsDataOrderInformationAmountDetails :  IEquatable<Upv1capturecontextsDataOrderInformationAmountDetails>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TotalAmount != null) sb.Append("  TotalAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "totalAmount", TotalAmount.ToString())).Append("\n");
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "currency", Currency.ToString())).Append("\n");
            if (Surcharge != null) sb.Append("  Surcharge: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "surcharge", Surcharge.ToString())).Append("\n");
            if (DiscountAmount != null) sb.Append("  DiscountAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "discountAmount", DiscountAmount.ToString())).Append("\n");
            if (SubTotalAmount != null) sb.Append("  SubTotalAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "subTotalAmount", SubTotalAmount.ToString())).Append("\n");
            if (ServiceFeeAmount != null) sb.Append("  ServiceFeeAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "serviceFeeAmount", ServiceFeeAmount.ToString())).Append("\n");
            if (TaxAmount != null) sb.Append("  TaxAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "taxAmount", TaxAmount.ToString())).Append("\n");
            if (TaxDetails != null) sb.Append("  TaxDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Upv1capturecontextsDataOrderInformationAmountDetails", "taxDetails", TaxDetails.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Upv1capturecontextsDataOrderInformationAmountDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
