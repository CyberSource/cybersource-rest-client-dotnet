...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation :  IEquatable<Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation" /> class.
        /// </summary>
        ...
        public Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation(string RequestorID = default(string), string TransactionType = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation);
        }

        /// <summary>
        /// Returns true if Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
