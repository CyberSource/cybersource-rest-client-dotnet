...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012OrderInformationAmountDetails :  IEquatable<InlineResponse20012OrderInformationAmountDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012OrderInformationAmountDetails" /> class.
        /// </summary>
        ...
        public InlineResponse20012OrderInformationAmountDetails(string TotalAmount = default(string), string Currency = default(string), string TaxAmount = default(string), string AuthorizedAmount = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012OrderInformationAmountDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse20012OrderInformationAmountDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012OrderInformationAmountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012OrderInformationAmountDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
