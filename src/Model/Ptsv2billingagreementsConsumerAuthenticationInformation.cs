...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2billingagreementsConsumerAuthenticationInformation :  IEquatable<Ptsv2billingagreementsConsumerAuthenticationInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AuthenticationTransactionContextId != null) sb.Append("  AuthenticationTransactionContextId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsConsumerAuthenticationInformation", "authenticationTransactionContextId", AuthenticationTransactionContextId.ToString())).Append("\n");
            if (Cavv != null) sb.Append("  Cavv: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsConsumerAuthenticationInformation", "cavv", Cavv.ToString())).Append("\n");
            if (TransactionToken != null) sb.Append("  TransactionToken: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsConsumerAuthenticationInformation", "transactionToken", TransactionToken.ToString())).Append("\n");
            if (Xid != null) sb.Append("  Xid: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2billingagreementsConsumerAuthenticationInformation", "xid", Xid.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2billingagreementsConsumerAuthenticationInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
