...
namespace CyberSource.Model
{
    ...
    public partial class PostRegistrationBody :  IEquatable<PostRegistrationBody>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (RegistrationInformation != null) sb.Append("  RegistrationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PostRegistrationBody", "registrationInformation", RegistrationInformation.ToString())).Append("\n");
            if (IntegrationInformation != null) sb.Append("  IntegrationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PostRegistrationBody", "integrationInformation", IntegrationInformation.ToString())).Append("\n");
