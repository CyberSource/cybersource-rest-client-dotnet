...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Vasv2taxidClientReferenceInformationPartner :  IEquatable<Vasv2taxidClientReferenceInformationPartner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Vasv2taxidClientReferenceInformationPartner" /> class.
        /// </summary>
        ...
        public Vasv2taxidClientReferenceInformationPartner(string SolutionId = default(string), string DeveloperId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            if (SolutionId != null) sb.Append("  SolutionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Vasv2taxidClientReferenceInformationPartner", "solutionId", SolutionId.ToString())).Append("\n");
            if (DeveloperId != null) sb.Append("  DeveloperId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Vasv2taxidClientReferenceInformationPartner", "developerId", DeveloperId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Vasv2taxidClientReferenceInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Vasv2taxidClientReferenceInformationPartner);
        }

        /// <summary>
        /// Returns true if Vasv2taxidClientReferenceInformationPartner instances are equal
        /// </summary>
        /// <param name="other">Instance of Vasv2taxidClientReferenceInformationPartner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Vasv2taxidClientReferenceInformationPartner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
