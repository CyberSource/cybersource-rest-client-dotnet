...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse40012 :  IEquatable<InlineResponse40012>, IValidatableObject
    {
        ...
        public InlineResponse40012(string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), string Reason = default(string), string Message = default(string), List<PushFunds400ResponseDetails> Details = default(List<PushFunds400ResponseDetails>))
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse40012);
        }

        /// <summary>
        /// Returns true if InlineResponse40012 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse40012 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40012 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
