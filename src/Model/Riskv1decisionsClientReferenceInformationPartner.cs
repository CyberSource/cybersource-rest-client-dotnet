...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1decisionsClientReferenceInformationPartner :  IEquatable<Riskv1decisionsClientReferenceInformationPartner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1decisionsClientReferenceInformationPartner" /> class.
        /// </summary>
        ...
        public Riskv1decisionsClientReferenceInformationPartner(string DeveloperId = default(string), string SolutionId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            if (DeveloperId != null) sb.Append("  DeveloperId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsClientReferenceInformationPartner", "developerId", DeveloperId.ToString())).Append("\n");
            if (SolutionId != null) sb.Append("  SolutionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsClientReferenceInformationPartner", "solutionId", SolutionId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1decisionsClientReferenceInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1decisionsClientReferenceInformationPartner);
        }

        /// <summary>
        /// Returns true if Riskv1decisionsClientReferenceInformationPartner instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1decisionsClientReferenceInformationPartner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1decisionsClientReferenceInformationPartner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
