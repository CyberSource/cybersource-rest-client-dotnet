...
**ClientCorrelationId** | **string** | Client-generated unique identifier for correlating token operations across API calls. This value helps track and associate token-related transactions.  | [optional] 
**TokenAuthenticationInformation** | [**Ptsv2paymentsTokenInformationTokenAuthenticationInformation**](Ptsv2paymentsTokenInformationTokenAuthenticationInformation.md) |  | [optional] 
