...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011ResponseRecord :  IEquatable<InlineResponse20011ResponseRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ResponseRecord" /> class.
        /// </summary>
        ...
        public InlineResponse20011ResponseRecord(string Response = default(string), string Reason = default(string), string Token = default(string), string InstrumentIdentifierId = default(string), string InstrumentIdentifierCreated = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string), List<InlineResponse20011ResponseRecordAdditionalUpdates> AdditionalUpdates = default(List<InlineResponse20011ResponseRecordAdditionalUpdates>))
        {
        ...
        public List<InlineResponse20011ResponseRecordAdditionalUpdates> AdditionalUpdates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011ResponseRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20011ResponseRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ResponseRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20011ResponseRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ResponseRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
