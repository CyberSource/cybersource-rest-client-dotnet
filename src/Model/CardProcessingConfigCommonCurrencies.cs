...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardProcessingConfigCommonCurrencies :  IEquatable<CardProcessingConfigCommonCurrencies>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardProcessingConfigCommonCurrencies" /> class.
        /// </summary>
        ...
        /// <param name="EnabledCardNotPresent">Indicates whether the card-not-present transaction is activated for the selected currency. If both enabledCardPresent and enabledCardNotPresent are set to null, then enabledCardNotPresent will have the value of enabled..</param>
        /// <param name="MerchantId">Merchant ID assigned by an acquirer or a processor. Should not be overridden by any other party..</param>
        ...
        /// </summary>
        /// <value>Indicates whether the card-not-present transaction is activated for the selected currency. If both enabledCardPresent and enabledCardNotPresent are set to null, then enabledCardNotPresent will have the value of enabled.</value>
        ...
        /// </summary>
        /// <value>Merchant ID assigned by an acquirer or a processor. Should not be overridden by any other party.</value>
        ...
        public override string ToString()
        {
            ...
            if (Enabled != null) sb.Append("  Enabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "enabled", Enabled.ToString())).Append("\n");
            if (EnabledCardPresent != null) sb.Append("  EnabledCardPresent: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "enabledCardPresent", EnabledCardPresent.ToString())).Append("\n");
            if (EnabledCardNotPresent != null) sb.Append("  EnabledCardNotPresent: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "enabledCardNotPresent", EnabledCardNotPresent.ToString())).Append("\n");
            if (MerchantId != null) sb.Append("  MerchantId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "merchantId", MerchantId.ToString())).Append("\n");
            if (TerminalId != null) sb.Append("  TerminalId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "terminalId", TerminalId.ToString())).Append("\n");
            if (TerminalIds != null) sb.Append("  TerminalIds: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "terminalIds", TerminalIds.ToString())).Append("\n");
            if (ServiceEnablementNumber != null) sb.Append("  ServiceEnablementNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfigCommonCurrencies", "serviceEnablementNumber", ServiceEnablementNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("CardProcessingConfigCommonCurrencies", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CardProcessingConfigCommonCurrencies);
        }

        /// <summary>
        /// Returns true if CardProcessingConfigCommonCurrencies instances are equal
        /// </summary>
        /// <param name="other">Instance of CardProcessingConfigCommonCurrencies to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardProcessingConfigCommonCurrencies other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
