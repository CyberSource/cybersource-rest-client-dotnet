...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessingInfoAuthorizationOptionsInitiator :  IEquatable<ProcessingInfoAuthorizationOptionsInitiator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessingInfoAuthorizationOptionsInitiator" /> class.
        /// </summary>
        ...
        public ProcessingInfoAuthorizationOptionsInitiator(string Type = default(string), bool? CredentialStoredOnFile = default(bool?), bool? StoredCredentialUsed = default(bool?), ProcessingInfoAuthorizationOptionsInitiatorMerchantInitiatedTransaction MerchantInitiatedTransaction = default(ProcessingInfoAuthorizationOptionsInitiatorMerchantInitiatedTransaction))
        {
            this.Type = Type;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public ProcessingInfoAuthorizationOptionsInitiatorMerchantInitiatedTransaction MerchantInitiatedTransaction { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptionsInitiator", "type", Type.ToString())).Append("\n");
            if (CredentialStoredOnFile != null) sb.Append("  CredentialStoredOnFile: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptionsInitiator", "credentialStoredOnFile", CredentialStoredOnFile.ToString())).Append("\n");
            if (StoredCredentialUsed != null) sb.Append("  StoredCredentialUsed: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptionsInitiator", "storedCredentialUsed", StoredCredentialUsed.ToString())).Append("\n");
            if (MerchantInitiatedTransaction != null) sb.Append("  MerchantInitiatedTransaction: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptionsInitiator", "merchantInitiatedTransaction", MerchantInitiatedTransaction.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("ProcessingInfoAuthorizationOptionsInitiator", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProcessingInfoAuthorizationOptionsInitiator);
        }

        /// <summary>
        /// Returns true if ProcessingInfoAuthorizationOptionsInitiator instances are equal
        /// </summary>
        /// <param name="other">Instance of ProcessingInfoAuthorizationOptionsInitiator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessingInfoAuthorizationOptionsInitiator other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
