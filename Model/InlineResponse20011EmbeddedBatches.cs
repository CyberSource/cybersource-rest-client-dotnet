...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011EmbeddedBatches :  IEquatable<InlineResponse20011EmbeddedBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011EmbeddedBatches" /> class.
        /// </summary>
        ...
        public InlineResponse20011EmbeddedBatches(InlineResponse20011EmbeddedLinks Links = default(InlineResponse20011EmbeddedLinks), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchModifiedDate = default(string), string BatchSource = default(string), string TokenSource = default(string), string MerchantReference = default(string), List<string> BatchCaEndpoints = default(List<string>), string Status = default(string), InlineResponse20011EmbeddedTotals Totals = default(InlineResponse20011EmbeddedTotals))
        {
            this.Links = Links;
        ...
        public InlineResponse20011EmbeddedLinks Links { get; set; }
        ...
        public InlineResponse20011EmbeddedTotals Totals { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20011EmbeddedBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse20011EmbeddedBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20011EmbeddedBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011EmbeddedBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
