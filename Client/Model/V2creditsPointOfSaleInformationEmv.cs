...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2creditsPointOfSaleInformationEmv :  IEquatable<V2creditsPointOfSaleInformationEmv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2creditsPointOfSaleInformationEmv" /> class.
        /// </summary>
        ...
        public V2creditsPointOfSaleInformationEmv(string Tags = default(string), bool? Fallback = false, decimal? FallbackCondition = default(decimal?))
        {
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2creditsPointOfSaleInformationEmv {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2creditsPointOfSaleInformationEmv);
        }

        /// <summary>
        /// Returns true if V2creditsPointOfSaleInformationEmv instances are equal
        /// </summary>
        /// <param name="other">Instance of V2creditsPointOfSaleInformationEmv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2creditsPointOfSaleInformationEmv other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
