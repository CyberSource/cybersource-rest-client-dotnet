...
namespace CyberSource.Model
{
    ...
    public partial class RefundCaptureRequest :  IEquatable<RefundCaptureRequest>, IValidatableObject
    {
        ...
        public RefundCaptureRequest(V2paymentsClientReferenceInformation ClientReferenceInformation = default(V2paymentsClientReferenceInformation), V2paymentsidrefundsProcessingInformation ProcessingInformation = default(V2paymentsidrefundsProcessingInformation), V2paymentsidrefundsPaymentInformation PaymentInformation = default(V2paymentsidrefundsPaymentInformation), V2paymentsidrefundsOrderInformation OrderInformation = default(V2paymentsidrefundsOrderInformation), V2paymentsidcapturesBuyerInformation BuyerInformation = default(V2paymentsidcapturesBuyerInformation), V2paymentsDeviceInformation DeviceInformation = default(V2paymentsDeviceInformation), V2paymentsidrefundsMerchantInformation MerchantInformation = default(V2paymentsidrefundsMerchantInformation), V2paymentsidcapturesAggregatorInformation AggregatorInformation = default(V2paymentsidcapturesAggregatorInformation), V2paymentsidrefundsPointOfSaleInformation PointOfSaleInformation = default(V2paymentsidrefundsPointOfSaleInformation), List<V2paymentsMerchantDefinedInformation> MerchantDefinedInformation = default(List<V2paymentsMerchantDefinedInformation>))
        {
        ...
        public V2paymentsidrefundsProcessingInformation ProcessingInformation { get; set; }
        ...
        public V2paymentsidrefundsPointOfSaleInformation PointOfSaleInformation { get; set; }
