...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse201ProcessorInformationCardVerification :  IEquatable<InlineResponse201ProcessorInformationCardVerification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse201ProcessorInformationCardVerification" /> class.
        /// </summary>
        ...
        public InlineResponse201ProcessorInformationCardVerification(string ResultCode = default(string), string ResultCodeRaw = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse201ProcessorInformationCardVerification);
        }

        /// <summary>
        /// Returns true if InlineResponse201ProcessorInformationCardVerification instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse201ProcessorInformationCardVerification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse201ProcessorInformationCardVerification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
