...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseOrderInformationShippingDetails :  IEquatable<TssV2TransactionsGet200ResponseOrderInformationShippingDetails>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (GiftWrap != null) sb.Append("  GiftWrap: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseOrderInformationShippingDetails", "giftWrap", GiftWrap.ToString())).Append("\n");
            if (ShippingMethod != null) sb.Append("  ShippingMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseOrderInformationShippingDetails", "shippingMethod", ShippingMethod.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseOrderInformationShippingDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
