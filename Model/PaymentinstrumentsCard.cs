...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentinstrumentsCard :  IEquatable<PaymentinstrumentsCard>, IValidatableObject
    {
        /// <summary>
        /// Credit card brand.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentinstrumentsCard" /> class.
        /// </summary>
        ...
        public PaymentinstrumentsCard(string ExpirationMonth = default(string), string ExpirationYear = default(string), TypeEnum? Type = default(TypeEnum?), string IssueNumber = default(string), string StartMonth = default(string), string StartYear = default(string), string UseAs = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentinstrumentsCard {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentinstrumentsCard);
        }

        /// <summary>
        /// Returns true if PaymentinstrumentsCard instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentinstrumentsCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentinstrumentsCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
