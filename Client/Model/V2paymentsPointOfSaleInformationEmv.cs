...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsPointOfSaleInformationEmv :  IEquatable<V2paymentsPointOfSaleInformationEmv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsPointOfSaleInformationEmv" /> class.
        /// </summary>
        ...
        public V2paymentsPointOfSaleInformationEmv(string Tags = default(string), decimal? CardholderVerificationMethod = default(decimal?), string CardSequenceNumber = default(string), bool? Fallback = false, decimal? FallbackCondition = default(decimal?))
        {
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsPointOfSaleInformationEmv {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsPointOfSaleInformationEmv);
        }

        /// <summary>
        /// Returns true if V2paymentsPointOfSaleInformationEmv instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsPointOfSaleInformationEmv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsPointOfSaleInformationEmv other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
