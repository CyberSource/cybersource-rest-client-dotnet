...
namespace CyberSource.Model
{
    ...
    public partial class PaymentInstrumentListLinksFirst :  IEquatable<PaymentInstrumentListLinksFirst>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Href != null) sb.Append("  Href: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinksFirst", "href", Href.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentInstrumentListLinksFirst", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
