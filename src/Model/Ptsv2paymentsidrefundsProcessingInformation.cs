...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidrefundsProcessingInformation :  IEquatable<Ptsv2paymentsidrefundsProcessingInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ActionList != null) sb.Append("  ActionList: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "actionList", ActionList.ToString())).Append("\n");
            if (PaymentSolution != null) sb.Append("  PaymentSolution: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "paymentSolution", PaymentSolution.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            if (LinkId != null) sb.Append("  LinkId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "linkId", LinkId.ToString())).Append("\n");
            if (ReportGroup != null) sb.Append("  ReportGroup: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "reportGroup", ReportGroup.ToString())).Append("\n");
            if (VisaCheckoutId != null) sb.Append("  VisaCheckoutId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "visaCheckoutId", VisaCheckoutId.ToString())).Append("\n");
            if (PurchaseLevel != null) sb.Append("  PurchaseLevel: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "purchaseLevel", PurchaseLevel.ToString())).Append("\n");
            if (RecurringOptions != null) sb.Append("  RecurringOptions: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "recurringOptions", RecurringOptions.ToString())).Append("\n");
            if (IndustryDataType != null) sb.Append("  IndustryDataType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "industryDataType", IndustryDataType.ToString())).Append("\n");
            if (PaymentType != null) sb.Append("  PaymentType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "paymentType", PaymentType.ToString())).Append("\n");
            if (RefundOptions != null) sb.Append("  RefundOptions: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "refundOptions", RefundOptions.ToString())).Append("\n");
            if (TransactionTypeIndicator != null) sb.Append("  TransactionTypeIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "transactionTypeIndicator", TransactionTypeIndicator.ToString())).Append("\n");
            if (MerchantVerificationValue != null) sb.Append("  MerchantVerificationValue: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsProcessingInformation", "merchantVerificationValue", MerchantVerificationValue.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsProcessingInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
