...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009EmbeddedTotals :  IEquatable<InlineResponse2009EmbeddedTotals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009EmbeddedTotals" /> class.
        /// </summary>
        ...
        public InlineResponse2009EmbeddedTotals(int? AcceptedRecords = default(int?), int? RejectedRecords = default(int?), int? UpdatedRecords = default(int?), int? CaResponses = default(int?), int? CaResponsesOmitted = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009EmbeddedTotals {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2009EmbeddedTotals);
        }

        /// <summary>
        /// Returns true if InlineResponse2009EmbeddedTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2009EmbeddedTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009EmbeddedTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
