...
namespace CyberSource.Model
{
    ...
    public partial class ReportingV3ReportsGet200Response :  IEquatable<ReportingV3ReportsGet200Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ReportSearchResults != null) sb.Append("  ReportSearchResults: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ReportingV3ReportsGet200Response", "reportSearchResults", ReportSearchResults.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("ReportingV3ReportsGet200Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
