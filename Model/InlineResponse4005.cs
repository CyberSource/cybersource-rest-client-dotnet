...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4005 :  IEquatable<InlineResponse4005>, IValidatableObject
    {
        ...
        public InlineResponse4005(string Code = default(string), string Message = default(string), string LocalizationKey = default(string), string CorrelationId = default(string), string Detail = default(string), List<InlineResponse4005Fields> Fields = default(List<InlineResponse4005Fields>))
        {
            this.Code = Code;
        ...
        public List<InlineResponse4005Fields> Fields { get; set; }
