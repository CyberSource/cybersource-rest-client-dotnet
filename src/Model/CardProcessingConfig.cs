...
namespace CyberSource.Model
{
    ...
    public partial class CardProcessingConfig :  IEquatable<CardProcessingConfig>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Common != null) sb.Append("  Common: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfig", "common", Common.ToString())).Append("\n");
            if (Features != null) sb.Append("  Features: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CardProcessingConfig", "features", Features.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("CardProcessingConfig", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
