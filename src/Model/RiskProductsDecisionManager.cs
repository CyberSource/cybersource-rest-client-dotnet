...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskProductsDecisionManager :  IEquatable<RiskProductsDecisionManager>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskProductsDecisionManager" /> class.
        /// </summary>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public RiskProductsDecisionManagerConfigurationInformation ConfigurationInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (SubscriptionInformation != null) sb.Append("  SubscriptionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskProductsDecisionManager", "subscriptionInformation", SubscriptionInformation.ToString())).Append("\n");
            if (ConfigurationInformation != null) sb.Append("  ConfigurationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskProductsDecisionManager", "configurationInformation", ConfigurationInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskProductsDecisionManager", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RiskProductsDecisionManager);
        }

        /// <summary>
        /// Returns true if RiskProductsDecisionManager instances are equal
        /// </summary>
        /// <param name="other">Instance of RiskProductsDecisionManager to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskProductsDecisionManager other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
