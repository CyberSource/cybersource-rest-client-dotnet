...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidcapturesOrderInformationBillTo :  IEquatable<Ptsv2paymentsidcapturesOrderInformationBillTo>, IValidatableObject
    {
        ...
        public Ptsv2paymentsidcapturesOrderInformationBillTo(string FirstName = default(string), string LastName = default(string), Ptsv2paymentsOrderInformationBillToCompany Company = default(Ptsv2paymentsOrderInformationBillToCompany), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string Country = default(string), string Email = default(string), string PhoneNumber = default(string))
        {
