...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink :  IEquatable<RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink" /> class.
        /// </summary>
        /// <param name="Enabled">Enabled.</param>
        /// <param name="EnableRealTime">EnableRealTime.</param>
        /// <param name="UseCybsCredentials">UseCybsCredentials.</param>
        /// <param name="Credentials">Credentials.</param>
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink(bool? Enabled = default(bool?), bool? EnableRealTime = default(bool?), bool? UseCybsCredentials = default(bool?), RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilinkCredentials Credentials = default(RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilinkCredentials))
        {
        ...
        public RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilinkCredentials Credentials { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink);
        }

        /// <summary>
        /// Returns true if RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink instances are equal
        /// </summary>
        /// <param name="other">Instance of RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskProductsDecisionManagerConfigurationInformationConfigurationsThirdpartyProviderCredilink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
