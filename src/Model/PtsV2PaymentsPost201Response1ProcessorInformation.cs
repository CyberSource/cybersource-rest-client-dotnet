...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201Response1ProcessorInformation :  IEquatable<PtsV2PaymentsPost201Response1ProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response1ProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (TradeNumber != null) sb.Append("  TradeNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response1ProcessorInformation", "tradeNumber", TradeNumber.ToString())).Append("\n");
            if (RawResponse != null) sb.Append("  RawResponse: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response1ProcessorInformation", "rawResponse", RawResponse.ToString())).Append("\n");
            if (RawResponseLocal != null) sb.Append("  RawResponseLocal: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201Response1ProcessorInformation", "rawResponseLocal", RawResponseLocal.ToString())).Append("\n");
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201Response1ProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
