...
{
    public class AvsNonUsMaestroUkDomestic
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AvsNonUsMaestroUkDomestic";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSNonUsSupportedCardTypes/CreateMaestroUKDomestic.csv"), true))
            {
