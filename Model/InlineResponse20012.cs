...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(string Version = default(string), string ReportCreatedDate = default(string), string BatchId = default(string), string BatchSource = default(string), string BatchCaEndpoints = default(string), string BatchCreatedDate = default(string), string MerchantReference = default(string), InlineResponse20010EmbeddedTotals Totals = default(InlineResponse20010EmbeddedTotals), InlineResponse20011Billing Billing = default(InlineResponse20011Billing), List<InlineResponse20012Records> Records = default(List<InlineResponse20012Records>))
        {
        ...
        public InlineResponse20011Billing Billing { get; set; }

        /// <summary>
        /// Gets or Sets Records
        /// </summary>
        [DataMember(Name="records", EmitDefaultValue=false)]
        public List<InlineResponse20012Records> Records { get; set; }
