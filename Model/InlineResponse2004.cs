...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(string Version = default(string), string ReportCreatedDate = default(string), string BatchId = default(string), string BatchSource = default(string), string BatchCaEndpoints = default(string), string BatchCreatedDate = default(string), string MerchantReference = default(string), InlineResponse2002EmbeddedTotals Totals = default(InlineResponse2002EmbeddedTotals), InlineResponse2003Billing Billing = default(InlineResponse2003Billing), List<InlineResponse2004Records> Records = default(List<InlineResponse2004Records>))
        {
        ...
        public List<InlineResponse2004Records> Records { get; set; }
