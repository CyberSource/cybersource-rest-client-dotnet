...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(List<InlineResponse20012Links> Links = default(List<InlineResponse20012Links>), string _Object = default(string), int? Offset = default(int?), int? Limit = default(int?), int? Count = default(int?), int? Total = default(int?), InlineResponse20012Embedded Embedded = default(InlineResponse20012Embedded))
        {
            this.Links = Links;
