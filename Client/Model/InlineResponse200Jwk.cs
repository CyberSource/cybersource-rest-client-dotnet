...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse200Jwk :  IEquatable<InlineResponse200Jwk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200Jwk" /> class.
        /// </summary>
        ...
        public InlineResponse200Jwk(string Kty = default(string), string Use = default(string), string Kid = default(string), string N = default(string), string E = default(string))
        {
            this.Kty = Kty;
            this.Use = Use;
            this.Kid = Kid;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse200Jwk);
        }

        /// <summary>
        /// Returns true if InlineResponse200Jwk instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse200Jwk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200Jwk other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
