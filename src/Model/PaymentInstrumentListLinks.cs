...
namespace CyberSource.Model
{
    ...
    public partial class PaymentInstrumentListLinks :  IEquatable<PaymentInstrumentListLinks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Self != null) sb.Append("  Self: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinks", "self", Self.ToString())).Append("\n");
            if (First != null) sb.Append("  First: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinks", "first", First.ToString())).Append("\n");
            if (Prev != null) sb.Append("  Prev: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinks", "prev", Prev.ToString())).Append("\n");
            if (Next != null) sb.Append("  Next: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinks", "next", Next.ToString())).Append("\n");
            if (Last != null) sb.Append("  Last: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinks", "last", Last.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentInstrumentListLinks", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
