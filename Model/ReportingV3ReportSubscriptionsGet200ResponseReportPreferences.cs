...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportingV3ReportSubscriptionsGet200ResponseReportPreferences :  IEquatable<ReportingV3ReportSubscriptionsGet200ResponseReportPreferences>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportingV3ReportSubscriptionsGet200ResponseReportPreferences" /> class.
        /// </summary>
        /// <param name="SignedAmounts">Indicator to determine whether negative sign infron of amount for all refunded transaction.</param>
        ...
        public ReportingV3ReportSubscriptionsGet200ResponseReportPreferences(bool? SignedAmounts = default(bool?), FieldNameConventionEnum? FieldNameConvention = default(FieldNameConventionEnum?))
        {
        ...
        /// </summary>
        /// <value>Indicator to determine whether negative sign infron of amount for all refunded transaction</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportingV3ReportSubscriptionsGet200ResponseReportPreferences);
        }

        /// <summary>
        /// Returns true if ReportingV3ReportSubscriptionsGet200ResponseReportPreferences instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportingV3ReportSubscriptionsGet200ResponseReportPreferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportingV3ReportSubscriptionsGet200ResponseReportPreferences other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
