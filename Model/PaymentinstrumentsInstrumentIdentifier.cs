...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentinstrumentsInstrumentIdentifier :  IEquatable<PaymentinstrumentsInstrumentIdentifier>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentinstrumentsInstrumentIdentifier" /> class.
        /// </summary>
        ...
        public PaymentinstrumentsInstrumentIdentifier(InstrumentidentifiersLinks Links = default(InstrumentidentifiersLinks), string Id = default(string), InstrumentidentifiersCard Card = default(InstrumentidentifiersCard), InstrumentidentifiersBankAccount BankAccount = default(InstrumentidentifiersBankAccount), InstrumentidentifiersProcessingInformation ProcessingInformation = default(InstrumentidentifiersProcessingInformation), InstrumentidentifiersMetadata Metadata = default(InstrumentidentifiersMetadata))
        {
            this.Links = Links;
            this.Id = Id;
            this.Card = Card;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentinstrumentsInstrumentIdentifier);
        }

        /// <summary>
        /// Returns true if PaymentinstrumentsInstrumentIdentifier instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentinstrumentsInstrumentIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentinstrumentsInstrumentIdentifier other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
