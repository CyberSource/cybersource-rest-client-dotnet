...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2creditsPointOfSaleInformationEmv :  IEquatable<Ptsv2creditsPointOfSaleInformationEmv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2creditsPointOfSaleInformationEmv" /> class.
        /// </summary>
        ...
        public Ptsv2creditsPointOfSaleInformationEmv(string Tags = default(string), bool? Fallback = false, decimal? FallbackCondition = default(decimal?))
        {
            this.Tags = Tags;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2creditsPointOfSaleInformationEmv);
        }

        /// <summary>
        /// Returns true if Ptsv2creditsPointOfSaleInformationEmv instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2creditsPointOfSaleInformationEmv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2creditsPointOfSaleInformationEmv other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
