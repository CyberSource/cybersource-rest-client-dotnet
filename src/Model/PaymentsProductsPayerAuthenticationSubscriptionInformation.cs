...
namespace CyberSource.Model
{
    ...
    public partial class PaymentsProductsPayerAuthenticationSubscriptionInformation :  IEquatable<PaymentsProductsPayerAuthenticationSubscriptionInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Enabled != null) sb.Append("  Enabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsPayerAuthenticationSubscriptionInformation", "enabled", Enabled.ToString())).Append("\n");
            if (SelfServiceability != null) sb.Append("  SelfServiceability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentsProductsPayerAuthenticationSubscriptionInformation", "selfServiceability", SelfServiceability.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentsProductsPayerAuthenticationSubscriptionInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
