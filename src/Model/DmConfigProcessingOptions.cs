...
namespace CyberSource.Model
{
    ...
    public partial class DmConfigProcessingOptions :  IEquatable<DmConfigProcessingOptions>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonPropertyName("stepUpAuthEnabled")]
        ...
        public override string ToString()
        {
            ...
            if (StepUpAuthEnabled != null) sb.Append("  StepUpAuthEnabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigProcessingOptions", "stepUpAuthEnabled", StepUpAuthEnabled.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DmConfigProcessingOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
