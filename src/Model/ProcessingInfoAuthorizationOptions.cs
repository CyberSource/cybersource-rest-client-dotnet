...
namespace CyberSource.Model
{
    ...
    public partial class ProcessingInfoAuthorizationOptions :  IEquatable<ProcessingInfoAuthorizationOptions>, IValidatableObject
    {
        ...
        /// <param name="BillPaymentType">Reason for the payment.  Possible values: - 001: Public utilities / Utility payment - 002: Government services - 003: Cellular / Mobile phone top-up - 004: Coupon payment - 005: Installment based repayment - 006: Billing payment - 007: Tax payment - 008: Tax payment refunds  The value for this field corresponds to the following data in the TC 33A capture file (applicable to Brazil): - Record: CP07 TCR0 - Position: 48-50 - Field: Bill Payment Transaction Type Identifier  The value for this field corresponds to the following data in the TC 33A capture file (applicable to Installment) based Repayment): - Record: CP01 TCR6 - Position: 154-156 - Field: Bill Payment Transaction Type Identifier   This field is supported for 1. Bill payments in Brazil with Mastercard on CyberSource through VisaNet. 2. Installment based repayment transactions on Cybersource through VisaNet. .</param>
        ...
        /// <param name="TransactionMode">Transaction mode identifier. Identifies the specific channel from which the transaction originates.  Possible values: - M – Mobile Order - T – Telephone Order .</param>
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public ProcessingInfoAuthorizationOptionsInitiator Initiator { get; set; }
        ...
        /// </summary>
        /// <value>#### Visa Platform Connect Indicates split payment transaction. A split payment allows the use of two payment methods for a single transaction.  Possible values:   - &#x60;true&#x60; (split payment transaction is supported)   - &#x60;false&#x60; (default: split payment transaction is not supported) </value>
        ...
        /// </summary>
        /// <value>Transaction mode identifier. Identifies the specific channel from which the transaction originates.  Possible values: - M – Mobile Order - T – Telephone Order </value>
        ...
        /// </summary>
        /// <value>Field is used for back-to-back funding transaction and can be defined as a payment flow that automatically transfers funds through a real-time  funding or a live-load. This type of transaction can also be connected to a purchase.  In back-to-back funding of general purpose card that is used to make a purchase, two separate accounts are involved:  - account one is used to make the purchase - account two is used to automatically fund or reimburse account one  Possible values: - 0B &#x3D; back to back funding transaction - 00 &#x3D; normal transaction - 01 &#x3D; originator hold - 02 &#x3D; Visa deferred OCT hold, default interval - 03 &#x3D; Visa deferred OCT hold, user-defined interval - 09 &#x3D; Cancel pending deferred OCT request - 0I &#x3D; Visa Direct custom program 1 - 0Q &#x3D; uery the status of the deferred OCT - A0 &#x3D; Alias Directory 2 </value>
        ...
        /// </summary>
        /// <value>Merchant to inform Cybersource whether a transaction is Money load with Balance Update.  Possible values:   - &#x60;true&#x60; (This is a Money load with balance update transaction)   - &#x60;false&#x60; (default value) (This is not a Money load with balance update transaction) </value>
        [JsonPropertyName("balanceUpdate")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public bool? BalanceUpdate { get; set; }
        ...
        /// </summary>
        /// <value>Merchant to inform Cybersource whether a transaction is Money load with Money load only.  Possible values:   - &#x60;true&#x60; (This is a money load transaction)   - &#x60;false&#x60; (default value) (This is not a money load transaction) </value>
        [JsonPropertyName("moneyLoad")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public bool? MoneyLoad { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessingInfoAuthorizationOptions {\n");
            if (AuthType != null) sb.Append("  AuthType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "authType", AuthType.ToString())).Append("\n");
            if (PanReturnIndicator != null) sb.Append("  PanReturnIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "panReturnIndicator", PanReturnIndicator.ToString())).Append("\n");
            if (VerbalAuthCode != null) sb.Append("  VerbalAuthCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "verbalAuthCode", VerbalAuthCode.ToString())).Append("\n");
            if (VerbalAuthTransactionId != null) sb.Append("  VerbalAuthTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "verbalAuthTransactionId", VerbalAuthTransactionId.ToString())).Append("\n");
            if (AuthIndicator != null) sb.Append("  AuthIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "authIndicator", AuthIndicator.ToString())).Append("\n");
            if (PartialAuthIndicator != null) sb.Append("  PartialAuthIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "partialAuthIndicator", PartialAuthIndicator.ToString())).Append("\n");
            if (ExtendAuthIndicator != null) sb.Append("  ExtendAuthIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "extendAuthIndicator", ExtendAuthIndicator.ToString())).Append("\n");
            ...
            if (BillPaymentType != null) sb.Append("  BillPaymentType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "billPaymentType", BillPaymentType.ToString())).Append("\n");
            if (RedemptionInquiry != null) sb.Append("  RedemptionInquiry: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "redemptionInquiry", RedemptionInquiry.ToString())).Append("\n");
            if (TransportationMode != null) sb.Append("  TransportationMode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "transportationMode", TransportationMode.ToString())).Append("\n");
            if (AggregatedAuthIndicator != null) sb.Append("  AggregatedAuthIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "aggregatedAuthIndicator", AggregatedAuthIndicator.ToString())).Append("\n");
            if (DebtRecoveryIndicator != null) sb.Append("  DebtRecoveryIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "debtRecoveryIndicator", DebtRecoveryIndicator.ToString())).Append("\n");
            if (DeferredAuthIndicator != null) sb.Append("  DeferredAuthIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "deferredAuthIndicator", DeferredAuthIndicator.ToString())).Append("\n");
            if (CashAdvanceIndicator != null) sb.Append("  CashAdvanceIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "cashAdvanceIndicator", CashAdvanceIndicator.ToString())).Append("\n");
            if (SplitPaymentTransaction != null) sb.Append("  SplitPaymentTransaction: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "splitPaymentTransaction", SplitPaymentTransaction.ToString())).Append("\n");
            if (CardVerificationIndicator != null) sb.Append("  CardVerificationIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "cardVerificationIndicator", CardVerificationIndicator.ToString())).Append("\n");
            if (TransactionMode != null) sb.Append("  TransactionMode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "transactionMode", TransactionMode.ToString())).Append("\n");
            if (AftIndicator != null) sb.Append("  AftIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("ProcessingInfoAuthorizationOptions", "aftIndicator", AftIndicator.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProcessingInfoAuthorizationOptions);
        }

        /// <summary>
        /// Returns true if ProcessingInfoAuthorizationOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of ProcessingInfoAuthorizationOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessingInfoAuthorizationOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.BalanceUpdate == other.BalanceUpdate ||
                    this.BalanceUpdate != null &&
                    this.BalanceUpdate.Equals(other.BalanceUpdate)
                ) && 
                (
                    this.MoneyLoad == other.MoneyLoad ||
                    this.MoneyLoad != null &&
                    this.MoneyLoad.Equals(other.MoneyLoad)
                );
        }
