...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions :  IEquatable<TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions>, IValidatableObject
    {
        ...
        [JsonPropertyName("businessNameEnglish")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        public override string ToString()
        {
            ...
            if (PaymentMethod != null) sb.Append("  PaymentMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions", "paymentMethod", PaymentMethod.ToString())).Append("\n");
            if (TerminalId != null) sb.Append("  TerminalId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions", "terminalId", TerminalId.ToString())).Append("\n");
            if (BusinessName != null) sb.Append("  BusinessName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions", "businessName", BusinessName.ToString())).Append("\n");
            if (BusinessNameKatakana != null) sb.Append("  BusinessNameKatakana: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions", "businessNameKatakana", BusinessNameKatakana.ToString())).Append("\n");
            if (BusinessNameEnglish != null) sb.Append("  BusinessNameEnglish: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions", "businessNameEnglish", BusinessNameEnglish.ToString())).Append("\n");
            if (Bonuses != null) sb.Append("  Bonuses: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions", "bonuses", Bonuses.ToString())).Append("\n");
