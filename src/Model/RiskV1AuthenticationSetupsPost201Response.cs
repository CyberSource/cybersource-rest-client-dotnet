...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1AuthenticationSetupsPost201Response :  IEquatable<RiskV1AuthenticationSetupsPost201Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "status", Status.ToString())).Append("\n");
            if (ConsumerAuthenticationInformation != null) sb.Append("  ConsumerAuthenticationInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "consumerAuthenticationInformation", ConsumerAuthenticationInformation.ToString())).Append("\n");
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ErrorInformation != null) sb.Append("  ErrorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1AuthenticationSetupsPost201Response", "errorInformation", ErrorInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskV1AuthenticationSetupsPost201Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
