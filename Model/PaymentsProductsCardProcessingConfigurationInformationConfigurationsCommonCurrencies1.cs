...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1 :  IEquatable<PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1" /> class.
        /// </summary>
        ...
        public PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1(bool? Enabled = default(bool?), bool? EnabledCardPresent = default(bool?), bool? EnabledCardNotPresent = default(bool?), List<string> TerminalIds = default(List<string>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1);
        }

        /// <summary>
        /// Returns true if PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1 instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
