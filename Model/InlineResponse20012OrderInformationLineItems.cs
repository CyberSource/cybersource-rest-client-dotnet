...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012OrderInformationLineItems :  IEquatable<InlineResponse20012OrderInformationLineItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012OrderInformationLineItems" /> class.
        /// </summary>
        ...
        public InlineResponse20012OrderInformationLineItems(string ProductCode = default(string), string ProductName = default(string), string ProductSku = default(string), string TaxAmount = default(string), decimal? Quantity = default(decimal?), string UnitPrice = default(string), string FulfillmentType = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012OrderInformationLineItems);
        }

        /// <summary>
        /// Returns true if InlineResponse20012OrderInformationLineItems instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012OrderInformationLineItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012OrderInformationLineItems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
