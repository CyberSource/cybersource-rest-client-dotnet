...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2014KeyInformation :  IEquatable<InlineResponse2014KeyInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2014KeyInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2014KeyInformation(string Provider = default(string), string Tenant = default(string), string OrganizationId = default(string), string ClientKeyId = default(string), string KeyId = default(string), string Key = default(string), string KeyType = default(string), string Status = default(string), string ExpirationDate = default(string), string Message = default(string), InlineResponse2014KeyInformationErrorInformation ErrorInformation = default(InlineResponse2014KeyInformationErrorInformation))
        {
        ...
        public InlineResponse2014KeyInformationErrorInformation ErrorInformation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2014KeyInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2014KeyInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2014KeyInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2014KeyInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
