...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2011OrganizationInformation :  IEquatable<InlineResponse2011OrganizationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2011OrganizationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2011OrganizationInformation(string OrganizationId = default(string), string ParentOrganizationId = default(string), List<string> ChildOrganizations = default(List<string>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2011OrganizationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2011OrganizationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2011OrganizationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2011OrganizationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
