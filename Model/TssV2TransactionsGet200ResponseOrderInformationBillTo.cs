...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseOrderInformationBillTo :  IEquatable<TssV2TransactionsGet200ResponseOrderInformationBillTo>, IValidatableObject
    {
        ...
        public TssV2TransactionsGet200ResponseOrderInformationBillTo(string FirstName = default(string), string LastName = default(string), string MiddelName = default(string), string NameSuffix = default(string), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string Company = default(string), string Email = default(string), string Country = default(string), string Title = default(string), string PhoneNumber = default(string))
        {
