...
namespace CybsQaScript.Payments.Authorize_Payment.Digital_Payments.SamSung_Pay
{
    public class SamsungPayRetailRetailEmvContactless
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "SamsungPayRetailRetailEmvContactless";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/DigitalPayments/SamsungPay/CreateSamsungPayRetailEMVcontactless.csv"), true))
            {
