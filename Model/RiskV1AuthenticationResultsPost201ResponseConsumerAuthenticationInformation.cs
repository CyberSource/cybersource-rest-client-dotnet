...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1AuthenticationResultsPost201ResponseConsumerAuthenticationInformation :  IEquatable<RiskV1AuthenticationResultsPost201ResponseConsumerAuthenticationInformation>, IValidatableObject
    {
        ...
        public RiskV1AuthenticationResultsPost201ResponseConsumerAuthenticationInformation(string AcsRenderingType = default(string), string AcsTransactionId = default(string), string AuthenticationResult = default(string), string AuthenticationStatusMsg = default(string), string AuthorizationPayload = default(string), string Cavv = default(string), string CavvAlgorithm = default(string), string DirectoryServerErrorCode = default(string), string DirectoryServerErrorDescription = default(string), string Indicator = default(string), string InteractionCounter = default(string), string Eci = default(string), string EciRaw = default(string), string ParesStatus = default(string), string SdkTransactionId = default(string), string SpecificationVersion = default(string), string ThreeDSServerTransactionId = default(string), string UcafAuthenticationData = default(string), decimal? UcafCollectionIndicator = default(decimal?), string WhiteListStatus = default(string), string WhiteListStatusSource = default(string), string Xid = default(string))
        {
