...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2012OrganizationInformation :  IEquatable<InlineResponse2012OrganizationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2012OrganizationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2012OrganizationInformation(string OrganizationId = default(string), string ParentOrganizationId = default(string), List<string> ChildOrganizations = default(List<string>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2012OrganizationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2012OrganizationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2012OrganizationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2012OrganizationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
