...
namespace CybsQaScript.Reporting.CoreServices
{
    ...
    {
        public static void GetRepResoInfoExec()
        {
            // Initialize Api Name
            var apiFunctionName = "GetReportingResourceInformation";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Reporting/CoreServices/GetReportingResourceInformation.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.GetResourceV2Info(organizationId);
                        ...
                        catch (Exception e)
                        {
                            ...
                            resultMessage = e.GetType().GetProperty("ErrorContent").GetValue(e).ToString();
                        }
                        finally
                        {
