...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse4008Details :  IEquatable<InlineResponse4008Details>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4008Details" /> class.
        /// </summary>
        ...
        public InlineResponse4008Details(string Field = default(string), string Reason = default(string), string Code = default(string))
        {
            this.Field = Field;
            this.Reason = Reason;
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse4008Details);
        }

        /// <summary>
        /// Returns true if InlineResponse4008Details instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse4008Details to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4008Details other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
