...
namespace CyberSource.Model
{
    ...
    public partial class DeAssociationRequestBody :  IEquatable<DeAssociationRequestBody>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (DeviceId != null) sb.Append("  DeviceId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DeAssociationRequestBody", "deviceId", DeviceId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DeAssociationRequestBody", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
