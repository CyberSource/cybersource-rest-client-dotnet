...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RefundCaptureRequest :  IEquatable<RefundCaptureRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public Ptsv2paymentsidrefundsClientReferenceInformation ClientReferenceInformation { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2paymentsidrefundsTravelInformation TravelInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "orderInformation", OrderInformation.ToString())).Append("\n");
            if (BuyerInformation != null) sb.Append("  BuyerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "buyerInformation", BuyerInformation.ToString())).Append("\n");
            if (DeviceInformation != null) sb.Append("  DeviceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "deviceInformation", DeviceInformation.ToString())).Append("\n");
            if (MerchantInformation != null) sb.Append("  MerchantInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "merchantInformation", MerchantInformation.ToString())).Append("\n");
            if (AggregatorInformation != null) sb.Append("  AggregatorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "aggregatorInformation", AggregatorInformation.ToString())).Append("\n");
            if (PointOfSaleInformation != null) sb.Append("  PointOfSaleInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "pointOfSaleInformation", PointOfSaleInformation.ToString())).Append("\n");
            if (MerchantDefinedInformation != null) sb.Append("  MerchantDefinedInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "merchantDefinedInformation", MerchantDefinedInformation.ToString())).Append("\n");
            if (TravelInformation != null) sb.Append("  TravelInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "travelInformation", TravelInformation.ToString())).Append("\n");
            if (PromotionInformation != null) sb.Append("  PromotionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "promotionInformation", PromotionInformation.ToString())).Append("\n");
            if (ProcessorInformation != null) sb.Append("  ProcessorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RefundCaptureRequest", "processorInformation", ProcessorInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RefundCaptureRequest", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RefundCaptureRequest);
        }

        /// <summary>
        /// Returns true if RefundCaptureRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of RefundCaptureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundCaptureRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
