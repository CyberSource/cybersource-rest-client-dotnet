...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2payoutsOrderInformationAmountDetailsSurcharge :  IEquatable<Ptsv2payoutsOrderInformationAmountDetailsSurcharge>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2payoutsOrderInformationAmountDetailsSurcharge" /> class.
        /// </summary>
        ...
        public Ptsv2payoutsOrderInformationAmountDetailsSurcharge(string Amount = default(string))
        {
            this.Amount = Amount;
        }
        ...
        public override string ToString()
        {
            ...
            if (Amount != null) sb.Append("  Amount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2payoutsOrderInformationAmountDetailsSurcharge", "amount", Amount.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2payoutsOrderInformationAmountDetailsSurcharge", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2payoutsOrderInformationAmountDetailsSurcharge);
        }

        /// <summary>
        /// Returns true if Ptsv2payoutsOrderInformationAmountDetailsSurcharge instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2payoutsOrderInformationAmountDetailsSurcharge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2payoutsOrderInformationAmountDetailsSurcharge other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
