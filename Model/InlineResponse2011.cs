...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2011 :  IEquatable<InlineResponse2011>, IValidatableObject
    {
        ...
        public InlineResponse2011(InlineResponse2011Links Links = default(InlineResponse2011Links), string Id = default(string), string SubmitTimeUtc = default(string), string Status = default(string), InlineResponse2011SubscriptionInformation SubscriptionInformation = default(InlineResponse2011SubscriptionInformation))
        {
            this.Links = Links;
            this.Id = Id;
