...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPaymentInformationTokenizedCard :  IEquatable<Ptsv2paymentsPaymentInformationTokenizedCard>, IValidatableObject
    {
        ...
        /// <param name="SecurityCode">Card Verification Number (CVN).  #### Ingenico ePayments Do not include this field when **commerceIndicator&#x3D;recurring**. **Note** Ingenico ePayments was previously called _Global Collect_. .</param>
        ...
        public override string ToString()
        {
            ...
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "number", Number.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "type", Type.ToString())).Append("\n");
            if (Cryptogram != null) sb.Append("  Cryptogram: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "cryptogram", Cryptogram.ToString())).Append("\n");
            if (RequestorId != null) sb.Append("  RequestorId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "requestorId", RequestorId.ToString())).Append("\n");
            if (TransactionType != null) sb.Append("  TransactionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "transactionType", TransactionType.ToString())).Append("\n");
            if (AssuranceLevel != null) sb.Append("  AssuranceLevel: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "assuranceLevel", AssuranceLevel.ToString())).Append("\n");
            if (StorageMethod != null) sb.Append("  StorageMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "storageMethod", StorageMethod.ToString())).Append("\n");
            if (SecurityCode != null) sb.Append("  SecurityCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "securityCode", SecurityCode.ToString())).Append("\n");
            if (SecurityCodeIndicator != null) sb.Append("  SecurityCodeIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "securityCodeIndicator", SecurityCodeIndicator.ToString())).Append("\n");
            if (AssuranceMethod != null) sb.Append("  AssuranceMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPaymentInformationTokenizedCard", "assuranceMethod", AssuranceMethod.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsPaymentInformationTokenizedCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
