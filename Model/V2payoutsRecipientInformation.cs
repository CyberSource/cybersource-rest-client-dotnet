...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsRecipientInformation :  IEquatable<V2payoutsRecipientInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsRecipientInformation" /> class.
        /// </summary>
        ...
        public V2payoutsRecipientInformation(string FirstName = default(string), string MiddleInitial = default(string), string LastName = default(string), string Address1 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string Country = default(string), string PostalCode = default(string), string PhoneNumber = default(string), string DateOfBirth = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2payoutsRecipientInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsRecipientInformation);
        }

        /// <summary>
        /// Returns true if V2payoutsRecipientInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsRecipientInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsRecipientInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
