...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsProcessingInformationAuthorizationOptionsInitiator :  IEquatable<V2paymentsProcessingInformationAuthorizationOptionsInitiator>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsProcessingInformationAuthorizationOptionsInitiator" /> class.
        /// </summary>
        ...
        public V2paymentsProcessingInformationAuthorizationOptionsInitiator(TypeEnum? Type = default(TypeEnum?), bool? CredentialStoredOnFile = default(bool?), bool? StoredCredentialUsed = default(bool?), V2paymentsProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction MerchantInitiatedTransaction = default(V2paymentsProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction))
        {
            this.Type = Type;
        ...
        public V2paymentsProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction MerchantInitiatedTransaction { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsProcessingInformationAuthorizationOptionsInitiator);
        }

        /// <summary>
        /// Returns true if V2paymentsProcessingInformationAuthorizationOptionsInitiator instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsProcessingInformationAuthorizationOptionsInitiator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsProcessingInformationAuthorizationOptionsInitiator other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
