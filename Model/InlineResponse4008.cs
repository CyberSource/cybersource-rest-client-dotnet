...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4008 :  IEquatable<InlineResponse4008>, IValidatableObject
    {
        ...
        public InlineResponse4008(string Type = default(string), string Message = default(string), Tmsv1instrumentidentifiersDetails Details = default(Tmsv1instrumentidentifiersDetails))
        {
            this.Type = Type;
