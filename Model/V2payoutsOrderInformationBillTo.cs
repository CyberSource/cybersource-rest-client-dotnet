...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsOrderInformationBillTo :  IEquatable<V2payoutsOrderInformationBillTo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsOrderInformationBillTo" /> class.
        /// </summary>
        ...
        public V2payoutsOrderInformationBillTo(string FirstName = default(string), string LastName = default(string), string Address1 = default(string), string Address2 = default(string), string Country = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string PhoneNumber = default(string), PhoneTypeEnum? PhoneType = default(PhoneTypeEnum?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsOrderInformationBillTo);
        }

        /// <summary>
        /// Returns true if V2payoutsOrderInformationBillTo instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsOrderInformationBillTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsOrderInformationBillTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
