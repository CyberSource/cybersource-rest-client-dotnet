...
namespace CyberSource.Model
{
    ...
    public partial class TmsBinLookupPaymentAccountInformationCard :  IEquatable<TmsBinLookupPaymentAccountInformationCard>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBinLookupPaymentAccountInformationCard", "type", Type.ToString())).Append("\n");
            if (BrandName != null) sb.Append("  BrandName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBinLookupPaymentAccountInformationCard", "brandName", BrandName.ToString())).Append("\n");
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBinLookupPaymentAccountInformationCard", "currency", Currency.ToString())).Append("\n");
            if (MaxLength != null) sb.Append("  MaxLength: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBinLookupPaymentAccountInformationCard", "maxLength", MaxLength.ToString())).Append("\n");
            if (CredentialType != null) sb.Append("  CredentialType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBinLookupPaymentAccountInformationCard", "credentialType", CredentialType.ToString())).Append("\n");
            if (Brands != null) sb.Append("  Brands: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBinLookupPaymentAccountInformationCard", "brands", Brands.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TmsBinLookupPaymentAccountInformationCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
