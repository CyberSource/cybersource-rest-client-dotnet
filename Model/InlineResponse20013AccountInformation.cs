...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20013AccountInformation :  IEquatable<InlineResponse20013AccountInformation>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013AccountInformation" /> class.
        /// </summary>
        ...
        public InlineResponse20013AccountInformation(string UserName = default(string), string RoleId = default(string), List<string> Permissions = default(List<string>), StatusEnum? Status = default(StatusEnum?), DateTime? CreatedTime = default(DateTime?), DateTime? LastAccessTime = default(DateTime?), string LanguagePreference = default(string), string Timezone = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20013AccountInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse20013AccountInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20013AccountInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013AccountInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
