...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesOrderInformationShipTo :  IEquatable<V2paymentsidcapturesOrderInformationShipTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesOrderInformationShipTo" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesOrderInformationShipTo(string AdministrativeArea = default(string), string Country = default(string), string PostalCode = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesOrderInformationShipTo);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesOrderInformationShipTo instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesOrderInformationShipTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesOrderInformationShipTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
