...
{
    public class AuthorizeApplePayCyberSourceDecryption
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizeApplePayCyberSourceDecryption";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/DigitalPayments/ApplePay/CreateAuthorizeApplePayCybersourceDecryption.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var emvObj = new Ptsv2paymentsPointOfSaleInformationEmv
                            {
