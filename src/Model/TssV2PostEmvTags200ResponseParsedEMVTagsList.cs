...
namespace CyberSource.Model
{
    ...
    public partial class TssV2PostEmvTags200ResponseParsedEMVTagsList :  IEquatable<TssV2PostEmvTags200ResponseParsedEMVTagsList>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (RequestId != null) sb.Append("  RequestId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2PostEmvTags200ResponseParsedEMVTagsList", "requestId", RequestId.ToString())).Append("\n");
            if (TotalTags != null) sb.Append("  TotalTags: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2PostEmvTags200ResponseParsedEMVTagsList", "totalTags", TotalTags.ToString())).Append("\n");
            if (EmvTagBreakdownList != null) sb.Append("  EmvTagBreakdownList: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2PostEmvTags200ResponseParsedEMVTagsList", "emvTagBreakdownList", EmvTagBreakdownList.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2PostEmvTags200ResponseParsedEMVTagsList", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
