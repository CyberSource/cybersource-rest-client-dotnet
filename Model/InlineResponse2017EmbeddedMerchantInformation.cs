...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2017EmbeddedMerchantInformation :  IEquatable<InlineResponse2017EmbeddedMerchantInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2017EmbeddedMerchantInformation" /> class.
        /// </summary>
        /// <param name="ResellerId">An unique identification number assigned by CyberSource to identify the submitted request..</param>
        public InlineResponse2017EmbeddedMerchantInformation(string ResellerId = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2017EmbeddedMerchantInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2017EmbeddedMerchantInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2017EmbeddedMerchantInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2017EmbeddedMerchantInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
