...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(InlineResponse20010Links Links = default(InlineResponse20010Links), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchSource = default(string), string MerchantReference = default(string), string BatchCaEndpoints = default(string), string Status = default(string), InlineResponse2009EmbeddedTotals Totals = default(InlineResponse2009EmbeddedTotals), InlineResponse20010Billing Billing = default(InlineResponse20010Billing), string Description = default(string))
        {
            this.Links = Links;
        ...
        public InlineResponse20010Links Links { get; set; }
