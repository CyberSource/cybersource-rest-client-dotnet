...
namespace CyberSource.Model
{
    ...
    public partial class Accountupdaterv1batchesIncluded :  IEquatable<Accountupdaterv1batchesIncluded>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Tokens != null) sb.Append("  Tokens: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Accountupdaterv1batchesIncluded", "tokens", Tokens.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Accountupdaterv1batchesIncluded", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
