...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner :  IEquatable<TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            if (SolutionId != null) sb.Append("  SolutionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner", "solutionId", SolutionId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        /// </summary>
        /// <param name="other">Instance of TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner to be compared</param>
        /// <returns>Boolean</returns>
