...
namespace CyberSource.Model
{
    ...
    public partial class CreateAccessTokenRequest : IEquatable<CreateAccessTokenRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("code", Code)).Append("\n");
            sb.Append("  ClientId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("client_id", ClientId)).Append("\n");
            sb.Append("  ClientSecret: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("client_secret", ClientSecret)).Append("\n");
            sb.Append("  RefreshToken: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("refresh_token", RefreshToken)).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson(JsonConvert.SerializeObject(this, Formatting.Indented));
        }
