...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsOrderInformationLineItems :  IEquatable<Ptsv2paymentsOrderInformationLineItems>, IValidatableObject
    {
        ...
        /// <param name="TaxTypeCode">Type of tax being applied to the item.  #### FDC Nashville Global - &#x60;alternate_tax_type_applied&#x60; - &#x60;alternate_tax_type_identifier&#x60;  #### Worldpay VAP - &#x60;alternate_tax_type_identifier&#x60;  #### RBS WorldPay Atlanta - &#x60;tax_type_applied&#x60;  #### TSYS Acquiring Solutions - &#x60;tax_type_applied&#x60; - &#x60;local_tax_indicator&#x60;  #### Chase Paymentech Solutions - &#x60;tax_type_applied&#x60;  #### Elavon Americas - &#x60;local_tax_indicator&#x60;  #### FDC Compass - &#x60;tax_type_applied&#x60;  #### OmniPay Direct - &#x60;local_tax_indicator&#x60; .</param>
        ...
        /// <param name="WeightIdentifier">Type of weight.  Possible values: - B: Billed weight - N: Actual net weight .</param>
        /// <param name="WeightUnit">Code that specifies the unit of measurement for the weight amount. For example, &#x60;OZ&#x60; specifies ounce and &#x60;LB&#x60; specifies pound. The possible values are defined by the ANSI Accredited Standards Committee (ASC). .</param>
        ...
        /// <param name="Measurement">This field would contain measurement of a line item. .</param>
        ...
        public Ptsv2paymentsOrderInformationLineItems(string ProductCode = default(string), string ProductName = default(string), string ProductSku = default(string), int? Quantity = default(int?), string UnitPrice = default(string), string UnitOfMeasure = default(string), string TotalAmount = default(string), string TaxAmount = default(string), string TaxRate = default(string), string TaxAppliedAfterDiscount = default(string), string TaxStatusIndicator = default(string), string TaxTypeCode = default(string), bool? AmountIncludesTax = default(bool?), string TypeOfSupply = default(string), string CommodityCode = default(string), string DiscountAmount = default(string), bool? DiscountApplied = default(bool?), string DiscountRate = default(string), string InvoiceNumber = default(string), List<Ptsv2paymentsOrderInformationAmountDetailsTaxDetails> TaxDetails = default(List<Ptsv2paymentsOrderInformationAmountDetailsTaxDetails>), string FulfillmentType = default(string), string Weight = default(string), string WeightIdentifier = default(string), string WeightUnit = default(string), string ReferenceDataCode = default(string), string ReferenceDataNumber = default(string), string UnitTaxAmount = default(string), string Measurement = default(string), string ProductDescription = default(string), int? GiftCardCurrency = default(int?), string ShippingDestinationTypes = default(string), bool? Gift = default(bool?), Ptsv2paymentsOrderInformationPassenger Passenger = default(Ptsv2paymentsOrderInformationPassenger), List<string> AllowedExportCountries = default(List<string>), List<string> RestrictedExportCountries = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Type of tax being applied to the item.  #### FDC Nashville Global - &#x60;alternate_tax_type_applied&#x60; - &#x60;alternate_tax_type_identifier&#x60;  #### Worldpay VAP - &#x60;alternate_tax_type_identifier&#x60;  #### RBS WorldPay Atlanta - &#x60;tax_type_applied&#x60;  #### TSYS Acquiring Solutions - &#x60;tax_type_applied&#x60; - &#x60;local_tax_indicator&#x60;  #### Chase Paymentech Solutions - &#x60;tax_type_applied&#x60;  #### Elavon Americas - &#x60;local_tax_indicator&#x60;  #### FDC Compass - &#x60;tax_type_applied&#x60;  #### OmniPay Direct - &#x60;local_tax_indicator&#x60; </value>
        ...
        /// Weight of the item. 
        /// </summary>
        /// <value>Weight of the item. </value>
        ...
        /// </summary>
        /// <value>Type of weight.  Possible values: - B: Billed weight - N: Actual net weight </value>
        ...
        /// </summary>
        /// <value>Code that specifies the unit of measurement for the weight amount. For example, &#x60;OZ&#x60; specifies ounce and &#x60;LB&#x60; specifies pound. The possible values are defined by the ANSI Accredited Standards Committee (ASC). </value>
        ...
        /// </summary>
        /// <value>Code that identifies the value of the corresponding &#x60;orderInformation.lineItems[].referenceDataNumber&#x60; field.  Possible values: - AN: Client-defined asset code - MG: Manufacturer&#39;s part number - PO: Purchase order number - SK: Supplier stock keeping unit number - UP: Universal product code - VC: Supplier catalog number - VP: Vendor part number  This field is a pass-through, which means that CyberSource does not verify the value or modify it in any way before sending it to the processor. </value>
        ...
        /// </summary>
        /// <value>This field would contain measurement of a line item. </value>
        ...
        public override string ToString()
        {
            ...
            if (ProductCode != null) sb.Append("  ProductCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "productCode", ProductCode.ToString())).Append("\n");
            if (ProductName != null) sb.Append("  ProductName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "productName", ProductName.ToString())).Append("\n");
            if (ProductSku != null) sb.Append("  ProductSku: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "productSku", ProductSku.ToString())).Append("\n");
            if (Quantity != null) sb.Append("  Quantity: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "quantity", Quantity.ToString())).Append("\n");
            if (UnitPrice != null) sb.Append("  UnitPrice: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "unitPrice", UnitPrice.ToString())).Append("\n");
            if (UnitOfMeasure != null) sb.Append("  UnitOfMeasure: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "unitOfMeasure", UnitOfMeasure.ToString())).Append("\n");
            if (TotalAmount != null) sb.Append("  TotalAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "totalAmount", TotalAmount.ToString())).Append("\n");
            if (TaxAmount != null) sb.Append("  TaxAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "taxAmount", TaxAmount.ToString())).Append("\n");
            if (TaxRate != null) sb.Append("  TaxRate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "taxRate", TaxRate.ToString())).Append("\n");
            if (TaxAppliedAfterDiscount != null) sb.Append("  TaxAppliedAfterDiscount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "taxAppliedAfterDiscount", TaxAppliedAfterDiscount.ToString())).Append("\n");
            if (TaxStatusIndicator != null) sb.Append("  TaxStatusIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "taxStatusIndicator", TaxStatusIndicator.ToString())).Append("\n");
            if (TaxTypeCode != null) sb.Append("  TaxTypeCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "taxTypeCode", TaxTypeCode.ToString())).Append("\n");
            if (AmountIncludesTax != null) sb.Append("  AmountIncludesTax: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "amountIncludesTax", AmountIncludesTax.ToString())).Append("\n");
            if (TypeOfSupply != null) sb.Append("  TypeOfSupply: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "typeOfSupply", TypeOfSupply.ToString())).Append("\n");
            if (CommodityCode != null) sb.Append("  CommodityCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "commodityCode", CommodityCode.ToString())).Append("\n");
            if (DiscountAmount != null) sb.Append("  DiscountAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "discountAmount", DiscountAmount.ToString())).Append("\n");
            if (DiscountApplied != null) sb.Append("  DiscountApplied: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "discountApplied", DiscountApplied.ToString())).Append("\n");
            if (DiscountRate != null) sb.Append("  DiscountRate: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "discountRate", DiscountRate.ToString())).Append("\n");
            if (InvoiceNumber != null) sb.Append("  InvoiceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "invoiceNumber", InvoiceNumber.ToString())).Append("\n");
            if (TaxDetails != null) sb.Append("  TaxDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "taxDetails", TaxDetails.ToString())).Append("\n");
            if (FulfillmentType != null) sb.Append("  FulfillmentType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "fulfillmentType", FulfillmentType.ToString())).Append("\n");
            if (Weight != null) sb.Append("  Weight: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "weight", Weight.ToString())).Append("\n");
            if (WeightIdentifier != null) sb.Append("  WeightIdentifier: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "weightIdentifier", WeightIdentifier.ToString())).Append("\n");
            if (WeightUnit != null) sb.Append("  WeightUnit: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "weightUnit", WeightUnit.ToString())).Append("\n");
            if (ReferenceDataCode != null) sb.Append("  ReferenceDataCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "referenceDataCode", ReferenceDataCode.ToString())).Append("\n");
            if (ReferenceDataNumber != null) sb.Append("  ReferenceDataNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "referenceDataNumber", ReferenceDataNumber.ToString())).Append("\n");
            if (UnitTaxAmount != null) sb.Append("  UnitTaxAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "unitTaxAmount", UnitTaxAmount.ToString())).Append("\n");
            if (Measurement != null) sb.Append("  Measurement: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "measurement", Measurement.ToString())).Append("\n");
            if (ProductDescription != null) sb.Append("  ProductDescription: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "productDescription", ProductDescription.ToString())).Append("\n");
            if (GiftCardCurrency != null) sb.Append("  GiftCardCurrency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "giftCardCurrency", GiftCardCurrency.ToString())).Append("\n");
            if (ShippingDestinationTypes != null) sb.Append("  ShippingDestinationTypes: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "shippingDestinationTypes", ShippingDestinationTypes.ToString())).Append("\n");
            if (Gift != null) sb.Append("  Gift: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "gift", Gift.ToString())).Append("\n");
            if (Passenger != null) sb.Append("  Passenger: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "passenger", Passenger.ToString())).Append("\n");
            if (AllowedExportCountries != null) sb.Append("  AllowedExportCountries: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "allowedExportCountries", AllowedExportCountries.ToString())).Append("\n");
            if (RestrictedExportCountries != null) sb.Append("  RestrictedExportCountries: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationLineItems", "restrictedExportCountries", RestrictedExportCountries.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsOrderInformationLineItems", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Measurement != null)
                    hash = hash * 59 + this.Measurement.GetHashCode();
