...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2008EmbeddedBatches :  IEquatable<InlineResponse2008EmbeddedBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008EmbeddedBatches" /> class.
        /// </summary>
        ...
        public InlineResponse2008EmbeddedBatches(InlineResponse2008EmbeddedLinks Links = default(InlineResponse2008EmbeddedLinks), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchModifiedDate = default(string), string BatchSource = default(string), string TokenSource = default(string), string MerchantReference = default(string), List<string> BatchCaEndpoints = default(List<string>), string Status = default(string), InlineResponse2008EmbeddedTotals Totals = default(InlineResponse2008EmbeddedTotals))
        {
            this.Links = Links;
        ...
        public InlineResponse2008EmbeddedLinks Links { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2008EmbeddedBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse2008EmbeddedBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2008EmbeddedBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008EmbeddedBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
