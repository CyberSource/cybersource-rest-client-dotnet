...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsCapturesPost201ResponseEmbeddedActionsApCapture :  IEquatable<PtsV2PaymentsCapturesPost201ResponseEmbeddedActionsApCapture>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Reason != null) sb.Append("  Reason: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseEmbeddedActionsApCapture", "reason", Reason.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsCapturesPost201ResponseEmbeddedActionsApCapture", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
