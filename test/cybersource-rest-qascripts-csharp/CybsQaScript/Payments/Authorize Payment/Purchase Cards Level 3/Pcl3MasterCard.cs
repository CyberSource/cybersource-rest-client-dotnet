...
namespace CybsQaScript.Payments.Authorize_Payment.Purchase_Cards_Level_3
{
    public class Pcl3MasterCard
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "PurchaseLevel3Mastercard";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/PurchaseCardsLevel3/CreateMasterCard.csv"), true))
            {
