...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsECheckConfigurationInformationConfigurationsCommon :  IEquatable<PaymentsProductsECheckConfigurationInformationConfigurationsCommon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsECheckConfigurationInformationConfigurationsCommon" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentsProductsECheckConfigurationInformationConfigurationsCommon() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsECheckConfigurationInformationConfigurationsCommon" /> class.
        /// </summary>
        ...
        public PaymentsProductsECheckConfigurationInformationConfigurationsCommon(Dictionary<string, PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors> Processors = default(Dictionary<string, PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors>), PaymentsProductsECheckConfigurationInformationConfigurationsCommonInternalOnly InternalOnly = default(PaymentsProductsECheckConfigurationInformationConfigurationsCommonInternalOnly), string AccountHolderName = default(string), string AccountType = default(string), string AccountRoutingNumber = default(string), string AccountNumber = default(string))
        {
            ...
            if (AccountType == null)
            {
                throw new InvalidDataException("AccountType is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsCommon and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AccountRoutingNumber is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsCommon and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AccountNumber is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsCommon and cannot be null");
            }
            else
            {
        ...
        public Dictionary<string, PaymentsProductsECheckConfigurationInformationConfigurationsCommonProcessors> Processors { get; set; }

        /// <summary>
        /// Gets or Sets InternalOnly
        /// </summary>
        [DataMember(Name="internalOnly", EmitDefaultValue=false)]
        public PaymentsProductsECheckConfigurationInformationConfigurationsCommonInternalOnly InternalOnly { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsECheckConfigurationInformationConfigurationsCommon);
        }

        /// <summary>
        /// Returns true if PaymentsProductsECheckConfigurationInformationConfigurationsCommon instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsECheckConfigurationInformationConfigurationsCommon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsECheckConfigurationInformationConfigurationsCommon other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
