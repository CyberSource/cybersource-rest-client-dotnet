...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsAggregatorInformationSubMerchant :  IEquatable<V2paymentsAggregatorInformationSubMerchant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsAggregatorInformationSubMerchant" /> class.
        /// </summary>
        ...
        /// <param name="Region">Sub-merchantâ€™s region. Example &#x60;NE&#x60; indicates that the sub-merchant is in the northeast region..</param>
        ...
        public V2paymentsAggregatorInformationSubMerchant(string CardAcceptorId = default(string), string Name = default(string), string Address1 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string Region = default(string), string PostalCode = default(string), string Country = default(string), string Email = default(string), string PhoneNumber = default(string))
        {
        ...
        /// </summary>
        /// <value>Sub-merchantâ€™s region. Example &#x60;NE&#x60; indicates that the sub-merchant is in the northeast region.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsAggregatorInformationSubMerchant {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsAggregatorInformationSubMerchant);
        }

        /// <summary>
        /// Returns true if V2paymentsAggregatorInformationSubMerchant instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsAggregatorInformationSubMerchant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsAggregatorInformationSubMerchant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
