...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1UpdatePost201Response :  IEquatable<RiskV1UpdatePost201Response>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonPropertyName("clientReferenceInformaton")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1UpdatePost201Response", "_links", Links.ToString())).Append("\n");
            if (ClientReferenceInformaton != null) sb.Append("  ClientReferenceInformaton: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1UpdatePost201Response", "clientReferenceInformaton", ClientReferenceInformaton.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1UpdatePost201Response", "id", Id.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1UpdatePost201Response", "status", Status.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("RiskV1UpdatePost201Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("RiskV1UpdatePost201Response", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
