...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsCapturesPost201ResponsePointOfSaleInformation :  IEquatable<PtsV2PaymentsCapturesPost201ResponsePointOfSaleInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TerminalId != null) sb.Append("  TerminalId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponsePointOfSaleInformation", "terminalId", TerminalId.ToString())).Append("\n");
            if (EncryptedKeyId != null) sb.Append("  EncryptedKeyId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponsePointOfSaleInformation", "encryptedKeyId", EncryptedKeyId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsCapturesPost201ResponsePointOfSaleInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
