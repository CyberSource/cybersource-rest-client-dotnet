...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsTravelInformationLegs :  IEquatable<Riskv1authenticationsTravelInformationLegs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsTravelInformationLegs" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsTravelInformationLegs(string Origination = default(string), string Destination = default(string), string CarrierCode = default(string), string DepartureDate = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsTravelInformationLegs);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsTravelInformationLegs instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsTravelInformationLegs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsTravelInformationLegs other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
