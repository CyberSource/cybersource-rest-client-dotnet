...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Paymentsflexv1tokensCardInfo :  IEquatable<Paymentsflexv1tokensCardInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Paymentsflexv1tokensCardInfo" /> class.
        /// </summary>
        ...
        public Paymentsflexv1tokensCardInfo(string CardNumber = default(string), string CardExpirationMonth = default(string), string CardExpirationYear = default(string), string CardType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Paymentsflexv1tokensCardInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Paymentsflexv1tokensCardInfo);
        }

        /// <summary>
        /// Returns true if Paymentsflexv1tokensCardInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of Paymentsflexv1tokensCardInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Paymentsflexv1tokensCardInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
