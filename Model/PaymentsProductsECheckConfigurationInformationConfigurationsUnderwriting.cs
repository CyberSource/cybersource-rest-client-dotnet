...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting :  IEquatable<PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting" /> class.
        /// </summary>
        ...
        public PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting(string StandardEntryClassCodes = "CCD,PPD,TEL,WEB", bool? EnableHold = true, decimal? MonthlyTotalTransactionAmountLimit = default(decimal?), decimal? HoldingDays = default(decimal?), bool? EnableCredits = default(bool?), decimal? TransactionAmountLimit = default(decimal?), string RiskReserveMethod = default(string), decimal? RiskReserveRate = default(decimal?), decimal? RiskReserveTargetAmount = default(decimal?), string SolutionOrganizationId = default(string))
        {
            ...
            {
                throw new InvalidDataException("StandardEntryClassCodes is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            if (EnableHold == null)
            {
                throw new InvalidDataException("EnableHold is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("MonthlyTotalTransactionAmountLimit is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            if (HoldingDays == null)
            {
                throw new InvalidDataException("HoldingDays is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionAmountLimit is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RiskReserveMethod is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RiskReserveRate is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RiskReserveTargetAmount is a required property for PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting);
        }

        /// <summary>
        /// Returns true if PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsECheckConfigurationInformationConfigurationsUnderwriting other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
