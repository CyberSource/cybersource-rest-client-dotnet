...
namespace CybsQaScript.Payments.Authorize_Payment.CVN
{
    public class CvnMaestroInternationalCopy
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "CvnMaestroInternationalCopy";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/CVN/CreateMaestroInternationalCopy.csv"), true))
            {
