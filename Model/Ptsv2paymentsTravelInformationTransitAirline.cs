...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsTravelInformationTransitAirline :  IEquatable<Ptsv2paymentsTravelInformationTransitAirline>, IValidatableObject
    {
        ...
        {
            // BookingReferenceNumber (string) maxLength
            if(this.BookingReferenceNumber != null && this.BookingReferenceNumber.Length >= 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for BookingReferenceNumber, length must be less than or equal to 15.", new [] { "BookingReferenceNumber" });
            }

            // CarrierName (string) maxLength
            if(this.CarrierName != null && this.CarrierName.Length >= 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CarrierName, length must be less than or equal to 15.", new [] { "CarrierName" });
            }
            ...
            // CheckDigit (string) maxLength
            if(this.CheckDigit != null && this.CheckDigit.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CheckDigit, length must be less than or equal to 1.", new [] { "CheckDigit" });
            }

            // ExtendedPaymentCode (string) maxLength
            if(this.ExtendedPaymentCode != null && this.ExtendedPaymentCode.Length >= 3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExtendedPaymentCode, length must be less than or equal to 3.", new [] { "ExtendedPaymentCode" });
            }

            // PassengerName (string) maxLength
            if(this.PassengerName != null && this.PassengerName.Length >= 42)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PassengerName, length must be less than or equal to 42.", new [] { "PassengerName" });
            }

            // CustomerCode (string) maxLength
            if(this.CustomerCode != null && this.CustomerCode.Length >= 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CustomerCode, length must be less than or equal to 40.", new [] { "CustomerCode" });
            }

            // DocumentType (string) maxLength
            if(this.DocumentType != null && this.DocumentType.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DocumentType, length must be less than or equal to 1.", new [] { "DocumentType" });
            }

            // DocumentNumber (string) maxLength
            if(this.DocumentNumber != null && this.DocumentNumber.Length >= 14)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DocumentNumber, length must be less than or equal to 14.", new [] { "DocumentNumber" });
            }

            // InvoiceNumber (string) maxLength
            if(this.InvoiceNumber != null && this.InvoiceNumber.Length >= 25)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceNumber, length must be less than or equal to 25.", new [] { "InvoiceNumber" });
            }

            // AdditionalCharges (string) maxLength
            if(this.AdditionalCharges != null && this.AdditionalCharges.Length >= 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AdditionalCharges, length must be less than or equal to 20.", new [] { "AdditionalCharges" });
            }

            // TotalFeeAmount (string) maxLength
            if(this.TotalFeeAmount != null && this.TotalFeeAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TotalFeeAmount, length must be less than or equal to 12.", new [] { "TotalFeeAmount" });
            }

            // ClearingSequence (string) maxLength
            if(this.ClearingSequence != null && this.ClearingSequence.Length >= 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ClearingSequence, length must be less than or equal to 2.", new [] { "ClearingSequence" });
            }

            // ClearingCount (string) maxLength
            if(this.ClearingCount != null && this.ClearingCount.Length >= 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ClearingCount, length must be less than or equal to 2.", new [] { "ClearingCount" });
            }

            // TotalClearingAmount (string) maxLength
            if(this.TotalClearingAmount != null && this.TotalClearingAmount.Length >= 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TotalClearingAmount, length must be less than or equal to 20.", new [] { "TotalClearingAmount" });
            }

            // ReservationSystemCode (string) maxLength
            if(this.ReservationSystemCode != null && this.ReservationSystemCode.Length >= 4)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReservationSystemCode, length must be less than or equal to 4.", new [] { "ReservationSystemCode" });
            }

            // ProcessIdentifier (string) maxLength
            if(this.ProcessIdentifier != null && this.ProcessIdentifier.Length >= 3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProcessIdentifier, length must be less than or equal to 3.", new [] { "ProcessIdentifier" });
            }

            // TicketIssueDate (string) maxLength
            if(this.TicketIssueDate != null && this.TicketIssueDate.Length >= 8)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TicketIssueDate, length must be less than or equal to 8.", new [] { "TicketIssueDate" });
            }

            // OriginalTicketNumber (string) maxLength
            if(this.OriginalTicketNumber != null && this.OriginalTicketNumber.Length >= 14)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OriginalTicketNumber, length must be less than or equal to 14.", new [] { "OriginalTicketNumber" });
            }

            // PurchaseType (string) maxLength
            if(this.PurchaseType != null && this.PurchaseType.Length >= 3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PurchaseType, length must be less than or equal to 3.", new [] { "PurchaseType" });
            }

            // CreditReasonIndicator (string) maxLength
            if(this.CreditReasonIndicator != null && this.CreditReasonIndicator.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CreditReasonIndicator, length must be less than or equal to 1.", new [] { "CreditReasonIndicator" });
            }

            // TicketChangeIndicator (string) maxLength
            if(this.TicketChangeIndicator != null && this.TicketChangeIndicator.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TicketChangeIndicator, length must be less than or equal to 1.", new [] { "TicketChangeIndicator" });
            }

            // PlanNumber (string) maxLength
            if(this.PlanNumber != null && this.PlanNumber.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PlanNumber, length must be less than or equal to 1.", new [] { "PlanNumber" });
            }

            // ArrivalDate (string) maxLength
            if(this.ArrivalDate != null && this.ArrivalDate.Length >= 8)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ArrivalDate, length must be less than or equal to 8.", new [] { "ArrivalDate" });
            }

            // RestrictedTicketDesciption (string) maxLength
            if(this.RestrictedTicketDesciption != null && this.RestrictedTicketDesciption.Length >= 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RestrictedTicketDesciption, length must be less than or equal to 20.", new [] { "RestrictedTicketDesciption" });
            }

            // ExchangeTicketAmount (string) maxLength
            if(this.ExchangeTicketAmount != null && this.ExchangeTicketAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExchangeTicketAmount, length must be less than or equal to 12.", new [] { "ExchangeTicketAmount" });
            }

            // ExchangeTicketFeeAmount (string) maxLength
            if(this.ExchangeTicketFeeAmount != null && this.ExchangeTicketFeeAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExchangeTicketFeeAmount, length must be less than or equal to 12.", new [] { "ExchangeTicketFeeAmount" });
            }

            // ReservationType (string) maxLength
            if(this.ReservationType != null && this.ReservationType.Length >= 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReservationType, length must be less than or equal to 32.", new [] { "ReservationType" });
            }

            // BoardingFeeAmount (string) maxLength
            if(this.BoardingFeeAmount != null && this.BoardingFeeAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for BoardingFeeAmount, length must be less than or equal to 12.", new [] { "BoardingFeeAmount" });
            }
