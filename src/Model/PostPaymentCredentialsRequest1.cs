...
namespace CyberSource.Model
{
    ...
    public partial class PostPaymentCredentialsRequest1 :  IEquatable<PostPaymentCredentialsRequest1>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostPaymentCredentialsRequest1 {\n");
            if (PaymentCredentialType != null) sb.Append("  PaymentCredentialType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PostPaymentCredentialsRequest1", "paymentCredentialType", PaymentCredentialType.ToString())).Append("\n");
            if (TransactionType != null) sb.Append("  TransactionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PostPaymentCredentialsRequest1", "transactionType", TransactionType.ToString())).Append("\n");
            if (ClientCorrelationId != null) sb.Append("  ClientCorrelationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PostPaymentCredentialsRequest1", "clientCorrelationId", ClientCorrelationId.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PostPaymentCredentialsRequest1", "orderInformation", OrderInformation.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PostPaymentCredentialsRequest1);
        }

        /// <summary>
        /// Returns true if PostPaymentCredentialsRequest1 instances are equal
        /// </summary>
        /// <param name="other">Instance of PostPaymentCredentialsRequest1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPaymentCredentialsRequest1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
