...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4007 :  IEquatable<InlineResponse4007>, IValidatableObject
    {
        ...
        public InlineResponse4007(string CorrelationId = default(string), List<InlineResponse4007Details> Details = default(List<InlineResponse4007Details>), string InformationLink = default(string), string Message = default(string), ReasonEnum? Reason = default(ReasonEnum?))
        {
            ...
            if (Reason == null)
            {
                throw new InvalidDataException("Reason is a required property for InlineResponse4007 and cannot be null");
            }
            else
            {
                this.Reason = Reason;
