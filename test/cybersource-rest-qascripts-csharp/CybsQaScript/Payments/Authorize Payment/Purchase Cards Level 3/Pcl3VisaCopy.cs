...
{
    public class Pcl3VisaCopy
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "PurchaseLevel3VisaCopy";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/PurchaseCardsLevel3/CreateVisaCopy.csv"), true))
            {
