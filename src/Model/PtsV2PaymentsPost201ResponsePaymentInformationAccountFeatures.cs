...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures :  IEquatable<PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AccountType != null) sb.Append("  AccountType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "accountType", AccountType.ToString())).Append("\n");
            if (AccountStatus != null) sb.Append("  AccountStatus: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "accountStatus", AccountStatus.ToString())).Append("\n");
            if (Balances != null) sb.Append("  Balances: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "balances", Balances.ToString())).Append("\n");
            if (BalanceAmount != null) sb.Append("  BalanceAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "balanceAmount", BalanceAmount.ToString())).Append("\n");
            if (BalanceAmountType != null) sb.Append("  BalanceAmountType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "balanceAmountType", BalanceAmountType.ToString())).Append("\n");
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "currency", Currency.ToString())).Append("\n");
            if (BalanceSign != null) sb.Append("  BalanceSign: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "balanceSign", BalanceSign.ToString())).Append("\n");
            if (AffluenceIndicator != null) sb.Append("  AffluenceIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "affluenceIndicator", AffluenceIndicator.ToString())).Append("\n");
            if (Category != null) sb.Append("  Category: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "category", Category.ToString())).Append("\n");
            if (Commercial != null) sb.Append("  Commercial: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "commercial", Commercial.ToString())).Append("\n");
            if (Group != null) sb.Append("  Group: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "group", Group.ToString())).Append("\n");
            if (HealthCare != null) sb.Append("  HealthCare: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "healthCare", HealthCare.ToString())).Append("\n");
            if (Payroll != null) sb.Append("  Payroll: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "payroll", Payroll.ToString())).Append("\n");
            if (Level3Eligible != null) sb.Append("  Level3Eligible: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "level3Eligible", Level3Eligible.ToString())).Append("\n");
            if (PinlessDebit != null) sb.Append("  PinlessDebit: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "pinlessDebit", PinlessDebit.ToString())).Append("\n");
            if (SignatureDebit != null) sb.Append("  SignatureDebit: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "signatureDebit", SignatureDebit.ToString())).Append("\n");
            if (Prepaid != null) sb.Append("  Prepaid: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "prepaid", Prepaid.ToString())).Append("\n");
            if (Regulated != null) sb.Append("  Regulated: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "regulated", Regulated.ToString())).Append("\n");
            if (AccountHolderType != null) sb.Append("  AccountHolderType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", "accountHolderType", AccountHolderType.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
