...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationsRiskInformationBuyerHistory :  IEquatable<Riskv1authenticationsRiskInformationBuyerHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationsRiskInformationBuyerHistory" /> class.
        /// </summary>
        ...
        public Riskv1authenticationsRiskInformationBuyerHistory(Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount CustomerAccount = default(Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount), Riskv1authenticationsRiskInformationBuyerHistoryAccountHistory AccountHistory = default(Riskv1authenticationsRiskInformationBuyerHistoryAccountHistory), int? AccountPurchases = default(int?), int? AddCardAttempts = default(int?), bool? PriorSuspiciousActivity = default(bool?), string PaymentAccountHistory = default(string), int? PaymentAccountDate = default(int?), int? TransactionCountDay = default(int?), int? TransactionCountYear = default(int?))
        {
        ...
        public Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount CustomerAccount { get; set; }

        /// <summary>
        /// Gets or Sets AccountHistory
        /// </summary>
        [DataMember(Name="accountHistory", EmitDefaultValue=false)]
        public Riskv1authenticationsRiskInformationBuyerHistoryAccountHistory AccountHistory { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationsRiskInformationBuyerHistory {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationsRiskInformationBuyerHistory);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationsRiskInformationBuyerHistory instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationsRiskInformationBuyerHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationsRiskInformationBuyerHistory other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
