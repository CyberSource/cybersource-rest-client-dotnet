...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2017EmbeddedClientReferenceInformation :  IEquatable<InlineResponse2017EmbeddedClientReferenceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2017EmbeddedClientReferenceInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2017EmbeddedClientReferenceInformation(string Code = default(string), string ApplicationName = default(string), string ApplicationUser = default(string))
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2017EmbeddedClientReferenceInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2017EmbeddedClientReferenceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2017EmbeddedClientReferenceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2017EmbeddedClientReferenceInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
