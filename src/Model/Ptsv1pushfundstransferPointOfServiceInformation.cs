...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv1pushfundstransferPointOfServiceInformation :  IEquatable<Ptsv1pushfundstransferPointOfServiceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Emv != null) sb.Append("  Emv: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv1pushfundstransferPointOfServiceInformation", "emv", Emv.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv1pushfundstransferPointOfServiceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
