...
{
    public class ScPartialBills
    {
        public static void CapturePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "ScPartialBills";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/CapturePayment/SimpleCapture/CreatePartialBills.csv"), true))
            {
