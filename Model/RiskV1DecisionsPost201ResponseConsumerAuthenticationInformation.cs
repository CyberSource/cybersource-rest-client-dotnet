...
namespace CyberSource.Model
{
    ...
    public partial class RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation :  IEquatable<RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IdciDecision: ").Append(IdciDecision).Append("\n");
            sb.Append("  IdciReasonCode1: ").Append(IdciReasonCode1).Append("\n");
            sb.Append("  IdciReasonCode2: ").Append(IdciReasonCode2).Append("\n");
            sb.Append("  IdciScore: ").Append(IdciScore).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
