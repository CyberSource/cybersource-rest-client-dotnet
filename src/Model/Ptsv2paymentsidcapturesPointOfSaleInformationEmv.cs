...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidcapturesPointOfSaleInformationEmv :  IEquatable<Ptsv2paymentsidcapturesPointOfSaleInformationEmv>, IValidatableObject
    {
        ...
        public Ptsv2paymentsidcapturesPointOfSaleInformationEmv(string Tags = default(string), bool? Fallback = default(bool?))
        {
            this.Tags = Tags;
        ...
        public override string ToString()
        {
            ...
            if (Tags != null) sb.Append("  Tags: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesPointOfSaleInformationEmv", "tags", Tags.ToString())).Append("\n");
            if (Fallback != null) sb.Append("  Fallback: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesPointOfSaleInformationEmv", "fallback", Fallback.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidcapturesPointOfSaleInformationEmv", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
