...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseProcessorInformationCardVerification :  IEquatable<PtsV2PaymentsPost201ResponseProcessorInformationCardVerification>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ResultCode != null) sb.Append("  ResultCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationCardVerification", "resultCode", ResultCode.ToString())).Append("\n");
            if (ResultCodeRaw != null) sb.Append("  ResultCodeRaw: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseProcessorInformationCardVerification", "resultCodeRaw", ResultCodeRaw.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseProcessorInformationCardVerification", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
