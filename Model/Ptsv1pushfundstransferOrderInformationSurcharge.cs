...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv1pushfundstransferOrderInformationSurcharge :  IEquatable<Ptsv1pushfundstransferOrderInformationSurcharge>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv1pushfundstransferOrderInformationSurcharge" /> class.
        /// </summary>
        ...
        public Ptsv1pushfundstransferOrderInformationSurcharge(string Amount = default(string))
        {
            this.Amount = Amount;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ptsv1pushfundstransferOrderInformationSurcharge {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv1pushfundstransferOrderInformationSurcharge);
        }

        /// <summary>
        /// Returns true if Ptsv1pushfundstransferOrderInformationSurcharge instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv1pushfundstransferOrderInformationSurcharge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv1pushfundstransferOrderInformationSurcharge other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
