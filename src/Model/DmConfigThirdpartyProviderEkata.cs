...
namespace CyberSource.Model
{
    ...
    public partial class DmConfigThirdpartyProviderEkata :  IEquatable<DmConfigThirdpartyProviderEkata>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Enabled != null) sb.Append("  Enabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigThirdpartyProviderEkata", "enabled", Enabled.ToString())).Append("\n");
            if (EnableRealTime != null) sb.Append("  EnableRealTime: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigThirdpartyProviderEkata", "enableRealTime", EnableRealTime.ToString())).Append("\n");
            if (UseCybsCredentials != null) sb.Append("  UseCybsCredentials: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigThirdpartyProviderEkata", "useCybsCredentials", UseCybsCredentials.ToString())).Append("\n");
            if (Credentials != null) sb.Append("  Credentials: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DmConfigThirdpartyProviderEkata", "credentials", Credentials.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DmConfigThirdpartyProviderEkata", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
