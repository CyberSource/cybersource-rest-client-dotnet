...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations :  IEquatable<PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations" /> class.
        /// </summary>
        ...
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations(string ParentProfileId = default(string), PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsContactInformation ContactInformation = default(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsContactInformation), PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotifications Notifications = default(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotifications), PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService Service = default(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService), PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsPaymentMethods PaymentMethods = default(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsPaymentMethods), PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout Checkout = default(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout), PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsPaymentTypes PaymentTypes = default(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsPaymentTypes))
        {
        ...
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsContactInformation ContactInformation { get; set; }

        /// <summary>
        /// Gets or Sets Notifications
        /// </summary>
        [DataMember(Name="notifications", EmitDefaultValue=false)]
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotifications Notifications { get; set; }

        /// <summary>
        /// Gets or Sets Service
        /// </summary>
        [DataMember(Name="service", EmitDefaultValue=false)]
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsService Service { get; set; }

        /// <summary>
        /// Gets or Sets PaymentMethods
        /// </summary>
        [DataMember(Name="paymentMethods", EmitDefaultValue=false)]
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsPaymentMethods PaymentMethods { get; set; }

        /// <summary>
        /// Gets or Sets Checkout
        /// </summary>
        [DataMember(Name="checkout", EmitDefaultValue=false)]
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsCheckout Checkout { get; set; }

        /// <summary>
        /// Gets or Sets PaymentTypes
        /// </summary>
        [DataMember(Name="paymentTypes", EmitDefaultValue=false)]
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsPaymentTypes PaymentTypes { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations);
        }

        /// <summary>
        /// Returns true if PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
