...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentIdentifierTokenizedCard :  IEquatable<InstrumentIdentifierTokenizedCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentIdentifierTokenizedCard" /> class.
        /// </summary>
        /// <param name="State">Issuer state for the Network Token Valid values: - ACTIVE - SUSPENDED - DELETED .</param>
        /// <param name="Card">Card.</param>
        public InstrumentIdentifierTokenizedCard(string State = default(string), TmsV1InstrumentIdentifiersPost200ResponseTokenizedCardCard Card = default(TmsV1InstrumentIdentifiersPost200ResponseTokenizedCardCard))
        {
            this.State = State;
            this.Card = Card;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InstrumentIdentifierTokenizedCard);
        }

        /// <summary>
        /// Returns true if InstrumentIdentifierTokenizedCard instances are equal
        /// </summary>
        /// <param name="other">Instance of InstrumentIdentifierTokenizedCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentIdentifierTokenizedCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
