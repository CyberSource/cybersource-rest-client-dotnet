...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsReversalsPost201ResponseProcessorInformation :  IEquatable<PtsV2PaymentsReversalsPost201ResponseProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            if (NetworkTransactionId != null) sb.Append("  NetworkTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "networkTransactionId", NetworkTransactionId.ToString())).Append("\n");
            if (ResponseCategoryCode != null) sb.Append("  ResponseCategoryCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "responseCategoryCode", ResponseCategoryCode.ToString())).Append("\n");
            if (ForwardedAcquirerCode != null) sb.Append("  ForwardedAcquirerCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "forwardedAcquirerCode", ForwardedAcquirerCode.ToString())).Append("\n");
            if (MasterCardServiceCode != null) sb.Append("  MasterCardServiceCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "masterCardServiceCode", MasterCardServiceCode.ToString())).Append("\n");
            if (MasterCardServiceReplyCode != null) sb.Append("  MasterCardServiceReplyCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", "masterCardServiceReplyCode", MasterCardServiceReplyCode.ToString())).Append("\n");
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsReversalsPost201ResponseProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
