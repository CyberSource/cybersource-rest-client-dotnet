...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentInstrumentsForInstrumentIdentifier :  IEquatable<PaymentInstrumentsForInstrumentIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInstrumentsForInstrumentIdentifier" /> class.
        /// </summary>
        /// <param name="Links">Links.</param>
        /// <param name="Embedded">Embedded.</param>
        public PaymentInstrumentsForInstrumentIdentifier(TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseLinks Links = default(TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseLinks), TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbedded Embedded = default(TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbedded))
        {
            this.Links = Links;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentInstrumentsForInstrumentIdentifier);
        }

        /// <summary>
        /// Returns true if PaymentInstrumentsForInstrumentIdentifier instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentInstrumentsForInstrumentIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentInstrumentsForInstrumentIdentifier other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
