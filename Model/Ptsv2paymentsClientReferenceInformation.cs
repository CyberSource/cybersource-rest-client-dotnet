...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsClientReferenceInformation :  IEquatable<Ptsv2paymentsClientReferenceInformation>, IValidatableObject
    {
        ...
        /// <param name="TransactionId">Identifier that you assign to the transaction.  **Note** Use this field only if you want to support merchant-initiated reversal and void operations.  #### Used by **Authorization, Authorization Reversal, Capture, Credit, and Void**\\ Optional field. .</param>
        ...
        /// </summary>
        /// <value>Identifier that you assign to the transaction.  **Note** Use this field only if you want to support merchant-initiated reversal and void operations.  #### Used by **Authorization, Authorization Reversal, Capture, Credit, and Void**\\ Optional field. </value>
