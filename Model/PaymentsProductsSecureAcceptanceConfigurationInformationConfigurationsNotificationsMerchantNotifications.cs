...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications :  IEquatable<PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications" /> class.
        /// </summary>
        ...
        public PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications(bool? BackofficePostEnabled = default(bool?), string BackofficeEmailAddress = default(string), bool? BackofficeEmailEnabled = default(bool?), string BackofficePostUrl = default(string), string CardNumberFormat = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications);
        }

        /// <summary>
        /// Returns true if PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
