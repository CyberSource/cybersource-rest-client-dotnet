...
namespace CybsQaScript.TMS.CoreServices
{
    public class RetrievePaymentInstrument
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "RetrievePaymentInstrument";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/TMS/CoreServices/RetrievePaymentInstrument.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.TmsV1PaymentinstrumentsTokenIdGet(profileId, tokenId);
