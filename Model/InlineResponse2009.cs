...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(InlineResponse2009Links Links = default(InlineResponse2009Links), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchSource = default(string), string MerchantReference = default(string), string BatchCaEndpoints = default(string), string Status = default(string), InlineResponse2008EmbeddedTotals Totals = default(InlineResponse2008EmbeddedTotals), InlineResponse2009Billing Billing = default(InlineResponse2009Billing), string Description = default(string))
        {
            this.Links = Links;
