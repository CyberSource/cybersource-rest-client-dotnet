...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse4004Fields :  IEquatable<InlineResponse4004Fields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4004Fields" /> class.
        /// </summary>
        ...
        public InlineResponse4004Fields(string Path = default(string), string Message = default(string), string LocalizationKey = default(string))
        {
            this.Path = Path;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse4004Fields);
        }

        /// <summary>
        /// Returns true if InlineResponse4004Fields instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse4004Fields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4004Fields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
