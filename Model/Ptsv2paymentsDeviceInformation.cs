...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsDeviceInformation :  IEquatable<Ptsv2paymentsDeviceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (UseRawFingerprintSessionId != null) sb.Append("  UseRawFingerprintSessionId: ").Append(UseRawFingerprintSessionId).Append("\n");
            if (DeviceType != null) sb.Append("  DeviceType: ").Append(DeviceType).Append("\n");
            if (AppUrl != null) sb.Append("  AppUrl: ").Append(AppUrl).Append("\n");
            ...
            if (HttpBrowserEmail != null) sb.Append("  HttpBrowserEmail: ").Append(HttpBrowserEmail).Append("\n");
