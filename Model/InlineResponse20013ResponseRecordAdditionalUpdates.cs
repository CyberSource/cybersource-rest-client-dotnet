...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20013ResponseRecordAdditionalUpdates :  IEquatable<InlineResponse20013ResponseRecordAdditionalUpdates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013ResponseRecordAdditionalUpdates" /> class.
        /// </summary>
        ...
        public InlineResponse20013ResponseRecordAdditionalUpdates(string CustomerId = default(string), string PaymentInstrumentId = default(string), string Creator = default(string), string State = default(string), string Message = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20013ResponseRecordAdditionalUpdates);
        }

        /// <summary>
        /// Returns true if InlineResponse20013ResponseRecordAdditionalUpdates instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20013ResponseRecordAdditionalUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013ResponseRecordAdditionalUpdates other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
