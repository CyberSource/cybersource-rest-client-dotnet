...
namespace CybsQaScript.Reporting.CoreServices
{
    ...
    {
        public static void GetAllSubsExec()
        {
            // Initialize Api Name
            var apiFunctionName = "GetAllSubscriptions";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Reporting/CoreServices/GetAllSubscriptions.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.GetAllSubscriptions();
