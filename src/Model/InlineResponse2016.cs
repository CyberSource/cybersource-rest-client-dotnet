...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2016 :  IEquatable<InlineResponse2016>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (WebhookId != null) sb.Append("  WebhookId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "webhookId", WebhookId.ToString())).Append("\n");
            if (OrganizationId != null) sb.Append("  OrganizationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "organizationId", OrganizationId.ToString())).Append("\n");
            if (Products != null) sb.Append("  Products: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "products", Products.ToString())).Append("\n");
            if (WebhookUrl != null) sb.Append("  WebhookUrl: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "webhookUrl", WebhookUrl.ToString())).Append("\n");
            if (HealthCheckUrl != null) sb.Append("  HealthCheckUrl: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "healthCheckUrl", HealthCheckUrl.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "status", Status.ToString())).Append("\n");
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "name", Name.ToString())).Append("\n");
            if (Description != null) sb.Append("  Description: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "description", Description.ToString())).Append("\n");
            if (RetryPolicy != null) sb.Append("  RetryPolicy: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "retryPolicy", RetryPolicy.ToString())).Append("\n");
            if (SecurityPolicy != null) sb.Append("  SecurityPolicy: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "securityPolicy", SecurityPolicy.ToString())).Append("\n");
            if (CreatedOn != null) sb.Append("  CreatedOn: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "createdOn", CreatedOn.ToString())).Append("\n");
            if (NotificationScope != null) sb.Append("  NotificationScope: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2016", "notificationScope", NotificationScope.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InlineResponse2016", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
