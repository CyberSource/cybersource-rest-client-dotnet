...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponsePaymentAccountInformationCard :  IEquatable<PtsV2PaymentsPost201ResponsePaymentAccountInformationCard>, IValidatableObject
    {
        ...
        public PtsV2PaymentsPost201ResponsePaymentAccountInformationCard(string Suffix = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Type = default(string), string Prefix = default(string))
        {
            this.Suffix = Suffix;
