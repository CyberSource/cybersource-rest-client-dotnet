...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsSenderInformation :  IEquatable<V2payoutsSenderInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsSenderInformation" /> class.
        /// </summary>
        ...
        /// <param name="AdministrativeArea">Senderâ€™s state. Use the State, Province, and Territory Codes for the United States and Canada. .</param>
        /// <param name="CountryCode">Country of sender. Use the ISO Standard Country Codes. * CTV (3) .</param>
        /// <param name="PostalCode">Senderâ€™s postal code. Required only for FDCCompass..</param>
        /// <param name="PhoneNumber">Senderâ€™s phone number. Required only for FDCCompass..</param>
        /// <param name="DateOfBirth">Senderâ€™s date of birth in YYYYMMDD format. Required only for FDCCompass..</param>
        /// <param name="VatRegistrationNumber">Customer&#39;s government-assigned tax identification number. .</param>
        public V2payoutsSenderInformation(string ReferenceNumber = default(string), V2payoutsSenderInformationAccount Account = default(V2payoutsSenderInformationAccount), string FirstName = default(string), string MiddleInitial = default(string), string LastName = default(string), string Name = default(string), string Address1 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string CountryCode = default(string), string PostalCode = default(string), string PhoneNumber = default(string), string DateOfBirth = default(string), string VatRegistrationNumber = default(string))
        {
        ...
        public V2payoutsSenderInformationAccount Account { get; set; }
        ...
        /// </summary>
        /// <value>Senderâ€™s state. Use the State, Province, and Territory Codes for the United States and Canada. </value>
        ...
        /// </summary>
        /// <value>Senderâ€™s postal code. Required only for FDCCompass.</value>
        ...
        /// </summary>
        /// <value>Senderâ€™s phone number. Required only for FDCCompass.</value>
        ...
        /// </summary>
        /// <value>Senderâ€™s date of birth in YYYYMMDD format. Required only for FDCCompass.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsSenderInformation);
        }

        /// <summary>
        /// Returns true if V2payoutsSenderInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsSenderInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsSenderInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
