...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsDeviceInformation :  IEquatable<Ptsv2paymentsDeviceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "id", Id.ToString())).Append("\n");
            if (HostName != null) sb.Append("  HostName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "hostName", HostName.ToString())).Append("\n");
            if (IpAddress != null) sb.Append("  IpAddress: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "ipAddress", IpAddress.ToString())).Append("\n");
            if (UserAgent != null) sb.Append("  UserAgent: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "userAgent", UserAgent.ToString())).Append("\n");
            if (FingerprintSessionId != null) sb.Append("  FingerprintSessionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "fingerprintSessionId", FingerprintSessionId.ToString())).Append("\n");
            if (UseRawFingerprintSessionId != null) sb.Append("  UseRawFingerprintSessionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "useRawFingerprintSessionId", UseRawFingerprintSessionId.ToString())).Append("\n");
            if (DeviceType != null) sb.Append("  DeviceType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "deviceType", DeviceType.ToString())).Append("\n");
            if (AppUrl != null) sb.Append("  AppUrl: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "appUrl", AppUrl.ToString())).Append("\n");
            if (Metadata != null) sb.Append("  Metadata: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "metadata", Metadata.ToString())).Append("\n");
            if (RawData != null) sb.Append("  RawData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "rawData", RawData.ToString())).Append("\n");
            if (HttpAcceptBrowserValue != null) sb.Append("  HttpAcceptBrowserValue: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpAcceptBrowserValue", HttpAcceptBrowserValue.ToString())).Append("\n");
            if (HttpAcceptContent != null) sb.Append("  HttpAcceptContent: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpAcceptContent", HttpAcceptContent.ToString())).Append("\n");
            if (HttpBrowserEmail != null) sb.Append("  HttpBrowserEmail: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserEmail", HttpBrowserEmail.ToString())).Append("\n");
            if (HttpBrowserLanguage != null) sb.Append("  HttpBrowserLanguage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserLanguage", HttpBrowserLanguage.ToString())).Append("\n");
            if (HttpBrowserJavaEnabled != null) sb.Append("  HttpBrowserJavaEnabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserJavaEnabled", HttpBrowserJavaEnabled.ToString())).Append("\n");
            if (HttpBrowserJavaScriptEnabled != null) sb.Append("  HttpBrowserJavaScriptEnabled: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserJavaScriptEnabled", HttpBrowserJavaScriptEnabled.ToString())).Append("\n");
            if (HttpBrowserColorDepth != null) sb.Append("  HttpBrowserColorDepth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserColorDepth", HttpBrowserColorDepth.ToString())).Append("\n");
            if (HttpBrowserScreenHeight != null) sb.Append("  HttpBrowserScreenHeight: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserScreenHeight", HttpBrowserScreenHeight.ToString())).Append("\n");
            if (HttpBrowserScreenWidth != null) sb.Append("  HttpBrowserScreenWidth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserScreenWidth", HttpBrowserScreenWidth.ToString())).Append("\n");
            if (HttpBrowserTimeDifference != null) sb.Append("  HttpBrowserTimeDifference: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "httpBrowserTimeDifference", HttpBrowserTimeDifference.ToString())).Append("\n");
            if (UserAgentBrowserValue != null) sb.Append("  UserAgentBrowserValue: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsDeviceInformation", "userAgentBrowserValue", UserAgentBrowserValue.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsDeviceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
