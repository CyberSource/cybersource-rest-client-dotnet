...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012PaymentInformationPaymentType :  IEquatable<InlineResponse20012PaymentInformationPaymentType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012PaymentInformationPaymentType" /> class.
        /// </summary>
        ...
        public InlineResponse20012PaymentInformationPaymentType(string Name = default(string), string Type = default(string), string SubType = default(string), string Method = default(string), string FundingSource = default(string), string FundingSourceAffiliation = default(string), string Credential = default(string))
        {
            this.Name = Name;
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012PaymentInformationPaymentType);
        }

        /// <summary>
        /// Returns true if InlineResponse20012PaymentInformationPaymentType instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012PaymentInformationPaymentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012PaymentInformationPaymentType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
