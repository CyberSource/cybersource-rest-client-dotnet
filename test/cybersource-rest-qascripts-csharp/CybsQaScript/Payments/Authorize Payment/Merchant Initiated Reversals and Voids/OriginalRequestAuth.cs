...
namespace CybsQaScript.Payments.Authorize_Payment.Merchant_Initiated_Reversals_and_Voids
{
    public class OriginalRequestAuth
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "OriginalRequestAuth";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/MerchantIntiatedReversalsAndVoids/CreateOriginalRequestAuth.csv"), true))
            {
