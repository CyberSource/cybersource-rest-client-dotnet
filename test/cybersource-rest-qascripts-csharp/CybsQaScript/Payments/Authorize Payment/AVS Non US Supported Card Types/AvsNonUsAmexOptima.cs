...
{
    public class AvsNonUsAmexOptima
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AvsNonUsAmexOptima";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSNonUsSupportedCardTypes/CreateAmexOptima.csv"), true))
            {
        ...
        private class PaymentApi
        {
            private object configurationSwagger;

            public PaymentApi(object configurationSwagger)
            {
                this.configurationSwagger = configurationSwagger;
            }
        }
    }
}