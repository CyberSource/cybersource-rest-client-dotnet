...
namespace CybsQaScript.Payments.Authorize_Payment.AVS_US_Supported_Card_Types
{
    public class AvsUsMasterCard
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "AvsUsMasterCard";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/AVSusSupportedCardTypes/CreateMasterCard.csv"), true))
            {
