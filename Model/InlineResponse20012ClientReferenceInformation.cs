...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012ClientReferenceInformation :  IEquatable<InlineResponse20012ClientReferenceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012ClientReferenceInformation" /> class.
        /// </summary>
        ...
        public InlineResponse20012ClientReferenceInformation(string Code = default(string), string ApplicationVersion = default(string), string ApplicationName = default(string), string ApplicationUser = default(string), string Comments = default(string))
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012ClientReferenceInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse20012ClientReferenceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012ClientReferenceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012ClientReferenceInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
