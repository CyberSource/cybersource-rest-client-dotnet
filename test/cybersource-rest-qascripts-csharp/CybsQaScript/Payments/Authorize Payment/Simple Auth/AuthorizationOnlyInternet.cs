...
{
    public class AuthorizationOnlyInternet
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizationOnlyInternet";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/CreateAuthorizationOnlyInternet.csv"), true))
            {
