...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsPointOfSaleInformation :  IEquatable<Ptsv2paymentsPointOfSaleInformation>, IValidatableObject
    {
        ...
        /// <param name="ServiceCode">#### Visa Platform Connect Mastercard service code that is included in the track data.  This field is supported only for Mastercard on Visa Platform Connect.   You can extract the service code from the track data and provide it in this API field.   When not provided it will be extracted from:   - Track2Data for MSR transactions   - EMV tag 5F30 for EMV transactions  To enable this feature please call support. .</param>
        public Ptsv2paymentsPointOfSaleInformation(string TerminalId = default(string), string TerminalSerialNumber = default(string), int? CardholderVerificationMethodUsed = default(int?), string LaneNumber = default(string), int? CatLevel = default(int?), string EntryMode = default(string), int? TerminalCapability = default(int?), string OperatingEnvironment = default(string), Ptsv2paymentsPointOfSaleInformationEmv Emv = default(Ptsv2paymentsPointOfSaleInformationEmv), string AmexCapnData = default(string), string TrackData = default(string), string StoreAndForwardIndicator = default(string), List<string> CardholderVerificationMethod = default(List<string>), string TerminalCategory = default(string), List<string> TerminalInputCapability = default(List<string>), string TerminalCardCaptureCapability = default(string), string TerminalOutputCapability = default(string), int? TerminalPinCapability = default(int?), string PinEntrySolution = default(string), string DeviceId = default(string), int? PinBlockEncodingFormat = default(int?), string EncryptedPin = default(string), string EncryptedKeySerialNumber = default(string), string EncryptedKeyId = default(string), string PartnerSdkVersion = default(string), string EmvApplicationIdentifierAndDedicatedFileName = default(string), string TerminalCompliance = default(string), string IsDedicatedHardwareTerminal = default(string), string TerminalModel = default(string), string TerminalMake = default(string), string ServiceCode = default(string))
        {
        ...
        /// </summary>
        /// <value>Method that was used to verify the cardholder&#39;s identity. Possible values:    - &#x60;0&#x60;: No verification   - &#x60;1&#x60;: Signature   - &#x60;2&#x60;: PIN   - &#x60;3&#x60;: Cardholder device CVM   - &#x60;4&#x60;: Biometric   - &#x60;5&#x60;: OTP </value>
        ...
        /// </summary>
        /// <value>Maximum PIN length that the terminal can capture.  Possible values: -  0: No PIN capture capability -  1: PIN capture capability unknown -  2: PIN Pad down -  4: Four characters -  5: Five characters -  6: Six characters -  7: Seven characters -  8: Eight characters -  9: Nine characters - 10: Ten characters - 11: Eleven characters - 12: Twelve characters  This field is supported for authorizations and credits only on the following processors: - American Express Direct - Credit Mutuel-CIC - OmniPay Direct - SIX - Visa Platform Connect  Required field for authorization or credit of PIN transactions. </value>
        ...
        /// </summary>
        /// <value>This field will contain the type of Pin Pad the terminal has.  Possible values: -   PCI-SPoC: Where the pin is being put on screen -   PCI-PTS: Where the pin is being put on actual hardware pin pad </value>
        [JsonPropertyName("pinEntrySolution")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public string PinEntrySolution { get; set; }
        ...
        /// </summary>
        /// <value>#### Visa Platform Connect Mastercard service code that is included in the track data.  This field is supported only for Mastercard on Visa Platform Connect.   You can extract the service code from the track data and provide it in this API field.   When not provided it will be extracted from:   - Track2Data for MSR transactions   - EMV tag 5F30 for EMV transactions  To enable this feature please call support. </value>
        ...
        public override string ToString()
        {
            ...
            if (TerminalId != null) sb.Append("  TerminalId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalId", TerminalId.ToString())).Append("\n");
            if (TerminalSerialNumber != null) sb.Append("  TerminalSerialNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalSerialNumber", TerminalSerialNumber.ToString())).Append("\n");
            if (CardholderVerificationMethodUsed != null) sb.Append("  CardholderVerificationMethodUsed: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "cardholderVerificationMethodUsed", CardholderVerificationMethodUsed.ToString())).Append("\n");
            if (LaneNumber != null) sb.Append("  LaneNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "laneNumber", LaneNumber.ToString())).Append("\n");
            if (CatLevel != null) sb.Append("  CatLevel: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "catLevel", CatLevel.ToString())).Append("\n");
            if (EntryMode != null) sb.Append("  EntryMode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "entryMode", EntryMode.ToString())).Append("\n");
            if (TerminalCapability != null) sb.Append("  TerminalCapability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalCapability", TerminalCapability.ToString())).Append("\n");
            if (OperatingEnvironment != null) sb.Append("  OperatingEnvironment: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "operatingEnvironment", OperatingEnvironment.ToString())).Append("\n");
            if (Emv != null) sb.Append("  Emv: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "emv", Emv.ToString())).Append("\n");
            if (AmexCapnData != null) sb.Append("  AmexCapnData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "amexCapnData", AmexCapnData.ToString())).Append("\n");
            if (TrackData != null) sb.Append("  TrackData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "trackData", TrackData.ToString())).Append("\n");
            if (StoreAndForwardIndicator != null) sb.Append("  StoreAndForwardIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "storeAndForwardIndicator", StoreAndForwardIndicator.ToString())).Append("\n");
            if (CardholderVerificationMethod != null) sb.Append("  CardholderVerificationMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "cardholderVerificationMethod", CardholderVerificationMethod.ToString())).Append("\n");
            if (TerminalCategory != null) sb.Append("  TerminalCategory: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalCategory", TerminalCategory.ToString())).Append("\n");
            if (TerminalInputCapability != null) sb.Append("  TerminalInputCapability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalInputCapability", TerminalInputCapability.ToString())).Append("\n");
            if (TerminalCardCaptureCapability != null) sb.Append("  TerminalCardCaptureCapability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalCardCaptureCapability", TerminalCardCaptureCapability.ToString())).Append("\n");
            if (TerminalOutputCapability != null) sb.Append("  TerminalOutputCapability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalOutputCapability", TerminalOutputCapability.ToString())).Append("\n");
            if (TerminalPinCapability != null) sb.Append("  TerminalPinCapability: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalPinCapability", TerminalPinCapability.ToString())).Append("\n");
            if (PinEntrySolution != null) sb.Append("  PinEntrySolution: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "pinEntrySolution", PinEntrySolution.ToString())).Append("\n");
            if (DeviceId != null) sb.Append("  DeviceId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "deviceId", DeviceId.ToString())).Append("\n");
            if (PinBlockEncodingFormat != null) sb.Append("  PinBlockEncodingFormat: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "pinBlockEncodingFormat", PinBlockEncodingFormat.ToString())).Append("\n");
            if (EncryptedPin != null) sb.Append("  EncryptedPin: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "encryptedPin", EncryptedPin.ToString())).Append("\n");
            if (EncryptedKeySerialNumber != null) sb.Append("  EncryptedKeySerialNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "encryptedKeySerialNumber", EncryptedKeySerialNumber.ToString())).Append("\n");
            if (EncryptedKeyId != null) sb.Append("  EncryptedKeyId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "encryptedKeyId", EncryptedKeyId.ToString())).Append("\n");
            if (PartnerSdkVersion != null) sb.Append("  PartnerSdkVersion: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "partnerSdkVersion", PartnerSdkVersion.ToString())).Append("\n");
            if (EmvApplicationIdentifierAndDedicatedFileName != null) sb.Append("  EmvApplicationIdentifierAndDedicatedFileName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "emvApplicationIdentifierAndDedicatedFileName", EmvApplicationIdentifierAndDedicatedFileName.ToString())).Append("\n");
            if (TerminalCompliance != null) sb.Append("  TerminalCompliance: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "terminalCompliance", TerminalCompliance.ToString())).Append("\n");
            if (IsDedicatedHardwareTerminal != null) sb.Append("  IsDedicatedHardwareTerminal: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsPointOfSaleInformation", "isDedicatedHardwareTerminal", IsDedicatedHardwareTerminal.ToString())).Append("\n");
        ...
        public bool Equals(Ptsv2paymentsPointOfSaleInformation other)
        {
            ...
            return 
                ...
                (
                    this.PinEntrySolution == other.PinEntrySolution ||
                    this.PinEntrySolution != null &&
                    this.PinEntrySolution.Equals(other.PinEntrySolution)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PinEntrySolution != null)
                    hash = hash * 59 + this.PinEntrySolution.GetHashCode();
