...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse4003Fields :  IEquatable<InlineResponse4003Fields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4003Fields" /> class.
        /// </summary>
        ...
        public InlineResponse4003Fields(string Path = default(string), string Message = default(string), string LocalizationKey = default(string))
        {
            this.Path = Path;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4003Fields {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse4003Fields);
        }

        /// <summary>
        /// Returns true if InlineResponse4003Fields instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse4003Fields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4003Fields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
