...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DefaultPaymentInstrumentCardTokenizedInformation :  IEquatable<DefaultPaymentInstrumentCardTokenizedInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultPaymentInstrumentCardTokenizedInformation" /> class.
        /// </summary>
        ...
        public DefaultPaymentInstrumentCardTokenizedInformation(string RequestorID = default(string), string TransactionType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            if (RequestorID != null) sb.Append("  RequestorID: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCardTokenizedInformation", "requestorID", RequestorID.ToString())).Append("\n");
            if (TransactionType != null) sb.Append("  TransactionType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("DefaultPaymentInstrumentCardTokenizedInformation", "transactionType", TransactionType.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("DefaultPaymentInstrumentCardTokenizedInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DefaultPaymentInstrumentCardTokenizedInformation);
        }

        /// <summary>
        /// Returns true if DefaultPaymentInstrumentCardTokenizedInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of DefaultPaymentInstrumentCardTokenizedInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DefaultPaymentInstrumentCardTokenizedInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
