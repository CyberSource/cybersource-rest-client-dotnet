...
namespace CyberSource.Model
{
    ...
    public partial class PtsV1TransactionBatchesIdGet200ResponseLinks :  IEquatable<PtsV1TransactionBatchesIdGet200ResponseLinks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Transactions != null) sb.Append("  Transactions: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV1TransactionBatchesIdGet200ResponseLinks", "transactions", Transactions.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV1TransactionBatchesIdGet200ResponseLinks", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
