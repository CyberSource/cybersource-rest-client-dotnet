...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsCardPresentConnect :  IEquatable<PaymentProductsCardPresentConnect>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsCardPresentConnect" /> class.
        /// </summary>
        ...
        public PaymentProductsCardPresentConnect(PaymentProductsCardPresentConnectSubscriptionInformation SubscriptionInformation = default(PaymentProductsCardPresentConnectSubscriptionInformation), PaymentProductsCardPresentConnectConfigurationInformation ConfigurationInformation = default(PaymentProductsCardPresentConnectConfigurationInformation))
        {
        ...
        public PaymentProductsCardPresentConnectSubscriptionInformation SubscriptionInformation { get; set; }

        /// <summary>
        /// Gets or Sets ConfigurationInformation
        /// </summary>
        [DataMember(Name="configurationInformation", EmitDefaultValue=false)]
        public PaymentProductsCardPresentConnectConfigurationInformation ConfigurationInformation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsCardPresentConnect);
        }

        /// <summary>
        /// Returns true if PaymentProductsCardPresentConnect instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsCardPresentConnect to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsCardPresentConnect other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
