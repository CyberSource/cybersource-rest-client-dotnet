...
namespace CybsQaScript.Payments.Authorize_Payment
{
    public class MerchantDescriptorsAuth
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "MerchantDescriptorsAuth";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/MerchantDescriptorAuth.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var merchantDescriptorObj = new Ptsv2paymentsMerchantInformationMerchantDescriptor
                            {
