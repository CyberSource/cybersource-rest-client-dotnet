...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator :  IEquatable<Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            if (StoredCredentialUsed != null) sb.Append("  StoredCredentialUsed: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator", "storedCredentialUsed", StoredCredentialUsed.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsidProcessingInformationAuthorizationOptionsInitiator other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
