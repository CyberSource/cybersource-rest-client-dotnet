...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesProcessingInformationAuthorizationOptions :  IEquatable<V2paymentsidcapturesProcessingInformationAuthorizationOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesProcessingInformationAuthorizationOptions" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesProcessingInformationAuthorizationOptions(string AuthType = default(string), string VerbalAuthCode = default(string), string VerbalAuthTransactionId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsidcapturesProcessingInformationAuthorizationOptions {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesProcessingInformationAuthorizationOptions);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesProcessingInformationAuthorizationOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesProcessingInformationAuthorizationOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesProcessingInformationAuthorizationOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
