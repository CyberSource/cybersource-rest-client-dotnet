...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Tmsv1paymentinstrumentsCard :  IEquatable<Tmsv1paymentinstrumentsCard>, IValidatableObject
    {
        /// <summary>
        /// Credit card brand.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Tmsv1paymentinstrumentsCard" /> class.
        /// </summary>
        ...
        public Tmsv1paymentinstrumentsCard(string ExpirationMonth = default(string), string ExpirationYear = default(string), TypeEnum? Type = default(TypeEnum?), string IssueNumber = default(string), string StartMonth = default(string), string StartYear = default(string), string UseAs = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Tmsv1paymentinstrumentsCard);
        }

        /// <summary>
        /// Returns true if Tmsv1paymentinstrumentsCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Tmsv1paymentinstrumentsCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Tmsv1paymentinstrumentsCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
