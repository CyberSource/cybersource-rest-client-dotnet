...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse40011Details :  IEquatable<InlineResponse40011Details>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40011Details" /> class.
        /// </summary>
        ...
        public InlineResponse40011Details(string Field = default(string), string Reason = default(string))
        {
            this.Field = Field;
            this.Reason = Reason;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse40011Details);
        }

        /// <summary>
        /// Returns true if InlineResponse40011Details instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse40011Details to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40011Details other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
