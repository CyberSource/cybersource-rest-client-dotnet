...
namespace CyberSource.Model
{
    ...
    public partial class CardInfo :  IEquatable<CardInfo>, IValidatableObject
    {
        ...
        public CardInfo(string CardNumber = default(string), string CardExpirationMonth = default(string), string CardExpirationYear = default(string), string CardType = default(string))
        {
            ...
            if (CardNumber == null)
            {
                throw new InvalidDataException("CardNumber is a required property for CardInfo and cannot be null");
            }
            else
            {
            ...
            if (CardType == null)
            {
                throw new InvalidDataException("CardType is a required property for CardInfo and cannot be null");
            }
            else
            {
