...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsPaymentInformationTokenizedCard :  IEquatable<Riskv1authenticationsPaymentInformationTokenizedCard>, IValidatableObject
    {
        ...
        public Riskv1authenticationsPaymentInformationTokenizedCard(string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
