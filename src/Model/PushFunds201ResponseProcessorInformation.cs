...
namespace CyberSource.Model
{
    ...
    public partial class PushFunds201ResponseProcessorInformation :  IEquatable<PushFunds201ResponseProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            if (SystemTraceAuditNumber != null) sb.Append("  SystemTraceAuditNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "systemTraceAuditNumber", SystemTraceAuditNumber.ToString())).Append("\n");
            if (RetrievalReferenceNumber != null) sb.Append("  RetrievalReferenceNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "retrievalReferenceNumber", RetrievalReferenceNumber.ToString())).Append("\n");
            if (ActionCode != null) sb.Append("  ActionCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "actionCode", ActionCode.ToString())).Append("\n");
            if (ApprovalCode != null) sb.Append("  ApprovalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "approvalCode", ApprovalCode.ToString())).Append("\n");
            if (FeeProgramIndicator != null) sb.Append("  FeeProgramIndicator: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "feeProgramIndicator", FeeProgramIndicator.ToString())).Append("\n");
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "name", Name.ToString())).Append("\n");
            if (Routing != null) sb.Append("  Routing: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "routing", Routing.ToString())).Append("\n");
            if (Settlement != null) sb.Append("  Settlement: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "settlement", Settlement.ToString())).Append("\n");
            if (MerchantAdvice != null) sb.Append("  MerchantAdvice: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "merchantAdvice", MerchantAdvice.ToString())).Append("\n");
            if (Avs != null) sb.Append("  Avs: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "avs", Avs.ToString())).Append("\n");
            if (Customer != null) sb.Append("  Customer: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "customer", Customer.ToString())).Append("\n");
            if (ElectronicVerificationResults != null) sb.Append("  ElectronicVerificationResults: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "electronicVerificationResults", ElectronicVerificationResults.ToString())).Append("\n");
            if (CardVerification != null) sb.Append("  CardVerification: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PushFunds201ResponseProcessorInformation", "cardVerification", CardVerification.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PushFunds201ResponseProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
