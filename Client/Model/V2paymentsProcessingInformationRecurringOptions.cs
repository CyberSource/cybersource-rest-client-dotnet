...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsProcessingInformationRecurringOptions :  IEquatable<V2paymentsProcessingInformationRecurringOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsProcessingInformationRecurringOptions" /> class.
        /// </summary>
        ...
        public V2paymentsProcessingInformationRecurringOptions(bool? LoanPayment = false, bool? FirstRecurringPayment = false)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsProcessingInformationRecurringOptions);
        }

        /// <summary>
        /// Returns true if V2paymentsProcessingInformationRecurringOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsProcessingInformationRecurringOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsProcessingInformationRecurringOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
