...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013RegistrationInformation :  IEquatable<InlineResponse2013RegistrationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013RegistrationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2013RegistrationInformation(string Mode = default(string), string SalesRepId = default(string))
        {
            this.Mode = Mode;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2013RegistrationInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013RegistrationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2013RegistrationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013RegistrationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013RegistrationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
