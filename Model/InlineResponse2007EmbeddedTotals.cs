...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007EmbeddedTotals :  IEquatable<InlineResponse2007EmbeddedTotals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007EmbeddedTotals" /> class.
        /// </summary>
        ...
        public InlineResponse2007EmbeddedTotals(int? AcceptedRecords = default(int?), int? RejectedRecords = default(int?), int? UpdatedRecords = default(int?), int? CaResponses = default(int?), int? CaResponsesOmitted = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2007EmbeddedTotals);
        }

        /// <summary>
        /// Returns true if InlineResponse2007EmbeddedTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2007EmbeddedTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007EmbeddedTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
