...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(string ProductId = default(string), string ProductName = default(string), List<Notificationsubscriptionsv2productsorganizationIdEventTypes> EventTypes = default(List<Notificationsubscriptionsv2productsorganizationIdEventTypes>))
        {
