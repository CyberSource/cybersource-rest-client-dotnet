...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsCapturesPost201ResponseProcessorInformation :  IEquatable<PtsV2PaymentsCapturesPost201ResponseProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (NetworkTransactionId != null) sb.Append("  NetworkTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "networkTransactionId", NetworkTransactionId.ToString())).Append("\n");
            if (ResponseDetails != null) sb.Append("  ResponseDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "responseDetails", ResponseDetails.ToString())).Append("\n");
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            if (ProviderResponse != null) sb.Append("  ProviderResponse: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "providerResponse", ProviderResponse.ToString())).Append("\n");
            if (UpdateTimeUtc != null) sb.Append("  UpdateTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "updateTimeUtc", UpdateTimeUtc.ToString())).Append("\n");
            if (Network != null) sb.Append("  Network: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", "network", Network.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsCapturesPost201ResponseProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
