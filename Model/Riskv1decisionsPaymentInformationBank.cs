...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1decisionsPaymentInformationBank :  IEquatable<Riskv1decisionsPaymentInformationBank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1decisionsPaymentInformationBank" /> class.
        /// </summary>
        ...
        public Riskv1decisionsPaymentInformationBank(string AccountNumber = default(string), string Code = default(string), string Country = default(string), string Iban = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1decisionsPaymentInformationBank {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1decisionsPaymentInformationBank);
        }

        /// <summary>
        /// Returns true if Riskv1decisionsPaymentInformationBank instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1decisionsPaymentInformationBank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1decisionsPaymentInformationBank other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.AccountNumber != null && this.AccountNumber.Length >= 30)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountNumber, length must be less than or equal to 30.", new [] { "AccountNumber" });
            }
            ...
            if(this.Iban != null && this.Iban.Length >= 30)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Iban, length must be less than or equal to 30.", new [] { "Iban" });
            }
