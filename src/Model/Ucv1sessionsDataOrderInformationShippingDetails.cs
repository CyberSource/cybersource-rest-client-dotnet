...
{
    /// <summary>
    /// Ucv1sessionsDataOrderInformationShippingDetails
    /// </summary>
    [DataContract]
    public partial class Ucv1sessionsDataOrderInformationShippingDetails :  IEquatable<Ucv1sessionsDataOrderInformationShippingDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ucv1sessionsDataOrderInformationShippingDetails" /> class.
        /// </summary>
        ...
        public Ucv1sessionsDataOrderInformationShippingDetails(string ShippingMethod = default(string), string ShipFromPostalCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ucv1sessionsDataOrderInformationShippingDetails {\n");
            if (ShippingMethod != null) sb.Append("  ShippingMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataOrderInformationShippingDetails", "shippingMethod", ShippingMethod.ToString())).Append("\n");
            if (ShipFromPostalCode != null) sb.Append("  ShipFromPostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ucv1sessionsDataOrderInformationShippingDetails", "shipFromPostalCode", ShipFromPostalCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ucv1sessionsDataOrderInformationShippingDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ucv1sessionsDataOrderInformationShippingDetails);
        }

        /// <summary>
        /// Returns true if Ucv1sessionsDataOrderInformationShippingDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of Ucv1sessionsDataOrderInformationShippingDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ucv1sessionsDataOrderInformationShippingDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
