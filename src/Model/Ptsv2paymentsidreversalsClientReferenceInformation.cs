...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidreversalsClientReferenceInformation :  IEquatable<Ptsv2paymentsidreversalsClientReferenceInformation>, IValidatableObject
    {
        ...
        public Ptsv2paymentsidreversalsClientReferenceInformation(string Code = default(string), string PausedRequestId = default(string), string Comments = default(string), Ptsv2paymentsidreversalsClientReferenceInformationPartner Partner = default(Ptsv2paymentsidreversalsClientReferenceInformationPartner), string ApplicationName = default(string), string ApplicationVersion = default(string), string ApplicationUser = default(string), string ReconciliationId = default(string), string TransactionId = default(string))
        {
            this.Code = Code;
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "code", Code.ToString())).Append("\n");
            if (PausedRequestId != null) sb.Append("  PausedRequestId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "pausedRequestId", PausedRequestId.ToString())).Append("\n");
            if (Comments != null) sb.Append("  Comments: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "comments", Comments.ToString())).Append("\n");
            if (Partner != null) sb.Append("  Partner: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "partner", Partner.ToString())).Append("\n");
            if (ApplicationName != null) sb.Append("  ApplicationName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "applicationName", ApplicationName.ToString())).Append("\n");
            if (ApplicationVersion != null) sb.Append("  ApplicationVersion: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "applicationVersion", ApplicationVersion.ToString())).Append("\n");
            if (ApplicationUser != null) sb.Append("  ApplicationUser: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "applicationUser", ApplicationUser.ToString())).Append("\n");
            if (ReconciliationId != null) sb.Append("  ReconciliationId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "reconciliationId", ReconciliationId.ToString())).Append("\n");
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidreversalsClientReferenceInformation", "transactionId", TransactionId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidreversalsClientReferenceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
