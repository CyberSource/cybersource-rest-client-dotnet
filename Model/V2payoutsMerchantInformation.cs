...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2payoutsMerchantInformation :  IEquatable<V2payoutsMerchantInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2payoutsMerchantInformation" /> class.
        /// </summary>
        ...
        public V2payoutsMerchantInformation(int? CategoryCode = default(int?), string SubmitLocalDateTime = default(string), string VatRegistrationNumber = default(string), V2payoutsMerchantInformationMerchantDescriptor MerchantDescriptor = default(V2payoutsMerchantInformationMerchantDescriptor))
        {
        ...
        public V2payoutsMerchantInformationMerchantDescriptor MerchantDescriptor { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2payoutsMerchantInformation);
        }

        /// <summary>
        /// Returns true if V2payoutsMerchantInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2payoutsMerchantInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2payoutsMerchantInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.SubmitLocalDateTime != null && this.SubmitLocalDateTime.Length > 6)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SubmitLocalDateTime, length must be less than 6.", new [] { "SubmitLocalDateTime" });
            }
