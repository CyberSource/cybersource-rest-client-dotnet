...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013SetupsPayments :  IEquatable<InlineResponse2013SetupsPayments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013SetupsPayments" /> class.
        /// </summary>
        ...
        public InlineResponse2013SetupsPaymentsCardProcessing CardProcessing { get; set; }

        /// <summary>
        /// Gets or Sets AlternativePaymentMethods
        /// </summary>
        [DataMember(Name="alternativePaymentMethods", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsAlternativePaymentMethods AlternativePaymentMethods { get; set; }

        /// <summary>
        /// Gets or Sets CardPresentConnect
        /// </summary>
        [DataMember(Name="cardPresentConnect", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing CardPresentConnect { get; set; }

        /// <summary>
        /// Gets or Sets ECheck
        /// </summary>
        [DataMember(Name="eCheck", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing ECheck { get; set; }

        /// <summary>
        /// Gets or Sets PayerAuthentication
        /// </summary>
        [DataMember(Name="payerAuthentication", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing PayerAuthentication { get; set; }

        /// <summary>
        /// Gets or Sets DigitalPayments
        /// </summary>
        [DataMember(Name="digitalPayments", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments DigitalPayments { get; set; }

        /// <summary>
        /// Gets or Sets SecureAcceptance
        /// </summary>
        [DataMember(Name="secureAcceptance", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing SecureAcceptance { get; set; }

        /// <summary>
        /// Gets or Sets VirtualTerminal
        /// </summary>
        [DataMember(Name="virtualTerminal", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing VirtualTerminal { get; set; }

        /// <summary>
        /// Gets or Sets CurrencyConversion
        /// </summary>
        [DataMember(Name="currencyConversion", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing CurrencyConversion { get; set; }

        /// <summary>
        /// Gets or Sets Tax
        /// </summary>
        [DataMember(Name="tax", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments Tax { get; set; }

        /// <summary>
        /// Gets or Sets CustomerInvoicing
        /// </summary>
        [DataMember(Name="customerInvoicing", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments CustomerInvoicing { get; set; }

        /// <summary>
        /// Gets or Sets RecurringBilling
        /// </summary>
        [DataMember(Name="recurringBilling", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing RecurringBilling { get; set; }

        /// <summary>
        /// Gets or Sets CybsReadyTerminal
        /// </summary>
        [DataMember(Name="cybsReadyTerminal", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing CybsReadyTerminal { get; set; }

        /// <summary>
        /// Gets or Sets PaymentOrchestration
        /// </summary>
        [DataMember(Name="paymentOrchestration", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments PaymentOrchestration { get; set; }

        /// <summary>
        /// Gets or Sets Payouts
        /// </summary>
        [DataMember(Name="payouts", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing Payouts { get; set; }

        /// <summary>
        /// Gets or Sets PayByLink
        /// </summary>
        [DataMember(Name="payByLink", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments PayByLink { get; set; }

        /// <summary>
        /// Gets or Sets UnifiedCheckout
        /// </summary>
        [DataMember(Name="unifiedCheckout", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments UnifiedCheckout { get; set; }

        /// <summary>
        /// Gets or Sets ReceivablesManager
        /// </summary>
        [DataMember(Name="receivablesManager", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments ReceivablesManager { get; set; }

        /// <summary>
        /// Gets or Sets ServiceFee
        /// </summary>
        [DataMember(Name="serviceFee", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsCardProcessing ServiceFee { get; set; }

        /// <summary>
        /// Gets or Sets BatchUpload
        /// </summary>
        [DataMember(Name="batchUpload", EmitDefaultValue=false)]
        public InlineResponse2013SetupsPaymentsDigitalPayments BatchUpload { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013SetupsPayments);
        }

        /// <summary>
        /// Returns true if InlineResponse2013SetupsPayments instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013SetupsPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013SetupsPayments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
