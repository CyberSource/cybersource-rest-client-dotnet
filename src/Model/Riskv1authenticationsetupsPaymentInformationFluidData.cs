...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsetupsPaymentInformationFluidData :  IEquatable<Riskv1authenticationsetupsPaymentInformationFluidData>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Riskv1authenticationsetupsPaymentInformationFluidData" /> class.
        /// </summary>
        /// <param name="Value">Represents the encrypted payment data BLOB. The entry for this field is dependent on the payment solution used by the merchant. Used by Authorization and Standalone Credits. Required for authorizations and standalone credits that use a Cybersource suppored Point-to-Point encryption method. Card Present processing This field represents the encrypted payment data generated by the payment terminal/device.  (required).</param>
        ...
        public override string ToString()
        {
            ...
            if (Value != null) sb.Append("  Value: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformationFluidData", "value", Value.ToString())).Append("\n");
            if (KeySerialNumber != null) sb.Append("  KeySerialNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformationFluidData", "keySerialNumber", KeySerialNumber.ToString())).Append("\n");
            if (Descriptor != null) sb.Append("  Descriptor: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformationFluidData", "descriptor", Descriptor.ToString())).Append("\n");
            if (Encoding != null) sb.Append("  Encoding: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationsetupsPaymentInformationFluidData", "encoding", Encoding.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1authenticationsetupsPaymentInformationFluidData", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
