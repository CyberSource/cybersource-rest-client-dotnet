...
namespace CyberSource.Model
{
    ...
    public partial class Flexv2sessionsFieldsOrderInformationAmountDetails :  IEquatable<Flexv2sessionsFieldsOrderInformationAmountDetails>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TotalAmount != null) sb.Append("  TotalAmount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Flexv2sessionsFieldsOrderInformationAmountDetails", "totalAmount", TotalAmount.ToString())).Append("\n");
            if (Currency != null) sb.Append("  Currency: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Flexv2sessionsFieldsOrderInformationAmountDetails", "currency", Currency.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Flexv2sessionsFieldsOrderInformationAmountDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
