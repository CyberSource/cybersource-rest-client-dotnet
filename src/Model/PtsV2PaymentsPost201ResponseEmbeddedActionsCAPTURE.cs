...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseEmbeddedActionsCAPTURE :  IEquatable<PtsV2PaymentsPost201ResponseEmbeddedActionsCAPTURE>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseEmbeddedActionsCAPTURE", "status", Status.ToString())).Append("\n");
            if (Reason != null) sb.Append("  Reason: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseEmbeddedActionsCAPTURE", "reason", Reason.ToString())).Append("\n");
            if (Message != null) sb.Append("  Message: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponseEmbeddedActionsCAPTURE", "message", Message.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponseEmbeddedActionsCAPTURE", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
