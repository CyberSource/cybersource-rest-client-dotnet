...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors :  IEquatable<PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors" /> class.
        /// </summary>
        ...
        public PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors(string CompanyEntryDescription = default(string), string CompanyId = default(string), string BatchGroup = default(string), bool? EnableAccuityForAvs = true, bool? SetCompletedState = false)
        {
            // to ensure "CompanyEntryDescription" is required (not null)
            if (CompanyEntryDescription == null)
            {
                throw new InvalidDataException("CompanyEntryDescription is a required property for PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors);
        }

        /// <summary>
        /// Returns true if PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsECheckConfigurationInformationConfigurationsCommonProcessors other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
