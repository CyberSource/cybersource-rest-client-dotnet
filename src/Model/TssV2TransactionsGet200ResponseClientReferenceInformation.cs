...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseClientReferenceInformation :  IEquatable<TssV2TransactionsGet200ResponseClientReferenceInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Code != null) sb.Append("  Code: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseClientReferenceInformation", "code", Code.ToString())).Append("\n");
            if (ApplicationVersion != null) sb.Append("  ApplicationVersion: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseClientReferenceInformation", "applicationVersion", ApplicationVersion.ToString())).Append("\n");
            if (ApplicationName != null) sb.Append("  ApplicationName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseClientReferenceInformation", "applicationName", ApplicationName.ToString())).Append("\n");
            if (ApplicationUser != null) sb.Append("  ApplicationUser: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseClientReferenceInformation", "applicationUser", ApplicationUser.ToString())).Append("\n");
            if (Partner != null) sb.Append("  Partner: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseClientReferenceInformation", "partner", Partner.ToString())).Append("\n");
            if (Comments != null) sb.Append("  Comments: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseClientReferenceInformation", "comments", Comments.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseClientReferenceInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
