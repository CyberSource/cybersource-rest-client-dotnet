...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseLinks :  IEquatable<TssV2TransactionsGet200ResponseLinks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Self != null) sb.Append("  Self: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseLinks", "self", Self.ToString())).Append("\n");
            if (RelatedTransactions != null) sb.Append("  RelatedTransactions: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseLinks", "relatedTransactions", RelatedTransactions.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseLinks", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
