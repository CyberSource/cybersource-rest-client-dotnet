...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4005 :  IEquatable<InlineResponse4005>, IValidatableObject
    {
        ...
        public InlineResponse4005(DateTime? SubmitTimeUtc = default(DateTime?), string Status = default(string), ReasonEnum? Reason = default(ReasonEnum?), string Message = default(string), List<InlineResponse4005Details> Details = default(List<InlineResponse4005Details>))
        {
