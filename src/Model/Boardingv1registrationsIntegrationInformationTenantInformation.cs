...
namespace CyberSource.Model
{
    ...
    public partial class Boardingv1registrationsIntegrationInformationTenantInformation :  IEquatable<Boardingv1registrationsIntegrationInformationTenantInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (TenantId != null) sb.Append("  TenantId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Boardingv1registrationsIntegrationInformationTenantInformation", "tenantId", TenantId.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Boardingv1registrationsIntegrationInformationTenantInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
