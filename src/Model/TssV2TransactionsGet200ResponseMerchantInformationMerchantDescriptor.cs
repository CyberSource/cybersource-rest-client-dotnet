...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseMerchantInformationMerchantDescriptor :  IEquatable<TssV2TransactionsGet200ResponseMerchantInformationMerchantDescriptor>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseMerchantInformationMerchantDescriptor", "name", Name.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseMerchantInformationMerchantDescriptor", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
