...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod :  IEquatable<TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod" /> class.
        /// </summary>
        ...
        public TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod(string Name = default(string), string _Operator = default(string), string SchemeName = default(string), string SchemeOperator = default(string))
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod);
        }

        /// <summary>
        /// Returns true if TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod instances are equal
        /// </summary>
        /// <param name="other">Instance of TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TssV2TransactionsPost201Response1EmbeddedPaymentInformationPaymentTypeMethod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
