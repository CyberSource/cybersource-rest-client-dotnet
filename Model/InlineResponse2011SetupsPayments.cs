...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2011SetupsPayments :  IEquatable<InlineResponse2011SetupsPayments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2011SetupsPayments" /> class.
        /// </summary>
        ...
        public InlineResponse2011SetupsPaymentsCardProcessing CardProcessing { get; set; }

        /// <summary>
        /// Gets or Sets CardPresentConnect
        /// </summary>
        [DataMember(Name="cardPresentConnect", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing CardPresentConnect { get; set; }

        /// <summary>
        /// Gets or Sets ECheck
        /// </summary>
        [DataMember(Name="eCheck", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing ECheck { get; set; }

        /// <summary>
        /// Gets or Sets PayerAuthentication
        /// </summary>
        [DataMember(Name="payerAuthentication", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing PayerAuthentication { get; set; }

        /// <summary>
        /// Gets or Sets DigitalPayments
        /// </summary>
        [DataMember(Name="digitalPayments", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments DigitalPayments { get; set; }

        /// <summary>
        /// Gets or Sets SecureAcceptance
        /// </summary>
        [DataMember(Name="secureAcceptance", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing SecureAcceptance { get; set; }

        /// <summary>
        /// Gets or Sets VirtualTerminal
        /// </summary>
        [DataMember(Name="virtualTerminal", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing VirtualTerminal { get; set; }

        /// <summary>
        /// Gets or Sets CurrencyConversion
        /// </summary>
        [DataMember(Name="currencyConversion", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing CurrencyConversion { get; set; }

        /// <summary>
        /// Gets or Sets Tax
        /// </summary>
        [DataMember(Name="tax", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments Tax { get; set; }

        /// <summary>
        /// Gets or Sets CustomerInvoicing
        /// </summary>
        [DataMember(Name="customerInvoicing", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments CustomerInvoicing { get; set; }

        /// <summary>
        /// Gets or Sets RecurringBilling
        /// </summary>
        [DataMember(Name="recurringBilling", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing RecurringBilling { get; set; }

        /// <summary>
        /// Gets or Sets CybsReadyTerminal
        /// </summary>
        [DataMember(Name="cybsReadyTerminal", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing CybsReadyTerminal { get; set; }

        /// <summary>
        /// Gets or Sets PaymentOrchestration
        /// </summary>
        [DataMember(Name="paymentOrchestration", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments PaymentOrchestration { get; set; }

        /// <summary>
        /// Gets or Sets Payouts
        /// </summary>
        [DataMember(Name="payouts", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsCardProcessing Payouts { get; set; }

        /// <summary>
        /// Gets or Sets PayByLink
        /// </summary>
        [DataMember(Name="payByLink", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments PayByLink { get; set; }

        /// <summary>
        /// Gets or Sets UnifiedCheckout
        /// </summary>
        [DataMember(Name="unifiedCheckout", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments UnifiedCheckout { get; set; }

        /// <summary>
        /// Gets or Sets ReceivablesManager
        /// </summary>
        [DataMember(Name="receivablesManager", EmitDefaultValue=false)]
        public InlineResponse2011SetupsPaymentsDigitalPayments ReceivablesManager { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2011SetupsPayments);
        }

        /// <summary>
        /// Returns true if InlineResponse2011SetupsPayments instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2011SetupsPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2011SetupsPayments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
