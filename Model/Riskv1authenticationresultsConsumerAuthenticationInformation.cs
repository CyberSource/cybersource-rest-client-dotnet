...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationresultsConsumerAuthenticationInformation :  IEquatable<Riskv1authenticationresultsConsumerAuthenticationInformation>, IValidatableObject
    {
        ...
        /// <param name="ResponseAccessToken">A JWT returned by 3DS provider once the authentication is complete, required in cruise hybrid integration method when using CyberSource generated access token. .</param>
        ...
        /// </summary>
        /// <value>A JWT returned by 3DS provider once the authentication is complete, required in cruise hybrid integration method when using CyberSource generated access token. </value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // ResponseAccessToken (string) maxLength
            if(this.ResponseAccessToken != null && this.ResponseAccessToken.Length >= 2048)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ResponseAccessToken, length must be less than or equal to 2048.", new [] { "ResponseAccessToken" });
            }
