...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2005EmbeddedBatches :  IEquatable<InlineResponse2005EmbeddedBatches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2005EmbeddedBatches" /> class.
        /// </summary>
        ...
        public InlineResponse2005EmbeddedBatches(InlineResponse2005EmbeddedLinks Links = default(InlineResponse2005EmbeddedLinks), string BatchId = default(string), string BatchCreatedDate = default(string), string BatchModifiedDate = default(string), string BatchSource = default(string), string TokenSource = default(string), string MerchantReference = default(string), List<string> BatchCaEndpoints = default(List<string>), string Status = default(string), InlineResponse2005EmbeddedTotals Totals = default(InlineResponse2005EmbeddedTotals))
        {
            this.Links = Links;
        ...
        public InlineResponse2005EmbeddedLinks Links { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2005EmbeddedBatches);
        }

        /// <summary>
        /// Returns true if InlineResponse2005EmbeddedBatches instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2005EmbeddedBatches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005EmbeddedBatches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
