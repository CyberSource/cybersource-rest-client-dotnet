...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsDeviceInformation :  IEquatable<V2paymentsDeviceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsDeviceInformation" /> class.
        /// </summary>
        ...
        /// <param name="UserAgent">Customerâ€™s browser as identified from the HTTP header data. For example, Mozilla is the value that identifies the Netscape browser. .</param>
        public V2paymentsDeviceInformation(string HostName = default(string), string IpAddress = default(string), string UserAgent = default(string))
        {
        ...
        /// </summary>
        /// <value>Customerâ€™s browser as identified from the HTTP header data. For example, Mozilla is the value that identifies the Netscape browser. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2paymentsDeviceInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsDeviceInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsDeviceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsDeviceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsDeviceInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
