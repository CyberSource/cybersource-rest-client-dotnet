...
{
    public class AuthorizationOnlyNonRetail
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizationOnlyNonRetail";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/CreateAuthorizationOnlyNonRetail.csv"), true))
            {
