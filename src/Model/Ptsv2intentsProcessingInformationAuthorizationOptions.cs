...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2intentsProcessingInformationAuthorizationOptions :  IEquatable<Ptsv2intentsProcessingInformationAuthorizationOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2intentsProcessingInformationAuthorizationOptions" /> class.
        /// </summary>
        ...
        public Ptsv2intentsProcessingInformationAuthorizationOptions(string AuthType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            if (AuthType != null) sb.Append("  AuthType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2intentsProcessingInformationAuthorizationOptions", "authType", AuthType.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2intentsProcessingInformationAuthorizationOptions", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2intentsProcessingInformationAuthorizationOptions);
        }

        /// <summary>
        /// Returns true if Ptsv2intentsProcessingInformationAuthorizationOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2intentsProcessingInformationAuthorizationOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2intentsProcessingInformationAuthorizationOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
