...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation :  IEquatable<Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation" /> class.
        /// </summary>
        ...
        public Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation(string Name = default(string), string Value = default(string))
        {
            this.Name = Name;
            this.Value = Value;
        }
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation", "name", Name.ToString())).Append("\n");
            if (Value != null) sb.Append("  Value: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation", "value", Value.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation);
        }

        /// <summary>
        /// Returns true if Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Tmsv2tokenizeTokenInformationCustomerMerchantDefinedInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
