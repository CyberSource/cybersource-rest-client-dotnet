...
namespace CyberSource.Model
{
    ...
    public partial class TmsBusinessInformationAddress :  IEquatable<TmsBusinessInformationAddress>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBusinessInformationAddress", "country", Country.ToString())).Append("\n");
            if (Locality != null) sb.Append("  Locality: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TmsBusinessInformationAddress", "locality", Locality.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TmsBusinessInformationAddress", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
