...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsPaymentInformationCard :  IEquatable<Riskv1authenticationexemptionsPaymentInformationCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformationCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Riskv1authenticationexemptionsPaymentInformationCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformationCard" /> class.
        /// </summary>
        /// <param name="Bin">description: The BIN is the first six digits of the card&#39;s Primary Account Number (PAN).  (required).</param>
        ...
        public Riskv1authenticationexemptionsPaymentInformationCard(string Bin = default(string), string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
            // to ensure "Bin" is required (not null)
            if (Bin == null)
            {
                throw new InvalidDataException("Bin is a required property for Riskv1authenticationexemptionsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Bin = Bin;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Riskv1authenticationexemptionsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            {
                throw new InvalidDataException("ExpirationMonth is a required property for Riskv1authenticationexemptionsPaymentInformationCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationYear is a required property for Riskv1authenticationexemptionsPaymentInformationCard and cannot be null");
            }
            else
            {
            ...
            if (Number == null)
            {
                throw new InvalidDataException("Number is a required property for Riskv1authenticationexemptionsPaymentInformationCard and cannot be null");
            }
            else
            {
                this.Number = Number;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationexemptionsPaymentInformationCard {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsPaymentInformationCard);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsPaymentInformationCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsPaymentInformationCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsPaymentInformationCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
