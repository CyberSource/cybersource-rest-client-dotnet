...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse201 :  IEquatable<InlineResponse201>, IValidatableObject
    {
        ...
        public InlineResponse201(string SubmitTimeUtc = default(string), string Status = default(string), Kmsv2keyssymClientReferenceInformation ClientReferenceInformation = default(Kmsv2keyssymClientReferenceInformation), List<InlineResponse201KeyInformation> KeyInformation = default(List<InlineResponse201KeyInformation>))
        {
        ...
        public List<InlineResponse201KeyInformation> KeyInformation { get; set; }
