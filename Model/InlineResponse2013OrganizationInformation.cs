...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2013OrganizationInformation :  IEquatable<InlineResponse2013OrganizationInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2013OrganizationInformation" /> class.
        /// </summary>
        ...
        public InlineResponse2013OrganizationInformation(string OrganizationId = default(string), string ParentOrganizationId = default(string), List<string> ChildOrganizations = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2013OrganizationInformation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2013OrganizationInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2013OrganizationInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2013OrganizationInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2013OrganizationInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
