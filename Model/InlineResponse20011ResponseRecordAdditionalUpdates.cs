...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011ResponseRecordAdditionalUpdates :  IEquatable<InlineResponse20011ResponseRecordAdditionalUpdates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011ResponseRecordAdditionalUpdates" /> class.
        /// </summary>
        ...
        public InlineResponse20011ResponseRecordAdditionalUpdates(string CustomerId = default(string), string PaymentInstrumentId = default(string), string Creator = default(string), string State = default(string), string Message = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011ResponseRecordAdditionalUpdates {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20011ResponseRecordAdditionalUpdates);
        }

        /// <summary>
        /// Returns true if InlineResponse20011ResponseRecordAdditionalUpdates instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20011ResponseRecordAdditionalUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011ResponseRecordAdditionalUpdates other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
