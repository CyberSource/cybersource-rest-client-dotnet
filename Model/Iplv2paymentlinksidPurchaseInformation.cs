...
namespace CyberSource.Model
{
    ...
    public partial class Iplv2paymentlinksidPurchaseInformation :  IEquatable<Iplv2paymentlinksidPurchaseInformation>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Iplv2paymentlinksidPurchaseInformation);
        }

        /// <summary>
        /// Returns true if Iplv2paymentlinksidPurchaseInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Iplv2paymentlinksidPurchaseInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Iplv2paymentlinksidPurchaseInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
