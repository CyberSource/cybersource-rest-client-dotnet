...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(List<InlineResponse2005Links> Links = default(List<InlineResponse2005Links>), string _Object = default(string), int? Offset = default(int?), int? Limit = default(int?), int? Count = default(int?), int? Total = default(int?), InlineResponse2005Embedded Embedded = default(InlineResponse2005Embedded))
        {
            this.Links = Links;
