...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidrefundsProcessingInformationRecurringOptions :  IEquatable<V2paymentsidrefundsProcessingInformationRecurringOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidrefundsProcessingInformationRecurringOptions" /> class.
        /// </summary>
        ...
        public V2paymentsidrefundsProcessingInformationRecurringOptions(bool? LoanPayment = false)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidrefundsProcessingInformationRecurringOptions);
        }

        /// <summary>
        /// Returns true if V2paymentsidrefundsProcessingInformationRecurringOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidrefundsProcessingInformationRecurringOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidrefundsProcessingInformationRecurringOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
