...
namespace CybsQaScript.TransactionDetails.CoreServices
{
    public class RetrieveTransaction
    {
        public static void GetTransExec()
        {
            // Initialize Api Name
            var apiFunctionName = "RetrieveTransaction";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/TransactionDetails/CoreServices/RetrieveTransaction.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.GetTransaction(id);
