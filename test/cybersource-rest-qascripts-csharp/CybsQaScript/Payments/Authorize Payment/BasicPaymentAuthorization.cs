...
{
    public class BasicPaymentAuthorization
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "BasicPaymentAuthorization";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/BasicPaymentAuthorization.csv"), true))
            {
