...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidcapturesMerchantInformation :  IEquatable<V2paymentsidcapturesMerchantInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidcapturesMerchantInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidcapturesMerchantInformation(V2paymentsMerchantInformationMerchantDescriptor MerchantDescriptor = default(V2paymentsMerchantInformationMerchantDescriptor), string CardAcceptorReferenceNumber = default(string), int? CategoryCode = default(int?), string VatRegistrationNumber = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidcapturesMerchantInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidcapturesMerchantInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidcapturesMerchantInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidcapturesMerchantInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
