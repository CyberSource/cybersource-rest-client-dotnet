...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationsetupsClientReferenceInformation :  IEquatable<Riskv1authenticationsetupsClientReferenceInformation>, IValidatableObject
    {
        ...
        public Riskv1authenticationsetupsClientReferenceInformation(string Code = default(string), string PausedRequestId = default(string), string Comments = default(string), Riskv1decisionsClientReferenceInformationPartner Partner = default(Riskv1decisionsClientReferenceInformationPartner))
        {
            this.Code = Code;
