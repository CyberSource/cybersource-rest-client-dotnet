...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseRiskInformationProfile :  IEquatable<TssV2TransactionsGet200ResponseRiskInformationProfile>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseRiskInformationProfile", "name", Name.ToString())).Append("\n");
            if (Decision != null) sb.Append("  Decision: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponseRiskInformationProfile", "decision", Decision.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponseRiskInformationProfile", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
