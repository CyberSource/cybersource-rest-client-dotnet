...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponseOrderInformationAmountDetails :  IEquatable<PtsV2PaymentsPost201ResponseOrderInformationAmountDetails>, IValidatableObject
    {
        ...
        /// <param name="AuthorizedAmount">Amount that was authorized.  Returned by authorization service.  #### FDMS South If you accept IDR or CLP currencies, see the entry for FDMS South in Merchant Descriptors Using the SCMP API. .</param>
        ...
        /// </summary>
        /// <value>Amount that was authorized.  Returned by authorization service.  #### FDMS South If you accept IDR or CLP currencies, see the entry for FDMS South in Merchant Descriptors Using the SCMP API. </value>
