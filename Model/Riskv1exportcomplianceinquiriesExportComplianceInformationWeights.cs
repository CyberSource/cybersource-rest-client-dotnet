...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1exportcomplianceinquiriesExportComplianceInformationWeights :  IEquatable<Riskv1exportcomplianceinquiriesExportComplianceInformationWeights>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1exportcomplianceinquiriesExportComplianceInformationWeights" /> class.
        /// </summary>
        ...
        public Riskv1exportcomplianceinquiriesExportComplianceInformationWeights(string Address = default(string), string Company = default(string), string Name = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1exportcomplianceinquiriesExportComplianceInformationWeights);
        }

        /// <summary>
        /// Returns true if Riskv1exportcomplianceinquiriesExportComplianceInformationWeights instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1exportcomplianceinquiriesExportComplianceInformationWeights to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1exportcomplianceinquiriesExportComplianceInformationWeights other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
