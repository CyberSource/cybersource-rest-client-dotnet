...
namespace CyberSource.Model
{
    ...
    public partial class PaymentInstrumentListLinksSelf :  IEquatable<PaymentInstrumentListLinksSelf>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Href != null) sb.Append("  Href: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PaymentInstrumentListLinksSelf", "href", Href.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PaymentInstrumentListLinksSelf", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
