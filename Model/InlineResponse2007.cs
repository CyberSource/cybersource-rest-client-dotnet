...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(int? TotalCount = default(int?), int? Offset = default(int?), int? Limit = default(int?), string Sort = default(string), int? Count = default(int?), List<InlineResponse2007Devices> Devices = default(List<InlineResponse2007Devices>))
        {
        ...
        public List<InlineResponse2007Devices> Devices { get; set; }
