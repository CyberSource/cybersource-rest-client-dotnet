...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidreversalsClientReferenceInformation :  IEquatable<V2paymentsidreversalsClientReferenceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidreversalsClientReferenceInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidreversalsClientReferenceInformation(string Code = default(string), string Comments = default(string))
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidreversalsClientReferenceInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidreversalsClientReferenceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidreversalsClientReferenceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidreversalsClientReferenceInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
