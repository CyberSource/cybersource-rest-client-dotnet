...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation :  IEquatable<PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (ApprovalCode != null) sb.Append("  ApprovalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "approvalCode", ApprovalCode.ToString())).Append("\n");
            if (TransactionId != null) sb.Append("  TransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "transactionId", TransactionId.ToString())).Append("\n");
            if (NetworkTransactionId != null) sb.Append("  NetworkTransactionId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "networkTransactionId", NetworkTransactionId.ToString())).Append("\n");
            if (ResponseCode != null) sb.Append("  ResponseCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "responseCode", ResponseCode.ToString())).Append("\n");
            if (SystemTraceAuditNumber != null) sb.Append("  SystemTraceAuditNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "systemTraceAuditNumber", SystemTraceAuditNumber.ToString())).Append("\n");
            if (ResponseDetails != null) sb.Append("  ResponseDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "responseDetails", ResponseDetails.ToString())).Append("\n");
            if (MerchantAdvice != null) sb.Append("  MerchantAdvice: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "merchantAdvice", MerchantAdvice.ToString())).Append("\n");
            if (MerchantRiskPrediction != null) sb.Append("  MerchantRiskPrediction: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "merchantRiskPrediction", MerchantRiskPrediction.ToString())).Append("\n");
            if (SellerProtection != null) sb.Append("  SellerProtection: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "sellerProtection", SellerProtection.ToString())).Append("\n");
            if (Network != null) sb.Append("  Network: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", "network", Network.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
