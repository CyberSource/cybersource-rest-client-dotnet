...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCreditRequest :  IEquatable<CreateCreditRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCreditRequest" /> class.
        /// </summary>
        ...
        public CreateCreditRequest(Ptsv2paymentsClientReferenceInformation ClientReferenceInformation = default(Ptsv2paymentsClientReferenceInformation), Ptsv2creditsProcessingInformation ProcessingInformation = default(Ptsv2creditsProcessingInformation), Ptsv2paymentsidrefundsPaymentInformation PaymentInformation = default(Ptsv2paymentsidrefundsPaymentInformation), Ptsv2paymentsidrefundsOrderInformation OrderInformation = default(Ptsv2paymentsidrefundsOrderInformation), Ptsv2paymentsidcapturesBuyerInformation BuyerInformation = default(Ptsv2paymentsidcapturesBuyerInformation), Ptsv2paymentsidcapturesDeviceInformation DeviceInformation = default(Ptsv2paymentsidcapturesDeviceInformation), Ptsv2paymentsidrefundsMerchantInformation MerchantInformation = default(Ptsv2paymentsidrefundsMerchantInformation), Ptsv2paymentsidcapturesAggregatorInformation AggregatorInformation = default(Ptsv2paymentsidcapturesAggregatorInformation), Ptsv2paymentsPointOfSaleInformation PointOfSaleInformation = default(Ptsv2paymentsPointOfSaleInformation), List<Ptsv2paymentsMerchantDefinedInformation> MerchantDefinedInformation = default(List<Ptsv2paymentsMerchantDefinedInformation>), Ptsv2paymentsMerchantDefinedSecureInformation MerchantDefinedSecureInformation = default(Ptsv2paymentsMerchantDefinedSecureInformation), Ptsv2creditsInstallmentInformation InstallmentInformation = default(Ptsv2creditsInstallmentInformation), Ptsv2paymentsTravelInformation TravelInformation = default(Ptsv2paymentsTravelInformation), Ptsv2creditsRecipientInformation RecipientInformation = default(Ptsv2creditsRecipientInformation), Ptsv2creditsSenderInformation SenderInformation = default(Ptsv2creditsSenderInformation), Ptsv2paymentsPromotionInformation PromotionInformation = default(Ptsv2paymentsPromotionInformation), Ptsv2reversalsProcessorInformation ProcessorInformation = default(Ptsv2reversalsProcessorInformation), Ptsv2creditsTokenInformation TokenInformation = default(Ptsv2creditsTokenInformation))
        {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2creditsProcessingInformation ProcessingInformation { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2creditsInstallmentInformation InstallmentInformation { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2creditsRecipientInformation RecipientInformation { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2creditsSenderInformation SenderInformation { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Ptsv2creditsTokenInformation TokenInformation { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (ClientReferenceInformation != null) sb.Append("  ClientReferenceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "clientReferenceInformation", ClientReferenceInformation.ToString())).Append("\n");
            if (ProcessingInformation != null) sb.Append("  ProcessingInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "processingInformation", ProcessingInformation.ToString())).Append("\n");
            if (PaymentInformation != null) sb.Append("  PaymentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "paymentInformation", PaymentInformation.ToString())).Append("\n");
            if (OrderInformation != null) sb.Append("  OrderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "orderInformation", OrderInformation.ToString())).Append("\n");
            if (BuyerInformation != null) sb.Append("  BuyerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "buyerInformation", BuyerInformation.ToString())).Append("\n");
            if (DeviceInformation != null) sb.Append("  DeviceInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "deviceInformation", DeviceInformation.ToString())).Append("\n");
            if (MerchantInformation != null) sb.Append("  MerchantInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "merchantInformation", MerchantInformation.ToString())).Append("\n");
            if (AggregatorInformation != null) sb.Append("  AggregatorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "aggregatorInformation", AggregatorInformation.ToString())).Append("\n");
            if (PointOfSaleInformation != null) sb.Append("  PointOfSaleInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "pointOfSaleInformation", PointOfSaleInformation.ToString())).Append("\n");
            if (MerchantDefinedInformation != null) sb.Append("  MerchantDefinedInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "merchantDefinedInformation", MerchantDefinedInformation.ToString())).Append("\n");
            if (MerchantDefinedSecureInformation != null) sb.Append("  MerchantDefinedSecureInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "merchantDefinedSecureInformation", MerchantDefinedSecureInformation.ToString())).Append("\n");
            if (InstallmentInformation != null) sb.Append("  InstallmentInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "installmentInformation", InstallmentInformation.ToString())).Append("\n");
            if (TravelInformation != null) sb.Append("  TravelInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "travelInformation", TravelInformation.ToString())).Append("\n");
            if (RecipientInformation != null) sb.Append("  RecipientInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "recipientInformation", RecipientInformation.ToString())).Append("\n");
            if (SenderInformation != null) sb.Append("  SenderInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "senderInformation", SenderInformation.ToString())).Append("\n");
            if (PromotionInformation != null) sb.Append("  PromotionInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "promotionInformation", PromotionInformation.ToString())).Append("\n");
            if (ProcessorInformation != null) sb.Append("  ProcessorInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "processorInformation", ProcessorInformation.ToString())).Append("\n");
            if (TokenInformation != null) sb.Append("  TokenInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("CreateCreditRequest", "tokenInformation", TokenInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("CreateCreditRequest", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateCreditRequest);
        }

        /// <summary>
        /// Returns true if CreateCreditRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateCreditRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCreditRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
