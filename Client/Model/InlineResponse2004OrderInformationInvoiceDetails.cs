...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004OrderInformationInvoiceDetails :  IEquatable<InlineResponse2004OrderInformationInvoiceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004OrderInformationInvoiceDetails" /> class.
        /// </summary>
        ...
        public InlineResponse2004OrderInformationInvoiceDetails(string PurchaseOrderNumber = default(string), string PurchaseOrderDate = default(string), bool? Taxable = default(bool?), string VatInvoiceReferenceNumber = default(string), string CommodityCode = default(string), List<V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum> TransactionAdviceAddendum = default(List<V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum>), bool? Level3TransmissionStatus = default(bool?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004OrderInformationInvoiceDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse2004OrderInformationInvoiceDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004OrderInformationInvoiceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004OrderInformationInvoiceDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
