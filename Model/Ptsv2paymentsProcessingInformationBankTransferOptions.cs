...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsProcessingInformationBankTransferOptions :  IEquatable<Ptsv2paymentsProcessingInformationBankTransferOptions>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DeclineAvsFlags, length must be less than or equal to 15.", new [] { "DeclineAvsFlags" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PaymentCategoryCode, length must be less than or equal to 1.", new [] { "PaymentCategoryCode" });
            }
