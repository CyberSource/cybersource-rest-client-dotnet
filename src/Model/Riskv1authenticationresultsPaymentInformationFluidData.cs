...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationresultsPaymentInformationFluidData :  IEquatable<Riskv1authenticationresultsPaymentInformationFluidData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationresultsPaymentInformationFluidData" /> class.
        /// </summary>
        ...
        public Riskv1authenticationresultsPaymentInformationFluidData(string Value = default(string), string KeySerialNumber = default(string), string Descriptor = default(string), string Encoding = default(string))
        {
            this.Value = Value;
        ...
        public override string ToString()
        {
            ...
            if (Value != null) sb.Append("  Value: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformationFluidData", "value", Value.ToString())).Append("\n");
            if (KeySerialNumber != null) sb.Append("  KeySerialNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformationFluidData", "keySerialNumber", KeySerialNumber.ToString())).Append("\n");
            if (Descriptor != null) sb.Append("  Descriptor: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformationFluidData", "descriptor", Descriptor.ToString())).Append("\n");
            if (Encoding != null) sb.Append("  Encoding: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformationFluidData", "encoding", Encoding.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1authenticationresultsPaymentInformationFluidData", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationresultsPaymentInformationFluidData);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationresultsPaymentInformationFluidData instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationresultsPaymentInformationFluidData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationresultsPaymentInformationFluidData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
