...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponsePaymentInformationBrands :  IEquatable<TssV2TransactionsGet200ResponsePaymentInformationBrands>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponsePaymentInformationBrands", "type", Type.ToString())).Append("\n");
            if (BrandName != null) sb.Append("  BrandName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("TssV2TransactionsGet200ResponsePaymentInformationBrands", "brandName", BrandName.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("TssV2TransactionsGet200ResponsePaymentInformationBrands", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
