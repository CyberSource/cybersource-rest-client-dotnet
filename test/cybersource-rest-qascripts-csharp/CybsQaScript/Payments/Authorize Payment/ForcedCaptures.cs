...
{
    public class ForcedCaptures
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "ForcedCaptures";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/ForcedCaptures.csv"), true))
            {
