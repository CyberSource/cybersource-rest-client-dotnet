...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsOrderInformationBillTo :  IEquatable<Riskv1authenticationexemptionsOrderInformationBillTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsOrderInformationBillTo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Riskv1authenticationexemptionsOrderInformationBillTo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsOrderInformationBillTo" /> class.
        /// </summary>
        ...
        public Riskv1authenticationexemptionsOrderInformationBillTo(string Address1 = default(string), string Address2 = default(string), string AdministrativeArea = default(string), string Country = default(string), string Locality = default(string), string FirstName = default(string), string LastName = default(string), string PhoneNumber = default(string), string Email = default(string), string PostalCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("AdministrativeArea is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (Locality == null)
            {
                throw new InvalidDataException("Locality is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (LastName == null)
            {
                throw new InvalidDataException("LastName is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
                this.Email = Email;
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for Riskv1authenticationexemptionsOrderInformationBillTo and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsOrderInformationBillTo);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsOrderInformationBillTo instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsOrderInformationBillTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsOrderInformationBillTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
