...
namespace CyberSource.Model
{
    ...
    public partial class Invoicingv2invoicesOrderInformation :  IEquatable<Invoicingv2invoicesOrderInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AmountDetails != null) sb.Append("  AmountDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoicesOrderInformation", "amountDetails", AmountDetails.ToString())).Append("\n");
            if (LineItems != null) sb.Append("  LineItems: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoicesOrderInformation", "lineItems", LineItems.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Invoicingv2invoicesOrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
