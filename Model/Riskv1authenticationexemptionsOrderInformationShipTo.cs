...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsOrderInformationShipTo :  IEquatable<Riskv1authenticationexemptionsOrderInformationShipTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsOrderInformationShipTo" /> class.
        /// </summary>
        ...
        public Riskv1authenticationexemptionsOrderInformationShipTo(string Address1 = default(string), string Address2 = default(string), string AdministrativeArea = default(string), string Country = default(string), string Locality = default(string), string FirstName = default(string), string LastName = default(string), string PhoneNumber = default(string), string PostalCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Riskv1authenticationexemptionsOrderInformationShipTo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsOrderInformationShipTo);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsOrderInformationShipTo instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsOrderInformationShipTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsOrderInformationShipTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
