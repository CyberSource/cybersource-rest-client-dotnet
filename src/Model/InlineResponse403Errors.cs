...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse403Errors :  IEquatable<InlineResponse403Errors>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse403Errors", "type", Type.ToString())).Append("\n");
            if (Message != null) sb.Append("  Message: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse403Errors", "message", Message.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InlineResponse403Errors", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
