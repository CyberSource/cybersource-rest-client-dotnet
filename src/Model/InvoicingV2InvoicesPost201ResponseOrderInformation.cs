...
namespace CyberSource.Model
{
    ...
    public partial class InvoicingV2InvoicesPost201ResponseOrderInformation :  IEquatable<InvoicingV2InvoicesPost201ResponseOrderInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AmountDetails != null) sb.Append("  AmountDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformation", "amountDetails", AmountDetails.ToString())).Append("\n");
            if (LineItems != null) sb.Append("  LineItems: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InvoicingV2InvoicesPost201ResponseOrderInformation", "lineItems", LineItems.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InvoicingV2InvoicesPost201ResponseOrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoicingV2InvoicesPost201ResponseOrderInformation);
        }

        /// <summary>
        /// Returns true if InvoicingV2InvoicesPost201ResponseOrderInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoicingV2InvoicesPost201ResponseOrderInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoicingV2InvoicesPost201ResponseOrderInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
