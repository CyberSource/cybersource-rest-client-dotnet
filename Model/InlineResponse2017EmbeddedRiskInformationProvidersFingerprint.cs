...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2017EmbeddedRiskInformationProvidersFingerprint :  IEquatable<InlineResponse2017EmbeddedRiskInformationProvidersFingerprint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2017EmbeddedRiskInformationProvidersFingerprint" /> class.
        /// </summary>
        ...
        public InlineResponse2017EmbeddedRiskInformationProvidersFingerprint(string TrueIpaddress = default(string), string Hash = default(string), string SmartId = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2017EmbeddedRiskInformationProvidersFingerprint);
        }

        /// <summary>
        /// Returns true if InlineResponse2017EmbeddedRiskInformationProvidersFingerprint instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2017EmbeddedRiskInformationProvidersFingerprint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2017EmbeddedRiskInformationProvidersFingerprint other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
