...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsidcapturesOrderInformationBillTo :  IEquatable<Ptsv2paymentsidcapturesOrderInformationBillTo>, IValidatableObject
    {
        ...
        public Ptsv2paymentsidcapturesOrderInformationBillTo(string Title = default(string), string FirstName = default(string), string MiddleName = default(string), string LastName = default(string), Ptsv2paymentsOrderInformationBillToCompany Company = default(Ptsv2paymentsOrderInformationBillToCompany), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string District = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string County = default(string), string Country = default(string), string Email = default(string), string PhoneNumber = default(string))
        {
            this.Title = Title;
        ...
        public override string ToString()
        {
            ...
            if (Title != null) sb.Append("  Title: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "title", Title.ToString())).Append("\n");
            if (FirstName != null) sb.Append("  FirstName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "firstName", FirstName.ToString())).Append("\n");
            if (MiddleName != null) sb.Append("  MiddleName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "middleName", MiddleName.ToString())).Append("\n");
            if (LastName != null) sb.Append("  LastName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "lastName", LastName.ToString())).Append("\n");
            if (Company != null) sb.Append("  Company: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "company", Company.ToString())).Append("\n");
            if (Address1 != null) sb.Append("  Address1: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "address1", Address1.ToString())).Append("\n");
            if (Address2 != null) sb.Append("  Address2: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "address2", Address2.ToString())).Append("\n");
            if (Locality != null) sb.Append("  Locality: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "locality", Locality.ToString())).Append("\n");
            if (District != null) sb.Append("  District: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "district", District.ToString())).Append("\n");
            if (AdministrativeArea != null) sb.Append("  AdministrativeArea: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "administrativeArea", AdministrativeArea.ToString())).Append("\n");
            if (PostalCode != null) sb.Append("  PostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "postalCode", PostalCode.ToString())).Append("\n");
            if (County != null) sb.Append("  County: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidcapturesOrderInformationBillTo", "county", County.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsidcapturesOrderInformationBillTo);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsidcapturesOrderInformationBillTo instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsidcapturesOrderInformationBillTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsidcapturesOrderInformationBillTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
