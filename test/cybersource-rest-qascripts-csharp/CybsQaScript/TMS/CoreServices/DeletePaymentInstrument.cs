...
namespace CybsQaScript.TMS.CoreServices
{
    public class DeletePaymentInstrument
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "DeletePaymentInstrument";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/TMS/CoreServices/DeletePaymentInstrument.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.TmsV1PaymentinstrumentsTokenIdDeleteWithHttpInfo(profileId, tokenId);
