...
namespace CyberSource.Model
{
    ...
    public partial class Invoicingv2invoiceSettingsInvoiceSettingsInformation :  IEquatable<Invoicingv2invoiceSettingsInvoiceSettingsInformation>, IValidatableObject
    {
        ...
        [JsonPropertyName("payerAuthenticationInInvoicing")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        public override string ToString()
        {
            ...
            if (MerchantLogo != null) sb.Append("  MerchantLogo: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "merchantLogo", MerchantLogo.ToString())).Append("\n");
            if (MerchantDisplayName != null) sb.Append("  MerchantDisplayName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "merchantDisplayName", MerchantDisplayName.ToString())).Append("\n");
            if (CustomEmailMessage != null) sb.Append("  CustomEmailMessage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "customEmailMessage", CustomEmailMessage.ToString())).Append("\n");
            if (EnableReminders != null) sb.Append("  EnableReminders: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "enableReminders", EnableReminders.ToString())).Append("\n");
            if (HeaderStyle != null) sb.Append("  HeaderStyle: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "headerStyle", HeaderStyle.ToString())).Append("\n");
            if (DeliveryLanguage != null) sb.Append("  DeliveryLanguage: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "deliveryLanguage", DeliveryLanguage.ToString())).Append("\n");
            if (DefaultCurrencyCode != null) sb.Append("  DefaultCurrencyCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "defaultCurrencyCode", DefaultCurrencyCode.ToString())).Append("\n");
            if (PayerAuthenticationInInvoicing != null) sb.Append("  PayerAuthenticationInInvoicing: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "payerAuthenticationInInvoicing", PayerAuthenticationInInvoicing.ToString())).Append("\n");
            if (ShowVatNumber != null) sb.Append("  ShowVatNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "showVatNumber", ShowVatNumber.ToString())).Append("\n");
            if (VatRegistrationNumber != null) sb.Append("  VatRegistrationNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "vatRegistrationNumber", VatRegistrationNumber.ToString())).Append("\n");
            if (ShipTo != null) sb.Append("  ShipTo: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Invoicingv2invoiceSettingsInvoiceSettingsInformation", "shipTo", ShipTo.ToString())).Append("\n");
