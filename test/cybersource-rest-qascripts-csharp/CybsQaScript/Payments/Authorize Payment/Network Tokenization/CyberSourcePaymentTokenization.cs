...
namespace CybsQaScript.Payments.Authorize_Payment.Network_Tokenization
{
    public class CyberSourcePaymentTokenization
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "CybersourcePaymentTokenization";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/NetworkTokenization/CybersourcePaymentTokenization.csv"), true))
            {
