...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1exportcomplianceinquiriesOrderInformationBillTo :  IEquatable<Riskv1exportcomplianceinquiriesOrderInformationBillTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1exportcomplianceinquiriesOrderInformationBillTo" /> class.
        /// </summary>
        [JsonConstructor]
        protected Riskv1exportcomplianceinquiriesOrderInformationBillTo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1exportcomplianceinquiriesOrderInformationBillTo" /> class.
        /// </summary>
        ...
        public Riskv1exportcomplianceinquiriesOrderInformationBillTo(string Address1 = default(string), string Address2 = default(string), string Address3 = default(string), string Address4 = default(string), string AdministrativeArea = default(string), string Country = default(string), string Locality = default(string), string PostalCode = default(string), Riskv1exportcomplianceinquiriesOrderInformationBillToCompany Company = default(Riskv1exportcomplianceinquiriesOrderInformationBillToCompany), string FirstName = default(string), string LastName = default(string), string Email = default(string))
        {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Riskv1exportcomplianceinquiriesOrderInformationBillToCompany Company { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Address1 != null) sb.Append("  Address1: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "address1", Address1.ToString())).Append("\n");
            if (Address2 != null) sb.Append("  Address2: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "address2", Address2.ToString())).Append("\n");
            if (Address3 != null) sb.Append("  Address3: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "address3", Address3.ToString())).Append("\n");
            if (Address4 != null) sb.Append("  Address4: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "address4", Address4.ToString())).Append("\n");
            if (AdministrativeArea != null) sb.Append("  AdministrativeArea: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "administrativeArea", AdministrativeArea.ToString())).Append("\n");
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "country", Country.ToString())).Append("\n");
            if (Locality != null) sb.Append("  Locality: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "locality", Locality.ToString())).Append("\n");
            if (PostalCode != null) sb.Append("  PostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "postalCode", PostalCode.ToString())).Append("\n");
            if (Company != null) sb.Append("  Company: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "company", Company.ToString())).Append("\n");
            if (FirstName != null) sb.Append("  FirstName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "firstName", FirstName.ToString())).Append("\n");
            if (LastName != null) sb.Append("  LastName: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "lastName", LastName.ToString())).Append("\n");
            if (Email != null) sb.Append("  Email: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1exportcomplianceinquiriesOrderInformationBillTo", "email", Email.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1exportcomplianceinquiriesOrderInformationBillTo", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1exportcomplianceinquiriesOrderInformationBillTo);
        }

        /// <summary>
        /// Returns true if Riskv1exportcomplianceinquiriesOrderInformationBillTo instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1exportcomplianceinquiriesOrderInformationBillTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1exportcomplianceinquiriesOrderInformationBillTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
