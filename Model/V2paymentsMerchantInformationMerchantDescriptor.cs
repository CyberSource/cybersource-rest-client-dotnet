...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsMerchantInformationMerchantDescriptor :  IEquatable<V2paymentsMerchantInformationMerchantDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsMerchantInformationMerchantDescriptor" /> class.
        /// </summary>
        ...
        public V2paymentsMerchantInformationMerchantDescriptor(string Name = default(string), string AlternateName = default(string), string Contact = default(string), string Address1 = default(string), string Locality = default(string), string Country = default(string), string PostalCode = default(string), string AdministrativeArea = default(string))
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsMerchantInformationMerchantDescriptor);
        }

        /// <summary>
        /// Returns true if V2paymentsMerchantInformationMerchantDescriptor instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsMerchantInformationMerchantDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsMerchantInformationMerchantDescriptor other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
