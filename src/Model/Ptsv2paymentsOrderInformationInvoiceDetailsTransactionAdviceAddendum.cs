...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum :  IEquatable<Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Data != null) sb.Append("  Data: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum", "data", Data.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
