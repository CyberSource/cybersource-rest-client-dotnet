...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Riskv1authenticationexemptionsPaymentInformationTokenizedCard :  IEquatable<Riskv1authenticationexemptionsPaymentInformationTokenizedCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Riskv1authenticationexemptionsPaymentInformationTokenizedCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Riskv1authenticationexemptionsPaymentInformationTokenizedCard" /> class.
        /// </summary>
        ...
        public Riskv1authenticationexemptionsPaymentInformationTokenizedCard(string Type = default(string), string ExpirationMonth = default(string), string ExpirationYear = default(string), string Number = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Riskv1authenticationexemptionsPaymentInformationTokenizedCard and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            {
                throw new InvalidDataException("ExpirationMonth is a required property for Riskv1authenticationexemptionsPaymentInformationTokenizedCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationYear is a required property for Riskv1authenticationexemptionsPaymentInformationTokenizedCard and cannot be null");
            }
            else
            {
            ...
            if (Number == null)
            {
                throw new InvalidDataException("Number is a required property for Riskv1authenticationexemptionsPaymentInformationTokenizedCard and cannot be null");
            }
            else
            {
                this.Number = Number;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Riskv1authenticationexemptionsPaymentInformationTokenizedCard);
        }

        /// <summary>
        /// Returns true if Riskv1authenticationexemptionsPaymentInformationTokenizedCard instances are equal
        /// </summary>
        /// <param name="other">Instance of Riskv1authenticationexemptionsPaymentInformationTokenizedCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Riskv1authenticationexemptionsPaymentInformationTokenizedCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
