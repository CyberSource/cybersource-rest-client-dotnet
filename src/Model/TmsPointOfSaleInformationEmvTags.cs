...
namespace CyberSource.Model
{
    ...
    public partial class TmsPointOfSaleInformationEmvTags :  IEquatable<TmsPointOfSaleInformationEmvTags>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        protected TmsPointOfSaleInformationEmvTags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TmsPointOfSaleInformationEmvTags" /> class.
        /// </summary>
        ...
        public TmsPointOfSaleInformationEmvTags(string Tag = default(string), string Value = default(string), string Source = default(string))
        {
            this.Tag = Tag;
            this.Value = Value;
            this.Source = Source;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TmsPointOfSaleInformationEmvTags);
        }

        /// <summary>
        /// Returns true if TmsPointOfSaleInformationEmvTags instances are equal
        /// </summary>
        /// <param name="other">Instance of TmsPointOfSaleInformationEmvTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmsPointOfSaleInformationEmvTags other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
