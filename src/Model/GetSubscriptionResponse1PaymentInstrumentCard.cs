...
namespace CyberSource.Model
{
    ...
    public partial class GetSubscriptionResponse1PaymentInstrumentCard :  IEquatable<GetSubscriptionResponse1PaymentInstrumentCard>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Number != null) sb.Append("  Number: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse1PaymentInstrumentCard", "number", Number.ToString())).Append("\n");
            if (ExpirationMonth != null) sb.Append("  ExpirationMonth: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse1PaymentInstrumentCard", "expirationMonth", ExpirationMonth.ToString())).Append("\n");
            if (ExpirationYear != null) sb.Append("  ExpirationYear: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse1PaymentInstrumentCard", "expirationYear", ExpirationYear.ToString())).Append("\n");
            if (Type != null) sb.Append("  Type: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("GetSubscriptionResponse1PaymentInstrumentCard", "type", Type.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("GetSubscriptionResponse1PaymentInstrumentCard", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
