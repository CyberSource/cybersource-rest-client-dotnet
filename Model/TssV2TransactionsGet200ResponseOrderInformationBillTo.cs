...
namespace CyberSource.Model
{
    ...
    public partial class TssV2TransactionsGet200ResponseOrderInformationBillTo :  IEquatable<TssV2TransactionsGet200ResponseOrderInformationBillTo>, IValidatableObject
    {
        ...
        /// <param name="MiddelName">Customer’s middle name. .</param>
        ...
        public TssV2TransactionsGet200ResponseOrderInformationBillTo(string FirstName = default(string), string LastName = default(string), string MiddelName = default(string), string NameSuffix = default(string), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), Ptsv2paymentsOrderInformationBillToCompany Company = default(Ptsv2paymentsOrderInformationBillToCompany), string Email = default(string), string Country = default(string), string Title = default(string), string PhoneNumber = default(string))
        {
        ...
        [DataMember(Name="middelName", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MiddelName: ").Append(MiddelName).Append("\n");
        ...
        public bool Equals(TssV2TransactionsGet200ResponseOrderInformationBillTo other)
        {
            ...
            return 
                ...
                (
                    this.MiddelName == other.MiddelName ||
                    this.MiddelName != null &&
                    this.MiddelName.Equals(other.MiddelName)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MiddelName != null)
                    hash = hash * 59 + this.MiddelName.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // MiddelName (string) maxLength
            if(this.MiddelName != null && this.MiddelName.Length > 60)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MiddelName, length must be less than 60.", new [] { "MiddelName" });
            }
