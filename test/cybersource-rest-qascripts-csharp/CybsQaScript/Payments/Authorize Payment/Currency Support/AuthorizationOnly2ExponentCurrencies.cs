...
namespace CybsQaScript.Payments.Authorize_Payment.Currency_Support
{
    public class AuthorizationOnly2ExponentCurrencies
    {
        ...
        {
            // Initialize Api Name
            var apiFunctionName = "AuthorizationOnly2ExponentCurrencies";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/CurrencySupport/AuthorizationOnly2exponentcurrenciesnonUSD.csv"), true))
            {
