...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsidrefundsProcessingInformation :  IEquatable<V2paymentsidrefundsProcessingInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsidrefundsProcessingInformation" /> class.
        /// </summary>
        ...
        public V2paymentsidrefundsProcessingInformation(string PaymentSolution = default(string), string ReconciliationId = default(string), string LinkId = default(string), string ReportGroup = default(string), string VisaCheckoutId = default(string), string PurchaseLevel = default(string), V2paymentsidrefundsProcessingInformationRecurringOptions RecurringOptions = default(V2paymentsidrefundsProcessingInformationRecurringOptions))
        {
        ...
        public V2paymentsidrefundsProcessingInformationRecurringOptions RecurringOptions { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsidrefundsProcessingInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsidrefundsProcessingInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsidrefundsProcessingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsidrefundsProcessingInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
