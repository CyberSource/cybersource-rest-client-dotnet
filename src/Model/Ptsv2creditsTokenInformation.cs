...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2creditsTokenInformation :  IEquatable<Ptsv2creditsTokenInformation>, IValidatableObject
    {
        ...
        public Ptsv2creditsTokenInformation(string Jti = default(string), string TransientTokenJwt = default(string), string NetworkTokenOption = default(string), Ptsv2paymentsTokenInformationTokenProvisioningInformation TokenProvisioningInformation = default(Ptsv2paymentsTokenInformationTokenProvisioningInformation))
        {
            this.Jti = Jti;
        ...
        public override string ToString()
        {
            ...
            if (Jti != null) sb.Append("  Jti: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2creditsTokenInformation", "jti", Jti.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2creditsTokenInformation);
        }

        /// <summary>
        /// Returns true if Ptsv2creditsTokenInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2creditsTokenInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2creditsTokenInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
