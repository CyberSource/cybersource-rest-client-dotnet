...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2006EmbeddedTotals :  IEquatable<InlineResponse2006EmbeddedTotals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006EmbeddedTotals" /> class.
        /// </summary>
        ...
        public InlineResponse2006EmbeddedTotals(int? AcceptedRecords = default(int?), int? RejectedRecords = default(int?), int? UpdatedRecords = default(int?), int? CaResponses = default(int?), int? CaResponsesOmitted = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2006EmbeddedTotals {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2006EmbeddedTotals);
        }

        /// <summary>
        /// Returns true if InlineResponse2006EmbeddedTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2006EmbeddedTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006EmbeddedTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
