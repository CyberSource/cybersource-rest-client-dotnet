...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsAggregatorInformation :  IEquatable<Ptsv2paymentsAggregatorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AggregatorId != null) sb.Append("  AggregatorId: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "aggregatorId", AggregatorId.ToString())).Append("\n");
            if (Name != null) sb.Append("  Name: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "name", Name.ToString())).Append("\n");
            if (SubMerchant != null) sb.Append("  SubMerchant: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "subMerchant", SubMerchant.ToString())).Append("\n");
            if (StreetAddress != null) sb.Append("  StreetAddress: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "streetAddress", StreetAddress.ToString())).Append("\n");
            if (City != null) sb.Append("  City: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "city", City.ToString())).Append("\n");
            if (State != null) sb.Append("  State: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "state", State.ToString())).Append("\n");
            if (PostalCode != null) sb.Append("  PostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "postalCode", PostalCode.ToString())).Append("\n");
            if (Country != null) sb.Append("  Country: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "country", Country.ToString())).Append("\n");
            if (ServiceProvidername != null) sb.Append("  ServiceProvidername: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsAggregatorInformation", "serviceProvidername", ServiceProvidername.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsAggregatorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
