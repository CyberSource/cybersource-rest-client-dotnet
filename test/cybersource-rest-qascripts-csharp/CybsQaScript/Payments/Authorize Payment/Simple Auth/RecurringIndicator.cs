...
{
    public class RecurringIndicator
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "SaRecurringIndicator";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/SimpleAuth/CreateRecurringIndicator.csv"), true))
            {
