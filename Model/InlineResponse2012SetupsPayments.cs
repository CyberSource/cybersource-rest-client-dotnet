...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2012SetupsPayments :  IEquatable<InlineResponse2012SetupsPayments>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse2012SetupsPaymentsCardProcessing CardPresentConnect { get; set; }

        /// <summary>
        /// Gets or Sets ECheck
        /// </summary>
        [DataMember(Name="eCheck", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing ECheck { get; set; }

        /// <summary>
        /// Gets or Sets PayerAuthentication
        /// </summary>
        [DataMember(Name="payerAuthentication", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing PayerAuthentication { get; set; }

        /// <summary>
        /// Gets or Sets DigitalPayments
        /// </summary>
        [DataMember(Name="digitalPayments", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments DigitalPayments { get; set; }

        /// <summary>
        /// Gets or Sets SecureAcceptance
        /// </summary>
        [DataMember(Name="secureAcceptance", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing SecureAcceptance { get; set; }

        /// <summary>
        /// Gets or Sets VirtualTerminal
        /// </summary>
        [DataMember(Name="virtualTerminal", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing VirtualTerminal { get; set; }

        /// <summary>
        /// Gets or Sets CurrencyConversion
        /// </summary>
        [DataMember(Name="currencyConversion", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing CurrencyConversion { get; set; }

        /// <summary>
        /// Gets or Sets Tax
        /// </summary>
        [DataMember(Name="tax", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments Tax { get; set; }

        /// <summary>
        /// Gets or Sets CustomerInvoicing
        /// </summary>
        [DataMember(Name="customerInvoicing", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments CustomerInvoicing { get; set; }

        /// <summary>
        /// Gets or Sets RecurringBilling
        /// </summary>
        [DataMember(Name="recurringBilling", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing RecurringBilling { get; set; }

        /// <summary>
        /// Gets or Sets CybsReadyTerminal
        /// </summary>
        [DataMember(Name="cybsReadyTerminal", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing CybsReadyTerminal { get; set; }

        /// <summary>
        /// Gets or Sets PaymentOrchestration
        /// </summary>
        [DataMember(Name="paymentOrchestration", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments PaymentOrchestration { get; set; }

        /// <summary>
        /// Gets or Sets Payouts
        /// </summary>
        [DataMember(Name="payouts", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing Payouts { get; set; }

        /// <summary>
        /// Gets or Sets PayByLink
        /// </summary>
        [DataMember(Name="payByLink", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments PayByLink { get; set; }

        /// <summary>
        /// Gets or Sets UnifiedCheckout
        /// </summary>
        [DataMember(Name="unifiedCheckout", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments UnifiedCheckout { get; set; }

        /// <summary>
        /// Gets or Sets ReceivablesManager
        /// </summary>
        [DataMember(Name="receivablesManager", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsDigitalPayments ReceivablesManager { get; set; }

        /// <summary>
        /// Gets or Sets ServiceFee
        /// </summary>
        [DataMember(Name="serviceFee", EmitDefaultValue=false)]
        public InlineResponse2012SetupsPaymentsCardProcessing ServiceFee { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2012SetupsPayments);
        }

        /// <summary>
        /// Returns true if InlineResponse2012SetupsPayments instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2012SetupsPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2012SetupsPayments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
