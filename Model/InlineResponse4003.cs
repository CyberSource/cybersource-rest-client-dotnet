...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse4003 :  IEquatable<InlineResponse4003>, IValidatableObject
    {
        ...
        public InlineResponse4003(string Code = default(string), string Message = default(string), string LocalizationKey = default(string), string CorrelationId = default(string), string Detail = default(string), List<InlineResponse4003Fields> Fields = default(List<InlineResponse4003Fields>))
        {
            // to ensure "Code" is required (not null)
            if (Code == null)
            {
                throw new InvalidDataException("Code is a required property for InlineResponse4003 and cannot be null");
            }
            else
            {
                this.Code = Code;
        ...
        public List<InlineResponse4003Fields> Fields { get; set; }
