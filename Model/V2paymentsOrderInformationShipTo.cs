...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsOrderInformationShipTo :  IEquatable<V2paymentsOrderInformationShipTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsOrderInformationShipTo" /> class.
        /// </summary>
        ...
        public V2paymentsOrderInformationShipTo(string FirstName = default(string), string LastName = default(string), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string Country = default(string), string District = default(string), string BuildingNumber = default(string), string PhoneNumber = default(string), string Company = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsOrderInformationShipTo);
        }

        /// <summary>
        /// Returns true if V2paymentsOrderInformationShipTo instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsOrderInformationShipTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsOrderInformationShipTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
