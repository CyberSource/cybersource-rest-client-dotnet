...
namespace CybsQaScript.Reporting.CoreServices
{
    ...
    {
        public static void DeleteSubsRepOrgExec()
        {
            // Initialize Api Name
            var apiFunctionName = "DeleteSubscriptionOfReportNameByOrganization";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Reporting/CoreServices/DeleteSubscriptionOfReportNameByOrganization.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.DeleteSubscriptionWithHttpInfo(reportName);
