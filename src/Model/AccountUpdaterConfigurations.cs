...
namespace CyberSource.Model
{
    ...
    public partial class AccountUpdaterConfigurations :  IEquatable<AccountUpdaterConfigurations>, IValidatableObject
    {
        ...
        public AccountUpdaterConfigurations(AccountUpdaterConfigurationsMasterCard MasterCard = default(AccountUpdaterConfigurationsMasterCard), AccountUpdaterConfigurationsVisa Visa = default(AccountUpdaterConfigurationsVisa), AccountUpdaterConfigurationsAmex Amex = default(AccountUpdaterConfigurationsAmex), decimal? PreferredDay = default(decimal?), decimal? DaysWindow = default(decimal?))
        {
        ...
        public AccountUpdaterConfigurationsMasterCard MasterCard { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public AccountUpdaterConfigurationsVisa Visa { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public AccountUpdaterConfigurationsAmex Amex { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (MasterCard != null) sb.Append("  MasterCard: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("AccountUpdaterConfigurations", "masterCard", MasterCard.ToString())).Append("\n");
            if (Visa != null) sb.Append("  Visa: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("AccountUpdaterConfigurations", "visa", Visa.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AccountUpdaterConfigurations);
        }

        /// <summary>
        /// Returns true if AccountUpdaterConfigurations instances are equal
        /// </summary>
        /// <param name="other">Instance of AccountUpdaterConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUpdaterConfigurations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
