...
{
    public class CvnMasterCardCvc2
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "CvnMasterCardCvc2";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/CVN/CreateMasterCardCVC2.csv"), true))
            {
