...
{
    public class ApRecurringIndicator
    {
        public static void CreatePaymentExec()
        {
            // Initialize Api Name
            var apiFunctionName = "ApRecurringIndicator";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/Payment/AuthorizePayment/RecurringIndicator.csv"), true))
            {
