...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002EmbeddedTotals :  IEquatable<InlineResponse2002EmbeddedTotals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002EmbeddedTotals" /> class.
        /// </summary>
        ...
        public InlineResponse2002EmbeddedTotals(int? AcceptedRecords = default(int?), int? RejectedRecords = default(int?), int? UpdatedRecords = default(int?), int? CaResponses = default(int?), int? CaResponsesOmitted = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002EmbeddedTotals);
        }

        /// <summary>
        /// Returns true if InlineResponse2002EmbeddedTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002EmbeddedTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002EmbeddedTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
