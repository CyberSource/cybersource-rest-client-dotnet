...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv1pushfundstransferOrderInformation :  IEquatable<Ptsv1pushfundstransferOrderInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (AmountDetails != null) sb.Append("  AmountDetails: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv1pushfundstransferOrderInformation", "amountDetails", AmountDetails.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv1pushfundstransferOrderInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
