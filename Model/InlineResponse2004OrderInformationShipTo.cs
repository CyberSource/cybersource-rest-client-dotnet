...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004OrderInformationShipTo :  IEquatable<InlineResponse2004OrderInformationShipTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004OrderInformationShipTo" /> class.
        /// </summary>
        ...
        public InlineResponse2004OrderInformationShipTo(string AdministrativeArea = default(string), string PostalCode = default(string), string Country = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004OrderInformationShipTo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004OrderInformationShipTo);
        }

        /// <summary>
        /// Returns true if InlineResponse2004OrderInformationShipTo instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004OrderInformationShipTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004OrderInformationShipTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
