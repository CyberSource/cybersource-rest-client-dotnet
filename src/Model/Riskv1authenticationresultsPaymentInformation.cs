...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1authenticationresultsPaymentInformation :  IEquatable<Riskv1authenticationresultsPaymentInformation>, IValidatableObject
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Riskv1authenticationresultsPaymentInformationFluidData FluidData { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (Card != null) sb.Append("  Card: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformation", "card", Card.ToString())).Append("\n");
            if (TokenizedCard != null) sb.Append("  TokenizedCard: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformation", "tokenizedCard", TokenizedCard.ToString())).Append("\n");
            if (FluidData != null) sb.Append("  FluidData: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformation", "fluidData", FluidData.ToString())).Append("\n");
            if (Customer != null) sb.Append("  Customer: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1authenticationresultsPaymentInformation", "customer", Customer.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1authenticationresultsPaymentInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
