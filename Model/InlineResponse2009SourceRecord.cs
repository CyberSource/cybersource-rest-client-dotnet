...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009SourceRecord :  IEquatable<InlineResponse2009SourceRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009SourceRecord" /> class.
        /// </summary>
        ...
        public InlineResponse2009SourceRecord(string Token = default(string), string CustomerId = default(string), string PaymentInstrumentId = default(string), string InstrumentIdentifierId = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string))
        {
            this.Token = Token;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009SourceRecord {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2009SourceRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse2009SourceRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2009SourceRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009SourceRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
