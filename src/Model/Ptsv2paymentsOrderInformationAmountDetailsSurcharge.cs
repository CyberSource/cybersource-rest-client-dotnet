...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsOrderInformationAmountDetailsSurcharge :  IEquatable<Ptsv2paymentsOrderInformationAmountDetailsSurcharge>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Amount != null) sb.Append("  Amount: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationAmountDetailsSurcharge", "amount", Amount.ToString())).Append("\n");
            if (Description != null) sb.Append("  Description: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsOrderInformationAmountDetailsSurcharge", "description", Description.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsOrderInformationAmountDetailsSurcharge", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
