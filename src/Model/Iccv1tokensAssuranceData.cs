...
namespace CyberSource.Model
{
    ...
    public partial class Iccv1tokensAssuranceData :  IEquatable<Iccv1tokensAssuranceData>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        protected Iccv1tokensAssuranceData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Iccv1tokensAssuranceData" /> class.
        /// </summary>
        ...
        [JsonPropertyName("verificationEntity")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        [JsonPropertyName("verificationEvents")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Iccv1tokensAuthenticationContext AuthenticationContext { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public Iccv1tokensAuthenticatedIdentities AuthenticatedIdentities { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (VerificationType != null) sb.Append("  VerificationType: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Iccv1tokensAssuranceData", "verificationType", VerificationType.ToString())).Append("\n");
            if (VerificationEntity != null) sb.Append("  VerificationEntity: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Iccv1tokensAssuranceData", "verificationEntity", VerificationEntity.ToString())).Append("\n");
            if (VerificationEvents != null) sb.Append("  VerificationEvents: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Iccv1tokensAssuranceData", "verificationEvents", VerificationEvents.ToString())).Append("\n");
            if (VerificationMethod != null) sb.Append("  VerificationMethod: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Iccv1tokensAssuranceData", "verificationMethod", VerificationMethod.ToString())).Append("\n");
            if (VerificationResults != null) sb.Append("  VerificationResults: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Iccv1tokensAssuranceData", "verificationResults", VerificationResults.ToString())).Append("\n");
            if (VerificationTimestamp != null) sb.Append("  VerificationTimestamp: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Iccv1tokensAssuranceData", "verificationTimestamp", VerificationTimestamp.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Iccv1tokensAssuranceData);
        }

        /// <summary>
        /// Returns true if Iccv1tokensAssuranceData instances are equal
        /// </summary>
        /// <param name="other">Instance of Iccv1tokensAssuranceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Iccv1tokensAssuranceData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
