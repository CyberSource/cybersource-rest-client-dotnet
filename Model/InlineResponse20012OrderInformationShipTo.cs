...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012OrderInformationShipTo :  IEquatable<InlineResponse20012OrderInformationShipTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012OrderInformationShipTo" /> class.
        /// </summary>
        ...
        public InlineResponse20012OrderInformationShipTo(string FirstName = default(string), string LastName = default(string), string Address1 = default(string), string Address2 = default(string), string Locality = default(string), string AdministrativeArea = default(string), string PostalCode = default(string), string Company = default(string), string Country = default(string), string PhoneNumber = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012OrderInformationShipTo);
        }

        /// <summary>
        /// Returns true if InlineResponse20012OrderInformationShipTo instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012OrderInformationShipTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012OrderInformationShipTo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
