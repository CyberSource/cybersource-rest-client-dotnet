...
namespace CyberSource.Model
{
    ...
    public partial class PblPaymentLinksPost201Response :  IEquatable<PblPaymentLinksPost201Response>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Links != null) sb.Append("  Links: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksPost201Response", "_links", Links.ToString())).Append("\n");
            if (Id != null) sb.Append("  Id: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksPost201Response", "id", Id.ToString())).Append("\n");
            if (SubmitTimeUtc != null) sb.Append("  SubmitTimeUtc: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksPost201Response", "submitTimeUtc", SubmitTimeUtc.ToString())).Append("\n");
            if (Status != null) sb.Append("  Status: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PblPaymentLinksPost201Response", "status", Status.ToString())).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PblPaymentLinksPost201Response);
        }

        /// <summary>
        /// Returns true if PblPaymentLinksPost201Response instances are equal
        /// </summary>
        /// <param name="other">Instance of PblPaymentLinksPost201Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PblPaymentLinksPost201Response other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
