...
namespace CyberSource.Model
{
    ...
    public partial class Ptsv2paymentsTravelInformationAutoRental :  IEquatable<Ptsv2paymentsTravelInformationAutoRental>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.CustomerName != null && this.CustomerName.Length >= 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CustomerName, length must be less than or equal to 40.", new [] { "CustomerName" });
            }

            // VehicleClass (string) maxLength
            if(this.VehicleClass != null && this.VehicleClass.Length >= 4)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VehicleClass, length must be less than or equal to 4.", new [] { "VehicleClass" });
            }

            // DistanceTravelled (string) maxLength
            if(this.DistanceTravelled != null && this.DistanceTravelled.Length >= 5)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DistanceTravelled, length must be less than or equal to 5.", new [] { "DistanceTravelled" });
            }

            // DistanceUnit (string) maxLength
            if(this.DistanceUnit != null && this.DistanceUnit.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DistanceUnit, length must be less than or equal to 1.", new [] { "DistanceUnit" });
            }

            // ReturnDateTime (string) maxLength
            if(this.ReturnDateTime != null && this.ReturnDateTime.Length >= 21)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReturnDateTime, length must be less than or equal to 21.", new [] { "ReturnDateTime" });
            }

            // RentalDateTime (string) maxLength
            if(this.RentalDateTime != null && this.RentalDateTime.Length >= 21)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RentalDateTime, length must be less than or equal to 21.", new [] { "RentalDateTime" });
            }

            // MaxFreeDistance (string) maxLength
            if(this.MaxFreeDistance != null && this.MaxFreeDistance.Length >= 4)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxFreeDistance, length must be less than or equal to 4.", new [] { "MaxFreeDistance" });
            }

            // ProgramCode (string) maxLength
            if(this.ProgramCode != null && this.ProgramCode.Length >= 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProgramCode, length must be less than or equal to 2.", new [] { "ProgramCode" });
            }

            // AgreementNumber (string) maxLength
            if(this.AgreementNumber != null && this.AgreementNumber.Length >= 25)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AgreementNumber, length must be less than or equal to 25.", new [] { "AgreementNumber" });
            }

            // OdometerReading (string) maxLength
            if(this.OdometerReading != null && this.OdometerReading.Length >= 8)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OdometerReading, length must be less than or equal to 8.", new [] { "OdometerReading" });
            }

            // VehicleIdentificationNumber (string) maxLength
            if(this.VehicleIdentificationNumber != null && this.VehicleIdentificationNumber.Length >= 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VehicleIdentificationNumber, length must be less than or equal to 20.", new [] { "VehicleIdentificationNumber" });
            }

            // CompanyId (string) maxLength
            if(this.CompanyId != null && this.CompanyId.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CompanyId, length must be less than or equal to 12.", new [] { "CompanyId" });
            }

            // NumberOfAdditionalDrivers (string) maxLength
            if(this.NumberOfAdditionalDrivers != null && this.NumberOfAdditionalDrivers.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfAdditionalDrivers, length must be less than or equal to 1.", new [] { "NumberOfAdditionalDrivers" });
            }

            // DriverAge (string) maxLength
            if(this.DriverAge != null && this.DriverAge.Length >= 3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DriverAge, length must be less than or equal to 3.", new [] { "DriverAge" });
            }

            // SpecialProgramCode (string) maxLength
            if(this.SpecialProgramCode != null && this.SpecialProgramCode.Length >= 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SpecialProgramCode, length must be less than or equal to 2.", new [] { "SpecialProgramCode" });
            }

            // VehicleMake (string) maxLength
            if(this.VehicleMake != null && this.VehicleMake.Length >= 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VehicleMake, length must be less than or equal to 10.", new [] { "VehicleMake" });
            }

            // VehicleModel (string) maxLength
            if(this.VehicleModel != null && this.VehicleModel.Length >= 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VehicleModel, length must be less than or equal to 10.", new [] { "VehicleModel" });
            }

            // TimePeriod (string) maxLength
            if(this.TimePeriod != null && this.TimePeriod.Length >= 7)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimePeriod, length must be less than or equal to 7.", new [] { "TimePeriod" });
            }
            ...
            // InsuranceAmount (string) maxLength
            if(this.InsuranceAmount != null && this.InsuranceAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InsuranceAmount, length must be less than or equal to 12.", new [] { "InsuranceAmount" });
            }

            // OneWayDropOffAmount (string) maxLength
            if(this.OneWayDropOffAmount != null && this.OneWayDropOffAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OneWayDropOffAmount, length must be less than or equal to 12.", new [] { "OneWayDropOffAmount" });
            }

            // AdjustedAmountIndicator (string) maxLength
            if(this.AdjustedAmountIndicator != null && this.AdjustedAmountIndicator.Length >= 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AdjustedAmountIndicator, length must be less than or equal to 1.", new [] { "AdjustedAmountIndicator" });
            }

            // AdjustedAmount (string) maxLength
            if(this.AdjustedAmount != null && this.AdjustedAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AdjustedAmount, length must be less than or equal to 12.", new [] { "AdjustedAmount" });
            }

            // FuelCharges (string) maxLength
            if(this.FuelCharges != null && this.FuelCharges.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FuelCharges, length must be less than or equal to 12.", new [] { "FuelCharges" });
            }

            // WeeklyRentalRate (string) maxLength
            if(this.WeeklyRentalRate != null && this.WeeklyRentalRate.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for WeeklyRentalRate, length must be less than or equal to 12.", new [] { "WeeklyRentalRate" });
            }

            // DailyRentalRate (string) maxLength
            if(this.DailyRentalRate != null && this.DailyRentalRate.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DailyRentalRate, length must be less than or equal to 12.", new [] { "DailyRentalRate" });
            }

            // RatePerMile (string) maxLength
            if(this.RatePerMile != null && this.RatePerMile.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RatePerMile, length must be less than or equal to 12.", new [] { "RatePerMile" });
            }

            // MileageCharge (string) maxLength
            if(this.MileageCharge != null && this.MileageCharge.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MileageCharge, length must be less than or equal to 12.", new [] { "MileageCharge" });
            }

            // ExtraMileageCharge (string) maxLength
            if(this.ExtraMileageCharge != null && this.ExtraMileageCharge.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExtraMileageCharge, length must be less than or equal to 12.", new [] { "ExtraMileageCharge" });
            }

            // LateFeeAmount (string) maxLength
            if(this.LateFeeAmount != null && this.LateFeeAmount.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LateFeeAmount, length must be less than or equal to 12.", new [] { "LateFeeAmount" });
            }

            // TowingCharge (string) maxLength
            if(this.TowingCharge != null && this.TowingCharge.Length >= 4)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TowingCharge, length must be less than or equal to 4.", new [] { "TowingCharge" });
            }

            // ExtraCharge (string) maxLength
            if(this.ExtraCharge != null && this.ExtraCharge.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExtraCharge, length must be less than or equal to 12.", new [] { "ExtraCharge" });
            }

            // GpsCharge (string) maxLength
            if(this.GpsCharge != null && this.GpsCharge.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GpsCharge, length must be less than or equal to 12.", new [] { "GpsCharge" });
            }

            // PhoneCharge (string) maxLength
            if(this.PhoneCharge != null && this.PhoneCharge.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PhoneCharge, length must be less than or equal to 12.", new [] { "PhoneCharge" });
            }

            // ParkingViolationCharge (string) maxLength
            if(this.ParkingViolationCharge != null && this.ParkingViolationCharge.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ParkingViolationCharge, length must be less than or equal to 12.", new [] { "ParkingViolationCharge" });
            }

            // OtherCharges (string) maxLength
            if(this.OtherCharges != null && this.OtherCharges.Length >= 12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OtherCharges, length must be less than or equal to 12.", new [] { "OtherCharges" });
            }
