...
namespace CyberSource.Model
{
    ...
    public partial class PtsV2PaymentsPost201ResponsePaymentInformationBankAccount :  IEquatable<PtsV2PaymentsPost201ResponsePaymentInformationBankAccount>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="CorrectedAccountNumber">Corrected account number from the ACH verification service. .</param>
        ...
        public override string ToString()
        {
            ...
            if (CorrectedAccountNumber != null) sb.Append("  CorrectedAccountNumber: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("PtsV2PaymentsPost201ResponsePaymentInformationBankAccount", "correctedAccountNumber", CorrectedAccountNumber.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("PtsV2PaymentsPost201ResponsePaymentInformationBankAccount", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
