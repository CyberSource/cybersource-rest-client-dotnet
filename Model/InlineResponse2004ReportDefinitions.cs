...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004ReportDefinitions :  IEquatable<InlineResponse2004ReportDefinitions>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004ReportDefinitions" /> class.
        /// </summary>
        ...
        public InlineResponse2004ReportDefinitions(string Type = default(string), int? ReportDefinitionId = default(int?), string ReportDefintionName = default(string), List<SupportedFormatsEnum> SupportedFormats = default(List<SupportedFormatsEnum>), string Description = default(string))
        {
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2004ReportDefinitions);
        }

        /// <summary>
        /// Returns true if InlineResponse2004ReportDefinitions instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2004ReportDefinitions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004ReportDefinitions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
