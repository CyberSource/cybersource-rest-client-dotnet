...
namespace CyberSource.Model
{
    ...
    public partial class InlineResponse2013 :  IEquatable<InlineResponse2013>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (PaymentAccountInformation != null) sb.Append("  PaymentAccountInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2013", "paymentAccountInformation", PaymentAccountInformation.ToString())).Append("\n");
            if (IssuerInformation != null) sb.Append("  IssuerInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2013", "issuerInformation", IssuerInformation.ToString())).Append("\n");
            if (PayoutInformation != null) sb.Append("  PayoutInformation: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("InlineResponse2013", "payoutInformation", PayoutInformation.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("InlineResponse2013", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
