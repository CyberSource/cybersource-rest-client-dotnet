...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002IntegrationInformationTenantConfigurations :  IEquatable<InlineResponse2002IntegrationInformationTenantConfigurations>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002IntegrationInformationTenantConfigurations" /> class.
        /// </summary>
        ...
        public InlineResponse2002IntegrationInformationTenantConfigurations(string SolutionId = default(string), string TenantConfigurationId = default(string), StatusEnum? Status = default(StatusEnum?), DateTime? SubmitTimeUtc = default(DateTime?), Boardingv1registrationsIntegrationInformationTenantInformation TenantInformation = default(Boardingv1registrationsIntegrationInformationTenantInformation))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse2002IntegrationInformationTenantConfigurations);
        }

        /// <summary>
        /// Returns true if InlineResponse2002IntegrationInformationTenantConfigurations instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2002IntegrationInformationTenantConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002IntegrationInformationTenantConfigurations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // TenantConfigurationId (string) pattern
            Regex regexTenantConfigurationId = new Regex(@"^[0-9a-zA-Z_]+$", RegexOptions.CultureInvariant);
            if (false == regexTenantConfigurationId.Match(this.TenantConfigurationId).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantConfigurationId, must match a pattern of " + regexTenantConfigurationId, new [] { "TenantConfigurationId" });
            }
