...
namespace CybsQaScript.TransactionBatches.CoreServices
{
    public class GetIndividualBatchFile
    {
        public static void GetTransBatchExec()
        {
            // Initialize Api Name
            var apiFunctionName = "GetIndividualBatchFile";
            ...
            using (var csv =
                new CsvReader(new StreamReader(@"../../CSV_Files/TransactionBatches/CoreServices/GetIndividualBatchFile.csv"), true))
            {
                ...
                using (var writer = new CsvFileWriter(@"../../CSV_Files/TestReport/TestResults.csv"))
                {
                    ...
                    while (csv.ReadNextRecord())
                    {
                        ...
                        try
                        {
                            ...
                            var response = apiInstance.PtsV1TransactionBatchesIdGetWithHttpInfo(id);
                            ...
                            if (response != null)
                            {
                                ...
                                if (id != idInResponse)
                                {
                                    ...
                                    resultMessage = "Fails due to mismatch in id";
                                }
                                else
                                {
