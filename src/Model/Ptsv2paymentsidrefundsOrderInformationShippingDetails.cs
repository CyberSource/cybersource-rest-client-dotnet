...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Ptsv2paymentsidrefundsOrderInformationShippingDetails :  IEquatable<Ptsv2paymentsidrefundsOrderInformationShippingDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ptsv2paymentsidrefundsOrderInformationShippingDetails" /> class.
        /// </summary>
        ...
        public Ptsv2paymentsidrefundsOrderInformationShippingDetails(string ShipFromPostalCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Ptsv2paymentsidrefundsOrderInformationShippingDetails {\n");
            if (ShipFromPostalCode != null) sb.Append("  ShipFromPostalCode: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Ptsv2paymentsidrefundsOrderInformationShippingDetails", "shipFromPostalCode", ShipFromPostalCode.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Ptsv2paymentsidrefundsOrderInformationShippingDetails", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Ptsv2paymentsidrefundsOrderInformationShippingDetails);
        }

        /// <summary>
        /// Returns true if Ptsv2paymentsidrefundsOrderInformationShippingDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of Ptsv2paymentsidrefundsOrderInformationShippingDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ptsv2paymentsidrefundsOrderInformationShippingDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
