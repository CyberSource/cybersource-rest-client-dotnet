...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ErrorBean :  IEquatable<ErrorBean>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorBean" /> class.
        /// </summary>
        ...
        public ErrorBean(string Code = default(string), string Message = default(string), string LocalizationKey = default(string), string CorrelationId = default(string), string Detail = default(string), List<InlineResponse4001Fields> Fields = default(List<InlineResponse4001Fields>))
        {
            ...
            if (Code == null)
            {
                throw new InvalidDataException("Code is a required property for ErrorBean and cannot be null");
            }
            else
            {
                this.Code = Code;
            ...
            if (Message == null)
            {
                throw new InvalidDataException("Message is a required property for ErrorBean and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ErrorBean);
        }

        /// <summary>
        /// Returns true if ErrorBean instances are equal
        /// </summary>
        /// <param name="other">Instance of ErrorBean to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorBean other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
