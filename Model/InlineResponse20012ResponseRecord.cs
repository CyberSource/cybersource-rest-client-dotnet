...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012ResponseRecord :  IEquatable<InlineResponse20012ResponseRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012ResponseRecord" /> class.
        /// </summary>
        ...
        public InlineResponse20012ResponseRecord(string Response = default(string), string Reason = default(string), string Token = default(string), string InstrumentIdentifierId = default(string), string InstrumentIdentifierCreated = default(string), string CardNumber = default(string), string CardExpiryMonth = default(string), string CardExpiryYear = default(string), string CardType = default(string), List<InlineResponse20012ResponseRecordAdditionalUpdates> AdditionalUpdates = default(List<InlineResponse20012ResponseRecordAdditionalUpdates>))
        {
        ...
        public List<InlineResponse20012ResponseRecordAdditionalUpdates> AdditionalUpdates { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse20012ResponseRecord);
        }

        /// <summary>
        /// Returns true if InlineResponse20012ResponseRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse20012ResponseRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012ResponseRecord other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
