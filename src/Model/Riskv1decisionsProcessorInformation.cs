...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1decisionsProcessorInformation :  IEquatable<Riskv1decisionsProcessorInformation>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            if (Avs != null) sb.Append("  Avs: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsProcessorInformation", "avs", Avs.ToString())).Append("\n");
            if (CardVerification != null) sb.Append("  CardVerification: ").Append(CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskFieldValue("Riskv1decisionsProcessorInformation", "cardVerification", CardVerification.ToString())).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return CyberSource.Utilities.SensitiveFieldMaskingUtility.MaskSensitiveDataInJson("Riskv1decisionsProcessorInformation", JsonSerializer.Serialize(this, CyberSource.Utilities.Serialization.ModelLevelSerializerOptions.ToJsonOptions));
        }
