...
namespace CyberSource.Model
{
    ...
    public partial class Riskv1exportcomplianceinquiriesOrderInformationBillTo :  IEquatable<Riskv1exportcomplianceinquiriesOrderInformationBillTo>, IValidatableObject
    {
        ...
        /// <param name="Email">Customer&#39;s email address, including the full domain name.  #### CyberSource through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. CyberSource through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent CyberSource through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, CyberSource through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.  **Important** It is your responsibility to determine whether a field is required for the transaction you are requesting.  For processor-specific information, see the &#x60;customer_email&#x60; request-level field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)  #### Invoicing Email address for the customer for sending the invoice. If the invoice is in SENT status and email is updated, the old email customer payment link won&#39;t work and you must resend the invoice with the new payment link.  (required).</param>
        public Riskv1exportcomplianceinquiriesOrderInformationBillTo(string Address1 = default(string), string Address2 = default(string), string Address3 = default(string), string Address4 = default(string), string AdministrativeArea = default(string), string Country = default(string), string Locality = default(string), string PostalCode = default(string), Riskv1exportcomplianceinquiriesOrderInformationBillToCompany Company = default(Riskv1exportcomplianceinquiriesOrderInformationBillToCompany), string FirstName = default(string), string LastName = default(string), string Email = default(string))
        {
            ...
            if (Address1 == null)
            {
                throw new InvalidDataException("Address1 is a required property for Riskv1exportcomplianceinquiriesOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for Riskv1exportcomplianceinquiriesOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (Locality == null)
            {
                throw new InvalidDataException("Locality is a required property for Riskv1exportcomplianceinquiriesOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for Riskv1exportcomplianceinquiriesOrderInformationBillTo and cannot be null");
            }
            else
            {
            ...
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for Riskv1exportcomplianceinquiriesOrderInformationBillTo and cannot be null");
            }
            else
            {
                this.Email = Email;
