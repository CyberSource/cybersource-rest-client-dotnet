...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2paymentsBuyerInformation :  IEquatable<V2paymentsBuyerInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2paymentsBuyerInformation" /> class.
        /// </summary>
        ...
        public V2paymentsBuyerInformation(string MerchantCustomerId = default(string), string DateOfBirth = default(string), string VatRegistrationNumber = default(string), List<V2paymentsBuyerInformationPersonalIdentification> PersonalIdentification = default(List<V2paymentsBuyerInformationPersonalIdentification>), string HashedPassword = default(string))
        {
        ...
        public List<V2paymentsBuyerInformationPersonalIdentification> PersonalIdentification { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2paymentsBuyerInformation);
        }

        /// <summary>
        /// Returns true if V2paymentsBuyerInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of V2paymentsBuyerInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2paymentsBuyerInformation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
