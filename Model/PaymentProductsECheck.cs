...
namespace CyberSource.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProductsECheck :  IEquatable<PaymentProductsECheck>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProductsECheck" /> class.
        /// </summary>
        ...
        public PaymentProductsECheck(PaymentProductsECheckSubscriptionInformation SubscriptionInformation = default(PaymentProductsECheckSubscriptionInformation), PaymentProductsECheckConfigurationInformation ConfigurationInformation = default(PaymentProductsECheckConfigurationInformation))
        {
        ...
        public PaymentProductsECheckSubscriptionInformation SubscriptionInformation { get; set; }

        /// <summary>
        /// Gets or Sets ConfigurationInformation
        /// </summary>
        [DataMember(Name="configurationInformation", EmitDefaultValue=false)]
        public PaymentProductsECheckConfigurationInformation ConfigurationInformation { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentProductsECheck);
        }

        /// <summary>
        /// Returns true if PaymentProductsECheck instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProductsECheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProductsECheck other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
